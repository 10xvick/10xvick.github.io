 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(U,q){var k=U.length;U.push(q);e:for(;0<k;){var Z=k-1>>>1,J=U[Z];if(0<r(J,q))U[Z]=q,U[k]=J,k=Z;else break e}}function n(U){return U.length===0?null:U[0]}function i(U){if(U.length===0)return null;var q=U[0],k=U.pop();if(k!==q){U[0]=k;e:for(var Z=0,J=U.length,ve=J>>>1;Z<ve;){var ye=2*(Z+1)-1,Me=U[ye],Y=ye+1,re=U[Y];if(0>r(Me,k))Y<J&&0>r(re,Me)?(U[Z]=re,U[Y]=k,Z=Y):(U[Z]=Me,U[ye]=k,Z=ye);else if(Y<J&&0>r(re,k))U[Z]=re,U[Y]=k,Z=Y;else break e}}return q}function r(U,q){var k=U.sortIndex-q.sortIndex;return k!==0?k:U.id-q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],h=1,u=null,d=3,m=!1,_=!1,M=!1,p=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(U){for(var q=n(c);q!==null;){if(q.callback===null)i(c);else if(q.startTime<=U)i(c),q.sortIndex=q.expirationTime,e(l,q);else break;q=n(c)}}function S(U){if(M=!1,y(U),!_)if(n(l)!==null)_=!0,K(R);else{var q=n(c);q!==null&&z(S,q.startTime-U)}}function R(U,q){_=!1,M&&(M=!1,f(g),g=-1),m=!0;var k=d;try{for(y(q),u=n(l);u!==null&&(!(u.expirationTime>q)||U&&!P());){var Z=u.callback;if(typeof Z=="function"){u.callback=null,d=u.priorityLevel;var J=Z(u.expirationTime<=q);q=t.unstable_now(),typeof J=="function"?u.callback=J:u===n(l)&&i(l),y(q)}else i(l);u=n(l)}if(u!==null)var ve=!0;else{var ye=n(c);ye!==null&&z(S,ye.startTime-q),ve=!1}return ve}finally{u=null,d=k,m=!1}}var A=!1,T=null,g=-1,w=5,C=-1;function P(){return!(t.unstable_now()-C<w)}function L(){if(T!==null){var U=t.unstable_now();C=U;var q=!0;try{q=T(!0,U)}finally{q?I():(A=!1,T=null)}}else A=!1}var I;if(typeof v=="function")I=function(){v(L)};else if(typeof MessageChannel<"u"){var X=new MessageChannel,O=X.port2;X.port1.onmessage=L,I=function(){O.postMessage(null)}}else I=function(){p(L,0)};function K(U){T=U,A||(A=!0,I())}function z(U,q){g=p(function(){U(t.unstable_now())},q)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(U){U.callback=null},t.unstable_continueExecution=function(){_||m||(_=!0,K(R))},t.unstable_forceFrameRate=function(U){0>U||125<U?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):w=0<U?Math.floor(1e3/U):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(U){switch(d){case 1:case 2:case 3:var q=3;break;default:q=d}var k=d;d=q;try{return U()}finally{d=k}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(U,q){switch(U){case 1:case 2:case 3:case 4:case 5:break;default:U=3}var k=d;d=U;try{return q()}finally{d=k}},t.unstable_scheduleCallback=function(U,q,k){var Z=t.unstable_now();switch(typeof k=="object"&&k!==null?(k=k.delay,k=typeof k=="number"&&0<k?Z+k:Z):k=Z,U){case 1:var J=-1;break;case 2:J=250;break;case 5:J=1073741823;break;case 4:J=1e4;break;default:J=5e3}return J=k+J,U={id:h++,callback:q,priorityLevel:U,startTime:k,expirationTime:J,sortIndex:-1},k>Z?(U.sortIndex=k,e(c,U),n(l)===null&&U===n(c)&&(M?(f(g),g=-1):M=!0,z(S,k-Z))):(U.sortIndex=J,e(l,U),_||m||(_=!0,K(R))),U},t.unstable_shouldYield=P,t.unstable_wrapCallback=function(U){var q=d;return function(){var k=d;d=q;try{return U.apply(this,arguments)}finally{d=k}}}})(Qm);Jm.exports=Qm;var u_=Jm.exports;/**
 * @license React
...
`)+`
`+f);const y=v+p+o,S=v+f+a,R=Am(r,r.VERTEX_SHADER,y),A=Am(r,r.FRAGMENT_SHADER,S);r.attachShader(M,R),r.attachShader(M,A),n.index0AttributeName!==void 0?r.bindAttribLocation(M,0,n.index0AttributeName):n.hasPositionAttribute===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function T(P){if(t.debug.checkShaderErrors){const L=r.getProgramInfoLog(M)||"",I=r.getShaderInfoLog(R)||"",X=r.getShaderInfoLog(A)||"",O=L.trim(),K=I.trim(),z=X.trim();let U=!0,q=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(U=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,M,R,A);else{const k=Cm(r,R,"vertex"),Z=Cm(r,A,"fragment");Ye("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
