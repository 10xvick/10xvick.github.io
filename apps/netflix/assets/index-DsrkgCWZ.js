 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(U,q){var j=U.length;U.push(q);e:for(;0<j;){var G=j-1>>>1,J=U[G];if(0<r(J,q))U[G]=q,U[j]=J,j=G;else break e}}function n(U){return U.length===0?null:U[0]}function i(U){if(U.length===0)return null;var q=U[0],j=U.pop();if(j!==q){U[0]=j;e:for(var G=0,J=U.length,Me=J>>>1;G<Me;){var _e=2*(G+1)-1,ge=U[_e],K=_e+1,se=U[K];if(0>r(ge,j))K<J&&0>r(se,ge)?(U[G]=se,U[K]=j,G=K):(U[G]=ge,U[_e]=j,G=_e);else if(K<J&&0>r(se,j))U[G]=se,U[K]=j,G=K;else break e}}return q}function r(U,q){var j=U.sortIndex-q.sortIndex;return j!==0?j:U.id-q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],h=1,u=null,d=3,m=!1,v=!1,M=!1,p=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function S(U){for(var q=n(c);q!==null;){if(q.callback===null)i(c);else if(q.startTime<=U)i(c),q.sortIndex=q.expirationTime,e(l,q);else break;q=n(c)}}function y(U){if(M=!1,S(U),!v)if(n(l)!==null)v=!0,Y(A);else{var q=n(c);q!==null&&B(y,q.startTime-U)}}function A(U,q){v=!1,M&&(M=!1,f(_),_=-1),m=!0;var j=d;try{for(S(q),u=n(l);u!==null&&(!(u.expirationTime>q)||U&&!P());){var G=u.callback;if(typeof G=="function"){u.callback=null,d=u.priorityLevel;var J=G(u.expirationTime<=q);q=t.unstable_now(),typeof J=="function"?u.callback=J:u===n(l)&&i(l),S(q)}else i(l);u=n(l)}if(u!==null)var Me=!0;else{var _e=n(c);_e!==null&&B(y,_e.startTime-q),Me=!1}return Me}finally{u=null,d=j,m=!1}}var w=!1,R=null,_=-1,E=5,C=-1;function P(){return!(t.unstable_now()-C<E)}function L(){if(R!==null){var U=t.unstable_now();C=U;var q=!0;try{q=R(!0,U)}finally{q?I():(w=!1,R=null)}}else w=!1}var I;if(typeof g=="function")I=function(){g(L)};else if(typeof MessageChannel<"u"){var z=new MessageChannel,D=z.port2;z.port1.onmessage=L,I=function(){D.postMessage(null)}}else I=function(){p(L,0)};function Y(U){R=U,w||(w=!0,I())}function B(U,q){_=p(function(){U(t.unstable_now())},q)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(U){U.callback=null},t.unstable_continueExecution=function(){v||m||(v=!0,Y(A))},t.unstable_forceFrameRate=function(U){0>U||125<U?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):E=0<U?Math.floor(1e3/U):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(U){switch(d){case 1:case 2:case 3:var q=3;break;default:q=d}var j=d;d=q;try{return U()}finally{d=j}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(U,q){switch(U){case 1:case 2:case 3:case 4:case 5:break;default:U=3}var j=d;d=U;try{return q()}finally{d=j}},t.unstable_scheduleCallback=function(U,q,j){var G=t.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?G+j:G):j=G,U){case 1:var J=-1;break;case 2:J=250;break;case 5:J=1073741823;break;case 4:J=1e4;break;default:J=5e3}return J=j+J,U={id:h++,callback:q,priorityLevel:U,startTime:j,expirationTime:J,sortIndex:-1},j>G?(U.sortIndex=j,e(c,U),n(l)===null&&U===n(c)&&(M?(f(_),_=-1):M=!0,B(y,j-G))):(U.sortIndex=J,e(l,U),v||m||(v=!0,Y(A))),U},t.unstable_shouldYield=P,t.unstable_wrapCallback=function(U){var q=d;return function(){var j=d;d=q;try{return U.apply(this,arguments)}finally{d=j}}}})(jm);Jm.exports=jm;var d_=Jm.exports;/**
 * @license React
...
void main() {
	...
	`}class Pv extends hi{constructor(e=1,n={}){super(e,e,n),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new wv(r),this._setTextureOptions(n),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,n){this.texture.type=n.type,this.texture.colorSpace=n.colorSpace,this.texture.generateMipmaps=n.generateMipmaps,this.texture.minFilter=n.minFilter,this.texture.magFilter=n.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new na(5,5,5),s=new Jn({name:"CubemapFromEquirect",uniforms:Gs(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:_n,blending:Ci});s.uniforms.tEquirect.value=n;const o=new pn(r,s),a=n.minFilter;return n.minFilter===Lr&&(n.minFilter=en),new qS(1,10,this).update(e,o),n.minFilter=a,o.geometry.dispose(),o.material.dispose(),this}clear(e,n=!0,i=!0,r=!0){const s=e.getRenderTarget();for(let o=0;o<6;o++)e.setRenderTarget(this,o),e.clear(n,i,r);e.setRenderTarget(s)}}function G1(t){let e=new WeakMap,n=new WeakMap,i=null;function r(d,m=!1){return d==null?null:m?o(d):s(d)}function s(d){if(d&&d.isTexture){const m=d.mapping;if(m===kc||m===Bc)if(e.has(d)){const v=e.get(d).texture;return a(v,d.mapping)}else{const v=d.image;if(v&&v.height>0){const M=new Pv(v.height);return M.fromEquirectangularTexture(t,d),e.set(d,M),d.addEventListener("dispose",c),a(M.texture,d.mapping)}else return null}}return d}function o(d){if(d&&d.isTexture){const m=d.mapping,v=m===kc||m===Bc,M=m===Vr||m===Vs;if(v||M){let p=n.get(d);const f=p!==void 0?p.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==f)return i===null&&(i=new mm(t)),p=v?i.fromEquirectangular(d,p):i.fromCubemap(d,p),p.texture.pmremVersion=d.pmremVersion,n.set(d,p),p.texture;if(p!==void 0)return p.texture;{const g=d.image;return v&&g&&g.height>0||M&&g&&l(g)?(i===null&&(i=new mm(t)),p=v?i.fromEquirectangular(d):i.fromCubemap(d),p.texture.pmremVersion=d.pmremVersion,n.set(d,p),d.addEventListener("dispose",h),p.texture):null}}}return d}function a(d,m){return m===kc?d.mapping=Vr:m===Bc&&(d.mapping=Vs),d}function l(d){let m=0;const v=6;for(let M=0;M<v;M++)d[M]!==void 0&&m++;return m===v}function c(d){const m=d.target;m.removeEventListener("dispose",c);const v=e.get(m);v!==void 0&&(e.delete(m),v.dispose())}function h(d){const m=d.target;m.removeEventListener("dispose",h);const v=n.get(m);v!==void 0&&(n.delete(m),v.dispose())}function u(){e=new WeakMap,n=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:u}}function W1(t){const e={};function n(i){if(e[i]!==void 0)return e[i];const r=t.getExtension(i);return e[i]=r,r}return{has:function(i){return n(i)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(i){const r=n(i);return r===null&&Ls("WebGLRenderer: "+i+" extension not supported."),r}}}function X1(t,e,n,i){const r={},s=new WeakMap;function o(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const v in d.attributes)e.remove(d.attributes[v]);d.removeEventListener("dispose",o),delete r[d.id];const m=s.get(d);m&&(e.remove(m),s.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,n.memory.geometries--}function a(u,d){return r[d.id]===!0||(d.addEventListener("dispose",o),r[d.id]=!0,n.memory.geometries++),d}function l(u){const d=u.attributes;for(const m in d)e.update(d[m],t.ARRAY_BUFFER)}function c(u){const d=[],m=u.index,v=u.attributes.position;let M=0;if(v===void 0)return;if(m!==null){const g=m.array;M=m.version;for(let S=0,y=g.length;S<y;S+=3){const A=g[S+0],w=g[S+1],R=g[S+2];d.push(A,w,w,R,R,A)}}else{const g=v.array;M=v.version;for(let S=0,y=g.length/3-1;S<y;S+=3){const A=S+0,w=S+1,R=S+2;d.push(A,w,w,R,R,A)}}const p=new(v.count>=65535?Ev:Mv)(d,1);p.version=M;const f=s.get(u);f&&e.remove(f),s.set(u,p)}function h(u){const d=s.get(u);if(d){const m=u.index;m!==null&&d.version<m.version&&c(u)}else c(u);return s.get(u)}return{get:a,update:l,getWireframeAttribute:h}}function Y1(t,e,n){let i;function r(u){i=u}let s,o;function a(u){s=u.type,o=u.bytesPerElement}function l(u,d){t.drawElements(i,d,s,u*o),n.update(d,i,1)}function c(u,d,m){m!==0&&(t.drawElementsInstanced(i,d,s,u*o,m),n.update(d,i,m))}function h(u,d,m){if(m===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,d,0,s,u,0,m);let M=0;for(let p=0;p<m;p++)M+=d[p];n.update(M,i,1)}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=h}function $1(t){const e={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(n.calls++,o){case t.TRIANGLES:n.triangles+=a*(s/3);break;case t.LINES:n.lines+=a*(s/2);break;case t.LINE_STRIP:n.lines+=a*(s-1);break;case t.LINE_LOOP:n.lines+=a*s;break;case t.POINTS:n.points+=a*s;break;default:$e("WebGLInfo: Unknown draw mode:",o);break}}function r(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:e,render:n,programs:null,autoReset:!0,reset:r,update:i}}function q1(t,e,n){const i=new WeakMap,r=new Mt;function s(o,a,l){const c=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let d=i.get(a);if(d===void 0||d.count!==u){let C=function(){_.dispose(),i.delete(a),a.removeEventListener("dispose",C)};var m=C;d!==void 0&&d.texture.dispose();const v=a.morphAttributes.position!==void 0,M=a.morphAttributes.normal!==void 0,p=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],g=a.morphAttributes.normal||[],S=a.morphAttributes.color||[];let y=0;v===!0&&(y=1),M===!0&&(y=2),p===!0&&(y=3);let A=a.attributes.position.count*y,w=1;A>e.maxTextureSize&&(w=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const R=new Float32Array(A*w*4*u),_=new _v(R,A,w,u);_.type=li,_.needsUpdate=!0;const E=y*4;for(let P=0;P<u;P++){const L=f[P],I=g[P],z=S[P],D=A*w*4*P;for(let Y=0;Y<L.count;Y++){const B=Y*E;v===!0&&(r.fromBufferAttribute(L,Y),R[D+B+0]=r.x,R[D+B+1]=r.y,R[D+B+2]=r.z,R[D+B+3]=0),M===!0&&(r.fromBufferAttribute(I,Y),R[D+B+4]=r.x,R[D+B+5]=r.y,R[D+B+6]=r.z,R[D+B+7]=0),p===!0&&(r.fromBufferAttribute(z,Y),R[D+B+8]=r.x,R[D+B+9]=r.y,R[D+B+10]=r.z,R[D+B+11]=z.itemSize===4?r.w:1)}}d={count:u,texture:_,size:new Ke(A,w)},i.set(a,d),a.addEventListener("dispose",C)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(t,"morphTexture",o.morphTexture,n);else{let v=0;for(let p=0;p<c.length;p++)v+=c[p];const M=a.morphTargetsRelative?1:1-v;l.getUniforms().setValue(t,"morphTargetBaseInfluence",M),l.getUniforms().setValue(t,"morphTargetInfluences",c)}l.getUniforms().setValue(t,"morphTargetsTexture",d.texture,n),l.getUniforms().setValue(t,"morphTargetsTextureSize",d.size)}return{update:s}}function K1(t,e,n,i,r){let s=new WeakMap;function o(c){const h=r.render.frame,u=c.geometry,d=e.get(c,u);if(s.get(d)!==h&&(e.update(d),s.set(d,h)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),s.get(c)!==h&&(n.update(c.instanceMatrix,t.ARRAY_BUFFER),c.instanceColor!==null&&n.update(c.instanceColor,t.ARRAY_BUFFER),s.set(c,h))),c.isSkinnedMesh){const m=c.skeleton;s.get(m)!==h&&(m.update(),s.set(m,h))}return d}function a(){s=new WeakMap}function l(c){const h=c.target;h.removeEventListener("dispose",l),i.releaseStatesOfObject(h),n.remove(h.instanceMatrix),h.instanceColor!==null&&n.remove(h.instanceColor)}return{update:o,dispose:a}}const Z1={[nv]:"LINEAR_TONE_MAPPING",[iv]:"REINHARD_TONE_MAPPING",[rv]:"CINEON_TONE_MAPPING",[sv]:"ACES_FILMIC_TONE_MAPPING",[av]:"AGX_TONE_MAPPING",[lv]:"NEUTRAL_TONE_MAPPING",[ov]:"CUSTOM_TONE_MAPPING"};function Q1(t,e,n,i,r,s){const o=new hi(e,n,{type:t,depthBuffer:r,stencilBuffer:s,samples:i?4:0,depthTexture:r?new Hs(e,n):void 0}),a=new hi(e,n,{type:Ui,depthBuffer:!1,stencilBuffer:!1}),l=new ki;l.setAttribute("position",new Pi([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute("uv",new Pi([0,2,0,0,2,0],2));const c=new XS({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)+`
`+f);const S=g+p+o,y=g+f+a,A=wm(r,r.VERTEX_SHADER,S),w=wm(r,r.FRAGMENT_SHADER,y);r.attachShader(M,A),r.attachShader(M,w),n.index0AttributeName!==void 0?r.bindAttribLocation(M,0,n.index0AttributeName):n.hasPositionAttribute===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function R(P){if(t.debug.checkShaderErrors){const L=r.getProgramInfoLog(M)||"",I=r.getShaderInfoLog(A)||"",z=r.getShaderInfoLog(w)||"",D=L.trim(),Y=I.trim(),B=z.trim();let U=!0,q=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(U=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,M,A,w);else{const j=Rm(r,A,"vertex"),G=Rm(r,w,"fragment");$e("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
Program Info Log: `+D+`
`+j+`
`+G)}else D!==""?Ie("WebGLProgram: Program Info Log:",D):(Y===""||B==="")&&(q=!1);q&&(P.diagnostics={runnable:U,programLog:D,vertexShader:{log:Y,prefix:p},fragmentShader:{log:B,prefix:f}})}r.deleteShader(A),r.deleteShader(w),_=new cl(r,M),E=JT(r,M)}let _;this.getUniforms=function(){return _===void 0&&R(this),_};let E;this.getAttributes=function(){return E===void 0&&R(this),E};let C=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return C===!1&&(C=r.getProgramParameter(M,HT)),C},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(M),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=GT++,this.cacheKey=e,this.usedTimes=1,this.program=M,this.vertexShader=A,this.fragmentShader=w,this}let pw=0;class mw{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,n,i){const r=this._getShaderCacheForMaterial(e);return r.has(n)===!1&&(r.add(n),n.usedTimes++),r.has(i)===!1&&(r.add(i),i.usedTimes++),this}remove(e){const n=this.materialCache.get(e);for(const i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const n=this.materialCache;let i=n.get(e);return i===void 0&&(i=new Set,n.set(e,i)),i}_getShaderStage(e){const n=this.shaderCache;let i=n.get(e);return i===void 0&&(i=new gw(e),n.set(e,i)),i}}class gw{constructor(e){this.id=pw++,this.code=e,this.usedTimes=0}}function vw(t){return t===Hr||t===Ul||t===Fl}function _w(t,e,n,i,r,s){const o=new xv,a=new mw,l=new Set,c=[],h=new Map,u=i.logarithmicDepthBuffer;let d=i.precision;const m={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function v(_){return l.add(_),_===0?"uv":`uv${_}`}function M(_,E,C,P,L,I){const z=P.fog,D=L.geometry,Y=_.isMeshStandardMaterial||_.isMeshLambertMaterial||_.isMeshPhongMaterial?P.environment:null,B=_.isMeshStandardMaterial||_.isMeshLambertMaterial&&!_.envMap||_.isMeshPhongMaterial&&!_.envMap,U=e.get(_.envMap||Y,B),q=U&&U.mapping===rc?U.image.height:null,j=m[_.type];_.precision!==null&&(d=i.getMaxPrecision(_.precision),d!==_.precision&&Ie("WebGLProgram.getParameters:",_.precision,"not supported, using",d,"instead."));const G=D.morphAttributes.position||D.morphAttributes.normal||D.morphAttributes.color,J=G!==void 0?G.length:0;let Me=0;D.morphAttributes.position!==void 0&&(Me=1),D.morphAttributes.normal!==void 0&&(Me=2),D.morphAttributes.color!==void 0&&(Me=3);let _e,ge,K,se;if(j){const Ee=oi[j];_e=Ee.vertexShader,ge=Ee.fragmentShader}else{_e=_.vertexShader,ge=_.fragmentShader;const Ee=a.getVertexShaderStage(_),xt=a.getFragmentShaderStage(_);a.update(_,Ee,xt),K=Ee.id,se=xt.id}const ie=t.getRenderTarget(),De=t.state.buffers.depth.getReversed(),Ue=L.isInstancedMesh===!0,Pe=L.isBatchedMesh===!0,Et=!!_.map,Ve=!!_.matcap,st=!!U,Ze=!!_.aoMap,Xe=!!_.lightMap,Ct=!!_.bumpMap&&_.wireframe===!1,It=!!_.normalMap,kt=!!_.displacementMap,Ht=!!_.emissiveMap,_t=!!_.metalnessMap,bt=!!_.roughnessMap,F=_.anisotropy>0,cn=_.clearcoat>0,je=_.dispersion>0,b=_.iridescence>0,x=_.sheen>0,k=_.transmission>0,W=F&&!!_.anisotropyMap,Z=cn&&!!_.clearcoatMap,oe=cn&&!!_.clearcoatNormalMap,le=cn&&!!_.clearcoatRoughnessMap,Q=b&&!!_.iridescenceMap,te=b&&!!_.iridescenceThicknessMap,ce=x&&!!_.sheenColorMap,Ae=x&&!!_.sheenRoughnessMap,fe=!!_.specularMap,ue=!!_.specularColorMap,be=!!_.specularIntensityMap,Le=k&&!!_.transmissionMap,Fe=k&&!!_.thicknessMap,N=!!_.gradientMap,ae=!!_.alphaMap,ee=_.alphaTest>0,de=!!_.alphaHash,ve=!!_.extensions;let ne=fi;_.toneMapped&&(ie===null||ie.isXRRenderTarget===!0)&&(ne=t.toneMapping);const we={shaderID:j,shaderType:_.type,shaderName:_.name,vertexShader:_e,fragmentShader:ge,defines:_.defines,customVertexShaderID:K,customFragmentShaderID:se,isRawShaderMaterial:_.isRawShaderMaterial===!0,glslVersion:_.glslVersion,precision:d,batching:Pe,batchingColor:Pe&&L._colorsTexture!==null,instancing:Ue,instancingColor:Ue&&L.instanceColor!==null,instancingMorph:Ue&&L.morphTexture!==null,outputColorSpace:ie===null?t.outputColorSpace:ie.isXRRenderTarget===!0?ie.texture.colorSpace:He.workingColorSpace,alphaToCoverage:!!_.alphaToCoverage,map:Et,matcap:Ve,envMap:st,envMapMode:st&&U.mapping,envMapCubeUVHeight:q,aoMap:Ze,lightMap:Xe,bumpMap:Ct,normalMap:It,displacementMap:kt,emissiveMap:Ht,normalMapObjectSpace:It&&_.normalMapType===sS,normalMapTangentSpace:It&&_.normalMapType===Hp,packedNormalMap:It&&_.normalMapType===Hp&&vw(_.normalMap.format),metalnessMap:_t,roughnessMap:bt,anisotropy:F,anisotropyMap:W,clearcoat:cn,clearcoatMap:Z,clearcoatNormalMap:oe,clearcoatRoughnessMap:le,dispersion:je,iridescence:b,iridescenceMap:Q,iridescenceThicknessMap:te,sheen:x,sheenColorMap:ce,sheenRoughnessMap:Ae,specularMap:fe,specularColorMap:ue,specularIntensityMap:be,transmission:k,transmissionMap:Le,thicknessMap:Fe,gradientMap:N,opaque:_.transparent===!1&&_.blending===Ps&&_.alphaToCoverage===!1,alphaMap:ae,alphaTest:ee,alphaHash:de,combine:_.combine,mapUv:Et&&v(_.map.channel),aoMapUv:Ze&&v(_.aoMap.channel),lightMapUv:Xe&&v(_.lightMap.channel),bumpMapUv:Ct&&v(_.bumpMap.channel),normalMapUv:It&&v(_.normalMap.channel),displacementMapUv:kt&&v(_.displacementMap.channel),emissiveMapUv:Ht&&v(_.emissiveMap.channel),metalnessMapUv:_t&&v(_.metalnessMap.channel),roughnessMapUv:bt&&v(_.roughnessMap.channel),anisotropyMapUv:W&&v(_.anisotropyMap.channel),clearcoatMapUv:Z&&v(_.clearcoatMap.channel),clearcoatNormalMapUv:oe&&v(_.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:le&&v(_.clearcoatRoughnessMap.channel),iridescenceMapUv:Q&&v(_.iridescenceMap.channel),iridescenceThicknessMapUv:te&&v(_.iridescenceThicknessMap.channel),sheenColorMapUv:ce&&v(_.sheenColorMap.channel),sheenRoughnessMapUv:Ae&&v(_.sheenRoughnessMap.channel),specularMapUv:fe&&v(_.specularMap.channel),specularColorMapUv:ue&&v(_.specularColorMap.channel),specularIntensityMapUv:be&&v(_.specularIntensityMap.channel),transmissionMapUv:Le&&v(_.transmissionMap.channel),thicknessMapUv:Fe&&v(_.thicknessMap.channel),alphaMapUv:ae&&v(_.alphaMap.channel),vertexTangents:!!D.attributes.tangent&&(It||F),vertexNormals:!!D.attributes.normal,vertexColors:_.vertexColors,vertexAlphas:_.vertexColors===!0&&!!D.attributes.color&&D.attributes.color.itemSize===4,pointsUvs:L.isPoints===!0&&!!D.attributes.uv&&(Et||ae),fog:!!z,useFog:_.fog===!0,fogExp2:!!z&&z.isFogExp2,flatShading:_.wireframe===!1&&(_.flatShading===!0||D.attributes.normal===void 0&&It===!1&&(_.isMeshLambertMaterial||_.isMeshPhongMaterial||_.isMeshStandardMaterial||_.isMeshPhysicalMaterial)),sizeAttenuation:_.sizeAttenuation===!0,logarithmicDepthBuffer:u,reversedDepthBuffer:De,skinning:L.isSkinnedMesh===!0,hasPositionAttribute:D.attributes.position!==void 0,morphTargets:D.morphAttributes.position!==void 0,morphNormals:D.morphAttributes.normal!==void 0,morphColors:D.morphAttributes.color!==void 0,morphTargetsCount:J,morphTextureStride:Me,numDirLights:E.directional.length,numPointLights:E.point.length,numSpotLights:E.spot.length,numSpotLightMaps:E.spotLightMap.length,numRectAreaLights:E.rectArea.length,numHemiLights:E.hemi.length,numDirLightShadows:E.directionalShadowMap.length,numPointLightShadows:E.pointShadowMap.length,numSpotLightShadows:E.spotShadowMap.length,numSpotLightShadowsWithMaps:E.numSpotLightShadowsWithMaps,numLightProbes:E.numLightProbes,numLightProbeGrids:I.length,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:_.dithering,shadowMapEnabled:t.shadowMap.enabled&&C.length>0,shadowMapType:t.shadowMap.type,toneMapping:ne,decodeVideoTexture:Et&&_.map.isVideoTexture===!0&&He.getTransfer(_.map.colorSpace)===nt,decodeVideoTextureEmissive:Ht&&_.emissiveMap.isVideoTexture===!0&&He.getTransfer(_.emissiveMap.colorSpace)===nt,premultipliedAlpha:_.premultipliedAlpha,doubleSided:_.side===En,flipSided:_.side===_n,useDepthPacking:_.depthPacking>=0,depthPacking:_.depthPacking||0,index0AttributeName:_.index0AttributeName,extensionClipCullDistance:ve&&_.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ve&&_.extensions.multiDraw===!0||Pe)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:_.customProgramCacheKey()};return we.vertexUv1s=l.has(1),we.vertexUv2s=l.has(2),we.vertexUv3s=l.has(3),l.clear(),we}function p(_){const E=[];if(_.shaderID?E.push(_.shaderID):(E.push(_.customVertexShaderID),E.push(_.customFragmentShaderID)),_.defines!==void 0)for(const C in _.defines)E.push(C),E.push(_.defines[C]);return _.isRawShaderMaterial===!1&&(f(E,_),g(E,_),E.push(t.outputColorSpace)),E.push(_.customProgramCacheKey),E.join()}function f(_,E){_.push(E.precision),_.push(E.outputColorSpace),_.push(E.envMapMode),_.push(E.envMapCubeUVHeight),_.push(E.mapUv),_.push(E.alphaMapUv),_.push(E.lightMapUv),_.push(E.aoMapUv),_.push(E.bumpMapUv),_.push(E.normalMapUv),_.push(E.displacementMapUv),_.push(E.emissiveMapUv),_.push(E.metalnessMapUv),_.push(E.roughnessMapUv),_.push(E.anisotropyMapUv),_.push(E.clearcoatMapUv),_.push(E.clearcoatNormalMapUv),_.push(E.clearcoatRoughnessMapUv),_.push(E.iridescenceMapUv),_.push(E.iridescenceThicknessMapUv),_.push(E.sheenColorMapUv),_.push(E.sheenRoughnessMapUv),_.push(E.specularMapUv),_.push(E.specularColorMapUv),_.push(E.specularIntensityMapUv),_.push(E.transmissionMapUv),_.push(E.thicknessMapUv),_.push(E.combine),_.push(E.fogExp2),_.push(E.sizeAttenuation),_.push(E.morphTargetsCount),_.push(E.morphAttributeCount),_.push(E.numDirLights),_.push(E.numPointLights),_.push(E.numSpotLights),_.push(E.numSpotLightMaps),_.push(E.numHemiLights),_.push(E.numRectAreaLights),_.push(E.numDirLightShadows),_.push(E.numPointLightShadows),_.push(E.numSpotLightShadows),_.push(E.numSpotLightShadowsWithMaps),_.push(E.numLightProbes),_.push(E.shadowMapType),_.push(E.toneMapping),_.push(E.numClippingPlanes),_.push(E.numClipIntersection),_.push(E.depthPacking)}function g(_,E){o.disableAll(),E.instancing&&o.enable(0),E.instancingColor&&o.enable(1),E.instancingMorph&&o.enable(2),E.matcap&&o.enable(3),E.envMap&&o.enable(4),E.normalMapObjectSpace&&o.enable(5),E.normalMapTangentSpace&&o.enable(6),E.clearcoat&&o.enable(7),E.iridescence&&o.enable(8),E.alphaTest&&o.enable(9),E.vertexColors&&o.enable(10),E.vertexAlphas&&o.enable(11),E.vertexUv1s&&o.enable(12),E.vertexUv2s&&o.enable(13),E.vertexUv3s&&o.enable(14),E.vertexTangents&&o.enable(15),E.anisotropy&&o.enable(16),E.alphaHash&&o.enable(17),E.batching&&o.enable(18),E.dispersion&&o.enable(19),E.batchingColor&&o.enable(20),E.gradientMap&&o.enable(21),E.packedNormalMap&&o.enable(22),E.vertexNormals&&o.enable(23),_.push(o.mask),o.disableAll(),E.fog&&o.enable(0),E.useFog&&o.enable(1),E.flatShading&&o.enable(2),E.logarithmicDepthBuffer&&o.enable(3),E.reversedDepthBuffer&&o.enable(4),E.skinning&&o.enable(5),E.morphTargets&&o.enable(6),E.morphNormals&&o.enable(7),E.morphColors&&o.enable(8),E.premultipliedAlpha&&o.enable(9),E.shadowMapEnabled&&o.enable(10),E.doubleSided&&o.enable(11),E.flipSided&&o.enable(12),E.useDepthPacking&&o.enable(13),E.dithering&&o.enable(14),E.transmission&&o.enable(15),E.sheen&&o.enable(16),E.opaque&&o.enable(17),E.pointsUvs&&o.enable(18),E.decodeVideoTexture&&o.enable(19),E.decodeVideoTextureEmissive&&o.enable(20),E.alphaToCoverage&&o.enable(21),E.numLightProbeGrids>0&&o.enable(22),E.hasPositionAttribute&&o.enable(23),_.push(o.mask)}function S(_){const E=m[_.type];let C;if(E){const P=oi[E];C=HS.clone(P.uniforms)}else C=_.uniforms;return C}function y(_,E){let C=h.get(E);return C!==void 0?++C.usedTimes:(C=new hw(t,E,_,r),c.push(C),h.set(E,C)),C}function A(_){if(--_.usedTimes===0){const E=c.indexOf(_);c[E]=c[c.length-1],c.pop(),h.delete(_.cacheKey),_.destroy()}}function w(_){a.remove(_)}function R(){a.dispose()}return{getParameters:M,getProgramCacheKey:p,getUniforms:S,acquireProgram:y,releaseProgram:A,releaseShaderCache:w,programs:c,dispose:R}}function xw(){let t=new WeakMap;function e(o){return t.has(o)}function n(o){let a=t.get(o);return a===void 0&&(a={},t.set(o,a)),a}function i(o){t.delete(o)}function r(o,a,l){t.get(o)[a]=l}function s(){t=new WeakMap}return{has:e,get:n,remove:i,update:r,dispose:s}}function yw(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.material.id!==e.material.id?t.material.id-e.material.id:t.materialVariant!==e.materialVariant?t.materialVariant-e.materialVariant:t.z!==e.z?t.z-e.z:t.id-e.id}function Dm(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.z!==e.z?e.z-t.z:t.id-e.id}function Im(){const t=[];let e=0;const n=[],i=[],r=[];function s(){e=0,n.length=0,i.length=0,r.length=0}function o(d){let m=0;return d.isInstancedMesh&&(m+=2),d.isSkinnedMesh&&(m+=1),m}function a(d,m,v,M,p,f){let g=t[e];return g===void 0?(g={id:d.id,object:d,geometry:m,material:v,materialVariant:o(d),groupOrder:M,renderOrder:d.renderOrder,z:p,group:f},t[e]=g):(g.id=d.id,g.object=d,g.geometry=m,g.material=v,g.materialVariant=o(d),g.groupOrder=M,g.renderOrder=d.renderOrder,g.z=p,g.group=f),e++,g}function l(d,m,v,M,p,f){const g=a(d,m,v,M,p,f);v.transmission>0?i.push(g):v.transparent===!0?r.push(g):n.push(g)}function c(d,m,v,M,p,f){const g=a(d,m,v,M,p,f);v.transmission>0?i.unshift(g):v.transparent===!0?r.unshift(g):n.unshift(g)}function h(d,m,v){n.length>1&&n.sort(d||yw),i.length>1&&i.sort(m||Dm),r.length>1&&r.sort(m||Dm),v&&(n.reverse(),i.reverse(),r.reverse())}function u(){for(let d=e,m=t.length;d<m;d++){const v=t[d];if(v.id===null)break;v.id=null,v.object=null,v.geometry=null,v.material=null,v.group=null}}return{opaque:n,transmissive:i,transparent:r,init:s,push:l,unshift:c,finish:u,sort:h}}function Sw(){let t=new WeakMap;function e(i,r){const s=t.get(i);let o;return s===void 0?(o=new Im,t.set(i,[o])):r>=s.length?(o=new Im,s.push(o)):o=s[r],o}function n(){t=new WeakMap}return{get:e,dispose:n}}function Mw(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new X,color:new Je};break;case"SpotLight":n={position:new X,direction:new X,color:new Je,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new X,color:new Je,distance:0,decay:0};break;case"HemisphereLight":n={direction:new X,skyColor:new Je,groundColor:new Je};break;case"RectAreaLight":n={color:new Je,position:new X,halfWidth:new X,halfHeight:new X};break}return t[e.id]=n,n}}}function Ew(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ke};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ke};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ke,shadowCameraNear:1,shadowCameraFar:1e3};break}return t[e.id]=n,n}}}let Tw=0;function ww(t,e){return(e.castShadow?2:0)-(t.castShadow?2:0)+(e.map?1:0)-(t.map?1:0)}function Aw(t){const e=new Mw,n=Ew(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new X);const r=new X,s=new Dt,o=new Dt;function a(c){let h=0,u=0,d=0;for(let E=0;E<9;E++)i.probe[E].set(0,0,0);let m=0,v=0,M=0,p=0,f=0,g=0,S=0,y=0,A=0,w=0,R=0;c.sort(ww);for(let E=0,C=c.length;E<C;E++){const P=c[E],L=P.color,I=P.intensity,z=P.distance;let D=null;if(P.shadow&&P.shadow.map&&(P.shadow.map.texture.format===Hr?D=P.shadow.map.texture:D=P.shadow.map.depthTexture||P.shadow.map.texture),P.isAmbientLight)h+=L.r*I,u+=L.g*I,d+=L.b*I;else if(P.isLightProbe){for(let Y=0;Y<9;Y++)i.probe[Y].addScaledVector(P.sh.coefficients[Y],I);R++}else if(P.isDirectionalLight){const Y=e.get(P);if(Y.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){const B=P.shadow,U=n.get(P);U.shadowIntensity=B.intensity,U.shadowBias=B.bias,U.shadowNormalBias=B.normalBias,U.shadowRadius=B.radius,U.shadowMapSize=B.mapSize,i.directionalShadow[m]=U,i.directionalShadowMap[m]=D,i.directionalShadowMatrix[m]=P.shadow.matrix,g++}i.directional[m]=Y,m++}else if(P.isSpotLight){const Y=e.get(P);Y.position.setFromMatrixPosition(P.matrixWorld),Y.color.copy(L).multiplyScalar(I),Y.distance=z,Y.coneCos=Math.cos(P.angle),Y.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),Y.decay=P.decay,i.spot[M]=Y;const B=P.shadow;if(P.map&&(i.spotLightMap[A]=P.map,A++,B.updateMatrices(P),P.castShadow&&w++),i.spotLightMatrix[M]=B.matrix,P.castShadow){const U=n.get(P);U.shadowIntensity=B.intensity,U.shadowBias=B.bias,U.shadowNormalBias=B.normalBias,U.shadowRadius=B.radius,U.shadowMapSize=B.mapSize,i.spotShadow[M]=U,i.spotShadowMap[M]=D,y++}M++}else if(P.isRectAreaLight){const Y=e.get(P);Y.color.copy(L).multiplyScalar(I),Y.halfWidth.set(P.width*.5,0,0),Y.halfHeight.set(0,P.height*.5,0),i.rectArea[p]=Y,p++}else if(P.isPointLight){const Y=e.get(P);if(Y.color.copy(P.color).multiplyScalar(P.intensity),Y.distance=P.distance,Y.decay=P.decay,P.castShadow){const B=P.shadow,U=n.get(P);U.shadowIntensity=B.intensity,U.shadowBias=B.bias,U.shadowNormalBias=B.normalBias,U.shadowRadius=B.radius,U.shadowMapSize=B.mapSize,U.shadowCameraNear=B.camera.near,U.shadowCameraFar=B.camera.far,i.pointShadow[v]=U,i.pointShadowMap[v]=D,i.pointShadowMatrix[v]=P.shadow.matrix,S++}i.point[v]=Y,v++}else if(P.isHemisphereLight){const Y=e.get(P);Y.skyColor.copy(P.color).multiplyScalar(I),Y.groundColor.copy(P.groundColor).multiplyScalar(I),i.hemi[f]=Y,f++}}p>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=he.LTC_FLOAT_1,i.rectAreaLTC2=he.LTC_FLOAT_2):(i.rectAreaLTC1=he.LTC_HALF_1,i.rectAreaLTC2=he.LTC_HALF_2)),i.ambient[0]=h,i.ambient[1]=u,i.ambient[2]=d;const _=i.hash;(_.directionalLength!==m||_.pointLength!==v||_.spotLength!==M||_.rectAreaLength!==p||_.hemiLength!==f||_.numDirectionalShadows!==g||_.numPointShadows!==S||_.numSpotShadows!==y||_.numSpotMaps!==A||_.numLightProbes!==R)&&(i.directional.length=m,i.spot.length=M,i.rectArea.length=p,i.point.length=v,i.hemi.length=f,i.directionalShadow.length=g,i.directionalShadowMap.length=g,i.pointShadow.length=S,i.pointShadowMap.length=S,i.spotShadow.length=y,i.spotShadowMap.length=y,i.directionalShadowMatrix.length=g,i.pointShadowMatrix.length=S,i.spotLightMatrix.length=y+A-w,i.spotLightMap.length=A,i.numSpotLightShadowsWithMaps=w,i.numLightProbes=R,_.directionalLength=m,_.pointLength=v,_.spotLength=M,_.rectAreaLength=p,_.hemiLength=f,_.numDirectionalShadows=g,_.numPointShadows=S,_.numSpotShadows=y,_.numSpotMaps=A,_.numLightProbes=R,i.version=Tw++)}function l(c,h){let u=0,d=0,m=0,v=0,M=0;const p=h.matrixWorldInverse;for(let f=0,g=c.length;f<g;f++){const S=c[f];if(S.isDirectionalLight){const y=i.directional[u];y.direction.setFromMatrixPosition(S.matrixWorld),r.setFromMatrixPosition(S.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(p),u++}else if(S.isSpotLight){const y=i.spot[m];y.position.setFromMatrixPosition(S.matrixWorld),y.position.applyMatrix4(p),y.direction.setFromMatrixPosition(S.matrixWorld),r.setFromMatrixPosition(S.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(p),m++}else if(S.isRectAreaLight){const y=i.rectArea[v];y.position.setFromMatrixPosition(S.matrixWorld),y.position.applyMatrix4(p),o.identity(),s.copy(S.matrixWorld),s.premultiply(p),o.extractRotation(s),y.halfWidth.set(S.width*.5,0,0),y.halfHeight.set(0,S.height*.5,0),y.halfWidth.applyMatrix4(o),y.halfHeight.applyMatrix4(o),v++}else if(S.isPointLight){const y=i.point[d];y.position.setFromMatrixPosition(S.matrixWorld),y.position.applyMatrix4(p),d++}else if(S.isHemisphereLight){const y=i.hemi[M];y.direction.setFromMatrixPosition(S.matrixWorld),y.direction.transformDirection(p),M++}}}return{setup:a,setupView:l,state:i}}function Nm(t){const e=new Aw(t),n=[],i=[],r=[];function s(d){u.camera=d,n.length=0,i.length=0,r.length=0}function o(d){n.push(d)}function a(d){i.push(d)}function l(d){r.push(d)}function c(){e.setup(n)}function h(d){e.setupView(n,d)}const u={lightsArray:n,shadowsArray:i,lightProbeGridArray:r,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:s,state:u,setupLights:c,setupLightsView:h,pushLight:o,pushShadow:a,pushLightProbeGrid:l}}function Rw(t){let e=new WeakMap;function n(r,s=0){const o=e.get(r);let a;return o===void 0?(a=new Nm(t),e.set(r,[a])):s>=o.length?(a=new Nm(t),o.push(a)):a=o[s],a}function i(){e=new WeakMap}return{get:n,dispose:i}}const Cw=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,Pw=[new X(1,0,0),new X(-1,0,0),new X(0,1,0),new X(0,-1,0),new X(0,0,1),new X(0,0,-1)],Lw=[new X(0,-1,0),new X(0,-1,0),new X(0,0,1),new X(0,0,-1),new X(0,-1,0),new X(0,-1,0)],Um=new Dt,uo=new X,gu=new X;function Dw(t,e,n){let i=new Tv;const r=new Ke,s=new Ke,o=new Mt,a=new YS,l=new $S,c={},h=n.maxTextureSize,u={[hr]:_n,[_n]:hr,[En]:En},d=new Jn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ke},radius:{value:4}},vertexShader:Cw,fragmentShader:bw}),m=d.clone();m.defines.HORIZONTAL_PASS=1;const v=new ki;v.setAttribute("position",new pi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new pn(v,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=rl;let f=this.type;this.render=function(w,R,_){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||w.length===0)return;this.type===Fy&&(Ie("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=rl);const E=t.getRenderTarget(),C=t.getActiveCubeFace(),P=t.getActiveMipmapLevel(),L=t.state;L.setBlending(Ci),L.buffers.depth.getReversed()===!0?L.buffers.color.setClear(0,0,0,0):L.buffers.color.setClear(1,1,1,1),L.buffers.depth.setTest(!0),L.setScissorTest(!1);const I=f!==this.type;I&&R.traverse(function(z){z.material&&(Array.isArray(z.material)?z.material.forEach(D=>D.needsUpdate=!0):z.material.needsUpdate=!0)});for(let z=0,D=w.length;z<D;z++){const Y=w[z],B=Y.shadow;if(B===void 0){Ie("WebGLShadowMap:",Y,"has no shadow.");continue}if(B.autoUpdate===!1&&B.needsUpdate===!1)continue;r.copy(B.mapSize);const U=B.getFrameExtents();r.multiply(U),s.copy(B.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/U.x),r.x=s.x*U.x,B.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/U.y),r.y=s.y*U.y,B.mapSize.y=s.y));const q=t.state.buffers.depth.getReversed();if(B.camera._reversedDepth=q,B.map===null||I===!0){if(B.map!==null&&(B.map.depthTexture!==null&&(B.map.depthTexture.dispose(),B.map.depthTexture=null),B.map.dispose()),this.type===go){if(Y.isPointLight){Ie("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}B.map=new hi(r.x,r.y,{format:Hr,type:Ui,minFilter:en,magFilter:en,generateMipmaps:!1}),B.map.texture.name=Y.name+".shadowMap",B.map.depthTexture=new Hs(r.x,r.y,li),B.map.depthTexture.name=Y.name+".shadowMapDepth",B.map.depthTexture.format=Fi,B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=Xt,B.map.depthTexture.magFilter=Xt}else Y.isPointLight?(B.map=new Pv(r.x),B.map.depthTexture=new zS(r.x,mi)):(B.map=new hi(r.x,r.y),B.map.depthTexture=new Hs(r.x,r.y,mi)),B.map.depthTexture.name=Y.name+".shadowMap",B.map.depthTexture.format=Fi,this.type===rl?(B.map.depthTexture.compareFunction=q?sh:rh,B.map.depthTexture.minFilter=en,B.map.depthTexture.magFilter=en):(B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=Xt,B.map.depthTexture.magFilter=Xt);B.camera.updateProjectionMatrix()}const j=B.map.isWebGLCubeRenderTarget?6:1;for(let G=0;G<j;G++){if(B.map.isWebGLCubeRenderTarget)t.setRenderTarget(B.map,G),t.clear();else{G===0&&(t.setRenderTarget(B.map),t.clear());const J=B.getViewport(G);o.set(s.x*J.x,s.y*J.y,s.x*J.z,s.y*J.w),L.viewport(o)}if(Y.isPointLight){const J=B.camera,Me=B.matrix,_e=Y.distance||J.far;_e!==J.far&&(J.far=_e,J.updateProjectionMatrix()),uo.setFromMatrixPosition(Y.matrixWorld),J.position.copy(uo),gu.copy(J.position),gu.add(Pw[G]),J.up.copy(Lw[G]),J.lookAt(gu),J.updateMatrixWorld(),Me.makeTranslation(-uo.x,-uo.y,-uo.z),Um.multiplyMatrices(J.projectionMatrix,J.matrixWorldInverse),B._frustum.setFromProjectionMatrix(Um,J.coordinateSystem,J.reversedDepth)}else B.updateMatrices(Y);i=B.getFrustum(),y(R,_,B.camera,Y,this.type)}B.isPointLightShadow!==!0&&this.type===go&&g(B,_),B.needsUpdate=!1}f=this.type,p.needsUpdate=!1,t.setRenderTarget(E,C,P)};function g(w,R){const _=e.update(M);d.defines.VSM_SAMPLES!==w.blurSamples&&(d.defines.VSM_SAMPLES=w.blurSamples,m.defines.VSM_SAMPLES=w.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new hi(r.x,r.y,{format:Hr,type:Ui})),d.uniforms.shadow_pass.value=w.map.depthTexture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,t.setRenderTarget(w.mapPass),t.clear(),t.renderBufferDirect(R,null,_,d,M,null),m.uniforms.shadow_pass.value=w.mapPass.texture,m.uniforms.resolution.value=w.mapSize,m.uniforms.radius.value=w.radius,t.setRenderTarget(w.map),t.clear(),t.renderBufferDirect(R,null,_,m,M,null)}function S(w,R,_,E){let C=null;const P=_.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(P!==void 0)C=P;else if(C=_.isPointLight===!0?l:a,t.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const L=C.uuid,I=R.uuid;let z=c[L];z===void 0&&(z={},c[L]=z);let D=z[I];D===void 0&&(D=C.clone(),z[I]=D,R.addEventListener("dispose",A)),C=D}if(C.visible=R.visible,C.wireframe=R.wireframe,E===go?C.side=R.shadowSide!==null?R.shadowSide:R.side:C.side=R.shadowSide!==null?R.shadowSide:u[R.side],C.alphaMap=R.alphaMap,C.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,C.map=R.map,C.clipShadows=R.clipShadows,C.clippingPlanes=R.clippingPlanes,C.clipIntersection=R.clipIntersection,C.displacementMap=R.displacementMap,C.displacementScale=R.displacementScale,C.displacementBias=R.displacementBias,C.wireframeLinewidth=R.wireframeLinewidth,C.linewidth=R.linewidth,_.isPointLight===!0&&C.isMeshDistanceMaterial===!0){const L=t.properties.get(C);L.light=_}return C}function y(w,R,_,E,C){if(w.visible===!1)return;if(w.layers.test(R.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&C===go)&&(!w.frustumCulled||i.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,w.matrixWorld);const I=e.update(w),z=w.material;if(Array.isArray(z)){const D=I.groups;for(let Y=0,B=D.length;Y<B;Y++){const U=D[Y],q=z[U.materialIndex];if(q&&q.visible){const j=S(w,q,E,C);w.onBeforeShadow(t,w,R,_,I,j,U),t.renderBufferDirect(_,null,I,j,w,U),w.onAfterShadow(t,w,R,_,I,j,U)}}}else if(z.visible){const D=S(w,z,E,C);w.onBeforeShadow(t,w,R,_,I,D,null),t.renderBufferDirect(_,null,I,D,w,null),w.onAfterShadow(t,w,R,_,I,D,null)}}const L=w.children;for(let I=0,z=L.length;I<z;I++)y(L[I],R,_,E,C)}function A(w){w.target.removeEventListener("dispose",A);for(const _ in c){const E=c[_],C=w.target.uuid;C in E&&(E[C].dispose(),delete E[C])}}}function Iw(t,e){function n(){let N=!1;const ae=new Mt;let ee=null;const de=new Mt(0,0,0,0);return{setMask:function(ve){ee!==ve&&!N&&(t.colorMask(ve,ve,ve,ve),ee=ve)},setLocked:function(ve){N=ve},setClear:function(ve,ne,we,Ee,xt){xt===!0&&(ve*=Ee,ne*=Ee,we*=Ee),ae.set(ve,ne,we,Ee),de.equals(ae)===!1&&(t.clearColor(ve,ne,we,Ee),de.copy(ae))},reset:function(){N=!1,ee=null,de.set(-1,0,0,0)}}}function i(){let N=!1,ae=!1,ee=null,de=null,ve=null;return{setReversed:function(ne){if(ae!==ne){const we=e.get("EXT_clip_control");ne?we.clipControlEXT(we.LOWER_LEFT_EXT,we.ZERO_TO_ONE_EXT):we.clipControlEXT(we.LOWER_LEFT_EXT,we.NEGATIVE_ONE_TO_ONE_EXT),ae=ne;const Ee=ve;ve=null,this.setClear(Ee)}},getReversed:function(){return ae},setTest:function(ne){ne?ie(t.DEPTH_TEST):De(t.DEPTH_TEST)},setMask:function(ne){ee!==ne&&!N&&(t.depthMask(ne),ee=ne)},setFunc:function(ne){if(ae&&(ne=mS[ne]),de!==ne){switch(ne){case fd:t.depthFunc(t.NEVER);break;case hd:t.depthFunc(t.ALWAYS);break;case pd:t.depthFunc(t.LESS);break;case zs:t.depthFunc(t.LEQUAL);break;case md:t.depthFunc(t.EQUAL);break;case gd:t.depthFunc(t.GEQUAL);break;case vd:t.depthFunc(t.GREATER);break;case _d:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}de=ne}},setLocked:function(ne){N=ne},setClear:function(ne){ve!==ne&&(ve=ne,ae&&(ne=1-ne),t.clearDepth(ne))},reset:function(){N=!1,ee=null,de=null,ve=null,ae=!1}}}function r(){let N=!1,ae=null,ee=null,de=null,ve=null,ne=null,we=null,Ee=null,xt=null;return{setTest:function(lt){N||(lt?ie(t.STENCIL_TEST):De(t.STENCIL_TEST))},setMask:function(lt){ae!==lt&&!N&&(t.stencilMask(lt),ae=lt)},setFunc:function(lt,jn,ei){(ee!==lt||de!==jn||ve!==ei)&&(t.stencilFunc(lt,jn,ei),ee=lt,de=jn,ve=ei)},setOp:function(lt,jn,ei){(ne!==lt||we!==jn||Ee!==ei)&&(t.stencilOp(lt,jn,ei),ne=lt,we=jn,Ee=ei)},setLocked:function(lt){N=lt},setClear:function(lt){xt!==lt&&(t.clearStencil(lt),xt=lt)},reset:function(){N=!1,ae=null,ee=null,de=null,ve=null,ne=null,we=null,Ee=null,xt=null}}}const s=new n,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let h={},u={},d={},m=new WeakMap,v=[],M=null,p=!1,f=null,g=null,S=null,y=null,A=null,w=null,R=null,_=new Je(0,0,0),E=0,C=!1,P=null,L=null,I=null,z=null,D=null;const Y=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,U=0;const q=t.getParameter(t.VERSION);q.indexOf("WebGL")!==-1?(U=parseFloat(/^WebGL (\d)/.exec(q)[1]),B=U>=1):q.indexOf("OpenGL ES")!==-1&&(U=parseFloat(/^OpenGL ES (\d)/.exec(q)[1]),B=U>=2);let j=null,G={};const J=t.getParameter(t.SCISSOR_BOX),Me=t.getParameter(t.VIEWPORT),_e=new Mt().fromArray(J),ge=new Mt().fromArray(Me);function K(N,ae,ee,de){const ve=new Uint8Array(4),ne=t.createTexture();t.bindTexture(N,ne),t.texParameteri(N,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(N,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let we=0;we<ee;we++)N===t.TEXTURE_3D||N===t.TEXTURE_2D_ARRAY?t.texImage3D(ae,0,t.RGBA,1,1,de,0,t.RGBA,t.UNSIGNED_BYTE,ve):t.texImage2D(ae+we,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,ve);return ne}const se={};se[t.TEXTURE_2D]=K(t.TEXTURE_2D,t.TEXTURE_2D,1),se[t.TEXTURE_CUBE_MAP]=K(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),se[t.TEXTURE_2D_ARRAY]=K(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),se[t.TEXTURE_3D]=K(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),ie(t.DEPTH_TEST),o.setFunc(zs),Ct(!1),It(kp),ie(t.CULL_FACE),Ze(Ci);function ie(N){h[N]!==!0&&(t.enable(N),h[N]=!0)}function De(N){h[N]!==!1&&(t.disable(N),h[N]=!1)}function Ue(N,ae){return d[N]!==ae?(t.bindFramebuffer(N,ae),d[N]=ae,N===t.DRAW_FRAMEBUFFER&&(d[t.FRAMEBUFFER]=ae),N===t.FRAMEBUFFER&&(d[t.DRAW_FRAMEBUFFER]=ae),!0):!1}function Pe(N,ae){let ee=v,de=!1;if(N){ee=m.get(ae),ee===void 0&&(ee=[],m.set(ae,ee));const ve=N.textures;if(ee.length!==ve.length||ee[0]!==t.COLOR_ATTACHMENT0){for(let ne=0,we=ve.length;ne<we;ne++)ee[ne]=t.COLOR_ATTACHMENT0+ne;ee.length=ve.length,de=!0}}else ee[0]!==t.BACK&&(ee[0]=t.BACK,de=!0);de&&t.drawBuffers(ee)}function Et(N){return M!==N?(t.useProgram(N),M=N,!0):!1}const Ve={[wr]:t.FUNC_ADD,[ky]:t.FUNC_SUBTRACT,[By]:t.FUNC_REVERSE_SUBTRACT};Ve[zy]=t.MIN,Ve[Vy]=t.MAX;const st={[Hy]:t.ZERO,[Gy]:t.ONE,[Wy]:t.SRC_COLOR,[ud]:t.SRC_ALPHA,[Zy]:t.SRC_ALPHA_SATURATE,[qy]:t.DST_COLOR,[Yy]:t.DST_ALPHA,[Xy]:t.ONE_MINUS_SRC_COLOR,[dd]:t.ONE_MINUS_SRC_ALPHA,[Ky]:t.ONE_MINUS_DST_COLOR,[$y]:t.ONE_MINUS_DST_ALPHA,[Qy]:t.CONSTANT_COLOR,[Jy]:t.ONE_MINUS_CONSTANT_COLOR,[jy]:t.CONSTANT_ALPHA,[eS]:t.ONE_MINUS_CONSTANT_ALPHA};function Ze(N,ae,ee,de,ve,ne,we,Ee,xt,lt){if(N===Ci){p===!0&&(De(t.BLEND),p=!1);return}if(p===!1&&(ie(t.BLEND),p=!0),N!==Oy){if(N!==f||lt!==C){if((g!==wr||A!==wr)&&(t.blendEquation(t.FUNC_ADD),g=wr,A=wr),lt)switch(N){case Ps:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Bp:t.blendFunc(t.ONE,t.ONE);break;case zp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Vp:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:$e("WebGLState: Invalid blending: ",N);break}else switch(N){case Ps:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Bp:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case zp:$e("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Vp:$e("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:$e("WebGLState: Invalid blending: ",N);break}S=null,y=null,w=null,R=null,_.set(0,0,0),E=0,f=N,C=lt}return}ve=ve||ae,ne=ne||ee,we=we||de,(ae!==g||ve!==A)&&(t.blendEquationSeparate(Ve[ae],Ve[ve]),g=ae,A=ve),(ee!==S||de!==y||ne!==w||we!==R)&&(t.blendFuncSeparate(st[ee],st[de],st[ne],st[we]),S=ee,y=de,w=ne,R=we),(Ee.equals(_)===!1||xt!==E)&&(t.blendColor(Ee.r,Ee.g,Ee.b,xt),_.copy(Ee),E=xt),f=N,C=!1}function Xe(N,ae){N.side===En?De(t.CULL_FACE):ie(t.CULL_FACE);let ee=N.side===_n;ae&&(ee=!ee),Ct(ee),N.blending===Ps&&N.transparent===!1?Ze(Ci):Ze(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),s.setMask(N.colorWrite);const de=N.stencilWrite;a.setTest(de),de&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),Ht(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?ie(t.SAMPLE_ALPHA_TO_COVERAGE):De(t.SAMPLE_ALPHA_TO_COVERAGE)}function Ct(N){P!==N&&(N?t.frontFace(t.CW):t.frontFace(t.CCW),P=N)}function It(N){N!==Ny?(ie(t.CULL_FACE),N!==L&&(N===kp?t.cullFace(t.BACK):N===Uy?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):De(t.CULL_FACE),L=N}function kt(N){N!==I&&(B&&t.lineWidth(N),I=N)}function Ht(N,ae,ee){N?(ie(t.POLYGON_OFFSET_FILL),(z!==ae||D!==ee)&&(z=ae,D=ee,o.getReversed()&&(ae=-ae),t.polygonOffset(ae,ee))):De(t.POLYGON_OFFSET_FILL)}function _t(N){N?ie(t.SCISSOR_TEST):De(t.SCISSOR_TEST)}function bt(N){N===void 0&&(N=t.TEXTURE0+Y-1),j!==N&&(t.activeTexture(N),j=N)}function F(N,ae,ee){ee===void 0&&(j===null?ee=t.TEXTURE0+Y-1:ee=j);let de=G[ee];de===void 0&&(de={type:void 0,texture:void 0},G[ee]=de),(de.type!==N||de.texture!==ae)&&(j!==ee&&(t.activeTexture(ee),j=ee),t.bindTexture(N,ae||se[N]),de.type=N,de.texture=ae)}function cn(){const N=G[j];N!==void 0&&N.type!==void 0&&(t.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function je(){try{t.compressedTexImage2D(...arguments)}catch(N){$e("WebGLState:",N)}}function b(){try{t.compressedTexImage3D(...arguments)}catch(N){$e("WebGLState:",N)}}function x(){try{t.texSubImage2D(...arguments)}catch(N){$e("WebGLState:",N)}}function k(){try{t.texSubImage3D(...arguments)}catch(N){$e("WebGLState:",N)}}function W(){try{t.compressedTexSubImage2D(...arguments)}catch(N){$e("WebGLState:",N)}}function Z(){try{t.compressedTexSubImage3D(...arguments)}catch(N){$e("WebGLState:",N)}}function oe(){try{t.texStorage2D(...arguments)}catch(N){$e("WebGLState:",N)}}function le(){try{t.texStorage3D(...arguments)}catch(N){$e("WebGLState:",N)}}function Q(){try{t.texImage2D(...arguments)}catch(N){$e("WebGLState:",N)}}function te(){try{t.texImage3D(...arguments)}catch(N){$e("WebGLState:",N)}}function ce(N){return u[N]!==void 0?u[N]:t.getParameter(N)}function Ae(N,ae){u[N]!==ae&&(t.pixelStorei(N,ae),u[N]=ae)}function fe(N){_e.equals(N)===!1&&(t.scissor(N.x,N.y,N.z,N.w),_e.copy(N))}function ue(N){ge.equals(N)===!1&&(t.viewport(N.x,N.y,N.z,N.w),ge.copy(N))}function be(N,ae){let ee=c.get(ae);ee===void 0&&(ee=new WeakMap,c.set(ae,ee));let de=ee.get(N);de===void 0&&(de=t.getUniformBlockIndex(ae,N.name),ee.set(N,de))}function Le(N,ae){const de=c.get(ae).get(N);l.get(ae)!==de&&(t.uniformBlockBinding(ae,de,N.__bindingPointIndex),l.set(ae,de))}function Fe(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),o.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),h={},u={},j=null,G={},d={},m=new WeakMap,v=[],M=null,p=!1,f=null,g=null,S=null,y=null,A=null,w=null,R=null,_=new Je(0,0,0),E=0,C=!1,P=null,L=null,I=null,z=null,D=null,_e.set(0,0,t.canvas.width,t.canvas.height),ge.set(0,0,t.canvas.width,t.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:ie,disable:De,bindFramebuffer:Ue,drawBuffers:Pe,useProgram:Et,setBlending:Ze,setMaterial:Xe,setFlipSided:Ct,setCullFace:It,setLineWidth:kt,setPolygonOffset:Ht,setScissorTest:_t,activeTexture:bt,bindTexture:F,unbindTexture:cn,compressedTexImage2D:je,compressedTexImage3D:b,texImage2D:Q,texImage3D:te,pixelStorei:Ae,getParameter:ce,updateUBOMapping:be,uniformBlockBinding:Le,texStorage2D:oe,texStorage3D:le,texSubImage2D:x,texSubImage3D:k,compressedTexSubImage2D:W,compressedTexSubImage3D:Z,scissor:fe,viewport:ue,reset:Fe}}function Nw(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ke,h=new WeakMap,u=new Set;let d;const m=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(b,x){return v?new OffscreenCanvas(b,x):zl("canvas")}function p(b,x,k){let W=1;const Z=je(b);if((Z.width>k||Z.height>k)&&(W=k/Math.max(Z.width,Z.height)),W<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const oe=Math.floor(W*Z.width),le=Math.floor(W*Z.height);d===void 0&&(d=M(oe,le));const Q=x?M(oe,le):d;return Q.width=oe,Q.height=le,Q.getContext("2d").drawImage(b,0,0,oe,le),Ie("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+oe+"x"+le+")."),Q}else return"data"in b&&Ie("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),b;return b}function f(b){return b.generateMipmaps}function g(b){t.generateMipmap(b)}function S(b){return b.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?t.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function y(b,x,k,W,Z,oe=!1){if(b!==null){if(t[b]!==void 0)return t[b];Ie("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let le;W&&(le=e.get("EXT_texture_norm16"),le||Ie("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Q=x;if(x===t.RED&&(k===t.FLOAT&&(Q=t.R32F),k===t.HALF_FLOAT&&(Q=t.R16F),k===t.UNSIGNED_BYTE&&(Q=t.R8),k===t.UNSIGNED_SHORT&&le&&(Q=le.R16_EXT),k===t.SHORT&&le&&(Q=le.R16_SNORM_EXT)),x===t.RED_INTEGER&&(k===t.UNSIGNED_BYTE&&(Q=t.R8UI),k===t.UNSIGNED_SHORT&&(Q=t.R16UI),k===t.UNSIGNED_INT&&(Q=t.R32UI),k===t.BYTE&&(Q=t.R8I),k===t.SHORT&&(Q=t.R16I),k===t.INT&&(Q=t.R32I)),x===t.RG&&(k===t.FLOAT&&(Q=t.RG32F),k===t.HALF_FLOAT&&(Q=t.RG16F),k===t.UNSIGNED_BYTE&&(Q=t.RG8),k===t.UNSIGNED_SHORT&&le&&(Q=le.RG16_EXT),k===t.SHORT&&le&&(Q=le.RG16_SNORM_EXT)),x===t.RG_INTEGER&&(k===t.UNSIGNED_BYTE&&(Q=t.RG8UI),k===t.UNSIGNED_SHORT&&(Q=t.RG16UI),k===t.UNSIGNED_INT&&(Q=t.RG32UI),k===t.BYTE&&(Q=t.RG8I),k===t.SHORT&&(Q=t.RG16I),k===t.INT&&(Q=t.RG32I)),x===t.RGB_INTEGER&&(k===t.UNSIGNED_BYTE&&(Q=t.RGB8UI),k===t.UNSIGNED_SHORT&&(Q=t.RGB16UI),k===t.UNSIGNED_INT&&(Q=t.RGB32UI),k===t.BYTE&&(Q=t.RGB8I),k===t.SHORT&&(Q=t.RGB16I),k===t.INT&&(Q=t.RGB32I)),x===t.RGBA_INTEGER&&(k===t.UNSIGNED_BYTE&&(Q=t.RGBA8UI),k===t.UNSIGNED_SHORT&&(Q=t.RGBA16UI),k===t.UNSIGNED_INT&&(Q=t.RGBA32UI),k===t.BYTE&&(Q=t.RGBA8I),k===t.SHORT&&(Q=t.RGBA16I),k===t.INT&&(Q=t.RGBA32I)),x===t.RGB&&(k===t.UNSIGNED_SHORT&&le&&(Q=le.RGB16_EXT),k===t.SHORT&&le&&(Q=le.RGB16_SNORM_EXT),k===t.UNSIGNED_INT_5_9_9_9_REV&&(Q=t.RGB9_E5),k===t.UNSIGNED_INT_10F_11F_11F_REV&&(Q=t.R11F_G11F_B10F)),x===t.RGBA){const te=oe?kl:He.getTransfer(Z);k===t.FLOAT&&(Q=t.RGBA32F),k===t.HALF_FLOAT&&(Q=t.RGBA16F),k===t.UNSIGNED_BYTE&&(Q=te===nt?t.SRGB8_ALPHA8:t.RGBA8),k===t.UNSIGNED_SHORT&&le&&(Q=le.RGBA16_EXT),k===t.SHORT&&le&&(Q=le.RGBA16_SNORM_EXT),k===t.UNSIGNED_SHORT_4_4_4_4&&(Q=t.RGBA4),k===t.UNSIGNED_SHORT_5_5_5_1&&(Q=t.RGB5_A1)}return(Q===t.R16F||Q===t.R32F||Q===t.RG16F||Q===t.RG32F||Q===t.RGBA16F||Q===t.RGBA32F)&&e.get("EXT_color_buffer_float"),Q}function A(b,x){let k;return b?x===null||x===mi||x===qo?k=t.DEPTH24_STENCIL8:x===li?k=t.DEPTH32F_STENCIL8:x===$o&&(k=t.DEPTH24_STENCIL8,Ie("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===mi||x===qo?k=t.DEPTH_COMPONENT24:x===li?k=t.DEPTH_COMPONENT32F:x===$o&&(k=t.DEPTH_COMPONENT16),k}function w(b,x){return f(b)===!0||b.isFramebufferTexture&&b.minFilter!==Xt&&b.minFilter!==en?Math.log2(Math.max(x.width,x.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?x.mipmaps.length:1}function R(b){const x=b.target;x.removeEventListener("dispose",R),E(x),x.isVideoTexture&&h.delete(x),x.isHTMLTexture&&u.delete(x)}function _(b){const x=b.target;x.removeEventListener("dispose",_),P(x)}function E(b){const x=i.get(b);if(x.__webglInit===void 0)return;const k=b.source,W=m.get(k);if(W){const Z=W[x.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&C(b),Object.keys(W).length===0&&m.delete(k)}i.remove(b)}function C(b){const x=i.get(b);t.deleteTexture(x.__webglTexture);const k=b.source,W=m.get(k);delete W[x.__cacheKey],o.memory.textures--}function P(b){const x=i.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),i.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(x.__webglFramebuffer[W]))for(let Z=0;Z<x.__webglFramebuffer[W].length;Z++)t.deleteFramebuffer(x.__webglFramebuffer[W][Z]);else t.deleteFramebuffer(x.__webglFramebuffer[W]);x.__webglDepthbuffer&&t.deleteRenderbuffer(x.__webglDepthbuffer[W])}else{if(Array.isArray(x.__webglFramebuffer))for(let W=0;W<x.__webglFramebuffer.length;W++)t.deleteFramebuffer(x.__webglFramebuffer[W]);else t.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&t.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&t.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let W=0;W<x.__webglColorRenderbuffer.length;W++)x.__webglColorRenderbuffer[W]&&t.deleteRenderbuffer(x.__webglColorRenderbuffer[W]);x.__webglDepthRenderbuffer&&t.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const k=b.textures;for(let W=0,Z=k.length;W<Z;W++){const oe=i.get(k[W]);oe.__webglTexture&&(t.deleteTexture(oe.__webglTexture),o.memory.textures--),i.remove(k[W])}i.remove(b)}let L=0;function I(){L=0}function z(){return L}function D(b){L=b}function Y(){const b=L;return b>=r.maxTextures&&Ie("WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+r.maxTextures),L+=1,b}function B(b){const x=[];return x.push(b.wrapS),x.push(b.wrapT),x.push(b.wrapR||0),x.push(b.magFilter),x.push(b.minFilter),x.push(b.anisotropy),x.push(b.internalFormat),x.push(b.format),x.push(b.type),x.push(b.generateMipmaps),x.push(b.premultiplyAlpha),x.push(b.flipY),x.push(b.unpackAlignment),x.push(b.colorSpace),x.join()}function U(b,x){const k=i.get(b);if(b.isVideoTexture&&F(b),b.isRenderTargetTexture===!1&&b.isExternalTexture!==!0&&b.version>0&&k.__version!==b.version){const W=b.image;if(W===null)Ie("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)Ie("WebGLRenderer: Texture marked for update but image is incomplete");else{De(k,b,x);return}}else b.isExternalTexture&&(k.__webglTexture=b.sourceTexture?b.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,k.__webglTexture,t.TEXTURE0+x)}function q(b,x){const k=i.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&k.__version!==b.version){De(k,b,x);return}else b.isExternalTexture&&(k.__webglTexture=b.sourceTexture?b.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,k.__webglTexture,t.TEXTURE0+x)}function j(b,x){const k=i.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&k.__version!==b.version){De(k,b,x);return}n.bindTexture(t.TEXTURE_3D,k.__webglTexture,t.TEXTURE0+x)}function G(b,x){const k=i.get(b);if(b.isCubeDepthTexture!==!0&&b.version>0&&k.__version!==b.version){Ue(k,b,x);return}n.bindTexture(t.TEXTURE_CUBE_MAP,k.__webglTexture,t.TEXTURE0+x)}const J={[xd]:t.REPEAT,[wi]:t.CLAMP_TO_EDGE,[yd]:t.MIRRORED_REPEAT},Me={[Xt]:t.NEAREST,[iS]:t.NEAREST_MIPMAP_NEAREST,[Ea]:t.NEAREST_MIPMAP_LINEAR,[en]:t.LINEAR,[zc]:t.LINEAR_MIPMAP_NEAREST,[Lr]:t.LINEAR_MIPMAP_LINEAR},_e={[oS]:t.NEVER,[dS]:t.ALWAYS,[aS]:t.LESS,[rh]:t.LEQUAL,[lS]:t.EQUAL,[sh]:t.GEQUAL,[cS]:t.GREATER,[uS]:t.NOTEQUAL};function ge(b,x){if(x.type===li&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===en||x.magFilter===zc||x.magFilter===Ea||x.magFilter===Lr||x.minFilter===en||x.minFilter===zc||x.minFilter===Ea||x.minFilter===Lr)&&Ie("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(b,t.TEXTURE_WRAP_S,J[x.wrapS]),t.texParameteri(b,t.TEXTURE_WRAP_T,J[x.wrapT]),(b===t.TEXTURE_3D||b===t.TEXTURE_2D_ARRAY)&&t.texParameteri(b,t.TEXTURE_WRAP_R,J[x.wrapR]),t.texParameteri(b,t.TEXTURE_MAG_FILTER,Me[x.magFilter]),t.texParameteri(b,t.TEXTURE_MIN_FILTER,Me[x.minFilter]),x.compareFunction&&(t.texParameteri(b,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(b,t.TEXTURE_COMPARE_FUNC,_e[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===Xt||x.minFilter!==Ea&&x.minFilter!==Lr||x.type===li&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||i.get(x).__currentAnisotropy){const k=e.get("EXT_texture_filter_anisotropic");t.texParameterf(b,k.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,r.getMaxAnisotropy())),i.get(x).__currentAnisotropy=x.anisotropy}}}function K(b,x){let k=!1;b.__webglInit===void 0&&(b.__webglInit=!0,x.addEventListener("dispose",R));const W=x.source;let Z=m.get(W);Z===void 0&&(Z={},m.set(W,Z));const oe=B(x);if(oe!==b.__cacheKey){Z[oe]===void 0&&(Z[oe]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,k=!0),Z[oe].usedTimes++;const le=Z[b.__cacheKey];le!==void 0&&(Z[b.__cacheKey].usedTimes--,le.usedTimes===0&&C(x)),b.__cacheKey=oe,b.__webglTexture=Z[oe].texture}return k}function se(b,x,k){return Math.floor(Math.floor(b/k)/x)}function ie(b,x,k,W){const oe=b.updateRanges;if(oe.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,x.width,x.height,k,W,x.data);else{oe.sort((Ae,fe)=>Ae.start-fe.start);let le=0;for(let Ae=1;Ae<oe.length;Ae++){const fe=oe[le],ue=oe[Ae],be=fe.start+fe.count,Le=se(ue.start,x.width,4),Fe=se(fe.start,x.width,4);ue.start<=be+1&&Le===Fe&&se(ue.start+ue.count-1,x.width,4)===Le?fe.count=Math.max(fe.count,ue.start+ue.count-fe.start):(++le,oe[le]=ue)}oe.length=le+1;const Q=n.getParameter(t.UNPACK_ROW_LENGTH),te=n.getParameter(t.UNPACK_SKIP_PIXELS),ce=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,x.width);for(let Ae=0,fe=oe.length;Ae<fe;Ae++){const ue=oe[Ae],be=Math.floor(ue.start/4),Le=Math.ceil(ue.count/4),Fe=be%x.width,N=Math.floor(be/x.width),ae=Le,ee=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,Fe),n.pixelStorei(t.UNPACK_SKIP_ROWS,N),n.texSubImage2D(t.TEXTURE_2D,0,Fe,N,ae,ee,k,W,x.data)}b.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,Q),n.pixelStorei(t.UNPACK_SKIP_PIXELS,te),n.pixelStorei(t.UNPACK_SKIP_ROWS,ce)}}function De(b,x,k){let W=t.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(W=t.TEXTURE_2D_ARRAY),x.isData3DTexture&&(W=t.TEXTURE_3D);const Z=K(b,x),oe=x.source;n.bindTexture(W,b.__webglTexture,t.TEXTURE0+k);const le=i.get(oe);if(oe.version!==le.__version||Z===!0){if(n.activeTexture(t.TEXTURE0+k),(typeof ImageBitmap<"u"&&x.image instanceof ImageBitmap)===!1){const ee=He.getPrimaries(He.workingColorSpace),de=x.colorSpace===ji?null:He.getPrimaries(x.colorSpace),ve=x.colorSpace===ji||ee===de?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,ve)}n.pixelStorei(t.UNPACK_ALIGNMENT,x.unpackAlignment);let te=p(x.image,!1,r.maxTextureSize);te=cn(x,te);const ce=s.convert(x.format,x.colorSpace),Ae=s.convert(x.type);let fe=y(x.internalFormat,ce,Ae,x.normalized,x.colorSpace,x.isVideoTexture);ge(W,x);let ue;const be=x.mipmaps,Le=x.isVideoTexture!==!0,Fe=le.__version===void 0||Z===!0,N=oe.dataReady,ae=w(x,te);if(x.isDepthTexture)fe=A(x.format===Dr,x.type),Fe&&(Le?n.texStorage2D(t.TEXTURE_2D,1,fe,te.width,te.height):n.texImage2D(t.TEXTURE_2D,0,fe,te.width,te.height,0,ce,Ae,null));else if(x.isDataTexture)if(be.length>0){Le&&Fe&&n.texStorage2D(t.TEXTURE_2D,ae,fe,be[0].width,be[0].height);for(let ee=0,de=be.length;ee<de;ee++)ue=be[ee],Le?N&&n.texSubImage2D(t.TEXTURE_2D,ee,0,0,ue.width,ue.height,ce,Ae,ue.data):n.texImage2D(t.TEXTURE_2D,ee,fe,ue.width,ue.height,0,ce,Ae,ue.data);x.generateMipmaps=!1}else Le?(Fe&&n.texStorage2D(t.TEXTURE_2D,ae,fe,te.width,te.height),N&&ie(x,te,ce,Ae)):n.texImage2D(t.TEXTURE_2D,0,fe,te.width,te.height,0,ce,Ae,te.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Le&&Fe&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ae,fe,be[0].width,be[0].height,te.depth);for(let ee=0,de=be.length;ee<de;ee++)if(ue=be[ee],x.format!==qn)if(ce!==null)if(Le){if(N)if(x.layerUpdates.size>0){const ve=fm(ue.width,ue.height,x.format,x.type);for(const ne of x.layerUpdates){const we=ue.data.subarray(ne*ve/ue.data.BYTES_PER_ELEMENT,(ne+1)*ve/ue.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ee,0,0,ne,ue.width,ue.height,1,ce,we)}x.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ee,0,0,0,ue.width,ue.height,te.depth,ce,ue.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,ee,fe,ue.width,ue.height,te.depth,0,ue.data,0,0);else Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Le?N&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,ee,0,0,0,ue.width,ue.height,te.depth,ce,Ae,ue.data):n.texImage3D(t.TEXTURE_2D_ARRAY,ee,fe,ue.width,ue.height,te.depth,0,ce,Ae,ue.data)}else{Le&&Fe&&n.texStorage2D(t.TEXTURE_2D,ae,fe,be[0].width,be[0].height);for(let ee=0,de=be.length;ee<de;ee++)ue=be[ee],x.format!==qn?ce!==null?Le?N&&n.compressedTexSubImage2D(t.TEXTURE_2D,ee,0,0,ue.width,ue.height,ce,ue.data):n.compressedTexImage2D(t.TEXTURE_2D,ee,fe,ue.width,ue.height,0,ue.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Le?N&&n.texSubImage2D(t.TEXTURE_2D,ee,0,0,ue.width,ue.height,ce,Ae,ue.data):n.texImage2D(t.TEXTURE_2D,ee,fe,ue.width,ue.height,0,ce,Ae,ue.data)}else if(x.isDataArrayTexture)if(Le){if(Fe&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ae,fe,te.width,te.height,te.depth),N)if(x.layerUpdates.size>0){const ee=fm(te.width,te.height,x.format,x.type);for(const de of x.layerUpdates){const ve=te.data.subarray(de*ee/te.data.BYTES_PER_ELEMENT,(de+1)*ee/te.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,de,te.width,te.height,1,ce,Ae,ve)}x.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,te.width,te.height,te.depth,ce,Ae,te.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,fe,te.width,te.height,te.depth,0,ce,Ae,te.data);else if(x.isData3DTexture)Le?(Fe&&n.texStorage3D(t.TEXTURE_3D,ae,fe,te.width,te.height,te.depth),N&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,te.width,te.height,te.depth,ce,Ae,te.data)):n.texImage3D(t.TEXTURE_3D,0,fe,te.width,te.height,te.depth,0,ce,Ae,te.data);else if(x.isFramebufferTexture){if(Fe)if(Le)n.texStorage2D(t.TEXTURE_2D,ae,fe,te.width,te.height);else{let ee=te.width,de=te.height;for(let ve=0;ve<ae;ve++)n.texImage2D(t.TEXTURE_2D,ve,fe,ee,de,0,ce,Ae,null),ee>>=1,de>>=1}}else if(x.isHTMLTexture){if("texElementImage2D"in t){const ee=t.canvas;if(ee.hasAttribute("layoutsubtree")||ee.setAttribute("layoutsubtree","true"),te.parentNode!==ee){ee.appendChild(te),u.add(x),ee.onpaint=de=>{const ve=de.changedElements;for(const ne of u)ve.includes(ne.image)&&(ne.needsUpdate=!0)},ee.requestPaint();return}if(t.texElementImage2D.length===3)t.texElementImage2D(t.TEXTURE_2D,t.RGBA8,te);else{const ve=t.RGBA,ne=t.RGBA,we=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,0,ve,ne,we,te)}t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(be.length>0){if(Le&&Fe){const ee=je(be[0]);n.texStorage2D(t.TEXTURE_2D,ae,fe,ee.width,ee.height)}for(let ee=0,de=be.length;ee<de;ee++)ue=be[ee],Le?N&&n.texSubImage2D(t.TEXTURE_2D,ee,0,0,ce,Ae,ue):n.texImage2D(t.TEXTURE_2D,ee,fe,ce,Ae,ue);x.generateMipmaps=!1}else if(Le){if(Fe){const ee=je(te);n.texStorage2D(t.TEXTURE_2D,ae,fe,ee.width,ee.height)}N&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ce,Ae,te)}else n.texImage2D(t.TEXTURE_2D,0,fe,ce,Ae,te);f(x)&&g(W),le.__version=oe.version,x.onUpdate&&x.onUpdate(x)}b.__version=x.version}function Ue(b,x,k){if(x.image.length!==6)return;const W=K(b,x),Z=x.source;n.bindTexture(t.TEXTURE_CUBE_MAP,b.__webglTexture,t.TEXTURE0+k);const oe=i.get(Z);if(Z.version!==oe.__version||W===!0){n.activeTexture(t.TEXTURE0+k);const le=He.getPrimaries(He.workingColorSpace),Q=x.colorSpace===ji?null:He.getPrimaries(x.colorSpace),te=x.colorSpace===ji||le===Q?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,x.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,te);const ce=x.isCompressedTexture||x.image[0].isCompressedTexture,Ae=x.image[0]&&x.image[0].isDataTexture,fe=[];for(let ne=0;ne<6;ne++)!ce&&!Ae?fe[ne]=p(x.image[ne],!0,r.maxCubemapSize):fe[ne]=Ae?x.image[ne].image:x.image[ne],fe[ne]=cn(x,fe[ne]);const ue=fe[0],be=s.convert(x.format,x.colorSpace),Le=s.convert(x.type),Fe=y(x.internalFormat,be,Le,x.normalized,x.colorSpace),N=x.isVideoTexture!==!0,ae=oe.__version===void 0||W===!0,ee=Z.dataReady;let de=w(x,ue);ge(t.TEXTURE_CUBE_MAP,x);let ve;if(ce){N&&ae&&n.texStorage2D(t.TEXTURE_CUBE_MAP,de,Fe,ue.width,ue.height);for(let ne=0;ne<6;ne++){ve=fe[ne].mipmaps;for(let we=0;we<ve.length;we++){const Ee=ve[we];x.format!==qn?be!==null?N?ee&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we,0,0,Ee.width,Ee.height,be,Ee.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we,Fe,Ee.width,Ee.height,0,Ee.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?ee&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we,0,0,Ee.width,Ee.height,be,Le,Ee.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we,Fe,Ee.width,Ee.height,0,be,Le,Ee.data)}}}else{if(ve=x.mipmaps,N&&ae){ve.length>0&&de++;const ne=je(fe[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,de,Fe,ne.width,ne.height)}for(let ne=0;ne<6;ne++)if(Ae){N?ee&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,0,0,fe[ne].width,fe[ne].height,be,Le,fe[ne].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,Fe,fe[ne].width,fe[ne].height,0,be,Le,fe[ne].data);for(let we=0;we<ve.length;we++){const xt=ve[we].image[ne].image;N?ee&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we+1,0,0,xt.width,xt.height,be,Le,xt.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we+1,Fe,xt.width,xt.height,0,be,Le,xt.data)}}else{N?ee&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,0,0,be,Le,fe[ne]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,Fe,be,Le,fe[ne]);for(let we=0;we<ve.length;we++){const Ee=ve[we];N?ee&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we+1,0,0,be,Le,Ee.image[ne]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we+1,Fe,be,Le,Ee.image[ne])}}}f(x)&&g(t.TEXTURE_CUBE_MAP),oe.__version=Z.version,x.onUpdate&&x.onUpdate(x)}b.__version=x.version}function Pe(b,x,k,W,Z,oe){const le=s.convert(k.format,k.colorSpace),Q=s.convert(k.type),te=y(k.internalFormat,le,Q,k.normalized,k.colorSpace),ce=i.get(x),Ae=i.get(k);if(Ae.__renderTarget=x,!ce.__hasExternalTextures){const fe=Math.max(1,x.width>>oe),ue=Math.max(1,x.height>>oe);Z===t.TEXTURE_3D||Z===t.TEXTURE_2D_ARRAY?n.texImage3D(Z,oe,te,fe,ue,x.depth,0,le,Q,null):n.texImage2D(Z,oe,te,fe,ue,0,le,Q,null)}n.bindFramebuffer(t.FRAMEBUFFER,b),bt(x)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,W,Z,Ae.__webglTexture,0,_t(x)):(Z===t.TEXTURE_2D||Z>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,W,Z,Ae.__webglTexture,oe),n.bindFramebuffer(t.FRAMEBUFFER,null)}function Et(b,x,k){if(t.bindRenderbuffer(t.RENDERBUFFER,b),x.depthBuffer){const W=x.depthTexture,Z=W&&W.isDepthTexture?W.type:null,oe=A(x.stencilBuffer,Z),le=x.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;bt(x)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,_t(x),oe,x.width,x.height):k?t.renderbufferStorageMultisample(t.RENDERBUFFER,_t(x),oe,x.width,x.height):t.renderbufferStorage(t.RENDERBUFFER,oe,x.width,x.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,le,t.RENDERBUFFER,b)}else{const W=x.textures;for(let Z=0;Z<W.length;Z++){const oe=W[Z],le=s.convert(oe.format,oe.colorSpace),Q=s.convert(oe.type),te=y(oe.internalFormat,le,Q,oe.normalized,oe.colorSpace);bt(x)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,_t(x),te,x.width,x.height):k?t.renderbufferStorageMultisample(t.RENDERBUFFER,_t(x),te,x.width,x.height):t.renderbufferStorage(t.RENDERBUFFER,te,x.width,x.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Ve(b,x,k){const W=x.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,b),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const Z=i.get(x.depthTexture);if(Z.__renderTarget=x,(!Z.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),W){if(Z.__webglInit===void 0&&(Z.__webglInit=!0,x.depthTexture.addEventListener("dispose",R)),Z.__webglTexture===void 0){Z.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,Z.__webglTexture),ge(t.TEXTURE_CUBE_MAP,x.depthTexture);const ce=s.convert(x.depthTexture.format),Ae=s.convert(x.depthTexture.type);let fe;x.depthTexture.format===Fi?fe=t.DEPTH_COMPONENT24:x.depthTexture.format===Dr&&(fe=t.DEPTH24_STENCIL8);for(let ue=0;ue<6;ue++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,fe,x.width,x.height,0,ce,Ae,null)}}else U(x.depthTexture,0);const oe=Z.__webglTexture,le=_t(x),Q=W?t.TEXTURE_CUBE_MAP_POSITIVE_X+k:t.TEXTURE_2D,te=x.depthTexture.format===Dr?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(x.depthTexture.format===Fi)bt(x)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,te,Q,oe,0,le):t.framebufferTexture2D(t.FRAMEBUFFER,te,Q,oe,0);else if(x.depthTexture.format===Dr)bt(x)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,te,Q,oe,0,le):t.framebufferTexture2D(t.FRAMEBUFFER,te,Q,oe,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function st(b){const x=i.get(b),k=b.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==b.depthTexture){const W=b.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),W){const Z=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,W.removeEventListener("dispose",Z)};W.addEventListener("dispose",Z),x.__depthDisposeCallback=Z}x.__boundDepthTexture=W}if(b.depthTexture&&!x.__autoAllocateDepthBuffer)if(k)for(let W=0;W<6;W++)Ve(x.__webglFramebuffer[W],b,W);else{const W=b.texture.mipmaps;W&&W.length>0?Ve(x.__webglFramebuffer[0],b,0):Ve(x.__webglFramebuffer,b,0)}else if(k){x.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer[W]),x.__webglDepthbuffer[W]===void 0)x.__webglDepthbuffer[W]=t.createRenderbuffer(),Et(x.__webglDepthbuffer[W],b,!1);else{const Z=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,oe=x.__webglDepthbuffer[W];t.bindRenderbuffer(t.RENDERBUFFER,oe),t.framebufferRenderbuffer(t.FRAMEBUFFER,Z,t.RENDERBUFFER,oe)}}else{const W=b.texture.mipmaps;if(W&&W.length>0?n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=t.createRenderbuffer(),Et(x.__webglDepthbuffer,b,!1);else{const Z=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,oe=x.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,oe),t.framebufferRenderbuffer(t.FRAMEBUFFER,Z,t.RENDERBUFFER,oe)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function Ze(b,x,k){const W=i.get(b);x!==void 0&&Pe(W.__webglFramebuffer,b,b.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),k!==void 0&&st(b)}function Xe(b){const x=b.texture,k=i.get(b),W=i.get(x);b.addEventListener("dispose",_);const Z=b.textures,oe=b.isWebGLCubeRenderTarget===!0,le=Z.length>1;if(le||(W.__webglTexture===void 0&&(W.__webglTexture=t.createTexture()),W.__version=x.version,o.memory.textures++),oe){k.__webglFramebuffer=[];for(let Q=0;Q<6;Q++)if(x.mipmaps&&x.mipmaps.length>0){k.__webglFramebuffer[Q]=[];for(let te=0;te<x.mipmaps.length;te++)k.__webglFramebuffer[Q][te]=t.createFramebuffer()}else k.__webglFramebuffer[Q]=t.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){k.__webglFramebuffer=[];for(let Q=0;Q<x.mipmaps.length;Q++)k.__webglFramebuffer[Q]=t.createFramebuffer()}else k.__webglFramebuffer=t.createFramebuffer();if(le)for(let Q=0,te=Z.length;Q<te;Q++){const ce=i.get(Z[Q]);ce.__webglTexture===void 0&&(ce.__webglTexture=t.createTexture(),o.memory.textures++)}if(b.samples>0&&bt(b)===!1){k.__webglMultisampledFramebuffer=t.createFramebuffer(),k.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,k.__webglMultisampledFramebuffer);for(let Q=0;Q<Z.length;Q++){const te=Z[Q];k.__webglColorRenderbuffer[Q]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,k.__webglColorRenderbuffer[Q]);const ce=s.convert(te.format,te.colorSpace),Ae=s.convert(te.type),fe=y(te.internalFormat,ce,Ae,te.normalized,te.colorSpace,b.isXRRenderTarget===!0),ue=_t(b);t.renderbufferStorageMultisample(t.RENDERBUFFER,ue,fe,b.width,b.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Q,t.RENDERBUFFER,k.__webglColorRenderbuffer[Q])}t.bindRenderbuffer(t.RENDERBUFFER,null),b.depthBuffer&&(k.__webglDepthRenderbuffer=t.createRenderbuffer(),Et(k.__webglDepthRenderbuffer,b,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(oe){n.bindTexture(t.TEXTURE_CUBE_MAP,W.__webglTexture),ge(t.TEXTURE_CUBE_MAP,x);for(let Q=0;Q<6;Q++)if(x.mipmaps&&x.mipmaps.length>0)for(let te=0;te<x.mipmaps.length;te++)Pe(k.__webglFramebuffer[Q][te],b,x,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,te);else Pe(k.__webglFramebuffer[Q],b,x,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0);f(x)&&g(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(le){for(let Q=0,te=Z.length;Q<te;Q++){const ce=Z[Q],Ae=i.get(ce);let fe=t.TEXTURE_2D;(b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(fe=b.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(fe,Ae.__webglTexture),ge(fe,ce),Pe(k.__webglFramebuffer,b,ce,t.COLOR_ATTACHMENT0+Q,fe,0),f(ce)&&g(fe)}n.unbindTexture()}else{let Q=t.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(Q=b.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(Q,W.__webglTexture),ge(Q,x),x.mipmaps&&x.mipmaps.length>0)for(let te=0;te<x.mipmaps.length;te++)Pe(k.__webglFramebuffer[te],b,x,t.COLOR_ATTACHMENT0,Q,te);else Pe(k.__webglFramebuffer,b,x,t.COLOR_ATTACHMENT0,Q,0);f(x)&&g(Q),n.unbindTexture()}b.depthBuffer&&st(b)}function Ct(b){const x=b.textures;for(let k=0,W=x.length;k<W;k++){const Z=x[k];if(f(Z)){const oe=S(b),le=i.get(Z).__webglTexture;n.bindTexture(oe,le),g(oe),n.unbindTexture()}}}const It=[],kt=[];function Ht(b){if(b.samples>0){if(bt(b)===!1){const x=b.textures,k=b.width,W=b.height;let Z=t.COLOR_BUFFER_BIT;const oe=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,le=i.get(b),Q=x.length>1;if(Q)for(let ce=0;ce<x.length;ce++)n.bindFramebuffer(t.FRAMEBUFFER,le.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ce,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,le.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ce,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,le.__webglMultisampledFramebuffer);const te=b.texture.mipmaps;te&&te.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,le.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,le.__webglFramebuffer);for(let ce=0;ce<x.length;ce++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(Z|=t.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(Z|=t.STENCIL_BUFFER_BIT)),Q){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,le.__webglColorRenderbuffer[ce]);const Ae=i.get(x[ce]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Ae,0)}t.blitFramebuffer(0,0,k,W,0,0,k,W,Z,t.NEAREST),l===!0&&(It.length=0,kt.length=0,It.push(t.COLOR_ATTACHMENT0+ce),b.depthBuffer&&b.resolveDepthBuffer===!1&&(It.push(oe),kt.push(oe),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,kt)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,It))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),Q)for(let ce=0;ce<x.length;ce++){n.bindFramebuffer(t.FRAMEBUFFER,le.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ce,t.RENDERBUFFER,le.__webglColorRenderbuffer[ce]);const Ae=i.get(x[ce]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,le.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ce,t.TEXTURE_2D,Ae,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,le.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){const x=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[x])}}}function _t(b){return Math.min(r.maxSamples,b.samples)}function bt(b){const x=i.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function F(b){const x=o.render.frame;h.get(b)!==x&&(h.set(b,x),b.update())}function cn(b,x){const k=b.colorSpace,W=b.format,Z=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||k!==Ol&&k!==ji&&(He.getTransfer(k)===nt?(W!==qn||Z!==Nn)&&Ie("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):$e("WebGLTextures: Unsupported texture color space:",k)),x}function je(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=Y,this.resetTextureUnits=I,this.getTextureUnits=z,this.setTextureUnits=D,this.setTexture2D=U,this.setTexture2DArray=q,this.setTexture3D=j,this.setTextureCube=G,this.rebindTextures=Ze,this.setupRenderTarget=Xe,this.updateRenderTargetMipmap=Ct,this.updateMultisampleRenderTarget=Ht,this.setupDepthRenderbuffer=st,this.setupFrameBufferTexture=Pe,this.useMultisampledRTT=bt,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function Uw(t,e){function n(i,r=ji){let s;const o=He.getTransfer(r);if(i===Nn)return t.UNSIGNED_BYTE;if(i===jf)return t.UNSIGNED_SHORT_4_4_4_4;if(i===eh)return t.UNSIGNED_SHORT_5_5_5_1;if(i===fv)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===hv)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===uv)return t.BYTE;if(i===dv)return t.SHORT;if(i===$o)return t.UNSIGNED_SHORT;if(i===Jf)return t.INT;if(i===mi)return t.UNSIGNED_INT;if(i===li)return t.FLOAT;if(i===Ui)return t.HALF_FLOAT;if(i===pv)return t.ALPHA;if(i===mv)return t.RGB;if(i===qn)return t.RGBA;if(i===Fi)return t.DEPTH_COMPONENT;if(i===Dr)return t.DEPTH_STENCIL;if(i===gv)return t.RED;if(i===th)return t.RED_INTEGER;if(i===Hr)return t.RG;if(i===nh)return t.RG_INTEGER;if(i===ih)return t.RGBA_INTEGER;if(i===sl||i===ol||i===al||i===ll)if(o===nt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===sl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===ol)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===al)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===ll)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===sl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===ol)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===al)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===ll)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Sd||i===Md||i===Ed||i===Td)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Sd)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Md)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Ed)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Td)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===wd||i===Ad||i===Rd||i===Cd||i===bd||i===Ul||i===Pd)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===wd||i===Ad)return o===nt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Rd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Cd)return s.COMPRESSED_R11_EAC;if(i===bd)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Ul)return s.COMPRESSED_RG11_EAC;if(i===Pd)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Ld||i===Dd||i===Id||i===Nd||i===Ud||i===Fd||i===Od||i===kd||i===Bd||i===zd||i===Vd||i===Hd||i===Gd||i===Wd)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Ld)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Dd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Id)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Nd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Ud)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Fd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Od)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===kd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Bd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===zd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Vd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Hd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Gd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Wd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Xd||i===Yd||i===$d)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Xd)return o===nt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Yd)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===$d)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===qd||i===Kd||i===Fl||i===Zd)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===qd)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Kd)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Fl)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Zd)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===qo?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const Fw=`
void main() {
...
}`;class kw{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n){if(this.texture===null){const i=new Av(e.texture);(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new Jn({vertexShader:Fw,fragmentShader:Ow,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new pn(new Ai(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Bw extends Yr{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,h=null,u=null,d=null,m=null,v=null;const M=typeof XRWebGLBinding<"u",p=new kw,f={},g=n.getContextAttributes();let S=null,y=null;const A=[],w=[],R=new Ke;let _=null;const E=new Yn;E.viewport=new Mt;const C=new Yn;C.viewport=new Mt;const P=[E,C],L=new KS;let I=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let se=A[K];return se===void 0&&(se=new qc,A[K]=se),se.getTargetRaySpace()},this.getControllerGrip=function(K){let se=A[K];return se===void 0&&(se=new qc,A[K]=se),se.getGripSpace()},this.getHand=function(K){let se=A[K];return se===void 0&&(se=new qc,A[K]=se),se.getHandSpace()};function D(K){const se=w.indexOf(K.inputSource);if(se===-1)return;const ie=A[se];ie!==void 0&&(ie.update(K.inputSource,K.frame,c||o),ie.dispatchEvent({type:K.type,data:K.inputSource}))}function Y(){r.removeEventListener("select",D),r.removeEventListener("selectstart",D),r.removeEventListener("selectend",D),r.removeEventListener("squeeze",D),r.removeEventListener("squeezestart",D),r.removeEventListener("squeezeend",D),r.removeEventListener("end",Y),r.removeEventListener("inputsourceschange",B);for(let K=0;K<A.length;K++){const se=w[K];se!==null&&(w[K]=null,A[K].disconnect(se))}I=null,z=null,p.reset();for(const K in f)delete f[K];e.setRenderTarget(S),m=null,d=null,u=null,r=null,y=null,ge.stop(),i.isPresenting=!1,e.setPixelRatio(_),e.setSize(R.width,R.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){s=K,i.isPresenting===!0&&Ie("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){a=K,i.isPresenting===!0&&Ie("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return d!==null?d:m},this.getBinding=function(){return u===null&&M&&(u=new XRWebGLBinding(r,n)),u},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(K){if(r=K,r!==null){if(S=e.getRenderTarget(),r.addEventListener("select",D),r.addEventListener("selectstart",D),r.addEventListener("selectend",D),r.addEventListener("squeeze",D),r.addEventListener("squeezestart",D),r.addEventListener("squeezeend",D),r.addEventListener("end",Y),r.addEventListener("inputsourceschange",B),g.xrCompatible!==!0&&await n.makeXRCompatible(),_=e.getPixelRatio(),e.getSize(R),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let ie=null,De=null,Ue=null;g.depth&&(Ue=g.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,ie=g.stencil?Dr:Fi,De=g.stencil?qo:mi);const Pe={colorFormat:n.RGBA8,depthFormat:Ue,scaleFactor:s};u=this.getBinding(),d=u.createProjectionLayer(Pe),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),y=new hi(d.textureWidth,d.textureHeight,{format:qn,type:Nn,depthTexture:new Hs(d.textureWidth,d.textureHeight,De,void 0,void 0,void 0,void 0,void 0,void 0,ie),stencilBuffer:g.stencil,colorSpace:e.outputColorSpace,samples:g.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const ie={antialias:g.antialias,alpha:!0,depth:g.depth,stencil:g.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,n,ie),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),y=new hi(m.framebufferWidth,m.framebufferHeight,{format:qn,type:Nn,colorSpace:e.outputColorSpace,stencilBuffer:g.stencil,resolveDepthBuffer:m.ignoreDepthValues===!1,resolveStencilBuffer:m.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),ge.setContext(r),ge.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return p.getDepthTexture()};function B(K){for(let se=0;se<K.removed.length;se++){const ie=K.removed[se],De=w.indexOf(ie);De>=0&&(w[De]=null,A[De].disconnect(ie))}for(let se=0;se<K.added.length;se++){const ie=K.added[se];let De=w.indexOf(ie);if(De===-1){for(let Pe=0;Pe<A.length;Pe++)if(Pe>=w.length){w.push(ie),De=Pe;break}else if(w[Pe]===null){w[Pe]=ie,De=Pe;break}if(De===-1)break}const Ue=A[De];Ue&&Ue.connect(ie)}}const U=new X,q=new X;function j(K,se,ie){U.setFromMatrixPosition(se.matrixWorld),q.setFromMatrixPosition(ie.matrixWorld);const De=U.distanceTo(q),Ue=se.projectionMatrix.elements,Pe=ie.projectionMatrix.elements,Et=Ue[14]/(Ue[10]-1),Ve=Ue[14]/(Ue[10]+1),st=(Ue[9]+1)/Ue[5],Ze=(Ue[9]-1)/Ue[5],Xe=(Ue[8]-1)/Ue[0],Ct=(Pe[8]+1)/Pe[0],It=Et*Xe,kt=Et*Ct,Ht=De/(-Xe+Ct),_t=Ht*-Xe;if(se.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(_t),K.translateZ(Ht),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),Ue[10]===-1)K.projectionMatrix.copy(se.projectionMatrix),K.projectionMatrixInverse.copy(se.projectionMatrixInverse);else{const bt=Et+Ht,F=Ve+Ht,cn=It-_t,je=kt+(De-_t),b=st*Ve/F*bt,x=Ze*Ve/F*bt;K.projectionMatrix.makePerspective(cn,je,b,x,bt,F),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function G(K,se){se===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(se.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(r===null)return;let se=K.near,ie=K.far;p.texture!==null&&(p.depthNear>0&&(se=p.depthNear),p.depthFar>0&&(ie=p.depthFar)),L.near=C.near=E.near=se,L.far=C.far=E.far=ie,(I!==L.near||z!==L.far)&&(r.updateRenderState({depthNear:L.near,depthFar:L.far}),I=L.near,z=L.far),L.layers.mask=K.layers.mask|6,E.layers.mask=L.layers.mask&-5,C.layers.mask=L.layers.mask&-3;const De=K.parent,Ue=L.cameras;G(L,De);for(let Pe=0;Pe<Ue.length;Pe++)G(Ue[Pe],De);Ue.length===2?j(L,E,C):L.projectionMatrix.copy(E.projectionMatrix),J(K,L,De)};function J(K,se,ie){ie===null?K.matrix.copy(se.matrixWorld):(K.matrix.copy(ie.matrixWorld),K.matrix.invert(),K.matrix.multiply(se.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(se.projectionMatrix),K.projectionMatrixInverse.copy(se.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=Qd*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return L},this.getFoveation=function(){if(!(d===null&&m===null))return l},this.setFoveation=function(K){l=K,d!==null&&(d.fixedFoveation=K),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=K)},this.hasDepthSensing=function(){return p.texture!==null},this.getDepthSensingMesh=function(){return p.getMesh(L)},this.getCameraTexture=function(K){return f[K]};let Me=null;function _e(K,se){if(h=se.getViewerPose(c||o),v=se,h!==null){const ie=h.views;m!==null&&(e.setRenderTargetFramebuffer(y,m.framebuffer),e.setRenderTarget(y));let De=!1;ie.length!==L.cameras.length&&(L.cameras.length=0,De=!0);for(let Ve=0;Ve<ie.length;Ve++){const st=ie[Ve];let Ze=null;if(m!==null)Ze=m.getViewport(st);else{const Ct=u.getViewSubImage(d,st);Ze=Ct.viewport,Ve===0&&(e.setRenderTargetTextures(y,Ct.colorTexture,Ct.depthStencilTexture),e.setRenderTarget(y))}let Xe=P[Ve];Xe===void 0&&(Xe=new Yn,Xe.layers.enable(Ve),Xe.viewport=new Mt,P[Ve]=Xe),Xe.matrix.fromArray(st.transform.matrix),Xe.matrix.decompose(Xe.position,Xe.quaternion,Xe.scale),Xe.projectionMatrix.fromArray(st.projectionMatrix),Xe.projectionMatrixInverse.copy(Xe.projectionMatrix).invert(),Xe.viewport.set(Ze.x,Ze.y,Ze.width,Ze.height),Ve===0&&(L.matrix.copy(Xe.matrix),L.matrix.decompose(L.position,L.quaternion,L.scale)),De===!0&&L.cameras.push(Xe)}const Ue=r.enabledFeatures;if(Ue&&Ue.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&M){u=i.getBinding();const Ve=u.getDepthInformation(ie[0]);Ve&&Ve.isValid&&Ve.texture&&p.init(Ve,r.renderState)}if(Ue&&Ue.includes("camera-access")&&M){e.state.unbindTexture(),u=i.getBinding();for(let Ve=0;Ve<ie.length;Ve++){const st=ie[Ve].camera;if(st){let Ze=f[st];Ze||(Ze=new Av,f[st]=Ze);const Xe=u.getCameraImage(st);Ze.sourceTexture=Xe}}}}for(let ie=0;ie<A.length;ie++){const De=w[ie],Ue=A[ie];De!==null&&Ue!==void 0&&Ue.update(De,se,c||o)}Me&&Me(K,se),se.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:se}),v=null}const ge=new Cv;ge.setAnimationLoop(_e),this.setAnimationLoop=function(K){Me=K},this.dispose=function(){}}}const zw=new Dt,Uv=new Ne;Uv.set(-1,0,0,0,1,0,0,0,1);function Vw(t,e){function n(p,f){p.matrixAutoUpdate===!0&&p.updateMatrix(),f.value.copy(p.matrix)}function i(p,f){f.color.getRGB(p.fogColor.value,Rv(t)),f.isFog?(p.fogNear.value=f.near,p.fogFar.value=f.far):f.isFogExp2&&(p.fogDensity.value=f.density)}function r(p,f,g,S,y){f.isNodeMaterial?f.uniformsNeedUpdate=!1:f.isMeshBasicMaterial?s(p,f):f.isMeshLambertMaterial?(s(p,f),f.envMap&&(p.envMapIntensity.value=f.envMapIntensity)):f.isMeshToonMaterial?(s(p,f),u(p,f)):f.isMeshPhongMaterial?(s(p,f),h(p,f),f.envMap&&(p.envMapIntensity.value=f.envMapIntensity)):f.isMeshStandardMaterial?(s(p,f),d(p,f),f.isMeshPhysicalMaterial&&m(p,f,y)):f.isMeshMatcapMaterial?(s(p,f),v(p,f)):f.isMeshDepthMaterial?s(p,f):f.isMeshDistanceMaterial?(s(p,f),M(p,f)):f.isMeshNormalMaterial?s(p,f):f.isLineBasicMaterial?(o(p,f),f.isLineDashedMaterial&&a(p,f)):f.isPointsMaterial?l(p,f,g,S):f.isSpriteMaterial?c(p,f):f.isShadowMaterial?(p.color.value.copy(f.color),p.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function s(p,f){p.opacity.value=f.opacity,f.color&&p.diffuse.value.copy(f.color),f.emissive&&p.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(p.map.value=f.map,n(f.map,p.mapTransform)),f.alphaMap&&(p.alphaMap.value=f.alphaMap,n(f.alphaMap,p.alphaMapTransform)),f.bumpMap&&(p.bumpMap.value=f.bumpMap,n(f.bumpMap,p.bumpMapTransform),p.bumpScale.value=f.bumpScale,f.side===_n&&(p.bumpScale.value*=-1)),f.normalMap&&(p.normalMap.value=f.normalMap,n(f.normalMap,p.normalMapTransform),p.normalScale.value.copy(f.normalScale),f.side===_n&&p.normalScale.value.negate()),f.displacementMap&&(p.displacementMap.value=f.displacementMap,n(f.displacementMap,p.displacementMapTransform),p.displacementScale.value=f.displacementScale,p.displacementBias.value=f.displacementBias),f.emissiveMap&&(p.emissiveMap.value=f.emissiveMap,n(f.emissiveMap,p.emissiveMapTransform)),f.specularMap&&(p.specularMap.value=f.specularMap,n(f.specularMap,p.specularMapTransform)),f.alphaTest>0&&(p.alphaTest.value=f.alphaTest);const g=e.get(f),S=g.envMap,y=g.envMapRotation;S&&(p.envMap.value=S,p.envMapRotation.value.setFromMatrix4(zw.makeRotationFromEuler(y)).transpose(),S.isCubeTexture&&S.isRenderTargetTexture===!1&&p.envMapRotation.value.premultiply(Uv),p.reflectivity.value=f.reflectivity,p.ior.value=f.ior,p.refractionRatio.value=f.refractionRatio),f.lightMap&&(p.lightMap.value=f.lightMap,p.lightMapIntensity.value=f.lightMapIntensity,n(f.lightMap,p.lightMapTransform)),f.aoMap&&(p.aoMap.value=f.aoMap,p.aoMapIntensity.value=f.aoMapIntensity,n(f.aoMap,p.aoMapTransform))}function o(p,f){p.diffuse.value.copy(f.color),p.opacity.value=f.opacity,f.map&&(p.map.value=f.map,n(f.map,p.mapTransform))}function a(p,f){p.dashSize.value=f.dashSize,p.totalSize.value=f.dashSize+f.gapSize,p.scale.value=f.scale}function l(p,f,g,S){p.diffuse.value.copy(f.color),p.opacity.value=f.opacity,p.size.value=f.size*g,p.scale.value=S*.5,f.map&&(p.map.value=f.map,n(f.map,p.uvTransform)),f.alphaMap&&(p.alphaMap.value=f.alphaMap,n(f.alphaMap,p.alphaMapTransform)),f.alphaTest>0&&(p.alphaTest.value=f.alphaTest)}function c(p,f){p.diffuse.value.copy(f.color),p.opacity.value=f.opacity,p.rotation.value=f.rotation,f.map&&(p.map.value=f.map,n(f.map,p.mapTransform)),f.alphaMap&&(p.alphaMap.value=f.alphaMap,n(f.alphaMap,p.alphaMapTransform)),f.alphaTest>0&&(p.alphaTest.value=f.alphaTest)}function h(p,f){p.specular.value.copy(f.specular),p.shininess.value=Math.max(f.shininess,1e-4)}function u(p,f){f.gradientMap&&(p.gradientMap.value=f.gradientMap)}function d(p,f){p.metalness.value=f.metalness,f.metalnessMap&&(p.metalnessMap.value=f.metalnessMap,n(f.metalnessMap,p.metalnessMapTransform)),p.roughness.value=f.roughness,f.roughnessMap&&(p.roughnessMap.value=f.roughnessMap,n(f.roughnessMap,p.roughnessMapTransform)),f.envMap&&(p.envMapIntensity.value=f.envMapIntensity)}function m(p,f,g){p.ior.value=f.ior,f.sheen>0&&(p.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),p.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(p.sheenColorMap.value=f.sheenColorMap,n(f.sheenColorMap,p.sheenColorMapTransform)),f.sheenRoughnessMap&&(p.sheenRoughnessMap.value=f.sheenRoughnessMap,n(f.sheenRoughnessMap,p.sheenRoughnessMapTransform))),f.clearcoat>0&&(p.clearcoat.value=f.clearcoat,p.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(p.clearcoatMap.value=f.clearcoatMap,n(f.clearcoatMap,p.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,n(f.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(p.clearcoatNormalMap.value=f.clearcoatNormalMap,n(f.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===_n&&p.clearcoatNormalScale.value.negate())),f.dispersion>0&&(p.dispersion.value=f.dispersion),f.iridescence>0&&(p.iridescence.value=f.iridescence,p.iridescenceIOR.value=f.iridescenceIOR,p.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(p.iridescenceMap.value=f.iridescenceMap,n(f.iridescenceMap,p.iridescenceMapTransform)),f.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=f.iridescenceThicknessMap,n(f.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),f.transmission>0&&(p.transmission.value=f.transmission,p.transmissionSamplerMap.value=g.texture,p.transmissionSamplerSize.value.set(g.width,g.height),f.transmissionMap&&(p.transmissionMap.value=f.transmissionMap,n(f.transmissionMap,p.transmissionMapTransform)),p.thickness.value=f.thickness,f.thicknessMap&&(p.thicknessMap.value=f.thicknessMap,n(f.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=f.attenuationDistance,p.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(p.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(p.anisotropyMap.value=f.anisotropyMap,n(f.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=f.specularIntensity,p.specularColor.value.copy(f.specularColor),f.specularColorMap&&(p.specularColorMap.value=f.specularColorMap,n(f.specularColorMap,p.specularColorMapTransform)),f.specularIntensityMap&&(p.specularIntensityMap.value=f.specularIntensityMap,n(f.specularIntensityMap,p.specularIntensityMapTransform))}function v(p,f){f.matcap&&(p.matcap.value=f.matcap)}function M(p,f){const g=e.get(f).light;p.referencePosition.value.setFromMatrixPosition(g.matrixWorld),p.nearDistance.value=g.shadow.camera.near,p.farDistance.value=g.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function Hw(t,e,n,i){let r={},s={},o=[];const a=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(y,A){const w=A.program;i.uniformBlockBinding(y,w)}function c(y,A){let w=r[y.id];w===void 0&&(p(y),w=h(y),r[y.id]=w,y.addEventListener("dispose",g));const R=A.program;i.updateUBOMapping(y,R);const _=e.render.frame;s[y.id]!==_&&(d(y),s[y.id]=_)}function h(y){const A=u();y.__bindingPointIndex=A;const w=t.createBuffer(),R=y.__size,_=y.usage;return t.bindBuffer(t.UNIFORM_BUFFER,w),t.bufferData(t.UNIFORM_BUFFER,R,_),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,A,w),w}function u(){for(let y=0;y<a;y++)if(o.indexOf(y)===-1)return o.push(y),y;return $e("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(y){const A=r[y.id],w=y.uniforms,R=y.__cache;t.bindBuffer(t.UNIFORM_BUFFER,A);for(let _=0,E=w.length;_<E;_++){const C=w[_];if(Array.isArray(C))for(let P=0,L=C.length;P<L;P++)m(C[P],_,P,R);else m(C,_,0,R)}t.bindBuffer(t.UNIFORM_BUFFER,null)}function m(y,A,w,R){if(M(y,A,w,R)===!0){const _=y.__offset,E=y.value;if(Array.isArray(E)){let C=0;for(let P=0;P<E.length;P++){const L=E[P],I=f(L);v(L,y.__data,C),typeof L!="number"&&typeof L!="boolean"&&!L.isMatrix3&&!ArrayBuffer.isView(L)&&(C+=I.storage/Float32Array.BYTES_PER_ELEMENT)}}else v(E,y.__data,0);t.bufferSubData(t.UNIFORM_BUFFER,_,y.__data)}}function v(y,A,w){typeof y=="number"||typeof y=="boolean"?A[0]=y:y.isMatrix3?(A[0]=y.elements[0],A[1]=y.elements[1],A[2]=y.elements[2],A[3]=0,A[4]=y.elements[3],A[5]=y.elements[4],A[6]=y.elements[5],A[7]=0,A[8]=y.elements[6],A[9]=y.elements[7],A[10]=y.elements[8],A[11]=0):ArrayBuffer.isView(y)?A.set(new y.constructor(y.buffer,y.byteOffset,A.length)):y.toArray(A,w)}function M(y,A,w,R){const _=y.value,E=A+"_"+w;if(R[E]===void 0)return typeof _=="number"||typeof _=="boolean"?R[E]=_:ArrayBuffer.isView(_)?R[E]=_.slice():R[E]=_.clone(),!0;{const C=R[E];if(typeof _=="number"||typeof _=="boolean"){if(C!==_)return R[E]=_,!0}else{if(ArrayBuffer.isView(_))return!0;if(C.equals(_)===!1)return C.copy(_),!0}}return!1}function p(y){const A=y.uniforms;let w=0;const R=16;for(let E=0,C=A.length;E<C;E++){const P=Array.isArray(A[E])?A[E]:[A[E]];for(let L=0,I=P.length;L<I;L++){const z=P[L],D=Array.isArray(z.value)?z.value:[z.value];for(let Y=0,B=D.length;Y<B;Y++){const U=D[Y],q=f(U),j=w%R,G=j%q.boundary,J=j+G;w+=G,J!==0&&R-J<q.storage&&(w+=R-J),z.__data=new Float32Array(q.storage/Float32Array.BYTES_PER_ELEMENT),z.__offset=w,w+=q.storage}}}const _=w%R;return _>0&&(w+=R-_),y.__size=w,y.__cache={},this}function f(y){const A={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(A.boundary=4,A.storage=4):y.isVector2?(A.boundary=8,A.storage=8):y.isVector3||y.isColor?(A.boundary=16,A.storage=12):y.isVector4?(A.boundary=16,A.storage=16):y.isMatrix3?(A.boundary=48,A.storage=48):y.isMatrix4?(A.boundary=64,A.storage=64):y.isTexture?Ie("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(y)?(A.boundary=16,A.storage=y.byteLength):Ie("WebGLRenderer: Unsupported uniform value type.",y),A}function g(y){const A=y.target;A.removeEventListener("dispose",g);const w=o.indexOf(A.__bindingPointIndex);o.splice(w,1),t.deleteBuffer(r[A.id]),delete r[A.id],delete s[A.id]}function S(){for(const y in r)t.deleteBuffer(r[y]);o=[],r={},s={}}return{bind:l,update:c,dispose:S}}const Gw=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let ri=null;function Ww(){return ri===null&&(ri=new FS(Gw,16,16,Hr,Ui),ri.name="DFG_LUT",ri.minFilter=en,ri.magFilter=en,ri.wrapS=wi,ri.wrapT=wi,ri.generateMipmaps=!1,ri.needsUpdate=!0),ri}class Xw{constructor(e={}){const{canvas:n=hS(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:d=!1,outputBufferType:m=Nn}=e;this.isWebGLRenderer=!0;let v;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");v=i.getContextAttributes().alpha}else v=o;const M=m,p=new Set([ih,nh,th]),f=new Set([Nn,mi,$o,qo,jf,eh]),g=new Uint32Array(4),S=new Int32Array(4),y=new X;let A=null,w=null;const R=[],_=[];let E=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=fi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const C=this;let P=!1,L=null,I=null,z=null,D=null;this._outputColorSpace=Wt;let Y=0,B=0,U=null,q=-1,j=null;const G=new Mt,J=new Mt;let Me=null;const _e=new Je(0);let ge=0,K=n.width,se=n.height,ie=1,De=null,Ue=null;const Pe=new Mt(0,0,K,se),Et=new Mt(0,0,K,se);let Ve=!1;const st=new Tv;let Ze=!1,Xe=!1;const Ct=new Dt,It=new X,kt=new Mt,Ht={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let _t=!1;function bt(){return U===null?ie:1}let F=i;function cn(T,O){return n.getContext(T,O)}try{const T={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Qf}`),n.addEventListener("webglcontextlost",xt,!1),n.addEventListener("webglcontextrestored",lt,!1),n.addEventListener("webglcontextcreationerror",jn,!1),F===null){const O="webgl2";if(F=cn(O,T),F===null)throw cn(O)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(T){throw $e("WebGLRenderer: "+T.message),T}let je,b,x,k,W,Z,oe,le,Q,te,ce,Ae,fe,ue,be,Le,Fe,N,ae,ee,de,ve,ne;function we(){je=new W1(F),je.init(),de=new Uw(F,je),b=new F1(F,je,e,de),x=new Iw(F,je),b.reversedDepthBuffer&&d&&x.buffers.depth.setReversed(!0),I=F.createFramebuffer(),z=F.createFramebuffer(),D=F.createFramebuffer(),k=new $1(F),W=new xw,Z=new Nw(F,je,x,W,b,de,k),oe=new G1(C),le=new QS(F),ve=new N1(F,le),Q=new X1(F,le,k,ve),te=new K1(F,Q,le,ve,k),N=new q1(F,b,Z),be=new O1(W),ce=new _w(C,oe,je,b,ve,be),Ae=new Vw(C,W),fe=new Sw,ue=new Rw(je),Fe=new I1(C,oe,x,te,v,l),Le=new Dw(C,te,b),ne=new Hw(F,k,b,x),ae=new U1(F,je,k),ee=new Y1(F,je,k),k.programs=ce.programs,C.capabilities=b,C.extensions=je,C.properties=W,C.renderLists=fe,C.shadowMap=Le,C.state=x,C.info=k}we(),M!==Nn&&(E=new Q1(M,n.width,n.height,a,r,s));const Ee=new Bw(C,F);this.xr=Ee,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){const T=je.get("WEBGL_lose_context");T&&T.loseContext()},this.forceContextRestore=function(){const T=je.get("WEBGL_lose_context");T&&T.restoreContext()},this.getPixelRatio=function(){return ie},this.setPixelRatio=function(T){T!==void 0&&(ie=T,this.setSize(K,se,!1))},this.getSize=function(T){return T.set(K,se)},this.setSize=function(T,O,$=!0){if(Ee.isPresenting){Ie("WebGLRenderer: Can't change size while VR device is presenting.");return}K=T,se=O,n.width=Math.floor(T*ie),n.height=Math.floor(O*ie),$===!0&&(n.style.width=T+"px",n.style.height=O+"px"),E!==null&&E.setSize(n.width,n.height),this.setViewport(0,0,T,O)},this.getDrawingBufferSize=function(T){return T.set(K*ie,se*ie).floor()},this.setDrawingBufferSize=function(T,O,$){K=T,se=O,ie=$,n.width=Math.floor(T*$),n.height=Math.floor(O*$),this.setViewport(0,0,T,O)},this.setEffects=function(T){if(M===Nn){$e("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(T){for(let O=0;O<T.length;O++)if(T[O].isOutputPass===!0){Ie("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}E.setEffects(T||[])},this.getCurrentViewport=function(T){return T.copy(G)},this.getViewport=function(T){return T.copy(Pe)},this.setViewport=function(T,O,$,V){T.isVector4?Pe.set(T.x,T.y,T.z,T.w):Pe.set(T,O,$,V),x.viewport(G.copy(Pe).multiplyScalar(ie).round())},this.getScissor=function(T){return T.copy(Et)},this.setScissor=function(T,O,$,V){T.isVector4?Et.set(T.x,T.y,T.z,T.w):Et.set(T,O,$,V),x.scissor(J.copy(Et).multiplyScalar(ie).round())},this.getScissorTest=function(){return Ve},this.setScissorTest=function(T){x.setScissorTest(Ve=T)},this.setOpaqueSort=function(T){De=T},this.setTransparentSort=function(T){Ue=T},this.getClearColor=function(T){return T.copy(Fe.getClearColor())},this.setClearColor=function(){Fe.setClearColor(...arguments)},this.getClearAlpha=function(){return Fe.getClearAlpha()},this.setClearAlpha=function(){Fe.setClearAlpha(...arguments)},this.clear=function(T=!0,O=!0,$=!0){let V=0;if(T){let H=!1;if(U!==null){const me=U.texture.format;H=p.has(me)}if(H){const me=U.texture.type,ye=f.has(me),pe=Fe.getClearColor(),Te=Fe.getClearAlpha(),Re=pe.r,Oe=pe.g,Be=pe.b;ye?(g[0]=Re,g[1]=Oe,g[2]=Be,g[3]=Te,F.clearBufferuiv(F.COLOR,0,g)):(S[0]=Re,S[1]=Oe,S[2]=Be,S[3]=Te,F.clearBufferiv(F.COLOR,0,S))}else V|=F.COLOR_BUFFER_BIT}O&&(V|=F.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),$&&(V|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),V!==0&&F.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(T){T.setRenderer(this),L=T},this.dispose=function(){n.removeEventListener("webglcontextlost",xt,!1),n.removeEventListener("webglcontextrestored",lt,!1),n.removeEventListener("webglcontextcreationerror",jn,!1),Fe.dispose(),fe.dispose(),ue.dispose(),W.dispose(),oe.dispose(),te.dispose(),ve.dispose(),ne.dispose(),ce.dispose(),Ee.dispose(),Ee.removeEventListener("sessionstart",gh),Ee.removeEventListener("sessionend",vh),vr.stop()};function xt(T){T.preventDefault(),$p("WebGLRenderer: Context Lost."),P=!0}function lt(){$p("WebGLRenderer: Context Restored."),P=!1;const T=k.autoReset,O=Le.enabled,$=Le.autoUpdate,V=Le.needsUpdate,H=Le.type;we(),k.autoReset=T,Le.enabled=O,Le.autoUpdate=$,Le.needsUpdate=V,Le.type=H}function jn(T){$e("WebGLRenderer: A WebGL context could not be created. Reason: ",T.statusMessage)}function ei(T){const O=T.target;O.removeEventListener("dispose",ei),Ov(O)}function Ov(T){kv(T),W.remove(T)}function kv(T){const O=W.get(T).programs;O!==void 0&&(O.forEach(function($){ce.releaseProgram($)}),T.isShaderMaterial&&ce.releaseShaderCache(T))}this.renderBufferDirect=function(T,O,$,V,H,me){O===null&&(O=Ht);const ye=H.isMesh&&H.matrixWorld.determinantAffine()<0,pe=Vv(T,O,$,V,H);x.setMaterial(V,ye);let Te=$.index,Re=1;if(V.wireframe===!0){if(Te=Q.getWireframeAttribute($),Te===void 0)return;Re=2}const Oe=$.drawRange,Be=$.attributes.position;let Ce=Oe.start*Re,rt=(Oe.start+Oe.count)*Re;me!==null&&(Ce=Math.max(Ce,me.start*Re),rt=Math.min(rt,(me.start+me.count)*Re)),Te!==null?(Ce=Math.max(Ce,0),rt=Math.min(rt,Te.count)):Be!=null&&(Ce=Math.max(Ce,0),rt=Math.min(rt,Be.count));const Tt=rt-Ce;if(Tt<0||Tt===1/0)return;ve.setup(H,V,pe,$,Te);let yt,ot=ae;if(Te!==null&&(yt=le.get(Te),ot=ee,ot.setIndex(yt)),H.isMesh)V.wireframe===!0?(x.setLineWidth(V.wireframeLinewidth*bt()),ot.setMode(F.LINES)):ot.setMode(F.TRIANGLES);else if(H.isLine){let qt=V.linewidth;qt===void 0&&(qt=1),x.setLineWidth(qt*bt()),H.isLineSegments?ot.setMode(F.LINES):H.isLineLoop?ot.setMode(F.LINE_LOOP):ot.setMode(F.LINE_STRIP)}else H.isPoints?ot.setMode(F.POINTS):H.isSprite&&ot.setMode(F.TRIANGLES);if(H.isBatchedMesh)if(je.get("WEBGL_multi_draw"))ot.renderMultiDraw(H._multiDrawStarts,H._multiDrawCounts,H._multiDrawCount);else{const qt=H._multiDrawStarts,xe=H._multiDrawCounts,xn=H._multiDrawCount,Ye=Te?le.get(Te).bytesPerElement:1,Pn=W.get(V).currentProgram.getUniforms();for(let ti=0;ti<xn;ti++)Pn.setValue(F,"_gl_DrawID",ti),ot.render(qt[ti]/Ye,xe[ti])}else if(H.isInstancedMesh)ot.renderInstances(Ce,Tt,H.count);else if($.isInstancedBufferGeometry){const qt=$._maxInstanceCount!==void 0?$._maxInstanceCount:1/0,xe=Math.min($.instanceCount,qt);ot.renderInstances(Ce,Tt,xe)}else ot.render(Ce,Tt)};function mh(T,O,$){T.transparent===!0&&T.side===En&&T.forceSinglePass===!1?(T.side=_n,T.needsUpdate=!0,ra(T,O,$),T.side=hr,T.needsUpdate=!0,ra(T,O,$),T.side=En):ra(T,O,$)}this.compile=function(T,O,$=null){$===null&&($=T),w=ue.get($),w.init(O),_.push(w),$.traverseVisible(function(H){H.isLight&&H.layers.test(O.layers)&&(w.pushLight(H),H.castShadow&&w.pushShadow(H))}),T!==$&&T.traverseVisible(function(H){H.isLight&&H.layers.test(O.layers)&&(w.pushLight(H),H.castShadow&&w.pushShadow(H))}),w.setupLights();const V=new Set;return T.traverse(function(H){if(!(H.isMesh||H.isPoints||H.isLine||H.isSprite))return;const me=H.material;if(me)if(Array.isArray(me))for(let ye=0;ye<me.length;ye++){const pe=me[ye];mh(pe,$,H),V.add(pe)}else mh(me,$,H),V.add(me)}),w=_.pop(),V},this.compileAsync=function(T,O,$=null){const V=this.compile(T,O,$);return new Promise(H=>{function me(){if(V.forEach(function(ye){W.get(ye).currentProgram.isReady()&&V.delete(ye)}),V.size===0){H(T);return}setTimeout(me,10)}je.get("KHR_parallel_shader_compile")!==null?me():setTimeout(me,10)})};let cc=null;function Bv(T){cc&&cc(T)}function gh(){vr.stop()}function vh(){vr.start()}const vr=new Cv;vr.setAnimationLoop(Bv),typeof self<"u"&&vr.setContext(self),this.setAnimationLoop=function(T){cc=T,Ee.setAnimationLoop(T),T===null?vr.stop():vr.start()},Ee.addEventListener("sessionstart",gh),Ee.addEventListener("sessionend",vh),this.render=function(T,O){if(O!==void 0&&O.isCamera!==!0){$e("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;L!==null&&L.renderStart(T,O);const $=Ee.enabled===!0&&Ee.isPresenting===!0,V=E!==null&&(U===null||$)&&E.begin(C,U);if(T.matrixWorldAutoUpdate===!0&&T.updateMatrixWorld(),O.parent===null&&O.matrixWorldAutoUpdate===!0&&O.updateMatrixWorld(),Ee.enabled===!0&&Ee.isPresenting===!0&&(E===null||E.isCompositing()===!1)&&(Ee.cameraAutoUpdate===!0&&Ee.updateCamera(O),O=Ee.getCamera()),T.isScene===!0&&T.onBeforeRender(C,T,O,U),w=ue.get(T,_.length),w.init(O),w.state.textureUnits=Z.getTextureUnits(),_.push(w),Ct.multiplyMatrices(O.projectionMatrix,O.matrixWorldInverse),st.setFromProjectionMatrix(Ct,ci,O.reversedDepth),Xe=this.localClippingEnabled,Ze=be.init(this.clippingPlanes,Xe),A=fe.get(T,R.length),A.init(),R.push(A),Ee.enabled===!0&&Ee.isPresenting===!0){const ye=C.xr.getDepthSensingMesh();ye!==null&&uc(ye,O,-1/0,C.sortObjects)}uc(T,O,0,C.sortObjects),A.finish(),C.sortObjects===!0&&A.sort(De,Ue,O.reversedDepth),_t=Ee.enabled===!1||Ee.isPresenting===!1||Ee.hasDepthSensing()===!1,_t&&Fe.addToRenderList(A,T),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Ze===!0&&be.beginShadows();const H=w.state.shadowsArray;if(Le.render(H,T,O),Ze===!0&&be.endShadows(),(V&&E.hasRenderPass())===!1){const ye=A.opaque,pe=A.transmissive;if(w.setupLights(),O.isArrayCamera){const Te=O.cameras;if(pe.length>0)for(let Re=0,Oe=Te.length;Re<Oe;Re++){const Be=Te[Re];xh(ye,pe,T,Be)}_t&&Fe.render(T);for(let Re=0,Oe=Te.length;Re<Oe;Re++){const Be=Te[Re];_h(A,T,Be,Be.viewport)}}else pe.length>0&&xh(ye,pe,T,O),_t&&Fe.render(T),_h(A,T,O)}U!==null&&B===0&&(Z.updateMultisampleRenderTarget(U),Z.updateRenderTargetMipmap(U)),V&&E.end(C),T.isScene===!0&&T.onAfterRender(C,T,O),ve.resetDefaultState(),q=-1,j=null,_.pop(),_.length>0?(w=_[_.length-1],Z.setTextureUnits(w.state.textureUnits),Ze===!0&&be.setGlobalState(C.clippingPlanes,w.state.camera)):w=null,R.pop(),R.length>0?A=R[R.length-1]:A=null,L!==null&&L.renderEnd()};function uc(T,O,$,V){if(T.visible===!1)return;if(T.layers.test(O.layers)){if(T.isGroup)$=T.renderOrder;else if(T.isLOD)T.autoUpdate===!0&&T.update(O);else if(T.isLightProbeGrid)w.pushLightProbeGrid(T);else if(T.isLight)w.pushLight(T),T.castShadow&&w.pushShadow(T);else if(T.isSprite){if(!T.frustumCulled||st.intersectsSprite(T)){V&&kt.setFromMatrixPosition(T.matrixWorld).applyMatrix4(Ct);const ye=te.update(T),pe=T.material;pe.visible&&A.push(T,ye,pe,$,kt.z,null)}}else if((T.isMesh||T.isLine||T.isPoints)&&(!T.frustumCulled||st.intersectsObject(T))){const ye=te.update(T),pe=T.material;if(V&&(T.boundingSphere!==void 0?(T.boundingSphere===null&&T.computeBoundingSphere(),kt.copy(T.boundingSphere.center)):(ye.boundingSphere===null&&ye.computeBoundingSphere(),kt.copy(ye.boundingSphere.center)),kt.applyMatrix4(T.matrixWorld).applyMatrix4(Ct)),Array.isArray(pe)){const Te=ye.groups;for(let Re=0,Oe=Te.length;Re<Oe;Re++){const Be=Te[Re],Ce=pe[Be.materialIndex];Ce&&Ce.visible&&A.push(T,ye,Ce,$,kt.z,Be)}}else pe.visible&&A.push(T,ye,pe,$,kt.z,null)}}const me=T.children;for(let ye=0,pe=me.length;ye<pe;ye++)uc(me[ye],O,$,V)}function _h(T,O,$,V){const{opaque:H,transmissive:me,transparent:ye}=T;w.setupLightsView($),Ze===!0&&be.setGlobalState(C.clippingPlanes,$),V&&x.viewport(G.copy(V)),H.length>0&&ia(H,O,$),me.length>0&&ia(me,O,$),ye.length>0&&ia(ye,O,$),x.buffers.depth.setTest(!0),x.buffers.depth.setMask(!0),x.buffers.color.setMask(!0),x.setPolygonOffset(!1)}function xh(T,O,$,V){if(($.isScene===!0?$.overrideMaterial:null)!==null)return;if(w.state.transmissionRenderTarget[V.id]===void 0){const Ce=je.has("EXT_color_buffer_half_float")||je.has("EXT_color_buffer_float");w.state.transmissionRenderTarget[V.id]=new hi(1,1,{generateMipmaps:!0,type:Ce?Ui:Nn,minFilter:Lr,samples:Math.max(4,b.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:He.workingColorSpace})}const me=w.state.transmissionRenderTarget[V.id],ye=V.viewport||G;me.setSize(ye.z*C.transmissionResolutionScale,ye.w*C.transmissionResolutionScale);const pe=C.getRenderTarget(),Te=C.getActiveCubeFace(),Re=C.getActiveMipmapLevel();C.setRenderTarget(me),C.getClearColor(_e),ge=C.getClearAlpha(),ge<1&&C.setClearColor(16777215,.5),C.clear(),_t&&Fe.render($);const Oe=C.toneMapping;C.toneMapping=fi;const Be=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),w.setupLightsView(V),Ze===!0&&be.setGlobalState(C.clippingPlanes,V),ia(T,$,V),Z.updateMultisampleRenderTarget(me),Z.updateRenderTargetMipmap(me),je.has("WEBGL_multisampled_render_to_texture")===!1){let Ce=!1;for(let rt=0,Tt=O.length;rt<Tt;rt++){const yt=O[rt],{object:ot,geometry:qt,material:xe,group:xn}=yt;if(xe.side===En&&ot.layers.test(V.layers)){const Ye=xe.side;xe.side=_n,xe.needsUpdate=!0,yh(ot,$,V,qt,xe,xn),xe.side=Ye,xe.needsUpdate=!0,Ce=!0}}Ce===!0&&(Z.updateMultisampleRenderTarget(me),Z.updateRenderTargetMipmap(me))}C.setRenderTarget(pe,Te,Re),C.setClearColor(_e,ge),Be!==void 0&&(V.viewport=Be),C.toneMapping=Oe}function ia(T,O,$){const V=O.isScene===!0?O.overrideMaterial:null;for(let H=0,me=T.length;H<me;H++){const ye=T[H],{object:pe,geometry:Te,group:Re}=ye;let Oe=ye.material;Oe.allowOverride===!0&&V!==null&&(Oe=V),pe.layers.test($.layers)&&yh(pe,O,$,Te,Oe,Re)}}function yh(T,O,$,V,H,me){T.onBeforeRender(C,O,$,V,H,me),T.modelViewMatrix.multiplyMatrices($.matrixWorldInverse,T.matrixWorld),T.normalMatrix.getNormalMatrix(T.modelViewMatrix),H.onBeforeRender(C,O,$,V,T,me),H.transparent===!0&&H.side===En&&H.forceSinglePass===!1?(H.side=_n,H.needsUpdate=!0,C.renderBufferDirect($,O,V,H,T,me),H.side=hr,H.needsUpdate=!0,C.renderBufferDirect($,O,V,H,T,me),H.side=En):C.renderBufferDirect($,O,V,H,T,me),T.onAfterRender(C,O,$,V,H,me)}function ra(T,O,$){O.isScene!==!0&&(O=Ht);const V=W.get(T),H=w.state.lights,me=w.state.shadowsArray,ye=H.state.version,pe=ce.getParameters(T,H.state,me,O,$,w.state.lightProbeGridArray),Te=ce.getProgramCacheKey(pe);let Re=V.programs;V.environment=T.isMeshStandardMaterial||T.isMeshLambertMaterial||T.isMeshPhongMaterial?O.environment:null,V.fog=O.fog;const Oe=T.isMeshStandardMaterial||T.isMeshLambertMaterial&&!T.envMap||T.isMeshPhongMaterial&&!T.envMap;V.envMap=oe.get(T.envMap||V.environment,Oe),V.envMapRotation=V.environment!==null&&T.envMap===null?O.environmentRotation:T.envMapRotation,Re===void 0&&(T.addEventListener("dispose",ei),Re=new Map,V.programs=Re);let Be=Re.get(Te);if(Be!==void 0){if(V.currentProgram===Be&&V.lightsStateVersion===ye)return Mh(T,pe),Be}else pe.uniforms=ce.getUniforms(T),L!==null&&T.isNodeMaterial&&L.build(T,$,pe),T.onBeforeCompile(pe,C),Be=ce.acquireProgram(pe,Te),Re.set(Te,Be),V.uniforms=pe.uniforms;const Ce=V.uniforms;return(!T.isShaderMaterial&&!T.isRawShaderMaterial||T.clipping===!0)&&(Ce.clippingPlanes=be.uniform),Mh(T,pe),V.needsLights=Gv(T),V.lightsStateVersion=ye,V.needsLights&&(Ce.ambientLightColor.value=H.state.ambient,Ce.lightProbe.value=H.state.probe,Ce.directionalLights.value=H.state.directional,Ce.directionalLightShadows.value=H.state.directionalShadow,Ce.spotLights.value=H.state.spot,Ce.spotLightShadows.value=H.state.spotShadow,Ce.rectAreaLights.value=H.state.rectArea,Ce.ltc_1.value=H.state.rectAreaLTC1,Ce.ltc_2.value=H.state.rectAreaLTC2,Ce.pointLights.value=H.state.point,Ce.pointLightShadows.value=H.state.pointShadow,Ce.hemisphereLights.value=H.state.hemi,Ce.directionalShadowMatrix.value=H.state.directionalShadowMatrix,Ce.spotLightMatrix.value=H.state.spotLightMatrix,Ce.spotLightMap.value=H.state.spotLightMap,Ce.pointShadowMatrix.value=H.state.pointShadowMatrix),V.lightProbeGrid=w.state.lightProbeGridArray.length>0,V.currentProgram=Be,V.uniformsList=null,Be}function Sh(T){if(T.uniformsList===null){const O=T.currentProgram.getUniforms();T.uniformsList=cl.seqWithValue(O.seq,T.uniforms)}return T.uniformsList}function Mh(T,O){const $=W.get(T);$.outputColorSpace=O.outputColorSpace,$.batching=O.batching,$.batchingColor=O.batchingColor,$.instancing=O.instancing,$.instancingColor=O.instancingColor,$.instancingMorph=O.instancingMorph,$.skinning=O.skinning,$.morphTargets=O.morphTargets,$.morphNormals=O.morphNormals,$.morphColors=O.morphColors,$.morphTargetsCount=O.morphTargetsCount,$.numClippingPlanes=O.numClippingPlanes,$.numIntersection=O.numClipIntersection,$.vertexAlphas=O.vertexAlphas,$.vertexTangents=O.vertexTangents,$.toneMapping=O.toneMapping}function zv(T,O){if(T.length===0)return null;if(T.length===1)return T[0].texture!==null?T[0]:null;y.setFromMatrixPosition(O.matrixWorld);for(let $=0,V=T.length;$<V;$++){const H=T[$];if(H.texture!==null&&H.boundingBox.containsPoint(y))return H}return null}function Vv(T,O,$,V,H){O.isScene!==!0&&(O=Ht),Z.resetTextureUnits();const me=O.fog,ye=V.isMeshStandardMaterial||V.isMeshLambertMaterial||V.isMeshPhongMaterial?O.environment:null,pe=U===null?C.outputColorSpace:U.isXRRenderTarget===!0?U.texture.colorSpace:He.workingColorSpace,Te=V.isMeshStandardMaterial||V.isMeshLambertMaterial&&!V.envMap||V.isMeshPhongMaterial&&!V.envMap,Re=oe.get(V.envMap||ye,Te),Oe=V.vertexColors===!0&&!!$.attributes.color&&$.attributes.color.itemSize===4,Be=!!$.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),Ce=!!$.morphAttributes.position,rt=!!$.morphAttributes.normal,Tt=!!$.morphAttributes.color;let yt=fi;V.toneMapped&&(U===null||U.isXRRenderTarget===!0)&&(yt=C.toneMapping);const ot=$.morphAttributes.position||$.morphAttributes.normal||$.morphAttributes.color,qt=ot!==void 0?ot.length:0,xe=W.get(V),xn=w.state.lights;if(Ze===!0&&(Xe===!0||T!==j)){const ct=T===j&&V.id===q;be.setState(V,T,ct)}let Ye=!1;V.version===xe.__version?(xe.needsLights&&xe.lightsStateVersion!==xn.state.version||xe.outputColorSpace!==pe||H.isBatchedMesh&&xe.batching===!1||!H.isBatchedMesh&&xe.batching===!0||H.isBatchedMesh&&xe.batchingColor===!0&&H.colorTexture===null||H.isBatchedMesh&&xe.batchingColor===!1&&H.colorTexture!==null||H.isInstancedMesh&&xe.instancing===!1||!H.isInstancedMesh&&xe.instancing===!0||H.isSkinnedMesh&&xe.skinning===!1||!H.isSkinnedMesh&&xe.skinning===!0||H.isInstancedMesh&&xe.instancingColor===!0&&H.instanceColor===null||H.isInstancedMesh&&xe.instancingColor===!1&&H.instanceColor!==null||H.isInstancedMesh&&xe.instancingMorph===!0&&H.morphTexture===null||H.isInstancedMesh&&xe.instancingMorph===!1&&H.morphTexture!==null||xe.envMap!==Re||V.fog===!0&&xe.fog!==me||xe.numClippingPlanes!==void 0&&(xe.numClippingPlanes!==be.numPlanes||xe.numIntersection!==be.numIntersection)||xe.vertexAlphas!==Oe||xe.vertexTangents!==Be||xe.morphTargets!==Ce||xe.morphNormals!==rt||xe.morphColors!==Tt||xe.toneMapping!==yt||xe.morphTargetsCount!==qt||!!xe.lightProbeGrid!=w.state.lightProbeGridArray.length>0)&&(Ye=!0):(Ye=!0,xe.__version=V.version);let Pn=xe.currentProgram;Ye===!0&&(Pn=ra(V,O,H),L&&V.isNodeMaterial&&L.onUpdateProgram(V,Pn,xe));let ti=!1,Bi=!1,$r=!1;const at=Pn.getUniforms(),wt=xe.uniforms;if(x.useProgram(Pn.program)&&(ti=!0,Bi=!0,$r=!0),V.id!==q&&(q=V.id,Bi=!0),xe.needsLights){const ct=zv(w.state.lightProbeGridArray,H);xe.lightProbeGrid!==ct&&(xe.lightProbeGrid=ct,Bi=!0)}if(ti||j!==T){x.buffers.depth.getReversed()&&T.reversedDepth!==!0&&(T._reversedDepth=!0,T.updateProjectionMatrix()),at.setValue(F,"projectionMatrix",T.projectionMatrix),at.setValue(F,"viewMatrix",T.matrixWorldInverse);const Vi=at.map.cameraPosition;Vi!==void 0&&Vi.setValue(F,It.setFromMatrixPosition(T.matrixWorld)),b.logarithmicDepthBuffer&&at.setValue(F,"logDepthBufFC",2/(Math.log(T.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&at.setValue(F,"isOrthographic",T.isOrthographicCamera===!0),j!==T&&(j=T,Bi=!0,$r=!0)}if(xe.needsLights&&(xn.state.directionalShadowMap.length>0&&at.setValue(F,"directionalShadowMap",xn.state.directionalShadowMap,Z),xn.state.spotShadowMap.length>0&&at.setValue(F,"spotShadowMap",xn.state.spotShadowMap,Z),xn.state.pointShadowMap.length>0&&at.setValue(F,"pointShadowMap",xn.state.pointShadowMap,Z)),H.isSkinnedMesh){at.setOptional(F,H,"bindMatrix"),at.setOptional(F,H,"bindMatrixInverse");const ct=H.skeleton;ct&&(ct.boneTexture===null&&ct.computeBoneTexture(),at.setValue(F,"boneTexture",ct.boneTexture,Z))}H.isBatchedMesh&&(at.setOptional(F,H,"batchingTexture"),at.setValue(F,"batchingTexture",H._matricesTexture,Z),at.setOptional(F,H,"batchingIdTexture"),at.setValue(F,"batchingIdTexture",H._indirectTexture,Z),at.setOptional(F,H,"batchingColorTexture"),H._colorsTexture!==null&&at.setValue(F,"batchingColorTexture",H._colorsTexture,Z));const zi=$.morphAttributes;if((zi.position!==void 0||zi.normal!==void 0||zi.color!==void 0)&&N.update(H,$,Pn),(Bi||xe.receiveShadow!==H.receiveShadow)&&(xe.receiveShadow=H.receiveShadow,at.setValue(F,"receiveShadow",H.receiveShadow)),(V.isMeshStandardMaterial||V.isMeshLambertMaterial||V.isMeshPhongMaterial)&&V.envMap===null&&O.environment!==null&&(wt.envMapIntensity.value=O.environmentIntensity),wt.dfgLUT!==void 0&&(wt.dfgLUT.value=Ww()),Bi){if(at.setValue(F,"toneMappingExposure",C.toneMappingExposure),xe.needsLights&&Hv(wt,$r),me&&V.fog===!0&&Ae.refreshFogUniforms(wt,me),Ae.refreshMaterialUniforms(wt,V,ie,se,w.state.transmissionRenderTarget[T.id]),xe.needsLights&&xe.lightProbeGrid){const ct=xe.lightProbeGrid;wt.probesSH.value=ct.texture,wt.probesMin.value.copy(ct.boundingBox.min),wt.probesMax.value.copy(ct.boundingBox.max),wt.probesResolution.value.copy(ct.resolution)}cl.upload(F,Sh(xe),wt,Z)}if(V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(cl.upload(F,Sh(xe),wt,Z),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&at.setValue(F,"center",H.center),at.setValue(F,"modelViewMatrix",H.modelViewMatrix),at.setValue(F,"normalMatrix",H.normalMatrix),at.setValue(F,"modelMatrix",H.matrixWorld),V.uniformsGroups!==void 0){const ct=V.uniformsGroups;for(let Vi=0,qr=ct.length;Vi<qr;Vi++){const Eh=ct[Vi];ne.update(Eh,Pn),ne.bind(Eh,Pn)}}return Pn}function Hv(T,O){T.ambientLightColor.needsUpdate=O,T.lightProbe.needsUpdate=O,T.directionalLights.needsUpdate=O,T.directionalLightShadows.needsUpdate=O,T.pointLights.needsUpdate=O,T.pointLightShadows.needsUpdate=O,T.spotLights.needsUpdate=O,T.spotLightShadows.needsUpdate=O,T.rectAreaLights.needsUpdate=O,T.hemisphereLights.needsUpdate=O}function Gv(T){return T.isMeshLambertMaterial||T.isMeshToonMaterial||T.isMeshPhongMaterial||T.isMeshStandardMaterial||T.isShadowMaterial||T.isShaderMaterial&&T.lights===!0}this.getActiveCubeFace=function(){return Y},this.getActiveMipmapLevel=function(){return B},this.getRenderTarget=function(){return U},this.setRenderTargetTextures=function(T,O,$){const V=W.get(T);V.__autoAllocateDepthBuffer=T.resolveDepthBuffer===!1,V.__autoAllocateDepthBuffer===!1&&(V.__useRenderToTexture=!1),W.get(T.texture).__webglTexture=O,W.get(T.depthTexture).__webglTexture=V.__autoAllocateDepthBuffer?void 0:$,V.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(T,O){const $=W.get(T);$.__webglFramebuffer=O,$.__useDefaultFramebuffer=O===void 0},this.setRenderTarget=function(T,O=0,$=0){U=T,Y=O,B=$;let V=null,H=!1,me=!1;if(T){const pe=W.get(T);if(pe.__useDefaultFramebuffer!==void 0){x.bindFramebuffer(F.FRAMEBUFFER,pe.__webglFramebuffer),G.copy(T.viewport),J.copy(T.scissor),Me=T.scissorTest,x.viewport(G),x.scissor(J),x.setScissorTest(Me),q=-1;return}else if(pe.__webglFramebuffer===void 0)Z.setupRenderTarget(T);else if(pe.__hasExternalTextures)Z.rebindTextures(T,W.get(T.texture).__webglTexture,W.get(T.depthTexture).__webglTexture);else if(T.depthBuffer){const Oe=T.depthTexture;if(pe.__boundDepthTexture!==Oe){if(Oe!==null&&W.has(Oe)&&(T.width!==Oe.image.width||T.height!==Oe.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");Z.setupDepthRenderbuffer(T)}}const Te=T.texture;(Te.isData3DTexture||Te.isDataArrayTexture||Te.isCompressedArrayTexture)&&(me=!0);const Re=W.get(T).__webglFramebuffer;T.isWebGLCubeRenderTarget?(Array.isArray(Re[O])?V=Re[O][$]:V=Re[O],H=!0):T.samples>0&&Z.useMultisampledRTT(T)===!1?V=W.get(T).__webglMultisampledFramebuffer:Array.isArray(Re)?V=Re[$]:V=Re,G.copy(T.viewport),J.copy(T.scissor),Me=T.scissorTest}else G.copy(Pe).multiplyScalar(ie).floor(),J.copy(Et).multiplyScalar(ie).floor(),Me=Ve;if($!==0&&(V=I),x.bindFramebuffer(F.FRAMEBUFFER,V)&&x.drawBuffers(T,V),x.viewport(G),x.scissor(J),x.setScissorTest(Me),H){const pe=W.get(T.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+O,pe.__webglTexture,$)}else if(me){const pe=O;for(let Te=0;Te<T.textures.length;Te++){const Re=W.get(T.textures[Te]);F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0+Te,Re.__webglTexture,$,pe)}}else if(T!==null&&$!==0){const pe=W.get(T.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,pe.__webglTexture,$)}q=-1},this.readRenderTargetPixels=function(T,O,$,V,H,me,ye,pe=0){if(!(T&&T.isWebGLRenderTarget)){$e("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Te=W.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&ye!==void 0&&(Te=Te[ye]),Te){x.bindFramebuffer(F.FRAMEBUFFER,Te);try{const Re=T.textures[pe],Oe=Re.format,Be=Re.type;if(T.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+pe),!b.textureFormatReadable(Oe)){$e("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!b.textureTypeReadable(Be)){$e("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}O>=0&&O<=T.width-V&&$>=0&&$<=T.height-H&&F.readPixels(O,$,V,H,de.convert(Oe),de.convert(Be),me)}finally{const Re=U!==null?W.get(U).__webglFramebuffer:null;x.bindFramebuffer(F.FRAMEBUFFER,Re)}}},this.readRenderTargetPixelsAsync=async function(T,O,$,V,H,me,ye,pe=0){if(!(T&&T.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Te=W.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&ye!==void 0&&(Te=Te[ye]),Te)if(O>=0&&O<=T.width-V&&$>=0&&$<=T.height-H){x.bindFramebuffer(F.FRAMEBUFFER,Te);const Re=T.textures[pe],Oe=Re.format,Be=Re.type;if(T.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+pe),!b.textureFormatReadable(Oe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!b.textureTypeReadable(Be))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ce=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,Ce),F.bufferData(F.PIXEL_PACK_BUFFER,me.byteLength,F.STREAM_READ),F.readPixels(O,$,V,H,de.convert(Oe),de.convert(Be),0);const rt=U!==null?W.get(U).__webglFramebuffer:null;x.bindFramebuffer(F.FRAMEBUFFER,rt);const Tt=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await pS(F,Tt,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,Ce),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,me),F.deleteBuffer(Ce),F.deleteSync(Tt),me}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(T,O=null,$=0){const V=Math.pow(2,-$),H=Math.floor(T.image.width*V),me=Math.floor(T.image.height*V),ye=O!==null?O.x:0,pe=O!==null?O.y:0;Z.setTexture2D(T,0),F.copyTexSubImage2D(F.TEXTURE_2D,$,0,0,ye,pe,H,me),x.unbindTexture()},this.copyTextureToTexture=function(T,O,$=null,V=null,H=0,me=0){let ye,pe,Te,Re,Oe,Be,Ce,rt,Tt;const yt=T.isCompressedTexture?T.mipmaps[me]:T.image;if($!==null)ye=$.max.x-$.min.x,pe=$.max.y-$.min.y,Te=$.isBox3?$.max.z-$.min.z:1,Re=$.min.x,Oe=$.min.y,Be=$.isBox3?$.min.z:0;else{const wt=Math.pow(2,-H);ye=Math.floor(yt.width*wt),pe=Math.floor(yt.height*wt),T.isDataArrayTexture?Te=yt.depth:T.isData3DTexture?Te=Math.floor(yt.depth*wt):Te=1,Re=0,Oe=0,Be=0}V!==null?(Ce=V.x,rt=V.y,Tt=V.z):(Ce=0,rt=0,Tt=0);const ot=de.convert(O.format),qt=de.convert(O.type);let xe;O.isData3DTexture?(Z.setTexture3D(O,0),xe=F.TEXTURE_3D):O.isDataArrayTexture||O.isCompressedArrayTexture?(Z.setTexture2DArray(O,0),xe=F.TEXTURE_2D_ARRAY):(Z.setTexture2D(O,0),xe=F.TEXTURE_2D),x.activeTexture(F.TEXTURE0),x.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,O.flipY),x.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),x.pixelStorei(F.UNPACK_ALIGNMENT,O.unpackAlignment);const xn=x.getParameter(F.UNPACK_ROW_LENGTH),Ye=x.getParameter(F.UNPACK_IMAGE_HEIGHT),Pn=x.getParameter(F.UNPACK_SKIP_PIXELS),ti=x.getParameter(F.UNPACK_SKIP_ROWS),Bi=x.getParameter(F.UNPACK_SKIP_IMAGES);x.pixelStorei(F.UNPACK_ROW_LENGTH,yt.width),x.pixelStorei(F.UNPACK_IMAGE_HEIGHT,yt.height),x.pixelStorei(F.UNPACK_SKIP_PIXELS,Re),x.pixelStorei(F.UNPACK_SKIP_ROWS,Oe),x.pixelStorei(F.UNPACK_SKIP_IMAGES,Be);const $r=T.isDataArrayTexture||T.isData3DTexture,at=O.isDataArrayTexture||O.isData3DTexture;if(T.isDepthTexture){const wt=W.get(T),zi=W.get(O),ct=W.get(wt.__renderTarget),Vi=W.get(zi.__renderTarget);x.bindFramebuffer(F.READ_FRAMEBUFFER,ct.__webglFramebuffer),x.bindFramebuffer(F.DRAW_FRAMEBUFFER,Vi.__webglFramebuffer);for(let qr=0;qr<Te;qr++)$r&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,W.get(T).__webglTexture,H,Be+qr),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,W.get(O).__webglTexture,me,Tt+qr)),F.blitFramebuffer(Re,Oe,ye,pe,Ce,rt,ye,pe,F.DEPTH_BUFFER_BIT,F.NEAREST);x.bindFramebuffer(F.READ_FRAMEBUFFER,null),x.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(H!==0||T.isRenderTargetTexture||W.has(T)){const wt=W.get(T),zi=W.get(O);x.bindFramebuffer(F.READ_FRAMEBUFFER,z),x.bindFramebuffer(F.DRAW_FRAMEBUFFER,D);for(let ct=0;ct<Te;ct++)$r?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,wt.__webglTexture,H,Be+ct):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,wt.__webglTexture,H),at?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,zi.__webglTexture,me,Tt+ct):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,zi.__webglTexture,me),H!==0?F.blitFramebuffer(Re,Oe,ye,pe,Ce,rt,ye,pe,F.COLOR_BUFFER_BIT,F.NEAREST):at?F.copyTexSubImage3D(xe,me,Ce,rt,Tt+ct,Re,Oe,ye,pe):F.copyTexSubImage2D(xe,me,Ce,rt,Re,Oe,ye,pe);x.bindFramebuffer(F.READ_FRAMEBUFFER,null),x.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else at?T.isDataTexture||T.isData3DTexture?F.texSubImage3D(xe,me,Ce,rt,Tt,ye,pe,Te,ot,qt,yt.data):O.isCompressedArrayTexture?F.compressedTexSubImage3D(xe,me,Ce,rt,Tt,ye,pe,Te,ot,yt.data):F.texSubImage3D(xe,me,Ce,rt,Tt,ye,pe,Te,ot,qt,yt):T.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,me,Ce,rt,ye,pe,ot,qt,yt.data):T.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,me,Ce,rt,yt.width,yt.height,ot,yt.data):F.texSubImage2D(F.TEXTURE_2D,me,Ce,rt,ye,pe,ot,qt,yt);x.pixelStorei(F.UNPACK_ROW_LENGTH,xn),x.pixelStorei(F.UNPACK_IMAGE_HEIGHT,Ye),x.pixelStorei(F.UNPACK_SKIP_PIXELS,Pn),x.pixelStorei(F.UNPACK_SKIP_ROWS,ti),x.pixelStorei(F.UNPACK_SKIP_IMAGES,Bi),me===0&&O.generateMipmaps&&F.generateMipmap(xe),x.unbindTexture()},this.initRenderTarget=function(T){W.get(T).__webglFramebuffer===void 0&&Z.setupRenderTarget(T)},this.initTexture=function(T){T.isCubeTexture?Z.setTextureCube(T,0):T.isData3DTexture?Z.setTexture3D(T,0):T.isDataArrayTexture||T.isCompressedArrayTexture?Z.setTexture2DArray(T,0):Z.setTexture2D(T,0),x.unbindTexture()},this.resetState=function(){Y=0,B=0,U=null,x.reset(),ve.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ci}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=He._getDrawingBufferColorSpace(e),n.unpackColorSpace=He._getUnpackColorSpace()}}function Yw(t){const n=document.createElement("canvas");n.width=t.w*2,n.height=t.h*2;const i=n.getContext("2d");i.scale(2,2),i.clearRect(0,0,t.w,t.h),i.fillStyle=t.bg||"rgba(15, 23, 42, 0.65)",i.fillRect(0,0,t.w,t.h),i.strokeStyle="rgba(255, 255, 255, 0.22)",i.lineWidth=1,i.strokeRect(.5,.5,t.w-1,t.h-1);const r=i.createLinearGradient(0,1,t.w,1);r.addColorStop(0,"rgba(255, 255, 255, 0.35)"),r.addColorStop(.5,"rgba(255, 255, 255, 0.12)"),r.addColorStop(1,"rgba(255, 255, 255, 0.35)"),i.strokeStyle=r,i.beginPath(),i.moveTo(1,1.5),i.lineTo(t.w-1,1.5),i.stroke();const s=6,o=t.w-s*2;let a=t.fontSize??22;const l=(R,_,E)=>{i.font=`${E?"600":"400"} ${_}px Inter, system-ui, sans-serif`;const C=R.split(" "),P=[];let L="";for(const I of C){const z=L?L+" "+I:I;i.measureText(z).width>o&&L?(P.push(L),L=I):L=z}return L&&P.push(L),P};let c=l(t.text,a,!0);for(;a>7&&c.some(R=>i.measureText(R).width>o);)a-=.5,c=l(t.text,a,!0);const h=Math.max(7,a*.75),u=t.subtext?l(t.subtext,h,!1):[],d=a*1.15,m=h*1.15,v=t.subtext?2:0;let M=c.length*d+v+u.length*m;for(;a>7&&M>t.h-4;){a-=.5;const R=l(t.text,a,!0),_=Math.max(7,a*.75),E=t.subtext?l(t.subtext,_,!1):[];M=R.length*(a*1.15)+v+E.length*(_*1.15)}const p=l(t.text,a,!0),f=Math.max(7,a*.75),g=t.subtext?l(t.subtext,f,!1):[];let S=Math.max(2,(t.h-M)/2);i.textBaseline="top";const y=t.align??(t.subtext?"left":"center");i.textAlign=y==="center"?"center":"left";const A=y==="center"?t.w/2:s;i.fillStyle=t.fg,i.font=`600 ${a}px Inter, system-ui, sans-serif`;for(const R of p)i.fillText(R,A,S),S+=a*1.15;if(g.length>0){S+=v,i.fillStyle=t.accent??"#f59e0b",i.font=`400 ${f}px Inter, system-ui, sans-serif`;for(const R of g)i.fillText(R,A,S),S+=f*1.15}t.icon&&(i.font=`${a*1.2}px Inter, system-ui, sans-serif`,i.textAlign="right",i.textBaseline="middle",i.fillStyle=t.accent??t.fg,i.fillText(t.icon,t.w-s,t.h/2));const w=new oc(n);return w.colorSpace=Wt,w}async function $w(t){const n=document.createElement("canvas");n.width=t.w*2,n.height=t.h*2;const i=n.getContext("2d");i.scale(2,2);const r=i.createLinearGradient(0,0,t.w,t.h);if(r.addColorStop(0,"#1a2a4a"),r.addColorStop(1,"#0a1120"),i.fillStyle=r,i.fillRect(0,0,t.w,t.h),t.imageUrl)try{const h=await Fv(t.imageUrl),u=h.width/h.height,d=t.w/t.h;let m=t.w,v=t.h,M=0,p=0;u>d?(v=t.h,m=v*u,M=(t.w-m)/2):(m=t.w,v=m/u,p=(t.h-v)/2),i.drawImage(h,M,p,m,v)}catch{Fm(i,t)}else Fm(i,t);const s=i.createLinearGradient(0,0,0,t.h*.25);if(s.addColorStop(0,"rgba(5,10,20,0.75)"),s.addColorStop(1,"rgba(5,10,20,0)"),i.fillStyle=s,i.fillRect(0,0,t.w,t.h*.25),t.rating>0){const h=`★ ${t.rating.toFixed(1)}`;i.font="700 10px Inter, system-ui, sans-serif";const u=i.measureText(h).width+10,d=18,m=t.w-u-5;i.fillStyle="rgba(245, 158, 11, 0.95)",i.fillRect(m,5,u,d),i.strokeStyle="rgba(255, 255, 255, 0.4)",i.strokeRect(m+.5,5.5,u-1,d-1),i.fillStyle="#0f172a",i.textAlign="center",i.textBaseline="middle",i.fillText(h,m+u/2,5+d/2)}const o=i.createLinearGradient(0,t.h*.4,0,t.h);o.addColorStop(0,"rgba(5,10,20,0)"),o.addColorStop(1,"rgba(5,10,20,0.95)"),i.fillStyle=o,i.fillRect(0,t.h*.4,t.w,t.h*.6);let a=13;const l=t.w-16;for(i.font=`600 ${a}px Inter, system-ui, sans-serif`;a>9.5&&Zw(i,t.title,l)>2;)a-=.5,i.font=`600 ${a}px Inter, system-ui, sans-serif`;i.fillStyle="#f8fafc",i.font=`600 ${a}px Inter, system-ui, sans-serif`,Qw(i,t.title,8,t.h-10,l,a,3);const c=new oc(n);return c.colorSpace=Wt,c}function Fm(t,e){t.fillStyle="#f1f5f9",t.font="600 11px Inter, system-ui, sans-serif",t.textAlign="center",t.textBaseline="middle",ef(t,e.title,e.w/2,e.h/2-10,e.w-12,13,3)}async function qw(t){const n=document.createElement("canvas");n.width=t.w*2,n.height=t.h*2;const i=n.getContext("2d");i.scale(2,2);const r=i.createLinearGradient(0,0,t.w,t.h);if(r.addColorStop(0,"#0d1b2a"),r.addColorStop(1,"#050810"),i.fillStyle=r,i.fillRect(0,0,t.w,t.h),t.imageUrl)try{const l=await Fv(t.imageUrl),c=l.width/l.height,h=t.w/t.h;let u=t.w,d=t.h,m=0,v=0;c>h?(d=t.h,u=d*c,m=(t.w-u)/2):(u=t.w,d=u/c,v=(t.h-d)/2),i.drawImage(l,m,v,u,d)}catch{}const s=i.createLinearGradient(0,0,t.w,0);s.addColorStop(0,"rgba(5,8,16,0.88)"),s.addColorStop(.5,"rgba(5,8,16,0.5)"),s.addColorStop(1,"rgba(5,8,16,0.2)"),i.fillStyle=s,i.fillRect(0,0,t.w,t.h),i.fillStyle="#f8fafc",i.font="700 18px Inter, system-ui, sans-serif",i.textAlign="left",i.textBaseline="top",ef(i,t.title,20,16,t.w*.55,22,2);let o=62;t.metadata&&(i.fillStyle="#94a3b8",i.font="500 10px Inter, system-ui, sans-serif",i.fillText(t.metadata,20,o),o+=16),i.fillStyle="#cbd5e1",i.font="400 11px Inter, system-ui, sans-serif",ef(i,t.overview,20,o,t.w*.5,15,6);const a=new oc(n);return a.colorSpace=Wt,a}function Kw(t){const n=document.createElement("canvas");n.width=t.w*2,n.height=t.h*2;const i=n.getContext("2d");i.scale(2,2),i.clearRect(0,0,t.w,t.h),i.fillStyle="#f8fafc",i.font="700 24px Inter, system-ui, sans-serif",i.textAlign="left",i.textBaseline="middle",i.fillText(t.title,4,t.h/2);const r=new oc(n);return r.colorSpace=Wt,r}function Fv(t){return new Promise((e,n)=>{const i=new Image;i.crossOrigin="anonymous",i.onload=()=>e(i),i.onerror=n,i.src=t})}function Zw(t,e,n){const i=e.split(" ");let r="",s=0;for(const o of i){const a=r?r+" "+o:o;t.measureText(a).width>n&&r?(s++,r=o):r=a}return r&&s++,s}function Qw(t,e,n,i,r,s,o=3){const a=e.split(" ");let l="",c=[];for(const v of a){const M=l?l+" "+v:v;t.measureText(M).width>r&&l?(c.push(l),l=v):l=M}l&&c.push(l);const h=c.slice(0,o),u=s*1.2,d=h.length*u,m=Math.max(8,i-d);t.textBaseline="top",t.textAlign="left",t.font=`600 ${s}px Inter, system-ui, sans-serif`;for(let v=0;v<h.length;v++)t.fillText(h[v],n,m+v*u)}function ef(t,e,n,i,r,s,o){const a=e.split(" ");let l="",c=[];for(const u of a){const d=l?l+" "+u:u;t.measureText(d).width>r&&l?(c.push(l),l=u):l=d}l&&c.push(l);const h=c.slice(0,o);for(let u=0;u<h.length;u++)t.fillText(h[u],n,i+u*s)}const Jw=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
...
`;class eA{constructor(){this.startTime=performance.now(),this.scene=new Sv,this.camera=new lh,this.material=new Jn({vertexShader:Jw,fragmentShader:jw,uniforms:{iTime:{value:0},iResolution:{value:new Ke(window.innerWidth,window.innerHeight)}},depthTest:!1,depthWrite:!1});const e=new Ai(2,2),n=new pn(e,this.material);this.scene.add(n)}update(e,n){this.material.uniforms.iTime.value=(performance.now()-this.startTime)/1e3,this.material.uniforms.iResolution.value.set(e,n)}}const vu=0;class Om{constructor(e,n,i){this.raf=0,this.views=new Map,this.disposed=!1,this.screenW=0,this.screenH=0,this.lastTime=performance.now(),this.textureLoads=new Map,this.textureCache=new Map,this.container=e,this.layout=n,this.engine=i;const r=new Xw({antialias:!0,alpha:!0,powerPreference:"high-performance"});r.setPixelRatio(Math.min(window.devicePixelRatio,2)),r.setSize(window.innerWidth,window.innerHeight),r.shadowMap.enabled=!1,r.colorSpace=Wt,r.autoClear=!1,this.renderer=r,e.appendChild(r.domElement),this.resize(),this.bg=new eA;for(const s of this.layout.allPanels)this.buildPanelView(s);this.loop=this.loop.bind(this),this.raf=requestAnimationFrame(this.loop)}resize(){this.screenW=this.container.clientWidth||window.innerWidth,this.screenH=this.container.clientHeight||window.innerHeight,this.renderer.setSize(this.screenW,this.screenH)}buildPanelView(e){const n=new Sv,i=e.viewport,r=new ch(0,i.w,0,-i.h,-100,100);r.position.z=50,n.add(r);const s=new vo;n.add(s);const o=new Map,a=new Map,l=new Map,c=new Map,h=(u,d)=>{const{x:m,y:v,w:M,h:p}=u.bounds,f=m+M/2,g=-(v+p/2),S=u.content.kind,y=S==="poster"||S==="backdrop",A=new Ai(M,p),w=new Ms({color:u.color,transparent:!0,opacity:d?0:.92,side:En,depthWrite:!1});w.userData.loaded=!y;const R=new pn(A,w);if(R.position.set(f,g,vu),R.renderOrder=1,R.visible=!y,!d&&(S==="poster"||S==="backdrop"||S==="text"||S==="section")){const _=new Ai(M,p),E=new Ms({color:16096779,side:En,depthWrite:!1}),C=new pn(_,E);C.position.set(0,0,-.05),C.scale.set(0,0,1),C.renderOrder=0,C.visible=!y,R.add(C),l.set(u.id,C)}s.add(R),o.set(u.id,R),a.set(u.id,w),this.loadTileTexture(u,w,M,p)};for(const u of e.tiles)h(u,!!u.childPanel);this.views.set(e.id,{panel:e,scene:n,camera:r,contentGroup:s,tileMeshes:o,tileMaterials:a,tileBackMeshes:l,tileContentKeys:c})}updateLayout(e){this.layout=e,this.engine.updateLayout(e);const n=new Set(e.allPanels.map(i=>i.id));for(const[i,r]of this.views.entries())n.has(i)||(r.scene.traverse(s=>{s.geometry&&s.geometry.dispose(),s.material&&(Array.isArray(s.material)?s.material:[s.material]).forEach(a=>{a.map&&a.map.dispose(),a.dispose()})}),this.views.delete(i));for(const i of e.allPanels){const r=this.views.get(i.id);if(!r){this.buildPanelView(i);continue}const s=r.panel;i.scrollX=s.scrollX,i.scrollY=s.scrollY,i.targetScrollX=s.targetScrollX,i.targetScrollY=s.targetScrollY,r.panel=i;const o=new Set(i.tiles.map(a=>a.id));for(const[a,l]of r.tileMeshes.entries())if(!o.has(a)){r.contentGroup.remove(l),r.tileMeshes.delete(a);const c=r.tileMaterials.get(a);c&&(c.map&&c.map.dispose(),c.dispose()),r.tileMaterials.delete(a),r.tileBackMeshes.delete(a),r.tileContentKeys.delete(a),l.geometry.dispose()}for(const a of i.tiles)if(r.tileMeshes.has(a.id)){const l=r.tileMeshes.get(a.id),{x:c,y:h,w:u,h:d}=a.bounds,m=c+u/2,v=-(h+d/2);if(l.position.set(m,v,vu),a.content.kind==="text"||a.content.kind==="section"){const M=a.content.kind==="text"?`text-${a.content.text}`:`section-${a.content.title}`;if(r.tileContentKeys.get(a.id)!==M){r.tileContentKeys.set(a.id,M);const f=r.tileMaterials.get(a.id);f&&(f.map&&(f.map.dispose(),f.map=null),this.loadTileTexture(a,f,u,d))}}}else{const l=!!a.childPanel,{x:c,y:h,w:u,h:d}=a.bounds,m=c+u/2,v=-(h+d/2),M=a.content.kind,p=M==="poster"||M==="backdrop",f=new Ai(u,d),g=new Ms({color:a.color,transparent:!0,opacity:l?.25:.94,side:En,depthWrite:!1});g.userData.loaded=!p;const S=new pn(f,g);if(S.position.set(m,v,vu),S.renderOrder=1,S.visible=!p,!l&&(M==="poster"||M==="backdrop"||M==="text"||M==="section")){const y=new Ai(u,d),A=new Ms({color:16096779,side:En,depthWrite:!1}),w=new pn(y,A);w.position.set(0,0,-.05),w.scale.set(0,0,1),w.renderOrder=0,w.visible=!p,S.add(w),r.tileBackMeshes.set(a.id,w)}r.contentGroup.add(S),r.tileMeshes.set(a.id,S),r.tileMaterials.set(a.id,g),this.loadTileTexture(a,g,u,d)}}}loadTileTexture(e,n,i,r){const s=e.content;let o=e.id;if(s.kind==="poster"||s.kind==="backdrop"?o=s.imageUrl||s.title||e.id:s.kind==="text"&&(o=`text-${s.text}`),this.textureCache.has(o)){n.map=this.textureCache.get(o),n.color.setHex(16777215),n.userData.loaded=!0,(s.kind==="poster"||s.kind==="backdrop")&&(n.opacity=1,n.transparent=!1),n.needsUpdate=!0;return}let a=this.textureLoads.get(o);switch(a?(s.kind==="poster"||s.kind==="backdrop")&&(n.opacity=0,n.transparent=!0,n.userData.loaded=!1):(s.kind==="poster"?(n.opacity=0,n.transparent=!0,n.userData.loaded=!1,s.imageUrl&&(a=$w({imageUrl:s.imageUrl,title:s.title,year:s.year,rating:s.rating,w:Math.max(80,Math.floor(i)),h:Math.max(120,Math.floor(r))}))):s.kind==="backdrop"&&(n.opacity=0,n.transparent=!0,n.userData.loaded=!1,s.imageUrl&&(a=qw({imageUrl:s.imageUrl,title:s.title,metadata:s.metadata,overview:s.overview,w:Math.max(200,Math.floor(i)),h:Math.max(120,Math.floor(r))}))),a&&this.textureLoads.set(o,a)),a&&a.then(l=>{this.disposed||!l||(this.textureCache.set(o,l),n.map=l,n.color.setHex(16777215),(s.kind==="poster"||s.kind==="backdrop")&&(n.opacity=1,n.transparent=!1,n.userData.loaded=!0),n.needsUpdate=!0)}).catch(()=>{}),s.kind){case"text":case"section":case"placeholder":case"detail":n.userData.loaded=!0;break}switch(s.kind){case"text":{n.color.setHex(16777215),n.transparent=!0,n.opacity=.82;const l={"#000000":"#050a14","#1e40af":"#0a1432","#16a34a":"#0a3520","#d97706":"#3a200a"},c="#"+e.color.toString(16).padStart(6,"0"),h=l[c]??"#0f172a",u=Yw({text:s.text,subtext:s.subtext,bg:h,fg:"#f1f5f9",accent:"#f59e0b",w:Math.max(80,Math.floor(i)),h:Math.max(40,Math.floor(r)),fontSize:i>200?22:20,align:s.subtext?"left":"center"});n.map=u,n.needsUpdate=!0;break}case"section":{n.color.setHex(16777215),n.transparent=!0,n.opacity=.75;const l=Kw({title:s.title,w:Math.max(100,Math.floor(i)),h:Math.max(30,Math.floor(r))});n.map=l,n.needsUpdate=!0;break}case"placeholder":n.color.setHex(0),n.opacity=0;break;case"detail":n.color.setHex(0),n.opacity=0;break}}updateFocus(){this.maybeLoadPreviewData()}maybeLoadPreviewData(){}loop(e){if(this.disposed)return;const n=Math.min(.05,(e-this.lastTime)/1e3);this.lastTime=e,this.engine.step(n);for(const s of this.views.values()){const o=s.panel;s.contentGroup.position.set(-o.scrollX,o.scrollY,0);for(const a of o.tiles){const l=s.tileMeshes.get(a.id),c=s.tileMaterials.get(a.id);if(l&&c){const h=this.engine.focused.id===a.id,u=a.content.kind,d=u==="poster",m=u==="poster"||u==="backdrop",v=h&&d?1.12:1;l.scale.x+=(v-l.scale.x)*14*n,l.scale.y+=(v-l.scale.y)*14*n;const M=h?d?10:3:0;l.position.z+=(M-l.position.z)*14*n,l.renderOrder=h?999:1,h&&s.contentGroup.children[s.contentGroup.children.length-1]!==l&&(s.contentGroup.remove(l),s.contentGroup.add(l));let p=0,f=0;if(d&&this.engine.focused.panel===o&&!h){const E=this.engine.focused.bounds;if(Math.abs(a.bounds.y-E.y)<10){const C=a.bounds.x-E.x,P=Math.PI/8,L=.055;C<0&&Math.abs(C)<a.bounds.w*1.5?(p=P,f=-a.bounds.w*L):C>0&&Math.abs(C)<a.bounds.w*1.5&&(p=-P,f=a.bounds.w*L)}}l.rotation.y+=(p-l.rotation.y)*14*n;const S=a.bounds.x+a.bounds.w/2+f;l.position.x+=(S-l.position.x)*14*n;const y=c.userData.loaded!==!1,A=s.tileBackMeshes.get(a.id);if(A)if(A.visible=y,y){const E=m?8:4,C=h?1+2*E/a.bounds.w:0,P=h?1+2*E/a.bounds.h:0;A.scale.x+=(C-A.scale.x)*14*n,A.scale.y+=(P-A.scale.y)*14*n,A.renderOrder=h?998:0}else A.scale.set(0,0,1);if(u==="poster"||u==="backdrop"){const C=h?.88:1,P=h?.55:1,L=c.color.r,I=c.color.g,z=c.color.b;c.color.setRGB(L+(1-L)*10*n,I+(C-I)*10*n,z+(P-z)*10*n)}else if(u==="text"||u==="section"){const E=h?1:.82;c.opacity+=(E-c.opacity)*14*n;const C=h?.85:1,P=h?.35:1,L=1,I=c.color.r,z=c.color.g,D=c.color.b;c.color.setRGB(I+(C-I)*10*n,z+(P-z)*10*n,D+(L-D)*10*n)}const w=a.bounds.y-o.scrollY,R=500,_=y&&!(w>o.viewport.h+R||w+a.bounds.h<-R);l.visible=_}}}const i=this.renderer;i.setScissorTest(!1),i.setViewport(0,0,this.screenW,this.screenH),i.setClearColor(461588,1),i.clear(!0,!0,!0),i.setScissorTest(!0);const r=[...this.views.values()].sort((s,o)=>s.panel.depth-o.panel.depth);for(const s of r){const o=s.panel,a=Yo(o),l=Dy(o);if(l.w<=0||l.h<=0)continue;const c=80,h=Math.max(0,l.x-c),u=l.y-c,d=Math.min(this.screenW,l.x+l.w+c)-h,m=l.h+c*2,v=a.x-c,M=this.screenH-(a.y+a.h)-c,p=a.w+c*2,f=a.h+c*2;i.setViewport(v,M,p,f),i.setScissor(h,this.screenH-(u+m),d,m),s.camera.left=-c,s.camera.right=o.viewport.w+c,s.camera.top=c,s.camera.bottom=-(o.viewport.h+c),s.camera.updateProjectionMatrix(),i.clearDepth(),i.render(s.scene,s.camera)}this.raf=requestAnimationFrame(this.loop)}dispose(){this.disposed=!0,cancelAnimationFrame(this.raf),this.renderer.dispose();for(const e of this.views.values())e.scene.traverse(n=>{n.geometry&&n.geometry.dispose();const i=n.material;Array.isArray(i)?i.forEach(r=>r.dispose()):i&&i.dispose()});this.renderer.domElement.parentElement===this.container&&this.container.removeChild(this.renderer.domElement)}}const tA=600,nA={ArrowUp:"up",ArrowDown:"down",ArrowLeft:"left",ArrowRight:"right"};function km(t){let e=t.key;return(t.keyCode===38||t.keyCode===19||e==="Up")&&(e="ArrowUp"),(t.keyCode===40||t.keyCode===20||e==="Down")&&(e="ArrowDown"),(t.keyCode===37||t.keyCode===21||e==="Left")&&(e="ArrowLeft"),(t.keyCode===39||t.keyCode===22||e==="Right")&&(e="ArrowRight"),(t.keyCode===13||t.keyCode===23||t.keyCode===66&&t.key.length!==1)&&(e="Enter"),e}class iA{constructor(e){this.holdTimer=null,this.holdFired=!1,this.callbacks=e,this.boundKeyDown=this.onKeyDown.bind(this),this.boundKeyUp=this.onKeyUp.bind(this)}attach(){window.addEventListener("keydown",this.boundKeyDown,!0),window.addEventListener("keyup",this.boundKeyUp,!0)}detach(){window.removeEventListener("keydown",this.boundKeyDown,!0),window.removeEventListener("keyup",this.boundKeyUp,!0),this.cancelHold()}cancelHold(){this.holdTimer!==null&&(clearTimeout(this.holdTimer),this.holdTimer=null)}onKeyDown(e){var r,s,o,a,l,c;if((s=(r=this.callbacks).isSuspended)!=null&&s.call(r))return;const n=km(e),i=nA[n];if(i){e.preventDefault(),e.stopPropagation(),this.callbacks.onNavigate(i);return}if(n==="Enter"){if(e.preventDefault(),e.stopPropagation(),e.repeat)return;this.holdFired=!1,this.holdTimer=window.setTimeout(()=>{this.holdFired=!0,this.holdTimer=null},tA);return}if(n==="Backspace"){e.preventDefault(),e.stopPropagation(),(a=(o=this.callbacks).onBackspace)==null||a.call(o);return}if(n.length===1&&!e.ctrlKey&&!e.altKey&&!e.metaKey){e.preventDefault(),e.stopPropagation(),(c=(l=this.callbacks).onType)==null||c.call(l,n);return}}onKeyUp(e){var i,r;if((r=(i=this.callbacks).isSuspended)!=null&&r.call(i)){e.preventDefault();return}if(km(e)==="Enter"){if(e.preventDefault(),e.stopPropagation(),this.holdFired){this.holdFired=!1,this.callbacks.onBack();return}this.cancelHold(),this.callbacks.onSelect()}}}function Bm(t,e,n){if(n.focusLabel){const s=e.allLeaves.find(o=>o.label===n.focusLabel);if(s){t.setFocus(s);return}}let r=e.allLeaves.find(s=>{var a;let o=s.panel;for(;o;){if(o.id==="header"||o.id==="sidebar")return!1;o=((a=o.parentTile)==null?void 0:a.panel)??null}return!0});if(n.type==="search"){const s=e.allLeaves.find(o=>o.label==="PageHeader"||o.content.kind==="text"&&typeof o.content.text=="string"&&o.content.text.includes("Search"));s&&(r=s)}r&&t.setFocus(r)}function rA(){const t=We.useRef(null),[e,n]=We.useState(!0),[i,r]=We.useState(null),[s,o]=We.useState(null),[a,l]=We.useState([{type:"home"}]),[c,h]=We.useState("all"),u=a[a.length-1],d=We.useRef([]),m=We.useRef(u),v=We.useRef(!1),M=We.useRef(!1),p=We.useRef(null);We.useEffect(()=>{d.current=u.dynamicData||[]},[u.dynamicData]),We.useEffect(()=>{m.current=u},[u]),We.useEffect(()=>{let E=!1;return(async()=>{try{const C=new Date().getFullYear(),P=Array.from({length:C-1900+1},(_e,ge)=>C-ge),[L,I,z,D,Y,B,U,q,j,G,J]=await Promise.all([tt.trendingMovies(),tt.popularMovies(),tt.topRatedMovies(),tt.upcomingMovies(),tt.nowPlayingMovies(),tt.trendingTV(),tt.popularTV(),tt.topRatedTV(),tt.latestTV(),tt.movieGenres(),tt.tvGenres()]);if(E)return;const Me={trending:dn(L.results),popular:dn(I.results),topRated:dn(z.results),upcoming:dn(D.results),nowPlaying:dn(Y.results),trendingTV:dn(B.results),popularTV:dn(U.results),topRatedTV:dn(q.results),latestTV:dn(j.results),movieGenres:G.genres,tvGenres:J.genres,years:P};o(Me),n(!1)}catch(C){if(E)return;r(C instanceof Error?C.message:"Failed to load movie data"),n(!1)}})(),()=>{E=!0}},[]),We.useEffect(()=>{let E=!1;return(async()=>{var C,P;if(!(u.type!=="genre"&&u.type!=="year"&&u.type!=="person"||u.dynamicData)){v.current=!0;try{if(u.type==="person"){const[_e,ge]=await Promise.all([tt.personMovieCredits(u.personId),tt.personTVCredits(u.personId)]),K=dn([..._e.cast||[],...ge.cast||[]].sort((se,ie)=>(ie.vote_average||0)-(se.vote_average||0)));if(E)return;l(se=>{const ie=[...se],De={...ie[ie.length-1]};return De.dynamicData=K,ie[ie.length-1]=De,ie}),v.current=!1;return}const L=((C=t.current)==null?void 0:C.clientWidth)||window.innerWidth,I=((P=t.current)==null?void 0:P.clientHeight)||window.innerHeight,D=Math.floor((L-32)/174),Y=Math.ceil(I/234),B=D*Y,U=Math.max(1,Math.ceil(B/20)),q=_e=>u.type==="genre"?u.mediaType==="tv"?tt.discoverTV({with_genres:u.genreId,page:_e}):tt.discoverMovies({with_genres:u.genreId,page:_e}):u.mediaType==="tv"?tt.discoverTV({first_air_date_year:u.year,page:_e}):tt.discoverMovies({year:u.year,page:_e}),j=[];for(let _e=1;_e<=U;_e++)j.push(q(_e));const G=await Promise.all(j);if(E)return;const J=G.flatMap(_e=>dn(_e.results)),Me=G[G.length-1];l(_e=>{const ge=[..._e],K={...ge[ge.length-1]};return K.dynamicData=J,K.dynamicPage=U,K.dynamicHasMore=Me.results.length>=20,ge[ge.length-1]=K,ge})}catch{}v.current=!1}})(),()=>{E=!0}},[u]),We.useEffect(()=>{if(u.type!=="search"||!u.query)return;const E=u.query,C=window.setTimeout(async()=>{try{const P=await tt.search(E),L=dn(P.results||[]);l(I=>{const z=[...I],D=z[z.length-1];return D.type==="search"&&D.query===E&&(z[z.length-1]={...D,dynamicData:L,dynamicPage:1,dynamicHasMore:(P.results||[]).length>=20}),z})}catch{}},2e3);return()=>window.clearTimeout(C)},[u.type==="search"?u.query:null]);const f=async()=>{const E=m.current;if(v.current||E.dynamicHasMore===!1||E.type!=="genre"&&E.type!=="year"&&E.type!=="search")return;v.current=!0;const C=(E.dynamicPage||1)+1;try{let P;if(E.type==="genre")P=E.mediaType==="tv"?await tt.discoverTV({with_genres:E.genreId,page:C}):await tt.discoverMovies({with_genres:E.genreId,page:C});else if(E.type==="year")P=E.mediaType==="tv"?await tt.discoverTV({first_air_date_year:E.year,page:C}):await tt.discoverMovies({year:E.year,page:C});else if(E.type==="search"&&E.query)P=await tt.search(E.query,C);else return;const L=dn(P.results);l(I=>{const z=[...I],D={...z[z.length-1]};return L.length>0&&(D.dynamicData=[...D.dynamicData||[],...L],D.dynamicPage=C),(L.length===0||P.results.length<20)&&(D.dynamicHasMore=!1),z[z.length-1]=D,z})}catch{}v.current=!1},g=We.useRef(null),S=We.useRef(null),y=We.useRef(null),A=We.useRef("all"),w=We.useRef(null),[R,_]=We.useState(null);return We.useEffect(()=>{if(u.type!=="details"||u.similar)return;const E=Pr(u.movie);tt.getSimilarMovies(u.movie.id,E).then(C=>{l(P=>{const L=[...P],I=L[L.length-1];return I.type==="details"&&I.movie.id===u.movie.id?(L[L.length-1]={...I,similar:dn(C.results)},L):P})}).catch(console.error),E==="tv"?tt.tvDetails(u.movie.id).then(C=>{const P=u.season||1;(C.seasons&&C.seasons.length>0?tt.tvSeason(u.movie.id,P):Promise.resolve({episodes:[]})).then(I=>{l(z=>{var B,U;const D=[...z],Y=D[D.length-1];return Y.type==="details"&&Y.movie.id===u.movie.id?(D[D.length-1]={...Y,movie:{...Y.movie,...C,cast:((B=C.credits)==null?void 0:B.cast)||[],crew:((U=C.credits)==null?void 0:U.crew)||[]},seasonsData:C.seasons||[],episodesData:I.episodes||[],season:P,episode:u.episode||1},D):z})}).catch(console.error)}).catch(console.error):tt.movieDetails(u.movie.id).then(C=>{l(P=>{var z,D;const L=[...P],I=L[L.length-1];return I.type==="details"&&I.movie.id===u.movie.id?(L[L.length-1]={...I,movie:{...I.movie,...C,cast:((z=C.credits)==null?void 0:z.cast)||[],crew:((D=C.credits)==null?void 0:D.crew)||[]}},L):P})}).catch(console.error)},[u]),We.useEffect(()=>{u.type!=="details"&&_(null)},[u.type]),We.useEffect(()=>{if(u.type!=="details"||R)return;let E;const C=()=>{g.current&&g.current.allLeaves.filter(L=>L.content.kind==="text"&&L.content.action==="play_server").forEach(L=>{const I=L.content.payload,z=document.getElementById(`server-iframe-${I}`);if(z){const D=L.panel,Y=Yo(D),B=Y.x+L.bounds.x-D.scrollX,U=Y.y+L.bounds.y-D.scrollY;U>-L.bounds.h&&U<window.innerHeight?(z.style.transform=`translate(${B}px, ${U}px)`,z.style.width=`${L.bounds.w}px`,z.style.height=`${L.bounds.h}px`,z.style.display="block"):z.style.display="none"}}),E=requestAnimationFrame(C)};return E=requestAnimationFrame(C),()=>cancelAnimationFrame(E)},[u.type,R]),We.useEffect(()=>{const E=p.current;E&&(u.type==="search"?(E.value=u.query||"",E.focus(),M.current=!0):(E.blur(),M.current=!1))},[u.type]),We.useEffect(()=>()=>{var E,C;(E=S.current)==null||E.dispose(),(C=w.current)==null||C.detach()},[]),We.useEffect(()=>{if(!s)return;const E=t.current;if(!E)return;const C=E.clientWidth||window.innerWidth,P=E.clientHeight||window.innerHeight,L=Ip(C,P,s,u,u.dynamicData||null,c),I=y.current,z=A.current!==c;let D=!1;if(I&&S.current&&g.current&&!z&&I.type===u.type&&(u.type==="genre"&&I.type==="genre"&&I.genreId===u.genreId||u.type==="year"&&I.type==="year"&&I.year===u.year||u.type==="details"&&I.type==="details"&&I.movie.id===u.movie.id&&I.season===u.season&&I.episode===u.episode||u.type==="search"&&I.type==="search"||u.type==="home"&&I.type==="home")&&(D=!0),D)g.current.updateLayout(L),S.current.updateLayout(L),window.engine=g.current,window.sceneManager=S.current;else{if(S.current&&S.current.dispose(),g.current=new Op(L),u.scrollStates)for(const G of g.current.allPanels){const J=u.scrollStates[G.id];J&&(G.scrollX=J.scrollX,G.scrollY=J.scrollY,G.targetScrollX=J.targetScrollX,G.targetScrollY=J.targetScrollY)}Bm(g.current,L,u),S.current=new Om(E,L,g.current),window.engine=g.current,window.sceneManager=S.current}y.current=u,A.current=c,g.current.onFocusChange=(G,J)=>{var _e;u.focusLabel=G.label;const Me=G.content;Me.kind==="poster"&&d.current.length>0&&d.current.findIndex(K=>K.id===Me.movieId)>=d.current.length-15&&f(),(_e=S.current)==null||_e.updateFocus()};const Y=G=>{var J,Me;console.log("NAVIGATING TO:",G.type,G.type==="details"?((J=G.movie)==null?void 0:J.title)||((Me=G.movie)==null?void 0:Me.name):""),l(_e=>{const ge=[..._e],K={...ge[ge.length-1]},se={};for(const ie of g.current.allPanels)se[ie.id]={scrollX:ie.scrollX,scrollY:ie.scrollY,targetScrollX:ie.targetScrollX,targetScrollY:ie.targetScrollY};return K.scrollStates=se,K.focusLabel=g.current.focused.label,ge[ge.length-1]=K,ge.push(G),ge})},B=()=>{if(R){_(null);return}l(G=>{if(G.length<=1)return G;const J=[...G];return J.pop(),J})};window.navigateBack=B;const U=()=>{const G=g.current.focused.content;if(console.log("SELECT on:",G.kind,"label:",g.current.focused.label),G.kind==="text"&&G.action==="play_server"&&u.type==="details"){const J=G.payload,Me=Pr(u.movie)==="tv"?"tv":"movie",ge=il(u.movie.id,Me,u.season,u.episode)[J];ge!=null&&ge.url&&_({url:ge.url});return}if(G.kind==="text"&&G.action){if(G.action==="home")h("all"),Y({type:"home"});else if(G.action==="setFilter")h(G.payload),u.type!=="home"&&Y({type:"home"});else if(G.action==="person"){const J=G.payload;Y({type:"person",personId:J.id,personName:J.name})}else if(G.action==="genre"){const J=G.payload;Y({type:"genre",genreId:J.id,genreName:J.name,mediaType:J.mediaType})}else if(G.action==="year"){const J=G.payload;Y({type:"year",year:J.year,mediaType:J.mediaType})}else if(G.action==="search"){const J=u.type==="search"&&u.query||"";p.current&&(p.current.value=J,p.current.focus()),m.current.type!=="search"&&Y({type:"search",query:J})}else if(G.action!=="play_server"){if(G.action==="change_season"&&u.type==="details"){const J=G.payload;tt.tvSeason(u.movie.id,J).then(Me=>{l(_e=>{const ge=[..._e],K=ge[ge.length-1];return K.type==="details"&&K.movie.id===u.movie.id?(ge[ge.length-1]={...K,season:J,episodesData:Me.episodes,episode:1},ge):_e})}).catch(Me=>console.error("CHANGE_SEASON TMDB ERROR:",Me))}else if(G.action==="change_episode"&&u.type==="details"){const J=G.payload;l(Me=>{const _e=[...Me],ge=_e[_e.length-1];return ge.type==="details"&&ge.movie.id===u.movie.id?(_e[_e.length-1]={...ge,episode:J},_e):Me})}}}else(G.kind==="poster"||G.kind==="backdrop")&&Y({type:"details",movie:G.movie})};w.current&&w.current.detach(),w.current=new iA({onNavigate:G=>g.current.handleInput(G),onSelect:U,onBack:B,onType:G=>{if(!(p.current&&document.activeElement===p.current)&&m.current.type==="search"){const Me=(m.current.query||"")+G;l(_e=>{const ge=[..._e];return ge[ge.length-1]={type:"search",query:Me,dynamicData:void 0},ge})}},onBackspace:()=>{if(!(p.current&&document.activeElement===p.current)&&m.current.type==="search"){const G=m.current.query||"";if(G.length>0){const J=G.slice(0,-1);l(Me=>{const _e=[...Me];return _e[_e.length-1]={type:"search",query:J,dynamicData:void 0},_e})}}},isSuspended:()=>!!(p.current&&(M.current||document.activeElement===p.current))}),w.current.attach();let q;const j=()=>{window.clearTimeout(q),q=window.setTimeout(()=>{const G=E.clientWidth||window.innerWidth,J=E.clientHeight||window.innerHeight;S.current&&S.current.dispose();const Me=Ip(G,J,s,u,u.dynamicData||null,c);g.current=new Op(Me),Bm(g.current,Me,u),S.current=new Om(E,Me,g.current),u.type==="search"&&p.current&&p.current.focus()},200)};return window.addEventListener("resize",j),()=>{window.removeEventListener("resize",j),window.clearTimeout(q)}},[s,u,c]),e?Qe.jsx("div",{className:"w-screen h-screen flex items-center justify-center bg-[#05070d] text-slate-100",children:Qe.jsxs("div",{className:"text-center",children:[Qe.jsx("div",{className:"inline-block w-12 h-12 border-4 border-amber-400 border-t-transparent rounded-full animate-spin mb-4"}),Qe.jsx("div",{className:"text-lg font-semibold text-amber-300",children:"CineDeck"}),Qe.jsx("div",{className:"text-sm text-slate-400 mt-1",children:"Loading movies & TV shows..."})]})}):i?Qe.jsx("div",{className:"w-screen h-screen flex items-center justify-center bg-[#05070d] text-slate-100",children:Qe.jsxs("div",{className:"text-center max-w-md",children:[Qe.jsx("div",{className:"text-rose-400 text-lg font-semibold mb-2",children:"Couldn't load movie data"}),Qe.jsx("div",{className:"text-sm text-slate-400",children:i})]})}):Qe.jsxs("div",{className:"relative w-screen h-screen overflow-hidden bg-[#05070d] text-slate-100 select-none outline-none",tabIndex:0,autoFocus:!0,ref:E=>{E&&E.focus()},children:[Qe.jsx("div",{ref:t,className:"absolute inset-0"}),Qe.jsx("textarea",{ref:p,rows:1,"aria-label":"Search",autoComplete:"off",autoCorrect:"off",autoCapitalize:"off",spellCheck:!1,enterKeyHint:"none",style:{position:"absolute",top:0,left:0,width:"100%",height:"80px",opacity:.001,color:"transparent",background:"transparent",border:"none",outline:"none",fontSize:"24px",resize:"none",overflow:"hidden",zIndex:50,pointerEvents:"auto",display:u.type==="search"?"block":"none"},onInput:E=>{if(m.current.type!=="search")return;const C=E.target.value.replace(/[\r\n]+/g,"");l(P=>{const L=[...P];return L[L.length-1]={type:"search",query:C,dynamicData:void 0},L})},onBlur:()=>{M.current=!1},onKeyDown:E=>{["ArrowDown","ArrowUp","ArrowLeft","ArrowRight","Escape"].includes(E.key)&&E.currentTarget.blur()},onKeyUp:E=>{["ArrowDown","ArrowUp","ArrowLeft","ArrowRight","Escape"].includes(E.key)?E.currentTarget.blur():(E.key==="Enter"||E.keyCode===13||E.keyCode===23||E.keyCode===66||E.keyCode===160||E.key==="OK"||E.key==="Select"||E.key==="Accept")&&(E.preventDefault(),E.stopPropagation())}}),u.type==="details"&&!R&&(()=>{const E=il(u.movie.id,Pr(u.movie),u.season,u.episode);return Qe.jsx("div",{className:"absolute inset-0 pointer-events-none z-40 overflow-hidden",children:E.map((C,P)=>Qe.jsx("div",{id:`server-iframe-${P}`,className:"absolute shadow-2xl bg-black overflow-hidden",style:{display:"none"},children:Qe.jsx("iframe",{src:`${C.url}?autoplay=1`,className:"w-full h-full border-none pointer-events-none",allow:"autoplay; encrypted-media; fullscreen",title:`Server ${P+1}`,referrerPolicy:"no-referrer"})},C.url))})})(),R&&Qe.jsxs("div",{className:"absolute inset-0 z-50 bg-black",children:[Qe.jsx("div",{className:"absolute top-4 left-6 text-slate-400 text-sm font-mono pointer-events-none z-10",children:"Hold OK to go back"}),Qe.jsx("iframe",{src:`${R.url}?autoplay=1`,className:"w-full h-full border-none",allowFullScreen:!0,allow:"autoplay; encrypted-media; fullscreen",title:"Player",referrerPolicy:"no-referrer"},R.url)]}),u.type==="player"&&!R&&(()=>{const E=il(u.movie.id,Pr(u.movie),u.season,u.episode)[u.serverIndex];return Qe.jsxs("div",{className:"absolute inset-0 z-50 bg-black",children:[Qe.jsx("div",{className:"absolute top-4 left-6 text-slate-400 text-sm font-mono pointer-events-none",children:"Hold OK to go back"}),Qe.jsx("iframe",{src:`${E.url}?autoplay=1&autoplay=true`,className:"w-full h-full border-none",allowFullScreen:!0,allow:"autoplay; encrypted-media; fullscreen",title:"Player",referrerPolicy:"no-referrer"},E.url)]})})()]})}function dn(t){return t?t.filter(e=>e&&(e.title||e.name)&&e.poster_path&&e.backdrop_path):[]}function sA(){const t=()=>{document.documentElement.requestFullscreen().catch(e=>{console.error("Failed to enter fullscreen:",e)})};return We.useEffect(()=>{const e=n=>{n.key==="Enter"&&t()};return document.addEventListener("keydown",e),()=>document.removeEventListener("keydown",e)},[]),Qe.jsxs("div",{className:"fixed inset-0 bg-[#070b14]/80 backdrop-blur-2xl flex flex-col items-center justify-center text-white cursor-pointer border border-white/10",onClick:t,children:[Qe.jsx("h1",{className:"text-6xl font-extrabold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-rose-500 to-amber-500 tracking-widest drop-shadow-lg",children:"NETFLIX"}),Qe.jsx("div",{className:"text-xs font-mono tracking-widest text-amber-400/90 uppercase mb-6 px-3 py-1 bg-amber-400/10 border border-amber-400/30 rounded-full",children:"Version 0.5.7"}),Qe.jsx("p",{className:"text-xl text-slate-300/80 mb-10 font-mono backdrop-blur-md px-6 py-2 border border-white/10 bg-white/5",children:"This app is designed for TV and requires Fullscreen mode."}),Qe.jsx("button",{className:"px-10 py-5 bg-gradient-to-r from-red-600/90 to-rose-600/90 hover:from-red-500 hover:to-rose-500 text-white font-bold text-2xl transition-all shadow-[0_8px_32px_rgba(220,38,38,0.4)] border border-white/30 backdrop-blur-md",children:"Press OK to Start"})]})}function oA(){const[t,e]=We.useState(!!document.fullscreenElement||!!window.__SKIP_FULLSCREEN__);return We.useEffect(()=>{const n=()=>e(!!document.fullscreenElement);return document.addEventListener("fullscreenchange",n),window.__enterApp__=()=>e(!0),()=>document.removeEventListener("fullscreenchange",n)},[]),t?Qe.jsx(rA,{}):Qe.jsx(sA,{})}J0(document.getElementById("root")).render(Qe.jsx(We.StrictMode,{children:Qe.jsx(oA,{})}));
