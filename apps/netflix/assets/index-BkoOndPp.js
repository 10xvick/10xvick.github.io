(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=n(r);fetch(r.href,s)}})();var zm={exports:{}},Hl={},Vm={exports:{}},ze={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(U,$){var J=U.length;U.push($);e:for(;0<J;){var ne=J-1>>>1,K=U[ne];if(0<r(K,$))U[ne]=$,U[J]=K,J=ne;else break e}}function n(U){return U.length===0?null:U[0]}function i(U){if(U.length===0)return null;var $=U[0],J=U.pop();if(J!==$){U[0]=J;e:for(var ne=0,K=U.length,le=K>>>1;ne<le;){var Ae=2*(ne+1)-1,ve=U[Ae],H=Ae+1,ie=U[H];if(0>r(ve,J))H<K&&0>r(ie,ve)?(U[ne]=ie,U[H]=J,ne=H):(U[ne]=ve,U[Ae]=J,ne=Ae);else if(H<K&&0>r(ie,J))U[ne]=ie,U[H]=J,ne=H;else break e}}return $}function r(U,$){var J=U.sortIndex-$.sortIndex;return J!==0?J:U.id-$.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],h=1,u=null,d=3,p=!1,v=!1,M=!1,m=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function S(U){for(var $=n(c);$!==null;){if($.callback===null)i(c);else if($.startTime<=U)i(c),$.sortIndex=$.expirationTime,e(l,$);else break;$=n(c)}}function y(U){if(M=!1,S(U),!v)if(n(l)!==null)v=!0,V(A);else{var $=n(c);$!==null&&k(y,$.startTime-U)}}function A(U,$){v=!1,M&&(M=!1,f(_),_=-1),p=!0;var J=d;try{for(S($),u=n(l);u!==null&&(!(u.expirationTime>$)||U&&!P());){var ne=u.callback;if(typeof ne=="function"){u.callback=null,d=u.priorityLevel;var K=ne(u.expirationTime<=$);$=t.unstable_now(),typeof K=="function"?u.callback=K:u===n(l)&&i(l),S($)}else i(l);u=n(l)}if(u!==null)var le=!0;else{var Ae=n(c);Ae!==null&&k(y,Ae.startTime-$),le=!1}return le}finally{u=null,d=J,p=!1}}var w=!1,C=null,_=-1,R=5,T=-1;function P(){return!(t.unstable_now()-T<R)}function L(){if(C!==null){var U=t.unstable_now();T=U;var $=!0;try{$=C(!0,U)}finally{$?D():(w=!1,C=null)}}else w=!1}var D;if(typeof g=="function")D=function(){g(L)};else if(typeof MessageChannel<"u"){var z=new MessageChannel,I=z.port2;z.port1.onmessage=L,D=function(){I.postMessage(null)}}else D=function(){m(L,0)};function V(U){C=U,w||(w=!0,D())}function k(U,$){_=m(function(){U(t.unstable_now())},$)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(U){U.callback=null},t.unstable_continueExecution=function(){v||p||(v=!0,V(A))},t.unstable_forceFrameRate=function(U){0>U||125<U?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<U?Math.floor(1e3/U):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(U){switch(d){case 1:case 2:case 3:var $=3;break;default:$=d}var J=d;d=$;try{return U()}finally{d=J}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(U,$){switch(U){case 1:case 2:case 3:case 4:case 5:break;default:U=3}var J=d;d=U;try{return $()}finally{d=J}},t.unstable_scheduleCallback=function(U,$,J){var ne=t.unstable_now();switch(typeof J=="object"&&J!==null?(J=J.delay,J=typeof J=="number"&&0<J?ne+J:ne):J=ne,U){case 1:var K=-1;break;case 2:K=250;break;case 5:K=1073741823;break;case 4:K=1e4;break;default:K=5e3}return K=J+K,U={id:h++,callback:$,priorityLevel:U,startTime:J,expirationTime:K,sortIndex:-1},J>ne?(U.sortIndex=J,e(c,U),n(l)===null&&U===n(c)&&(M?(f(_),_=-1):M=!0,k(y,J-ne))):(U.sortIndex=K,e(l,U),v||p||(v=!0,V(A))),U},t.unstable_shouldYield=P,t.unstable_wrapCallback=function(U){var $=d;return function(){var J=d;d=$;try{return U.apply(this,arguments)}finally{d=J}}}})(jm);Jm.exports=jm;var d_=Jm.exports;/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ci,depthTest:!1,depthWrite:!1})}function H1(t,e,n){const i=new Float32Array(Ar),r=new Y(0,1,0);return new Jn({name:"SphericalGaussianBlur",defines:{n:Ar,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:ac(),fragmentShader:`
	...
	`}class Pv extends hi{constructor(e=1,n={}){super(e,e,n),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new wv(r),this._setTextureOptions(n),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,n){this.texture.type=n.type,this.texture.colorSpace=n.colorSpace,this.texture.generateMipmaps=n.generateMipmaps,this.texture.minFilter=n.minFilter,this.texture.magFilter=n.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new na(5,5,5),s=new Jn({name:"CubemapFromEquirect",uniforms:Gs(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:_n,blending:Ci});s.uniforms.tEquirect.value=n;const o=new pn(r,s),a=n.minFilter;return n.minFilter===Lr&&(n.minFilter=en),new qS(1,10,this).update(e,o),n.minFilter=a,o.geometry.dispose(),o.material.dispose(),this}clear(e,n=!0,i=!0,r=!0){const s=e.getRenderTarget();for(let o=0;o<6;o++)e.setRenderTarget(this,o),e.clear(n,i,r);e.setRenderTarget(s)}}function G1(t){let e=new WeakMap,n=new WeakMap,i=null;function r(d,p=!1){return d==null?null:p?o(d):s(d)}function s(d){if(d&&d.isTexture){const p=d.mapping;if(p===kc||p===Bc)if(e.has(d)){const v=e.get(d).texture;return a(v,d.mapping)}else{const v=d.image;if(v&&v.height>0){const M=new Pv(v.height);return M.fromEquirectangularTexture(t,d),e.set(d,M),d.addEventListener("dispose",c),a(M.texture,d.mapping)}else return null}}return d}function o(d){if(d&&d.isTexture){const p=d.mapping,v=p===kc||p===Bc,M=p===Vr||p===Vs;if(v||M){let m=n.get(d);const f=m!==void 0?m.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==f)return i===null&&(i=new mm(t)),m=v?i.fromEquirectangular(d,m):i.fromCubemap(d,m),m.texture.pmremVersion=d.pmremVersion,n.set(d,m),m.texture;if(m!==void 0)return m.texture;{const g=d.image;return v&&g&&g.height>0||M&&g&&l(g)?(i===null&&(i=new mm(t)),m=v?i.fromEquirectangular(d):i.fromCubemap(d),m.texture.pmremVersion=d.pmremVersion,n.set(d,m),d.addEventListener("dispose",h),m.texture):null}}}return d}function a(d,p){return p===kc?d.mapping=Vr:p===Bc&&(d.mapping=Vs),d}function l(d){let p=0;const v=6;for(let M=0;M<v;M++)d[M]!==void 0&&p++;return p===v}function c(d){const p=d.target;p.removeEventListener("dispose",c);const v=e.get(p);v!==void 0&&(e.delete(p),v.dispose())}function h(d){const p=d.target;p.removeEventListener("dispose",h);const v=n.get(p);v!==void 0&&(n.delete(p),v.dispose())}function u(){e=new WeakMap,n=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:u}}function W1(t){const e={};function n(i){if(e[i]!==void 0)return e[i];const r=t.getExtension(i);return e[i]=r,r}return{has:function(i){return n(i)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(i){const r=n(i);return r===null&&Ls("WebGLRenderer: "+i+" extension not supported."),r}}}function X1(t,e,n,i){const r={},s=new WeakMap;function o(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const v in d.attributes)e.remove(d.attributes[v]);d.removeEventListener("dispose",o),delete r[d.id];const p=s.get(d);p&&(e.remove(p),s.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,n.memory.geometries--}function a(u,d){return r[d.id]===!0||(d.addEventListener("dispose",o),r[d.id]=!0,n.memory.geometries++),d}function l(u){const d=u.attributes;for(const p in d)e.update(d[p],t.ARRAY_BUFFER)}function c(u){const d=[],p=u.index,v=u.attributes.position;let M=0;if(v===void 0)return;if(p!==null){const g=p.array;M=p.version;for(let S=0,y=g.length;S<y;S+=3){const A=g[S+0],w=g[S+1],C=g[S+2];d.push(A,w,w,C,C,A)}}else{const g=v.array;M=v.version;for(let S=0,y=g.length/3-1;S<y;S+=3){const A=S+0,w=S+1,C=S+2;d.push(A,w,w,C,C,A)}}const m=new(v.count>=65535?Ev:Mv)(d,1);m.version=M;const f=s.get(u);f&&e.remove(f),s.set(u,m)}function h(u){const d=s.get(u);if(d){const p=u.index;p!==null&&d.version<p.version&&c(u)}else c(u);return s.get(u)}return{get:a,update:l,getWireframeAttribute:h}}function Y1(t,e,n){let i;function r(u){i=u}let s,o;function a(u){s=u.type,o=u.bytesPerElement}function l(u,d){t.drawElements(i,d,s,u*o),n.update(d,i,1)}function c(u,d,p){p!==0&&(t.drawElementsInstanced(i,d,s,u*o,p),n.update(d,i,p))}function h(u,d,p){if(p===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,d,0,s,u,0,p);let M=0;for(let m=0;m<p;m++)M+=d[m];n.update(M,i,1)}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=h}function $1(t){const e={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(n.calls++,o){case t.TRIANGLES:n.triangles+=a*(s/3);break;case t.LINES:n.lines+=a*(s/2);break;case t.LINE_STRIP:n.lines+=a*(s-1);break;case t.LINE_LOOP:n.lines+=a*s;break;case t.POINTS:n.points+=a*s;break;default:$e("WebGLInfo: Unknown draw mode:",o);break}}function r(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:e,render:n,programs:null,autoReset:!0,reset:r,update:i}}function q1(t,e,n){const i=new WeakMap,r=new Mt;function s(o,a,l){const c=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let d=i.get(a);if(d===void 0||d.count!==u){let T=function(){_.dispose(),i.delete(a),a.removeEventListener("dispose",T)};var p=T;d!==void 0&&d.texture.dispose();const v=a.morphAttributes.position!==void 0,M=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],g=a.morphAttributes.normal||[],S=a.morphAttributes.color||[];let y=0;v===!0&&(y=1),M===!0&&(y=2),m===!0&&(y=3);let A=a.attributes.position.count*y,w=1;A>e.maxTextureSize&&(w=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const C=new Float32Array(A*w*4*u),_=new _v(C,A,w,u);_.type=li,_.needsUpdate=!0;const R=y*4;for(let P=0;P<u;P++){const L=f[P],D=g[P],z=S[P],I=A*w*4*P;for(let V=0;V<L.count;V++){const k=V*R;v===!0&&(r.fromBufferAttribute(L,V),C[I+k+0]=r.x,C[I+k+1]=r.y,C[I+k+2]=r.z,C[I+k+3]=0),M===!0&&(r.fromBufferAttribute(D,V),C[I+k+4]=r.x,C[I+k+5]=r.y,C[I+k+6]=r.z,C[I+k+7]=0),m===!0&&(r.fromBufferAttribute(z,V),C[I+k+8]=r.x,C[I+k+9]=r.y,C[I+k+10]=r.z,C[I+k+11]=z.itemSize===4?r.w:1)}}d={count:u,texture:_,size:new Ke(A,w)},i.set(a,d),a.addEventListener("dispose",T)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(t,"morphTexture",o.morphTexture,n);else{let v=0;for(let m=0;m<c.length;m++)v+=c[m];const M=a.morphTargetsRelative?1:1-v;l.getUniforms().setValue(t,"morphTargetBaseInfluence",M),l.getUniforms().setValue(t,"morphTargetInfluences",c)}l.getUniforms().setValue(t,"morphTargetsTexture",d.texture,n),l.getUniforms().setValue(t,"morphTargetsTextureSize",d.size)}return{update:s}}function K1(t,e,n,i,r){let s=new WeakMap;function o(c){const h=r.render.frame,u=c.geometry,d=e.get(c,u);if(s.get(d)!==h&&(e.update(d),s.set(d,h)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),s.get(c)!==h&&(n.update(c.instanceMatrix,t.ARRAY_BUFFER),c.instanceColor!==null&&n.update(c.instanceColor,t.ARRAY_BUFFER),s.set(c,h))),c.isSkinnedMesh){const p=c.skeleton;s.get(p)!==h&&(p.update(),s.set(p,h))}return d}function a(){s=new WeakMap}function l(c){const h=c.target;h.removeEventListener("dispose",l),i.releaseStatesOfObject(h),n.remove(h.instanceMatrix),h.instanceColor!==null&&n.remove(h.instanceColor)}return{update:o,dispose:a}}const Z1={[nv]:"LINEAR_TONE_MAPPING",[iv]:"REINHARD_TONE_MAPPING",[rv]:"CINEON_TONE_MAPPING",[sv]:"ACES_FILMIC_TONE_MAPPING",[av]:"AGX_TONE_MAPPING",[lv]:"NEUTRAL_TONE_MAPPING",[ov]:"CUSTOM_TONE_MAPPING"};function Q1(t,e,n,i,r,s){const o=new hi(e,n,{type:t,depthBuffer:r,stencilBuffer:s,samples:i?4:0,depthTexture:r?new Hs(e,n):void 0}),a=new hi(e,n,{type:Ui,depthBuffer:!1,stencilBuffer:!1}),l=new ki;l.setAttribute("position",new Pi([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute("uv",new Pi([0,2,0,0,2,0],2));const c=new XS({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)}const $T={[nv]:"Linear",[iv]:"Reinhard",[rv]:"Cineon",[sv]:"ACESFilmic",[av]:"AgX",[lv]:"Neutral",[ov]:"Custom"};function qT(t,e){const n=$T[e];return n===void 0?(Ie("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+t+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const Wa=new Y;function KT(){Ge.getLuminanceCoefficients(Wa);const t=Wa.x.toFixed(4),e=Wa.y.toFixed(4),n=Wa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+f);const S=g+m+o,y=g+f+a,A=wm(r,r.VERTEX_SHADER,S),w=wm(r,r.FRAGMENT_SHADER,y);r.attachShader(M,A),r.attachShader(M,w),n.index0AttributeName!==void 0?r.bindAttribLocation(M,0,n.index0AttributeName):n.hasPositionAttribute===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function C(P){if(t.debug.checkShaderErrors){const L=r.getProgramInfoLog(M)||"",D=r.getShaderInfoLog(A)||"",z=r.getShaderInfoLog(w)||"",I=L.trim(),V=D.trim(),k=z.trim();let U=!0,$=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(U=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,M,A,w);else{const J=Rm(r,A,"vertex"),ne=Rm(r,w,"fragment");$e("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
Program Info Log: `+I+`
`+J+`
`+ne)}else I!==""?Ie("WebGLProgram: Program Info Log:",I):(V===""||k==="")&&($=!1);$&&(P.diagnostics={runnable:U,programLog:I,vertexShader:{log:V,prefix:m},fragmentShader:{log:k,prefix:f}})}r.deleteShader(A),r.deleteShader(w),_=new cl(r,M),R=JT(r,M)}let _;this.getUniforms=function(){return _===void 0&&C(this),_};let R;this.getAttributes=function(){return R===void 0&&C(this),R};let T=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return T===!1&&(T=r.getProgramParameter(M,HT)),T},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(M),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=GT++,this.cacheKey=e,this.usedTimes=1,this.program=M,this.vertexShader=A,this.fragmentShader=w,this}let pw=0;class mw{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,n,i){const r=this._getShaderCacheForMaterial(e);return r.has(n)===!1&&(r.add(n),n.usedTimes++),r.has(i)===!1&&(r.add(i),i.usedTimes++),this}remove(e){const n=this.materialCache.get(e);for(const i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const n=this.materialCache;let i=n.get(e);return i===void 0&&(i=new Set,n.set(e,i)),i}_getShaderStage(e){const n=this.shaderCache;let i=n.get(e);return i===void 0&&(i=new gw(e),n.set(e,i)),i}}class gw{constructor(e){this.id=pw++,this.code=e,this.usedTimes=0}}function vw(t){return t===Hr||t===Ul||t===Fl}function _w(t,e,n,i,r,s){const o=new xv,a=new mw,l=new Set,c=[],h=new Map,u=i.logarithmicDepthBuffer;let d=i.precision;const p={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function v(_){return l.add(_),_===0?"uv":`uv${_}`}function M(_,R,T,P,L,D){const z=P.fog,I=L.geometry,V=_.isMeshStandardMaterial||_.isMeshLambertMaterial||_.isMeshPhongMaterial?P.environment:null,k=_.isMeshStandardMaterial||_.isMeshLambertMaterial&&!_.envMap||_.isMeshPhongMaterial&&!_.envMap,U=e.get(_.envMap||V,k),$=U&&U.mapping===rc?U.image.height:null,J=p[_.type];_.precision!==null&&(d=i.getMaxPrecision(_.precision),d!==_.precision&&Ie("WebGLProgram.getParameters:",_.precision,"not supported, using",d,"instead."));const ne=I.morphAttributes.position||I.morphAttributes.normal||I.morphAttributes.color,K=ne!==void 0?ne.length:0;let le=0;I.morphAttributes.position!==void 0&&(le=1),I.morphAttributes.normal!==void 0&&(le=2),I.morphAttributes.color!==void 0&&(le=3);let Ae,ve,H,ie;if(J){const Me=oi[J];Ae=Me.vertexShader,ve=Me.fragmentShader}else{Ae=_.vertexShader,ve=_.fragmentShader;const Me=a.getVertexShaderStage(_),xt=a.getFragmentShaderStage(_);a.update(_,Me,xt),H=Me.id,ie=xt.id}const re=t.getRenderTarget(),Ee=t.state.buffers.depth.getReversed(),Ne=L.isInstancedMesh===!0,Le=L.isBatchedMesh===!0,Et=!!_.map,Ve=!!_.matcap,st=!!U,Ze=!!_.aoMap,Xe=!!_.lightMap,Ct=!!_.bumpMap&&_.wireframe===!1,It=!!_.normalMap,kt=!!_.displacementMap,Ht=!!_.emissiveMap,_t=!!_.metalnessMap,bt=!!_.roughnessMap,F=_.anisotropy>0,cn=_.clearcoat>0,je=_.dispersion>0,b=_.iridescence>0,x=_.sheen>0,B=_.transmission>0,X=F&&!!_.anisotropyMap,Z=cn&&!!_.clearcoatMap,oe=cn&&!!_.clearcoatNormalMap,ce=cn&&!!_.clearcoatRoughnessMap,Q=b&&!!_.iridescenceMap,ee=b&&!!_.iridescenceThicknessMap,ue=x&&!!_.sheenColorMap,Re=x&&!!_.sheenRoughnessMap,he=!!_.specularMap,de=!!_.specularColorMap,Pe=!!_.specularIntensityMap,De=B&&!!_.transmissionMap,Fe=B&&!!_.thicknessMap,N=!!_.gradientMap,ae=!!_.alphaMap,j=_.alphaTest>0,fe=!!_.alphaHash,_e=!!_.extensions;let te=fi;_.toneMapped&&(re===null||re.isXRRenderTarget===!0)&&(te=t.toneMapping);const we={shaderID:J,shaderType:_.type,shaderName:_.name,vertexShader:Ae,fragmentShader:ve,defines:_.defines,customVertexShaderID:H,customFragmentShaderID:ie,isRawShaderMaterial:_.isRawShaderMaterial===!0,glslVersion:_.glslVersion,precision:d,batching:Le,batchingColor:Le&&L._colorsTexture!==null,instancing:Ne,instancingColor:Ne&&L.instanceColor!==null,instancingMorph:Ne&&L.morphTexture!==null,outputColorSpace:re===null?t.outputColorSpace:re.isXRRenderTarget===!0?re.texture.colorSpace:Ge.workingColorSpace,alphaToCoverage:!!_.alphaToCoverage,map:Et,matcap:Ve,envMap:st,envMapMode:st&&U.mapping,envMapCubeUVHeight:$,aoMap:Ze,lightMap:Xe,bumpMap:Ct,normalMap:It,displacementMap:kt,emissiveMap:Ht,normalMapObjectSpace:It&&_.normalMapType===sS,normalMapTangentSpace:It&&_.normalMapType===Hp,packedNormalMap:It&&_.normalMapType===Hp&&vw(_.normalMap.format),metalnessMap:_t,roughnessMap:bt,anisotropy:F,anisotropyMap:X,clearcoat:cn,clearcoatMap:Z,clearcoatNormalMap:oe,clearcoatRoughnessMap:ce,dispersion:je,iridescence:b,iridescenceMap:Q,iridescenceThicknessMap:ee,sheen:x,sheenColorMap:ue,sheenRoughnessMap:Re,specularMap:he,specularColorMap:de,specularIntensityMap:Pe,transmission:B,transmissionMap:De,thicknessMap:Fe,gradientMap:N,opaque:_.transparent===!1&&_.blending===Ps&&_.alphaToCoverage===!1,alphaMap:ae,alphaTest:j,alphaHash:fe,combine:_.combine,mapUv:Et&&v(_.map.channel),aoMapUv:Ze&&v(_.aoMap.channel),lightMapUv:Xe&&v(_.lightMap.channel),bumpMapUv:Ct&&v(_.bumpMap.channel),normalMapUv:It&&v(_.normalMap.channel),displacementMapUv:kt&&v(_.displacementMap.channel),emissiveMapUv:Ht&&v(_.emissiveMap.channel),metalnessMapUv:_t&&v(_.metalnessMap.channel),roughnessMapUv:bt&&v(_.roughnessMap.channel),anisotropyMapUv:X&&v(_.anisotropyMap.channel),clearcoatMapUv:Z&&v(_.clearcoatMap.channel),clearcoatNormalMapUv:oe&&v(_.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ce&&v(_.clearcoatRoughnessMap.channel),iridescenceMapUv:Q&&v(_.iridescenceMap.channel),iridescenceThicknessMapUv:ee&&v(_.iridescenceThicknessMap.channel),sheenColorMapUv:ue&&v(_.sheenColorMap.channel),sheenRoughnessMapUv:Re&&v(_.sheenRoughnessMap.channel),specularMapUv:he&&v(_.specularMap.channel),specularColorMapUv:de&&v(_.specularColorMap.channel),specularIntensityMapUv:Pe&&v(_.specularIntensityMap.channel),transmissionMapUv:De&&v(_.transmissionMap.channel),thicknessMapUv:Fe&&v(_.thicknessMap.channel),alphaMapUv:ae&&v(_.alphaMap.channel),vertexTangents:!!I.attributes.tangent&&(It||F),vertexNormals:!!I.attributes.normal,vertexColors:_.vertexColors,vertexAlphas:_.vertexColors===!0&&!!I.attributes.color&&I.attributes.color.itemSize===4,pointsUvs:L.isPoints===!0&&!!I.attributes.uv&&(Et||ae),fog:!!z,useFog:_.fog===!0,fogExp2:!!z&&z.isFogExp2,flatShading:_.wireframe===!1&&(_.flatShading===!0||I.attributes.normal===void 0&&It===!1&&(_.isMeshLambertMaterial||_.isMeshPhongMaterial||_.isMeshStandardMaterial||_.isMeshPhysicalMaterial)),sizeAttenuation:_.sizeAttenuation===!0,logarithmicDepthBuffer:u,reversedDepthBuffer:Ee,skinning:L.isSkinnedMesh===!0,hasPositionAttribute:I.attributes.position!==void 0,morphTargets:I.morphAttributes.position!==void 0,morphNormals:I.morphAttributes.normal!==void 0,morphColors:I.morphAttributes.color!==void 0,morphTargetsCount:K,morphTextureStride:le,numDirLights:R.directional.length,numPointLights:R.point.length,numSpotLights:R.spot.length,numSpotLightMaps:R.spotLightMap.length,numRectAreaLights:R.rectArea.length,numHemiLights:R.hemi.length,numDirLightShadows:R.directionalShadowMap.length,numPointLightShadows:R.pointShadowMap.length,numSpotLightShadows:R.spotShadowMap.length,numSpotLightShadowsWithMaps:R.numSpotLightShadowsWithMaps,numLightProbes:R.numLightProbes,numLightProbeGrids:D.length,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:_.dithering,shadowMapEnabled:t.shadowMap.enabled&&T.length>0,shadowMapType:t.shadowMap.type,toneMapping:te,decodeVideoTexture:Et&&_.map.isVideoTexture===!0&&Ge.getTransfer(_.map.colorSpace)===nt,decodeVideoTextureEmissive:Ht&&_.emissiveMap.isVideoTexture===!0&&Ge.getTransfer(_.emissiveMap.colorSpace)===nt,premultipliedAlpha:_.premultipliedAlpha,doubleSided:_.side===En,flipSided:_.side===_n,useDepthPacking:_.depthPacking>=0,depthPacking:_.depthPacking||0,index0AttributeName:_.index0AttributeName,extensionClipCullDistance:_e&&_.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(_e&&_.extensions.multiDraw===!0||Le)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:_.customProgramCacheKey()};return we.vertexUv1s=l.has(1),we.vertexUv2s=l.has(2),we.vertexUv3s=l.has(3),l.clear(),we}function m(_){const R=[];if(_.shaderID?R.push(_.shaderID):(R.push(_.customVertexShaderID),R.push(_.customFragmentShaderID)),_.defines!==void 0)for(const T in _.defines)R.push(T),R.push(_.defines[T]);return _.isRawShaderMaterial===!1&&(f(R,_),g(R,_),R.push(t.outputColorSpace)),R.push(_.customProgramCacheKey),R.join()}function f(_,R){_.push(R.precision),_.push(R.outputColorSpace),_.push(R.envMapMode),_.push(R.envMapCubeUVHeight),_.push(R.mapUv),_.push(R.alphaMapUv),_.push(R.lightMapUv),_.push(R.aoMapUv),_.push(R.bumpMapUv),_.push(R.normalMapUv),_.push(R.displacementMapUv),_.push(R.emissiveMapUv),_.push(R.metalnessMapUv),_.push(R.roughnessMapUv),_.push(R.anisotropyMapUv),_.push(R.clearcoatMapUv),_.push(R.clearcoatNormalMapUv),_.push(R.clearcoatRoughnessMapUv),_.push(R.iridescenceMapUv),_.push(R.iridescenceThicknessMapUv),_.push(R.sheenColorMapUv),_.push(R.sheenRoughnessMapUv),_.push(R.specularMapUv),_.push(R.specularColorMapUv),_.push(R.specularIntensityMapUv),_.push(R.transmissionMapUv),_.push(R.thicknessMapUv),_.push(R.combine),_.push(R.fogExp2),_.push(R.sizeAttenuation),_.push(R.morphTargetsCount),_.push(R.morphAttributeCount),_.push(R.numDirLights),_.push(R.numPointLights),_.push(R.numSpotLights),_.push(R.numSpotLightMaps),_.push(R.numHemiLights),_.push(R.numRectAreaLights),_.push(R.numDirLightShadows),_.push(R.numPointLightShadows),_.push(R.numSpotLightShadows),_.push(R.numSpotLightShadowsWithMaps),_.push(R.numLightProbes),_.push(R.shadowMapType),_.push(R.toneMapping),_.push(R.numClippingPlanes),_.push(R.numClipIntersection),_.push(R.depthPacking)}function g(_,R){o.disableAll(),R.instancing&&o.enable(0),R.instancingColor&&o.enable(1),R.instancingMorph&&o.enable(2),R.matcap&&o.enable(3),R.envMap&&o.enable(4),R.normalMapObjectSpace&&o.enable(5),R.normalMapTangentSpace&&o.enable(6),R.clearcoat&&o.enable(7),R.iridescence&&o.enable(8),R.alphaTest&&o.enable(9),R.vertexColors&&o.enable(10),R.vertexAlphas&&o.enable(11),R.vertexUv1s&&o.enable(12),R.vertexUv2s&&o.enable(13),R.vertexUv3s&&o.enable(14),R.vertexTangents&&o.enable(15),R.anisotropy&&o.enable(16),R.alphaHash&&o.enable(17),R.batching&&o.enable(18),R.dispersion&&o.enable(19),R.batchingColor&&o.enable(20),R.gradientMap&&o.enable(21),R.packedNormalMap&&o.enable(22),R.vertexNormals&&o.enable(23),_.push(o.mask),o.disableAll(),R.fog&&o.enable(0),R.useFog&&o.enable(1),R.flatShading&&o.enable(2),R.logarithmicDepthBuffer&&o.enable(3),R.reversedDepthBuffer&&o.enable(4),R.skinning&&o.enable(5),R.morphTargets&&o.enable(6),R.morphNormals&&o.enable(7),R.morphColors&&o.enable(8),R.premultipliedAlpha&&o.enable(9),R.shadowMapEnabled&&o.enable(10),R.doubleSided&&o.enable(11),R.flipSided&&o.enable(12),R.useDepthPacking&&o.enable(13),R.dithering&&o.enable(14),R.transmission&&o.enable(15),R.sheen&&o.enable(16),R.opaque&&o.enable(17),R.pointsUvs&&o.enable(18),R.decodeVideoTexture&&o.enable(19),R.decodeVideoTextureEmissive&&o.enable(20),R.alphaToCoverage&&o.enable(21),R.numLightProbeGrids>0&&o.enable(22),R.hasPositionAttribute&&o.enable(23),_.push(o.mask)}function S(_){const R=p[_.type];let T;if(R){const P=oi[R];T=HS.clone(P.uniforms)}else T=_.uniforms;return T}function y(_,R){let T=h.get(R);return T!==void 0?++T.usedTimes:(T=new hw(t,R,_,r),c.push(T),h.set(R,T)),T}function A(_){if(--_.usedTimes===0){const R=c.indexOf(_);c[R]=c[c.length-1],c.pop(),h.delete(_.cacheKey),_.destroy()}}function w(_){a.remove(_)}function C(){a.dispose()}return{getParameters:M,getProgramCacheKey:m,getUniforms:S,acquireProgram:y,releaseProgram:A,releaseShaderCache:w,programs:c,dispose:C}}function xw(){let t=new WeakMap;function e(o){return t.has(o)}function n(o){let a=t.get(o);return a===void 0&&(a={},t.set(o,a)),a}function i(o){t.delete(o)}function r(o,a,l){t.get(o)[a]=l}function s(){t=new WeakMap}return{has:e,get:n,remove:i,update:r,dispose:s}}function yw(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.material.id!==e.material.id?t.material.id-e.material.id:t.materialVariant!==e.materialVariant?t.materialVariant-e.materialVariant:t.z!==e.z?t.z-e.z:t.id-e.id}function Dm(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.z!==e.z?e.z-t.z:t.id-e.id}function Im(){const t=[];let e=0;const n=[],i=[],r=[];function s(){e=0,n.length=0,i.length=0,r.length=0}function o(d){let p=0;return d.isInstancedMesh&&(p+=2),d.isSkinnedMesh&&(p+=1),p}function a(d,p,v,M,m,f){let g=t[e];return g===void 0?(g={id:d.id,object:d,geometry:p,material:v,materialVariant:o(d),groupOrder:M,renderOrder:d.renderOrder,z:m,group:f},t[e]=g):(g.id=d.id,g.object=d,g.geometry=p,g.material=v,g.materialVariant=o(d),g.groupOrder=M,g.renderOrder=d.renderOrder,g.z=m,g.group=f),e++,g}function l(d,p,v,M,m,f){const g=a(d,p,v,M,m,f);v.transmission>0?i.push(g):v.transparent===!0?r.push(g):n.push(g)}function c(d,p,v,M,m,f){const g=a(d,p,v,M,m,f);v.transmission>0?i.unshift(g):v.transparent===!0?r.unshift(g):n.unshift(g)}function h(d,p,v){n.length>1&&n.sort(d||yw),i.length>1&&i.sort(p||Dm),r.length>1&&r.sort(p||Dm),v&&(n.reverse(),i.reverse(),r.reverse())}function u(){for(let d=e,p=t.length;d<p;d++){const v=t[d];if(v.id===null)break;v.id=null,v.object=null,v.geometry=null,v.material=null,v.group=null}}return{opaque:n,transmissive:i,transparent:r,init:s,push:l,unshift:c,finish:u,sort:h}}function Sw(){let t=new WeakMap;function e(i,r){const s=t.get(i);let o;return s===void 0?(o=new Im,t.set(i,[o])):r>=s.length?(o=new Im,s.push(o)):o=s[r],o}function n(){t=new WeakMap}return{get:e,dispose:n}}function Mw(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new Y,color:new Je};break;case"SpotLight":n={position:new Y,direction:new Y,color:new Je,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new Y,color:new Je,distance:0,decay:0};break;case"HemisphereLight":n={direction:new Y,skyColor:new Je,groundColor:new Je};break;case"RectAreaLight":n={color:new Je,position:new Y,halfWidth:new Y,halfHeight:new Y};break}return t[e.id]=n,n}}}function Ew(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ke};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ke};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ke,shadowCameraNear:1,shadowCameraFar:1e3};break}return t[e.id]=n,n}}}let Tw=0;function ww(t,e){return(e.castShadow?2:0)-(t.castShadow?2:0)+(e.map?1:0)-(t.map?1:0)}function Aw(t){const e=new Mw,n=Ew(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new Y);const r=new Y,s=new Dt,o=new Dt;function a(c){let h=0,u=0,d=0;for(let R=0;R<9;R++)i.probe[R].set(0,0,0);let p=0,v=0,M=0,m=0,f=0,g=0,S=0,y=0,A=0,w=0,C=0;c.sort(ww);for(let R=0,T=c.length;R<T;R++){const P=c[R],L=P.color,D=P.intensity,z=P.distance;let I=null;if(P.shadow&&P.shadow.map&&(P.shadow.map.texture.format===Hr?I=P.shadow.map.texture:I=P.shadow.map.depthTexture||P.shadow.map.texture),P.isAmbientLight)h+=L.r*D,u+=L.g*D,d+=L.b*D;else if(P.isLightProbe){for(let V=0;V<9;V++)i.probe[V].addScaledVector(P.sh.coefficients[V],D);C++}else if(P.isDirectionalLight){const V=e.get(P);if(V.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){const k=P.shadow,U=n.get(P);U.shadowIntensity=k.intensity,U.shadowBias=k.bias,U.shadowNormalBias=k.normalBias,U.shadowRadius=k.radius,U.shadowMapSize=k.mapSize,i.directionalShadow[p]=U,i.directionalShadowMap[p]=I,i.directionalShadowMatrix[p]=P.shadow.matrix,g++}i.directional[p]=V,p++}else if(P.isSpotLight){const V=e.get(P);V.position.setFromMatrixPosition(P.matrixWorld),V.color.copy(L).multiplyScalar(D),V.distance=z,V.coneCos=Math.cos(P.angle),V.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),V.decay=P.decay,i.spot[M]=V;const k=P.shadow;if(P.map&&(i.spotLightMap[A]=P.map,A++,k.updateMatrices(P),P.castShadow&&w++),i.spotLightMatrix[M]=k.matrix,P.castShadow){const U=n.get(P);U.shadowIntensity=k.intensity,U.shadowBias=k.bias,U.shadowNormalBias=k.normalBias,U.shadowRadius=k.radius,U.shadowMapSize=k.mapSize,i.spotShadow[M]=U,i.spotShadowMap[M]=I,y++}M++}else if(P.isRectAreaLight){const V=e.get(P);V.color.copy(L).multiplyScalar(D),V.halfWidth.set(P.width*.5,0,0),V.halfHeight.set(0,P.height*.5,0),i.rectArea[m]=V,m++}else if(P.isPointLight){const V=e.get(P);if(V.color.copy(P.color).multiplyScalar(P.intensity),V.distance=P.distance,V.decay=P.decay,P.castShadow){const k=P.shadow,U=n.get(P);U.shadowIntensity=k.intensity,U.shadowBias=k.bias,U.shadowNormalBias=k.normalBias,U.shadowRadius=k.radius,U.shadowMapSize=k.mapSize,U.shadowCameraNear=k.camera.near,U.shadowCameraFar=k.camera.far,i.pointShadow[v]=U,i.pointShadowMap[v]=I,i.pointShadowMatrix[v]=P.shadow.matrix,S++}i.point[v]=V,v++}else if(P.isHemisphereLight){const V=e.get(P);V.skyColor.copy(P.color).multiplyScalar(D),V.groundColor.copy(P.groundColor).multiplyScalar(D),i.hemi[f]=V,f++}}m>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=pe.LTC_FLOAT_1,i.rectAreaLTC2=pe.LTC_FLOAT_2):(i.rectAreaLTC1=pe.LTC_HALF_1,i.rectAreaLTC2=pe.LTC_HALF_2)),i.ambient[0]=h,i.ambient[1]=u,i.ambient[2]=d;const _=i.hash;(_.directionalLength!==p||_.pointLength!==v||_.spotLength!==M||_.rectAreaLength!==m||_.hemiLength!==f||_.numDirectionalShadows!==g||_.numPointShadows!==S||_.numSpotShadows!==y||_.numSpotMaps!==A||_.numLightProbes!==C)&&(i.directional.length=p,i.spot.length=M,i.rectArea.length=m,i.point.length=v,i.hemi.length=f,i.directionalShadow.length=g,i.directionalShadowMap.length=g,i.pointShadow.length=S,i.pointShadowMap.length=S,i.spotShadow.length=y,i.spotShadowMap.length=y,i.directionalShadowMatrix.length=g,i.pointShadowMatrix.length=S,i.spotLightMatrix.length=y+A-w,i.spotLightMap.length=A,i.numSpotLightShadowsWithMaps=w,i.numLightProbes=C,_.directionalLength=p,_.pointLength=v,_.spotLength=M,_.rectAreaLength=m,_.hemiLength=f,_.numDirectionalShadows=g,_.numPointShadows=S,_.numSpotShadows=y,_.numSpotMaps=A,_.numLightProbes=C,i.version=Tw++)}function l(c,h){let u=0,d=0,p=0,v=0,M=0;const m=h.matrixWorldInverse;for(let f=0,g=c.length;f<g;f++){const S=c[f];if(S.isDirectionalLight){const y=i.directional[u];y.direction.setFromMatrixPosition(S.matrixWorld),r.setFromMatrixPosition(S.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(m),u++}else if(S.isSpotLight){const y=i.spot[p];y.position.setFromMatrixPosition(S.matrixWorld),y.position.applyMatrix4(m),y.direction.setFromMatrixPosition(S.matrixWorld),r.setFromMatrixPosition(S.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(m),p++}else if(S.isRectAreaLight){const y=i.rectArea[v];y.position.setFromMatrixPosition(S.matrixWorld),y.position.applyMatrix4(m),o.identity(),s.copy(S.matrixWorld),s.premultiply(m),o.extractRotation(s),y.halfWidth.set(S.width*.5,0,0),y.halfHeight.set(0,S.height*.5,0),y.halfWidth.applyMatrix4(o),y.halfHeight.applyMatrix4(o),v++}else if(S.isPointLight){const y=i.point[d];y.position.setFromMatrixPosition(S.matrixWorld),y.position.applyMatrix4(m),d++}else if(S.isHemisphereLight){const y=i.hemi[M];y.direction.setFromMatrixPosition(S.matrixWorld),y.direction.transformDirection(m),M++}}}return{setup:a,setupView:l,state:i}}function Nm(t){const e=new Aw(t),n=[],i=[],r=[];function s(d){u.camera=d,n.length=0,i.length=0,r.length=0}function o(d){n.push(d)}function a(d){i.push(d)}function l(d){r.push(d)}function c(){e.setup(n)}function h(d){e.setupView(n,d)}const u={lightsArray:n,shadowsArray:i,lightProbeGridArray:r,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:s,state:u,setupLights:c,setupLightsView:h,pushLight:o,pushShadow:a,pushLightProbeGrid:l}}function Rw(t){let e=new WeakMap;function n(r,s=0){const o=e.get(r);let a;return o===void 0?(a=new Nm(t),e.set(r,[a])):s>=o.length?(a=new Nm(t),o.push(a)):a=o[s],a}function i(){e=new WeakMap}return{get:n,dispose:i}}const Cw=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,Pw=[new Y(1,0,0),new Y(-1,0,0),new Y(0,1,0),new Y(0,-1,0),new Y(0,0,1),new Y(0,0,-1)],Lw=[new Y(0,-1,0),new Y(0,-1,0),new Y(0,0,1),new Y(0,0,-1),new Y(0,-1,0),new Y(0,-1,0)],Um=new Dt,uo=new Y,gu=new Y;function Dw(t,e,n){let i=new Tv;const r=new Ke,s=new Ke,o=new Mt,a=new YS,l=new $S,c={},h=n.maxTextureSize,u={[hr]:_n,[_n]:hr,[En]:En},d=new Jn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ke},radius:{value:4}},vertexShader:Cw,fragmentShader:bw}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const v=new ki;v.setAttribute("position",new pi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new pn(v,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=rl;let f=this.type;this.render=function(w,C,_){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;this.type===Fy&&(Ie("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=rl);const R=t.getRenderTarget(),T=t.getActiveCubeFace(),P=t.getActiveMipmapLevel(),L=t.state;L.setBlending(Ci),L.buffers.depth.getReversed()===!0?L.buffers.color.setClear(0,0,0,0):L.buffers.color.setClear(1,1,1,1),L.buffers.depth.setTest(!0),L.setScissorTest(!1);const D=f!==this.type;D&&C.traverse(function(z){z.material&&(Array.isArray(z.material)?z.material.forEach(I=>I.needsUpdate=!0):z.material.needsUpdate=!0)});for(let z=0,I=w.length;z<I;z++){const V=w[z],k=V.shadow;if(k===void 0){Ie("WebGLShadowMap:",V,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;r.copy(k.mapSize);const U=k.getFrameExtents();r.multiply(U),s.copy(k.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/U.x),r.x=s.x*U.x,k.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/U.y),r.y=s.y*U.y,k.mapSize.y=s.y));const $=t.state.buffers.depth.getReversed();if(k.camera._reversedDepth=$,k.map===null||D===!0){if(k.map!==null&&(k.map.depthTexture!==null&&(k.map.depthTexture.dispose(),k.map.depthTexture=null),k.map.dispose()),this.type===go){if(V.isPointLight){Ie("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}k.map=new hi(r.x,r.y,{format:Hr,type:Ui,minFilter:en,magFilter:en,generateMipmaps:!1}),k.map.texture.name=V.name+".shadowMap",k.map.depthTexture=new Hs(r.x,r.y,li),k.map.depthTexture.name=V.name+".shadowMapDepth",k.map.depthTexture.format=Fi,k.map.depthTexture.compareFunction=null,k.map.depthTexture.minFilter=Xt,k.map.depthTexture.magFilter=Xt}else V.isPointLight?(k.map=new Pv(r.x),k.map.depthTexture=new zS(r.x,mi)):(k.map=new hi(r.x,r.y),k.map.depthTexture=new Hs(r.x,r.y,mi)),k.map.depthTexture.name=V.name+".shadowMap",k.map.depthTexture.format=Fi,this.type===rl?(k.map.depthTexture.compareFunction=$?sh:rh,k.map.depthTexture.minFilter=en,k.map.depthTexture.magFilter=en):(k.map.depthTexture.compareFunction=null,k.map.depthTexture.minFilter=Xt,k.map.depthTexture.magFilter=Xt);k.camera.updateProjectionMatrix()}const J=k.map.isWebGLCubeRenderTarget?6:1;for(let ne=0;ne<J;ne++){if(k.map.isWebGLCubeRenderTarget)t.setRenderTarget(k.map,ne),t.clear();else{ne===0&&(t.setRenderTarget(k.map),t.clear());const K=k.getViewport(ne);o.set(s.x*K.x,s.y*K.y,s.x*K.z,s.y*K.w),L.viewport(o)}if(V.isPointLight){const K=k.camera,le=k.matrix,Ae=V.distance||K.far;Ae!==K.far&&(K.far=Ae,K.updateProjectionMatrix()),uo.setFromMatrixPosition(V.matrixWorld),K.position.copy(uo),gu.copy(K.position),gu.add(Pw[ne]),K.up.copy(Lw[ne]),K.lookAt(gu),K.updateMatrixWorld(),le.makeTranslation(-uo.x,-uo.y,-uo.z),Um.multiplyMatrices(K.projectionMatrix,K.matrixWorldInverse),k._frustum.setFromProjectionMatrix(Um,K.coordinateSystem,K.reversedDepth)}else k.updateMatrices(V);i=k.getFrustum(),y(C,_,k.camera,V,this.type)}k.isPointLightShadow!==!0&&this.type===go&&g(k,_),k.needsUpdate=!1}f=this.type,m.needsUpdate=!1,t.setRenderTarget(R,T,P)};function g(w,C){const _=e.update(M);d.defines.VSM_SAMPLES!==w.blurSamples&&(d.defines.VSM_SAMPLES=w.blurSamples,p.defines.VSM_SAMPLES=w.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new hi(r.x,r.y,{format:Hr,type:Ui})),d.uniforms.shadow_pass.value=w.map.depthTexture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,t.setRenderTarget(w.mapPass),t.clear(),t.renderBufferDirect(C,null,_,d,M,null),p.uniforms.shadow_pass.value=w.mapPass.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,t.setRenderTarget(w.map),t.clear(),t.renderBufferDirect(C,null,_,p,M,null)}function S(w,C,_,R){let T=null;const P=_.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(P!==void 0)T=P;else if(T=_.isPointLight===!0?l:a,t.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const L=T.uuid,D=C.uuid;let z=c[L];z===void 0&&(z={},c[L]=z);let I=z[D];I===void 0&&(I=T.clone(),z[D]=I,C.addEventListener("dispose",A)),T=I}if(T.visible=C.visible,T.wireframe=C.wireframe,R===go?T.side=C.shadowSide!==null?C.shadowSide:C.side:T.side=C.shadowSide!==null?C.shadowSide:u[C.side],T.alphaMap=C.alphaMap,T.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,T.map=C.map,T.clipShadows=C.clipShadows,T.clippingPlanes=C.clippingPlanes,T.clipIntersection=C.clipIntersection,T.displacementMap=C.displacementMap,T.displacementScale=C.displacementScale,T.displacementBias=C.displacementBias,T.wireframeLinewidth=C.wireframeLinewidth,T.linewidth=C.linewidth,_.isPointLight===!0&&T.isMeshDistanceMaterial===!0){const L=t.properties.get(T);L.light=_}return T}function y(w,C,_,R,T){if(w.visible===!1)return;if(w.layers.test(C.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&T===go)&&(!w.frustumCulled||i.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,w.matrixWorld);const D=e.update(w),z=w.material;if(Array.isArray(z)){const I=D.groups;for(let V=0,k=I.length;V<k;V++){const U=I[V],$=z[U.materialIndex];if($&&$.visible){const J=S(w,$,R,T);w.onBeforeShadow(t,w,C,_,D,J,U),t.renderBufferDirect(_,null,D,J,w,U),w.onAfterShadow(t,w,C,_,D,J,U)}}}else if(z.visible){const I=S(w,z,R,T);w.onBeforeShadow(t,w,C,_,D,I,null),t.renderBufferDirect(_,null,D,I,w,null),w.onAfterShadow(t,w,C,_,D,I,null)}}const L=w.children;for(let D=0,z=L.length;D<z;D++)y(L[D],C,_,R,T)}function A(w){w.target.removeEventListener("dispose",A);for(const _ in c){const R=c[_],T=w.target.uuid;T in R&&(R[T].dispose(),delete R[T])}}}function Iw(t,e){function n(){let N=!1;const ae=new Mt;let j=null;const fe=new Mt(0,0,0,0);return{setMask:function(_e){j!==_e&&!N&&(t.colorMask(_e,_e,_e,_e),j=_e)},setLocked:function(_e){N=_e},setClear:function(_e,te,we,Me,xt){xt===!0&&(_e*=Me,te*=Me,we*=Me),ae.set(_e,te,we,Me),fe.equals(ae)===!1&&(t.clearColor(_e,te,we,Me),fe.copy(ae))},reset:function(){N=!1,j=null,fe.set(-1,0,0,0)}}}function i(){let N=!1,ae=!1,j=null,fe=null,_e=null;return{setReversed:function(te){if(ae!==te){const we=e.get("EXT_clip_control");te?we.clipControlEXT(we.LOWER_LEFT_EXT,we.ZERO_TO_ONE_EXT):we.clipControlEXT(we.LOWER_LEFT_EXT,we.NEGATIVE_ONE_TO_ONE_EXT),ae=te;const Me=_e;_e=null,this.setClear(Me)}},getReversed:function(){return ae},setTest:function(te){te?re(t.DEPTH_TEST):Ee(t.DEPTH_TEST)},setMask:function(te){j!==te&&!N&&(t.depthMask(te),j=te)},setFunc:function(te){if(ae&&(te=mS[te]),fe!==te){switch(te){case fd:t.depthFunc(t.NEVER);break;case hd:t.depthFunc(t.ALWAYS);break;case pd:t.depthFunc(t.LESS);break;case zs:t.depthFunc(t.LEQUAL);break;case md:t.depthFunc(t.EQUAL);break;case gd:t.depthFunc(t.GEQUAL);break;case vd:t.depthFunc(t.GREATER);break;case _d:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}fe=te}},setLocked:function(te){N=te},setClear:function(te){_e!==te&&(_e=te,ae&&(te=1-te),t.clearDepth(te))},reset:function(){N=!1,j=null,fe=null,_e=null,ae=!1}}}function r(){let N=!1,ae=null,j=null,fe=null,_e=null,te=null,we=null,Me=null,xt=null;return{setTest:function(lt){N||(lt?re(t.STENCIL_TEST):Ee(t.STENCIL_TEST))},setMask:function(lt){ae!==lt&&!N&&(t.stencilMask(lt),ae=lt)},setFunc:function(lt,jn,ei){(j!==lt||fe!==jn||_e!==ei)&&(t.stencilFunc(lt,jn,ei),j=lt,fe=jn,_e=ei)},setOp:function(lt,jn,ei){(te!==lt||we!==jn||Me!==ei)&&(t.stencilOp(lt,jn,ei),te=lt,we=jn,Me=ei)},setLocked:function(lt){N=lt},setClear:function(lt){xt!==lt&&(t.clearStencil(lt),xt=lt)},reset:function(){N=!1,ae=null,j=null,fe=null,_e=null,te=null,we=null,Me=null,xt=null}}}const s=new n,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let h={},u={},d={},p=new WeakMap,v=[],M=null,m=!1,f=null,g=null,S=null,y=null,A=null,w=null,C=null,_=new Je(0,0,0),R=0,T=!1,P=null,L=null,D=null,z=null,I=null;const V=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let k=!1,U=0;const $=t.getParameter(t.VERSION);$.indexOf("WebGL")!==-1?(U=parseFloat(/^WebGL (\d)/.exec($)[1]),k=U>=1):$.indexOf("OpenGL ES")!==-1&&(U=parseFloat(/^OpenGL ES (\d)/.exec($)[1]),k=U>=2);let J=null,ne={};const K=t.getParameter(t.SCISSOR_BOX),le=t.getParameter(t.VIEWPORT),Ae=new Mt().fromArray(K),ve=new Mt().fromArray(le);function H(N,ae,j,fe){const _e=new Uint8Array(4),te=t.createTexture();t.bindTexture(N,te),t.texParameteri(N,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(N,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let we=0;we<j;we++)N===t.TEXTURE_3D||N===t.TEXTURE_2D_ARRAY?t.texImage3D(ae,0,t.RGBA,1,1,fe,0,t.RGBA,t.UNSIGNED_BYTE,_e):t.texImage2D(ae+we,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,_e);return te}const ie={};ie[t.TEXTURE_2D]=H(t.TEXTURE_2D,t.TEXTURE_2D,1),ie[t.TEXTURE_CUBE_MAP]=H(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),ie[t.TEXTURE_2D_ARRAY]=H(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),ie[t.TEXTURE_3D]=H(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),re(t.DEPTH_TEST),o.setFunc(zs),Ct(!1),It(kp),re(t.CULL_FACE),Ze(Ci);function re(N){h[N]!==!0&&(t.enable(N),h[N]=!0)}function Ee(N){h[N]!==!1&&(t.disable(N),h[N]=!1)}function Ne(N,ae){return d[N]!==ae?(t.bindFramebuffer(N,ae),d[N]=ae,N===t.DRAW_FRAMEBUFFER&&(d[t.FRAMEBUFFER]=ae),N===t.FRAMEBUFFER&&(d[t.DRAW_FRAMEBUFFER]=ae),!0):!1}function Le(N,ae){let j=v,fe=!1;if(N){j=p.get(ae),j===void 0&&(j=[],p.set(ae,j));const _e=N.textures;if(j.length!==_e.length||j[0]!==t.COLOR_ATTACHMENT0){for(let te=0,we=_e.length;te<we;te++)j[te]=t.COLOR_ATTACHMENT0+te;j.length=_e.length,fe=!0}}else j[0]!==t.BACK&&(j[0]=t.BACK,fe=!0);fe&&t.drawBuffers(j)}function Et(N){return M!==N?(t.useProgram(N),M=N,!0):!1}const Ve={[wr]:t.FUNC_ADD,[ky]:t.FUNC_SUBTRACT,[By]:t.FUNC_REVERSE_SUBTRACT};Ve[zy]=t.MIN,Ve[Vy]=t.MAX;const st={[Hy]:t.ZERO,[Gy]:t.ONE,[Wy]:t.SRC_COLOR,[ud]:t.SRC_ALPHA,[Zy]:t.SRC_ALPHA_SATURATE,[qy]:t.DST_COLOR,[Yy]:t.DST_ALPHA,[Xy]:t.ONE_MINUS_SRC_COLOR,[dd]:t.ONE_MINUS_SRC_ALPHA,[Ky]:t.ONE_MINUS_DST_COLOR,[$y]:t.ONE_MINUS_DST_ALPHA,[Qy]:t.CONSTANT_COLOR,[Jy]:t.ONE_MINUS_CONSTANT_COLOR,[jy]:t.CONSTANT_ALPHA,[eS]:t.ONE_MINUS_CONSTANT_ALPHA};function Ze(N,ae,j,fe,_e,te,we,Me,xt,lt){if(N===Ci){m===!0&&(Ee(t.BLEND),m=!1);return}if(m===!1&&(re(t.BLEND),m=!0),N!==Oy){if(N!==f||lt!==T){if((g!==wr||A!==wr)&&(t.blendEquation(t.FUNC_ADD),g=wr,A=wr),lt)switch(N){case Ps:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Bp:t.blendFunc(t.ONE,t.ONE);break;case zp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Vp:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:$e("WebGLState: Invalid blending: ",N);break}else switch(N){case Ps:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Bp:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case zp:$e("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Vp:$e("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:$e("WebGLState: Invalid blending: ",N);break}S=null,y=null,w=null,C=null,_.set(0,0,0),R=0,f=N,T=lt}return}_e=_e||ae,te=te||j,we=we||fe,(ae!==g||_e!==A)&&(t.blendEquationSeparate(Ve[ae],Ve[_e]),g=ae,A=_e),(j!==S||fe!==y||te!==w||we!==C)&&(t.blendFuncSeparate(st[j],st[fe],st[te],st[we]),S=j,y=fe,w=te,C=we),(Me.equals(_)===!1||xt!==R)&&(t.blendColor(Me.r,Me.g,Me.b,xt),_.copy(Me),R=xt),f=N,T=!1}function Xe(N,ae){N.side===En?Ee(t.CULL_FACE):re(t.CULL_FACE);let j=N.side===_n;ae&&(j=!j),Ct(j),N.blending===Ps&&N.transparent===!1?Ze(Ci):Ze(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),s.setMask(N.colorWrite);const fe=N.stencilWrite;a.setTest(fe),fe&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),Ht(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?re(t.SAMPLE_ALPHA_TO_COVERAGE):Ee(t.SAMPLE_ALPHA_TO_COVERAGE)}function Ct(N){P!==N&&(N?t.frontFace(t.CW):t.frontFace(t.CCW),P=N)}function It(N){N!==Ny?(re(t.CULL_FACE),N!==L&&(N===kp?t.cullFace(t.BACK):N===Uy?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Ee(t.CULL_FACE),L=N}function kt(N){N!==D&&(k&&t.lineWidth(N),D=N)}function Ht(N,ae,j){N?(re(t.POLYGON_OFFSET_FILL),(z!==ae||I!==j)&&(z=ae,I=j,o.getReversed()&&(ae=-ae),t.polygonOffset(ae,j))):Ee(t.POLYGON_OFFSET_FILL)}function _t(N){N?re(t.SCISSOR_TEST):Ee(t.SCISSOR_TEST)}function bt(N){N===void 0&&(N=t.TEXTURE0+V-1),J!==N&&(t.activeTexture(N),J=N)}function F(N,ae,j){j===void 0&&(J===null?j=t.TEXTURE0+V-1:j=J);let fe=ne[j];fe===void 0&&(fe={type:void 0,texture:void 0},ne[j]=fe),(fe.type!==N||fe.texture!==ae)&&(J!==j&&(t.activeTexture(j),J=j),t.bindTexture(N,ae||ie[N]),fe.type=N,fe.texture=ae)}function cn(){const N=ne[J];N!==void 0&&N.type!==void 0&&(t.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function je(){try{t.compressedTexImage2D(...arguments)}catch(N){$e("WebGLState:",N)}}function b(){try{t.compressedTexImage3D(...arguments)}catch(N){$e("WebGLState:",N)}}function x(){try{t.texSubImage2D(...arguments)}catch(N){$e("WebGLState:",N)}}function B(){try{t.texSubImage3D(...arguments)}catch(N){$e("WebGLState:",N)}}function X(){try{t.compressedTexSubImage2D(...arguments)}catch(N){$e("WebGLState:",N)}}function Z(){try{t.compressedTexSubImage3D(...arguments)}catch(N){$e("WebGLState:",N)}}function oe(){try{t.texStorage2D(...arguments)}catch(N){$e("WebGLState:",N)}}function ce(){try{t.texStorage3D(...arguments)}catch(N){$e("WebGLState:",N)}}function Q(){try{t.texImage2D(...arguments)}catch(N){$e("WebGLState:",N)}}function ee(){try{t.texImage3D(...arguments)}catch(N){$e("WebGLState:",N)}}function ue(N){return u[N]!==void 0?u[N]:t.getParameter(N)}function Re(N,ae){u[N]!==ae&&(t.pixelStorei(N,ae),u[N]=ae)}function he(N){Ae.equals(N)===!1&&(t.scissor(N.x,N.y,N.z,N.w),Ae.copy(N))}function de(N){ve.equals(N)===!1&&(t.viewport(N.x,N.y,N.z,N.w),ve.copy(N))}function Pe(N,ae){let j=c.get(ae);j===void 0&&(j=new WeakMap,c.set(ae,j));let fe=j.get(N);fe===void 0&&(fe=t.getUniformBlockIndex(ae,N.name),j.set(N,fe))}function De(N,ae){const fe=c.get(ae).get(N);l.get(ae)!==fe&&(t.uniformBlockBinding(ae,fe,N.__bindingPointIndex),l.set(ae,fe))}function Fe(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),o.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),h={},u={},J=null,ne={},d={},p=new WeakMap,v=[],M=null,m=!1,f=null,g=null,S=null,y=null,A=null,w=null,C=null,_=new Je(0,0,0),R=0,T=!1,P=null,L=null,D=null,z=null,I=null,Ae.set(0,0,t.canvas.width,t.canvas.height),ve.set(0,0,t.canvas.width,t.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:re,disable:Ee,bindFramebuffer:Ne,drawBuffers:Le,useProgram:Et,setBlending:Ze,setMaterial:Xe,setFlipSided:Ct,setCullFace:It,setLineWidth:kt,setPolygonOffset:Ht,setScissorTest:_t,activeTexture:bt,bindTexture:F,unbindTexture:cn,compressedTexImage2D:je,compressedTexImage3D:b,texImage2D:Q,texImage3D:ee,pixelStorei:Re,getParameter:ue,updateUBOMapping:Pe,uniformBlockBinding:De,texStorage2D:oe,texStorage3D:ce,texSubImage2D:x,texSubImage3D:B,compressedTexSubImage2D:X,compressedTexSubImage3D:Z,scissor:he,viewport:de,reset:Fe}}function Nw(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ke,h=new WeakMap,u=new Set;let d;const p=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(b,x){return v?new OffscreenCanvas(b,x):zl("canvas")}function m(b,x,B){let X=1;const Z=je(b);if((Z.width>B||Z.height>B)&&(X=B/Math.max(Z.width,Z.height)),X<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const oe=Math.floor(X*Z.width),ce=Math.floor(X*Z.height);d===void 0&&(d=M(oe,ce));const Q=x?M(oe,ce):d;return Q.width=oe,Q.height=ce,Q.getContext("2d").drawImage(b,0,0,oe,ce),Ie("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+oe+"x"+ce+")."),Q}else return"data"in b&&Ie("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),b;return b}function f(b){return b.generateMipmaps}function g(b){t.generateMipmap(b)}function S(b){return b.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?t.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function y(b,x,B,X,Z,oe=!1){if(b!==null){if(t[b]!==void 0)return t[b];Ie("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let ce;X&&(ce=e.get("EXT_texture_norm16"),ce||Ie("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Q=x;if(x===t.RED&&(B===t.FLOAT&&(Q=t.R32F),B===t.HALF_FLOAT&&(Q=t.R16F),B===t.UNSIGNED_BYTE&&(Q=t.R8),B===t.UNSIGNED_SHORT&&ce&&(Q=ce.R16_EXT),B===t.SHORT&&ce&&(Q=ce.R16_SNORM_EXT)),x===t.RED_INTEGER&&(B===t.UNSIGNED_BYTE&&(Q=t.R8UI),B===t.UNSIGNED_SHORT&&(Q=t.R16UI),B===t.UNSIGNED_INT&&(Q=t.R32UI),B===t.BYTE&&(Q=t.R8I),B===t.SHORT&&(Q=t.R16I),B===t.INT&&(Q=t.R32I)),x===t.RG&&(B===t.FLOAT&&(Q=t.RG32F),B===t.HALF_FLOAT&&(Q=t.RG16F),B===t.UNSIGNED_BYTE&&(Q=t.RG8),B===t.UNSIGNED_SHORT&&ce&&(Q=ce.RG16_EXT),B===t.SHORT&&ce&&(Q=ce.RG16_SNORM_EXT)),x===t.RG_INTEGER&&(B===t.UNSIGNED_BYTE&&(Q=t.RG8UI),B===t.UNSIGNED_SHORT&&(Q=t.RG16UI),B===t.UNSIGNED_INT&&(Q=t.RG32UI),B===t.BYTE&&(Q=t.RG8I),B===t.SHORT&&(Q=t.RG16I),B===t.INT&&(Q=t.RG32I)),x===t.RGB_INTEGER&&(B===t.UNSIGNED_BYTE&&(Q=t.RGB8UI),B===t.UNSIGNED_SHORT&&(Q=t.RGB16UI),B===t.UNSIGNED_INT&&(Q=t.RGB32UI),B===t.BYTE&&(Q=t.RGB8I),B===t.SHORT&&(Q=t.RGB16I),B===t.INT&&(Q=t.RGB32I)),x===t.RGBA_INTEGER&&(B===t.UNSIGNED_BYTE&&(Q=t.RGBA8UI),B===t.UNSIGNED_SHORT&&(Q=t.RGBA16UI),B===t.UNSIGNED_INT&&(Q=t.RGBA32UI),B===t.BYTE&&(Q=t.RGBA8I),B===t.SHORT&&(Q=t.RGBA16I),B===t.INT&&(Q=t.RGBA32I)),x===t.RGB&&(B===t.UNSIGNED_SHORT&&ce&&(Q=ce.RGB16_EXT),B===t.SHORT&&ce&&(Q=ce.RGB16_SNORM_EXT),B===t.UNSIGNED_INT_5_9_9_9_REV&&(Q=t.RGB9_E5),B===t.UNSIGNED_INT_10F_11F_11F_REV&&(Q=t.R11F_G11F_B10F)),x===t.RGBA){const ee=oe?kl:Ge.getTransfer(Z);B===t.FLOAT&&(Q=t.RGBA32F),B===t.HALF_FLOAT&&(Q=t.RGBA16F),B===t.UNSIGNED_BYTE&&(Q=ee===nt?t.SRGB8_ALPHA8:t.RGBA8),B===t.UNSIGNED_SHORT&&ce&&(Q=ce.RGBA16_EXT),B===t.SHORT&&ce&&(Q=ce.RGBA16_SNORM_EXT),B===t.UNSIGNED_SHORT_4_4_4_4&&(Q=t.RGBA4),B===t.UNSIGNED_SHORT_5_5_5_1&&(Q=t.RGB5_A1)}return(Q===t.R16F||Q===t.R32F||Q===t.RG16F||Q===t.RG32F||Q===t.RGBA16F||Q===t.RGBA32F)&&e.get("EXT_color_buffer_float"),Q}function A(b,x){let B;return b?x===null||x===mi||x===qo?B=t.DEPTH24_STENCIL8:x===li?B=t.DEPTH32F_STENCIL8:x===$o&&(B=t.DEPTH24_STENCIL8,Ie("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===mi||x===qo?B=t.DEPTH_COMPONENT24:x===li?B=t.DEPTH_COMPONENT32F:x===$o&&(B=t.DEPTH_COMPONENT16),B}function w(b,x){return f(b)===!0||b.isFramebufferTexture&&b.minFilter!==Xt&&b.minFilter!==en?Math.log2(Math.max(x.width,x.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?x.mipmaps.length:1}function C(b){const x=b.target;x.removeEventListener("dispose",C),R(x),x.isVideoTexture&&h.delete(x),x.isHTMLTexture&&u.delete(x)}function _(b){const x=b.target;x.removeEventListener("dispose",_),P(x)}function R(b){const x=i.get(b);if(x.__webglInit===void 0)return;const B=b.source,X=p.get(B);if(X){const Z=X[x.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&T(b),Object.keys(X).length===0&&p.delete(B)}i.remove(b)}function T(b){const x=i.get(b);t.deleteTexture(x.__webglTexture);const B=b.source,X=p.get(B);delete X[x.__cacheKey],o.memory.textures--}function P(b){const x=i.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),i.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(x.__webglFramebuffer[X]))for(let Z=0;Z<x.__webglFramebuffer[X].length;Z++)t.deleteFramebuffer(x.__webglFramebuffer[X][Z]);else t.deleteFramebuffer(x.__webglFramebuffer[X]);x.__webglDepthbuffer&&t.deleteRenderbuffer(x.__webglDepthbuffer[X])}else{if(Array.isArray(x.__webglFramebuffer))for(let X=0;X<x.__webglFramebuffer.length;X++)t.deleteFramebuffer(x.__webglFramebuffer[X]);else t.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&t.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&t.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let X=0;X<x.__webglColorRenderbuffer.length;X++)x.__webglColorRenderbuffer[X]&&t.deleteRenderbuffer(x.__webglColorRenderbuffer[X]);x.__webglDepthRenderbuffer&&t.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const B=b.textures;for(let X=0,Z=B.length;X<Z;X++){const oe=i.get(B[X]);oe.__webglTexture&&(t.deleteTexture(oe.__webglTexture),o.memory.textures--),i.remove(B[X])}i.remove(b)}let L=0;function D(){L=0}function z(){return L}function I(b){L=b}function V(){const b=L;return b>=r.maxTextures&&Ie("WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+r.maxTextures),L+=1,b}function k(b){const x=[];return x.push(b.wrapS),x.push(b.wrapT),x.push(b.wrapR||0),x.push(b.magFilter),x.push(b.minFilter),x.push(b.anisotropy),x.push(b.internalFormat),x.push(b.format),x.push(b.type),x.push(b.generateMipmaps),x.push(b.premultiplyAlpha),x.push(b.flipY),x.push(b.unpackAlignment),x.push(b.colorSpace),x.join()}function U(b,x){const B=i.get(b);if(b.isVideoTexture&&F(b),b.isRenderTargetTexture===!1&&b.isExternalTexture!==!0&&b.version>0&&B.__version!==b.version){const X=b.image;if(X===null)Ie("WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)Ie("WebGLRenderer: Texture marked for update but image is incomplete");else{Ee(B,b,x);return}}else b.isExternalTexture&&(B.__webglTexture=b.sourceTexture?b.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,B.__webglTexture,t.TEXTURE0+x)}function $(b,x){const B=i.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&B.__version!==b.version){Ee(B,b,x);return}else b.isExternalTexture&&(B.__webglTexture=b.sourceTexture?b.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,B.__webglTexture,t.TEXTURE0+x)}function J(b,x){const B=i.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&B.__version!==b.version){Ee(B,b,x);return}n.bindTexture(t.TEXTURE_3D,B.__webglTexture,t.TEXTURE0+x)}function ne(b,x){const B=i.get(b);if(b.isCubeDepthTexture!==!0&&b.version>0&&B.__version!==b.version){Ne(B,b,x);return}n.bindTexture(t.TEXTURE_CUBE_MAP,B.__webglTexture,t.TEXTURE0+x)}const K={[xd]:t.REPEAT,[wi]:t.CLAMP_TO_EDGE,[yd]:t.MIRRORED_REPEAT},le={[Xt]:t.NEAREST,[iS]:t.NEAREST_MIPMAP_NEAREST,[Ea]:t.NEAREST_MIPMAP_LINEAR,[en]:t.LINEAR,[zc]:t.LINEAR_MIPMAP_NEAREST,[Lr]:t.LINEAR_MIPMAP_LINEAR},Ae={[oS]:t.NEVER,[dS]:t.ALWAYS,[aS]:t.LESS,[rh]:t.LEQUAL,[lS]:t.EQUAL,[sh]:t.GEQUAL,[cS]:t.GREATER,[uS]:t.NOTEQUAL};function ve(b,x){if(x.type===li&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===en||x.magFilter===zc||x.magFilter===Ea||x.magFilter===Lr||x.minFilter===en||x.minFilter===zc||x.minFilter===Ea||x.minFilter===Lr)&&Ie("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(b,t.TEXTURE_WRAP_S,K[x.wrapS]),t.texParameteri(b,t.TEXTURE_WRAP_T,K[x.wrapT]),(b===t.TEXTURE_3D||b===t.TEXTURE_2D_ARRAY)&&t.texParameteri(b,t.TEXTURE_WRAP_R,K[x.wrapR]),t.texParameteri(b,t.TEXTURE_MAG_FILTER,le[x.magFilter]),t.texParameteri(b,t.TEXTURE_MIN_FILTER,le[x.minFilter]),x.compareFunction&&(t.texParameteri(b,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(b,t.TEXTURE_COMPARE_FUNC,Ae[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===Xt||x.minFilter!==Ea&&x.minFilter!==Lr||x.type===li&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||i.get(x).__currentAnisotropy){const B=e.get("EXT_texture_filter_anisotropic");t.texParameterf(b,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,r.getMaxAnisotropy())),i.get(x).__currentAnisotropy=x.anisotropy}}}function H(b,x){let B=!1;b.__webglInit===void 0&&(b.__webglInit=!0,x.addEventListener("dispose",C));const X=x.source;let Z=p.get(X);Z===void 0&&(Z={},p.set(X,Z));const oe=k(x);if(oe!==b.__cacheKey){Z[oe]===void 0&&(Z[oe]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,B=!0),Z[oe].usedTimes++;const ce=Z[b.__cacheKey];ce!==void 0&&(Z[b.__cacheKey].usedTimes--,ce.usedTimes===0&&T(x)),b.__cacheKey=oe,b.__webglTexture=Z[oe].texture}return B}function ie(b,x,B){return Math.floor(Math.floor(b/B)/x)}function re(b,x,B,X){const oe=b.updateRanges;if(oe.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,x.width,x.height,B,X,x.data);else{oe.sort((Re,he)=>Re.start-he.start);let ce=0;for(let Re=1;Re<oe.length;Re++){const he=oe[ce],de=oe[Re],Pe=he.start+he.count,De=ie(de.start,x.width,4),Fe=ie(he.start,x.width,4);de.start<=Pe+1&&De===Fe&&ie(de.start+de.count-1,x.width,4)===De?he.count=Math.max(he.count,de.start+de.count-he.start):(++ce,oe[ce]=de)}oe.length=ce+1;const Q=n.getParameter(t.UNPACK_ROW_LENGTH),ee=n.getParameter(t.UNPACK_SKIP_PIXELS),ue=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,x.width);for(let Re=0,he=oe.length;Re<he;Re++){const de=oe[Re],Pe=Math.floor(de.start/4),De=Math.ceil(de.count/4),Fe=Pe%x.width,N=Math.floor(Pe/x.width),ae=De,j=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,Fe),n.pixelStorei(t.UNPACK_SKIP_ROWS,N),n.texSubImage2D(t.TEXTURE_2D,0,Fe,N,ae,j,B,X,x.data)}b.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,Q),n.pixelStorei(t.UNPACK_SKIP_PIXELS,ee),n.pixelStorei(t.UNPACK_SKIP_ROWS,ue)}}function Ee(b,x,B){let X=t.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(X=t.TEXTURE_2D_ARRAY),x.isData3DTexture&&(X=t.TEXTURE_3D);const Z=H(b,x),oe=x.source;n.bindTexture(X,b.__webglTexture,t.TEXTURE0+B);const ce=i.get(oe);if(oe.version!==ce.__version||Z===!0){if(n.activeTexture(t.TEXTURE0+B),(typeof ImageBitmap<"u"&&x.image instanceof ImageBitmap)===!1){const j=Ge.getPrimaries(Ge.workingColorSpace),fe=x.colorSpace===ji?null:Ge.getPrimaries(x.colorSpace),_e=x.colorSpace===ji||j===fe?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,_e)}n.pixelStorei(t.UNPACK_ALIGNMENT,x.unpackAlignment);let ee=m(x.image,!1,r.maxTextureSize);ee=cn(x,ee);const ue=s.convert(x.format,x.colorSpace),Re=s.convert(x.type);let he=y(x.internalFormat,ue,Re,x.normalized,x.colorSpace,x.isVideoTexture);ve(X,x);let de;const Pe=x.mipmaps,De=x.isVideoTexture!==!0,Fe=ce.__version===void 0||Z===!0,N=oe.dataReady,ae=w(x,ee);if(x.isDepthTexture)he=A(x.format===Dr,x.type),Fe&&(De?n.texStorage2D(t.TEXTURE_2D,1,he,ee.width,ee.height):n.texImage2D(t.TEXTURE_2D,0,he,ee.width,ee.height,0,ue,Re,null));else if(x.isDataTexture)if(Pe.length>0){De&&Fe&&n.texStorage2D(t.TEXTURE_2D,ae,he,Pe[0].width,Pe[0].height);for(let j=0,fe=Pe.length;j<fe;j++)de=Pe[j],De?N&&n.texSubImage2D(t.TEXTURE_2D,j,0,0,de.width,de.height,ue,Re,de.data):n.texImage2D(t.TEXTURE_2D,j,he,de.width,de.height,0,ue,Re,de.data);x.generateMipmaps=!1}else De?(Fe&&n.texStorage2D(t.TEXTURE_2D,ae,he,ee.width,ee.height),N&&re(x,ee,ue,Re)):n.texImage2D(t.TEXTURE_2D,0,he,ee.width,ee.height,0,ue,Re,ee.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){De&&Fe&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ae,he,Pe[0].width,Pe[0].height,ee.depth);for(let j=0,fe=Pe.length;j<fe;j++)if(de=Pe[j],x.format!==qn)if(ue!==null)if(De){if(N)if(x.layerUpdates.size>0){const _e=fm(de.width,de.height,x.format,x.type);for(const te of x.layerUpdates){const we=de.data.subarray(te*_e/de.data.BYTES_PER_ELEMENT,(te+1)*_e/de.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,j,0,0,te,de.width,de.height,1,ue,we)}x.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,j,0,0,0,de.width,de.height,ee.depth,ue,de.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,j,he,de.width,de.height,ee.depth,0,de.data,0,0);else Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else De?N&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,j,0,0,0,de.width,de.height,ee.depth,ue,Re,de.data):n.texImage3D(t.TEXTURE_2D_ARRAY,j,he,de.width,de.height,ee.depth,0,ue,Re,de.data)}else{De&&Fe&&n.texStorage2D(t.TEXTURE_2D,ae,he,Pe[0].width,Pe[0].height);for(let j=0,fe=Pe.length;j<fe;j++)de=Pe[j],x.format!==qn?ue!==null?De?N&&n.compressedTexSubImage2D(t.TEXTURE_2D,j,0,0,de.width,de.height,ue,de.data):n.compressedTexImage2D(t.TEXTURE_2D,j,he,de.width,de.height,0,de.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):De?N&&n.texSubImage2D(t.TEXTURE_2D,j,0,0,de.width,de.height,ue,Re,de.data):n.texImage2D(t.TEXTURE_2D,j,he,de.width,de.height,0,ue,Re,de.data)}else if(x.isDataArrayTexture)if(De){if(Fe&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ae,he,ee.width,ee.height,ee.depth),N)if(x.layerUpdates.size>0){const j=fm(ee.width,ee.height,x.format,x.type);for(const fe of x.layerUpdates){const _e=ee.data.subarray(fe*j/ee.data.BYTES_PER_ELEMENT,(fe+1)*j/ee.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,fe,ee.width,ee.height,1,ue,Re,_e)}x.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,ee.width,ee.height,ee.depth,ue,Re,ee.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,he,ee.width,ee.height,ee.depth,0,ue,Re,ee.data);else if(x.isData3DTexture)De?(Fe&&n.texStorage3D(t.TEXTURE_3D,ae,he,ee.width,ee.height,ee.depth),N&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,ee.width,ee.height,ee.depth,ue,Re,ee.data)):n.texImage3D(t.TEXTURE_3D,0,he,ee.width,ee.height,ee.depth,0,ue,Re,ee.data);else if(x.isFramebufferTexture){if(Fe)if(De)n.texStorage2D(t.TEXTURE_2D,ae,he,ee.width,ee.height);else{let j=ee.width,fe=ee.height;for(let _e=0;_e<ae;_e++)n.texImage2D(t.TEXTURE_2D,_e,he,j,fe,0,ue,Re,null),j>>=1,fe>>=1}}else if(x.isHTMLTexture){if("texElementImage2D"in t){const j=t.canvas;if(j.hasAttribute("layoutsubtree")||j.setAttribute("layoutsubtree","true"),ee.parentNode!==j){j.appendChild(ee),u.add(x),j.onpaint=fe=>{const _e=fe.changedElements;for(const te of u)_e.includes(te.image)&&(te.needsUpdate=!0)},j.requestPaint();return}if(t.texElementImage2D.length===3)t.texElementImage2D(t.TEXTURE_2D,t.RGBA8,ee);else{const _e=t.RGBA,te=t.RGBA,we=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,0,_e,te,we,ee)}t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(Pe.length>0){if(De&&Fe){const j=je(Pe[0]);n.texStorage2D(t.TEXTURE_2D,ae,he,j.width,j.height)}for(let j=0,fe=Pe.length;j<fe;j++)de=Pe[j],De?N&&n.texSubImage2D(t.TEXTURE_2D,j,0,0,ue,Re,de):n.texImage2D(t.TEXTURE_2D,j,he,ue,Re,de);x.generateMipmaps=!1}else if(De){if(Fe){const j=je(ee);n.texStorage2D(t.TEXTURE_2D,ae,he,j.width,j.height)}N&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ue,Re,ee)}else n.texImage2D(t.TEXTURE_2D,0,he,ue,Re,ee);f(x)&&g(X),ce.__version=oe.version,x.onUpdate&&x.onUpdate(x)}b.__version=x.version}function Ne(b,x,B){if(x.image.length!==6)return;const X=H(b,x),Z=x.source;n.bindTexture(t.TEXTURE_CUBE_MAP,b.__webglTexture,t.TEXTURE0+B);const oe=i.get(Z);if(Z.version!==oe.__version||X===!0){n.activeTexture(t.TEXTURE0+B);const ce=Ge.getPrimaries(Ge.workingColorSpace),Q=x.colorSpace===ji?null:Ge.getPrimaries(x.colorSpace),ee=x.colorSpace===ji||ce===Q?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,x.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,ee);const ue=x.isCompressedTexture||x.image[0].isCompressedTexture,Re=x.image[0]&&x.image[0].isDataTexture,he=[];for(let te=0;te<6;te++)!ue&&!Re?he[te]=m(x.image[te],!0,r.maxCubemapSize):he[te]=Re?x.image[te].image:x.image[te],he[te]=cn(x,he[te]);const de=he[0],Pe=s.convert(x.format,x.colorSpace),De=s.convert(x.type),Fe=y(x.internalFormat,Pe,De,x.normalized,x.colorSpace),N=x.isVideoTexture!==!0,ae=oe.__version===void 0||X===!0,j=Z.dataReady;let fe=w(x,de);ve(t.TEXTURE_CUBE_MAP,x);let _e;if(ue){N&&ae&&n.texStorage2D(t.TEXTURE_CUBE_MAP,fe,Fe,de.width,de.height);for(let te=0;te<6;te++){_e=he[te].mipmaps;for(let we=0;we<_e.length;we++){const Me=_e[we];x.format!==qn?Pe!==null?N?j&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,we,0,0,Me.width,Me.height,Pe,Me.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,we,Fe,Me.width,Me.height,0,Me.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?j&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,we,0,0,Me.width,Me.height,Pe,De,Me.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,we,Fe,Me.width,Me.height,0,Pe,De,Me.data)}}}else{if(_e=x.mipmaps,N&&ae){_e.length>0&&fe++;const te=je(he[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,fe,Fe,te.width,te.height)}for(let te=0;te<6;te++)if(Re){N?j&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,he[te].width,he[te].height,Pe,De,he[te].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,Fe,he[te].width,he[te].height,0,Pe,De,he[te].data);for(let we=0;we<_e.length;we++){const xt=_e[we].image[te].image;N?j&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,we+1,0,0,xt.width,xt.height,Pe,De,xt.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,we+1,Fe,xt.width,xt.height,0,Pe,De,xt.data)}}else{N?j&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,Pe,De,he[te]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,Fe,Pe,De,he[te]);for(let we=0;we<_e.length;we++){const Me=_e[we];N?j&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,we+1,0,0,Pe,De,Me.image[te]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,we+1,Fe,Pe,De,Me.image[te])}}}f(x)&&g(t.TEXTURE_CUBE_MAP),oe.__version=Z.version,x.onUpdate&&x.onUpdate(x)}b.__version=x.version}function Le(b,x,B,X,Z,oe){const ce=s.convert(B.format,B.colorSpace),Q=s.convert(B.type),ee=y(B.internalFormat,ce,Q,B.normalized,B.colorSpace),ue=i.get(x),Re=i.get(B);if(Re.__renderTarget=x,!ue.__hasExternalTextures){const he=Math.max(1,x.width>>oe),de=Math.max(1,x.height>>oe);Z===t.TEXTURE_3D||Z===t.TEXTURE_2D_ARRAY?n.texImage3D(Z,oe,ee,he,de,x.depth,0,ce,Q,null):n.texImage2D(Z,oe,ee,he,de,0,ce,Q,null)}n.bindFramebuffer(t.FRAMEBUFFER,b),bt(x)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,X,Z,Re.__webglTexture,0,_t(x)):(Z===t.TEXTURE_2D||Z>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,X,Z,Re.__webglTexture,oe),n.bindFramebuffer(t.FRAMEBUFFER,null)}function Et(b,x,B){if(t.bindRenderbuffer(t.RENDERBUFFER,b),x.depthBuffer){const X=x.depthTexture,Z=X&&X.isDepthTexture?X.type:null,oe=A(x.stencilBuffer,Z),ce=x.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;bt(x)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,_t(x),oe,x.width,x.height):B?t.renderbufferStorageMultisample(t.RENDERBUFFER,_t(x),oe,x.width,x.height):t.renderbufferStorage(t.RENDERBUFFER,oe,x.width,x.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,ce,t.RENDERBUFFER,b)}else{const X=x.textures;for(let Z=0;Z<X.length;Z++){const oe=X[Z],ce=s.convert(oe.format,oe.colorSpace),Q=s.convert(oe.type),ee=y(oe.internalFormat,ce,Q,oe.normalized,oe.colorSpace);bt(x)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,_t(x),ee,x.width,x.height):B?t.renderbufferStorageMultisample(t.RENDERBUFFER,_t(x),ee,x.width,x.height):t.renderbufferStorage(t.RENDERBUFFER,ee,x.width,x.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Ve(b,x,B){const X=x.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,b),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const Z=i.get(x.depthTexture);if(Z.__renderTarget=x,(!Z.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),X){if(Z.__webglInit===void 0&&(Z.__webglInit=!0,x.depthTexture.addEventListener("dispose",C)),Z.__webglTexture===void 0){Z.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,Z.__webglTexture),ve(t.TEXTURE_CUBE_MAP,x.depthTexture);const ue=s.convert(x.depthTexture.format),Re=s.convert(x.depthTexture.type);let he;x.depthTexture.format===Fi?he=t.DEPTH_COMPONENT24:x.depthTexture.format===Dr&&(he=t.DEPTH24_STENCIL8);for(let de=0;de<6;de++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,he,x.width,x.height,0,ue,Re,null)}}else U(x.depthTexture,0);const oe=Z.__webglTexture,ce=_t(x),Q=X?t.TEXTURE_CUBE_MAP_POSITIVE_X+B:t.TEXTURE_2D,ee=x.depthTexture.format===Dr?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(x.depthTexture.format===Fi)bt(x)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,ee,Q,oe,0,ce):t.framebufferTexture2D(t.FRAMEBUFFER,ee,Q,oe,0);else if(x.depthTexture.format===Dr)bt(x)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,ee,Q,oe,0,ce):t.framebufferTexture2D(t.FRAMEBUFFER,ee,Q,oe,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function st(b){const x=i.get(b),B=b.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==b.depthTexture){const X=b.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),X){const Z=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,X.removeEventListener("dispose",Z)};X.addEventListener("dispose",Z),x.__depthDisposeCallback=Z}x.__boundDepthTexture=X}if(b.depthTexture&&!x.__autoAllocateDepthBuffer)if(B)for(let X=0;X<6;X++)Ve(x.__webglFramebuffer[X],b,X);else{const X=b.texture.mipmaps;X&&X.length>0?Ve(x.__webglFramebuffer[0],b,0):Ve(x.__webglFramebuffer,b,0)}else if(B){x.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer[X]),x.__webglDepthbuffer[X]===void 0)x.__webglDepthbuffer[X]=t.createRenderbuffer(),Et(x.__webglDepthbuffer[X],b,!1);else{const Z=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,oe=x.__webglDepthbuffer[X];t.bindRenderbuffer(t.RENDERBUFFER,oe),t.framebufferRenderbuffer(t.FRAMEBUFFER,Z,t.RENDERBUFFER,oe)}}else{const X=b.texture.mipmaps;if(X&&X.length>0?n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=t.createRenderbuffer(),Et(x.__webglDepthbuffer,b,!1);else{const Z=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,oe=x.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,oe),t.framebufferRenderbuffer(t.FRAMEBUFFER,Z,t.RENDERBUFFER,oe)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function Ze(b,x,B){const X=i.get(b);x!==void 0&&Le(X.__webglFramebuffer,b,b.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),B!==void 0&&st(b)}function Xe(b){const x=b.texture,B=i.get(b),X=i.get(x);b.addEventListener("dispose",_);const Z=b.textures,oe=b.isWebGLCubeRenderTarget===!0,ce=Z.length>1;if(ce||(X.__webglTexture===void 0&&(X.__webglTexture=t.createTexture()),X.__version=x.version,o.memory.textures++),oe){B.__webglFramebuffer=[];for(let Q=0;Q<6;Q++)if(x.mipmaps&&x.mipmaps.length>0){B.__webglFramebuffer[Q]=[];for(let ee=0;ee<x.mipmaps.length;ee++)B.__webglFramebuffer[Q][ee]=t.createFramebuffer()}else B.__webglFramebuffer[Q]=t.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){B.__webglFramebuffer=[];for(let Q=0;Q<x.mipmaps.length;Q++)B.__webglFramebuffer[Q]=t.createFramebuffer()}else B.__webglFramebuffer=t.createFramebuffer();if(ce)for(let Q=0,ee=Z.length;Q<ee;Q++){const ue=i.get(Z[Q]);ue.__webglTexture===void 0&&(ue.__webglTexture=t.createTexture(),o.memory.textures++)}if(b.samples>0&&bt(b)===!1){B.__webglMultisampledFramebuffer=t.createFramebuffer(),B.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let Q=0;Q<Z.length;Q++){const ee=Z[Q];B.__webglColorRenderbuffer[Q]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,B.__webglColorRenderbuffer[Q]);const ue=s.convert(ee.format,ee.colorSpace),Re=s.convert(ee.type),he=y(ee.internalFormat,ue,Re,ee.normalized,ee.colorSpace,b.isXRRenderTarget===!0),de=_t(b);t.renderbufferStorageMultisample(t.RENDERBUFFER,de,he,b.width,b.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Q,t.RENDERBUFFER,B.__webglColorRenderbuffer[Q])}t.bindRenderbuffer(t.RENDERBUFFER,null),b.depthBuffer&&(B.__webglDepthRenderbuffer=t.createRenderbuffer(),Et(B.__webglDepthRenderbuffer,b,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(oe){n.bindTexture(t.TEXTURE_CUBE_MAP,X.__webglTexture),ve(t.TEXTURE_CUBE_MAP,x);for(let Q=0;Q<6;Q++)if(x.mipmaps&&x.mipmaps.length>0)for(let ee=0;ee<x.mipmaps.length;ee++)Le(B.__webglFramebuffer[Q][ee],b,x,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ee);else Le(B.__webglFramebuffer[Q],b,x,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0);f(x)&&g(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(ce){for(let Q=0,ee=Z.length;Q<ee;Q++){const ue=Z[Q],Re=i.get(ue);let he=t.TEXTURE_2D;(b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(he=b.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(he,Re.__webglTexture),ve(he,ue),Le(B.__webglFramebuffer,b,ue,t.COLOR_ATTACHMENT0+Q,he,0),f(ue)&&g(he)}n.unbindTexture()}else{let Q=t.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(Q=b.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(Q,X.__webglTexture),ve(Q,x),x.mipmaps&&x.mipmaps.length>0)for(let ee=0;ee<x.mipmaps.length;ee++)Le(B.__webglFramebuffer[ee],b,x,t.COLOR_ATTACHMENT0,Q,ee);else Le(B.__webglFramebuffer,b,x,t.COLOR_ATTACHMENT0,Q,0);f(x)&&g(Q),n.unbindTexture()}b.depthBuffer&&st(b)}function Ct(b){const x=b.textures;for(let B=0,X=x.length;B<X;B++){const Z=x[B];if(f(Z)){const oe=S(b),ce=i.get(Z).__webglTexture;n.bindTexture(oe,ce),g(oe),n.unbindTexture()}}}const It=[],kt=[];function Ht(b){if(b.samples>0){if(bt(b)===!1){const x=b.textures,B=b.width,X=b.height;let Z=t.COLOR_BUFFER_BIT;const oe=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ce=i.get(b),Q=x.length>1;if(Q)for(let ue=0;ue<x.length;ue++)n.bindFramebuffer(t.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ue,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,ce.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ue,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,ce.__webglMultisampledFramebuffer);const ee=b.texture.mipmaps;ee&&ee.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ce.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ce.__webglFramebuffer);for(let ue=0;ue<x.length;ue++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(Z|=t.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(Z|=t.STENCIL_BUFFER_BIT)),Q){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,ce.__webglColorRenderbuffer[ue]);const Re=i.get(x[ue]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Re,0)}t.blitFramebuffer(0,0,B,X,0,0,B,X,Z,t.NEAREST),l===!0&&(It.length=0,kt.length=0,It.push(t.COLOR_ATTACHMENT0+ue),b.depthBuffer&&b.resolveDepthBuffer===!1&&(It.push(oe),kt.push(oe),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,kt)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,It))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),Q)for(let ue=0;ue<x.length;ue++){n.bindFramebuffer(t.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ue,t.RENDERBUFFER,ce.__webglColorRenderbuffer[ue]);const Re=i.get(x[ue]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,ce.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ue,t.TEXTURE_2D,Re,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ce.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){const x=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[x])}}}function _t(b){return Math.min(r.maxSamples,b.samples)}function bt(b){const x=i.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function F(b){const x=o.render.frame;h.get(b)!==x&&(h.set(b,x),b.update())}function cn(b,x){const B=b.colorSpace,X=b.format,Z=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||B!==Ol&&B!==ji&&(Ge.getTransfer(B)===nt?(X!==qn||Z!==Nn)&&Ie("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):$e("WebGLTextures: Unsupported texture color space:",B)),x}function je(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=V,this.resetTextureUnits=D,this.getTextureUnits=z,this.setTextureUnits=I,this.setTexture2D=U,this.setTexture2DArray=$,this.setTexture3D=J,this.setTextureCube=ne,this.rebindTextures=Ze,this.setupRenderTarget=Xe,this.updateRenderTargetMipmap=Ct,this.updateMultisampleRenderTarget=Ht,this.setupDepthRenderbuffer=st,this.setupFrameBufferTexture=Le,this.useMultisampledRTT=bt,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function Uw(t,e){function n(i,r=ji){let s;const o=Ge.getTransfer(r);if(i===Nn)return t.UNSIGNED_BYTE;if(i===jf)return t.UNSIGNED_SHORT_4_4_4_4;if(i===eh)return t.UNSIGNED_SHORT_5_5_5_1;if(i===fv)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===hv)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===uv)return t.BYTE;if(i===dv)return t.SHORT;if(i===$o)return t.UNSIGNED_SHORT;if(i===Jf)return t.INT;if(i===mi)return t.UNSIGNED_INT;if(i===li)return t.FLOAT;if(i===Ui)return t.HALF_FLOAT;if(i===pv)return t.ALPHA;if(i===mv)return t.RGB;if(i===qn)return t.RGBA;if(i===Fi)return t.DEPTH_COMPONENT;if(i===Dr)return t.DEPTH_STENCIL;if(i===gv)return t.RED;if(i===th)return t.RED_INTEGER;if(i===Hr)return t.RG;if(i===nh)return t.RG_INTEGER;if(i===ih)return t.RGBA_INTEGER;if(i===sl||i===ol||i===al||i===ll)if(o===nt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===sl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===ol)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===al)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===ll)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===sl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===ol)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===al)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===ll)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Sd||i===Md||i===Ed||i===Td)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Sd)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Md)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Ed)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Td)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===wd||i===Ad||i===Rd||i===Cd||i===bd||i===Ul||i===Pd)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===wd||i===Ad)return o===nt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Rd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Cd)return s.COMPRESSED_R11_EAC;if(i===bd)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Ul)return s.COMPRESSED_RG11_EAC;if(i===Pd)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Ld||i===Dd||i===Id||i===Nd||i===Ud||i===Fd||i===Od||i===kd||i===Bd||i===zd||i===Vd||i===Hd||i===Gd||i===Wd)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Ld)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Dd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Id)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Nd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Ud)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Fd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Od)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===kd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Bd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===zd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Vd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Hd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Gd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Wd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Xd||i===Yd||i===$d)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Xd)return o===nt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Yd)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===$d)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===qd||i===Kd||i===Fl||i===Zd)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===qd)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Kd)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Fl)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Zd)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===qo?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const Fw=`
void main() {
...
}`;class kw{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n){if(this.texture===null){const i=new Av(e.texture);(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new Jn({vertexShader:Fw,fragmentShader:Ow,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new pn(new Ai(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Bw extends Yr{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,h=null,u=null,d=null,p=null,v=null;const M=typeof XRWebGLBinding<"u",m=new kw,f={},g=n.getContextAttributes();let S=null,y=null;const A=[],w=[],C=new Ke;let _=null;const R=new Yn;R.viewport=new Mt;const T=new Yn;T.viewport=new Mt;const P=[R,T],L=new KS;let D=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(H){let ie=A[H];return ie===void 0&&(ie=new qc,A[H]=ie),ie.getTargetRaySpace()},this.getControllerGrip=function(H){let ie=A[H];return ie===void 0&&(ie=new qc,A[H]=ie),ie.getGripSpace()},this.getHand=function(H){let ie=A[H];return ie===void 0&&(ie=new qc,A[H]=ie),ie.getHandSpace()};function I(H){const ie=w.indexOf(H.inputSource);if(ie===-1)return;const re=A[ie];re!==void 0&&(re.update(H.inputSource,H.frame,c||o),re.dispatchEvent({type:H.type,data:H.inputSource}))}function V(){r.removeEventListener("select",I),r.removeEventListener("selectstart",I),r.removeEventListener("selectend",I),r.removeEventListener("squeeze",I),r.removeEventListener("squeezestart",I),r.removeEventListener("squeezeend",I),r.removeEventListener("end",V),r.removeEventListener("inputsourceschange",k);for(let H=0;H<A.length;H++){const ie=w[H];ie!==null&&(w[H]=null,A[H].disconnect(ie))}D=null,z=null,m.reset();for(const H in f)delete f[H];e.setRenderTarget(S),p=null,d=null,u=null,r=null,y=null,ve.stop(),i.isPresenting=!1,e.setPixelRatio(_),e.setSize(C.width,C.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(H){s=H,i.isPresenting===!0&&Ie("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(H){a=H,i.isPresenting===!0&&Ie("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(H){c=H},this.getBaseLayer=function(){return d!==null?d:p},this.getBinding=function(){return u===null&&M&&(u=new XRWebGLBinding(r,n)),u},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(H){if(r=H,r!==null){if(S=e.getRenderTarget(),r.addEventListener("select",I),r.addEventListener("selectstart",I),r.addEventListener("selectend",I),r.addEventListener("squeeze",I),r.addEventListener("squeezestart",I),r.addEventListener("squeezeend",I),r.addEventListener("end",V),r.addEventListener("inputsourceschange",k),g.xrCompatible!==!0&&await n.makeXRCompatible(),_=e.getPixelRatio(),e.getSize(C),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let re=null,Ee=null,Ne=null;g.depth&&(Ne=g.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,re=g.stencil?Dr:Fi,Ee=g.stencil?qo:mi);const Le={colorFormat:n.RGBA8,depthFormat:Ne,scaleFactor:s};u=this.getBinding(),d=u.createProjectionLayer(Le),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),y=new hi(d.textureWidth,d.textureHeight,{format:qn,type:Nn,depthTexture:new Hs(d.textureWidth,d.textureHeight,Ee,void 0,void 0,void 0,void 0,void 0,void 0,re),stencilBuffer:g.stencil,colorSpace:e.outputColorSpace,samples:g.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const re={antialias:g.antialias,alpha:!0,depth:g.depth,stencil:g.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,n,re),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),y=new hi(p.framebufferWidth,p.framebufferHeight,{format:qn,type:Nn,colorSpace:e.outputColorSpace,stencilBuffer:g.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),ve.setContext(r),ve.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function k(H){for(let ie=0;ie<H.removed.length;ie++){const re=H.removed[ie],Ee=w.indexOf(re);Ee>=0&&(w[Ee]=null,A[Ee].disconnect(re))}for(let ie=0;ie<H.added.length;ie++){const re=H.added[ie];let Ee=w.indexOf(re);if(Ee===-1){for(let Le=0;Le<A.length;Le++)if(Le>=w.length){w.push(re),Ee=Le;break}else if(w[Le]===null){w[Le]=re,Ee=Le;break}if(Ee===-1)break}const Ne=A[Ee];Ne&&Ne.connect(re)}}const U=new Y,$=new Y;function J(H,ie,re){U.setFromMatrixPosition(ie.matrixWorld),$.setFromMatrixPosition(re.matrixWorld);const Ee=U.distanceTo($),Ne=ie.projectionMatrix.elements,Le=re.projectionMatrix.elements,Et=Ne[14]/(Ne[10]-1),Ve=Ne[14]/(Ne[10]+1),st=(Ne[9]+1)/Ne[5],Ze=(Ne[9]-1)/Ne[5],Xe=(Ne[8]-1)/Ne[0],Ct=(Le[8]+1)/Le[0],It=Et*Xe,kt=Et*Ct,Ht=Ee/(-Xe+Ct),_t=Ht*-Xe;if(ie.matrixWorld.decompose(H.position,H.quaternion,H.scale),H.translateX(_t),H.translateZ(Ht),H.matrixWorld.compose(H.position,H.quaternion,H.scale),H.matrixWorldInverse.copy(H.matrixWorld).invert(),Ne[10]===-1)H.projectionMatrix.copy(ie.projectionMatrix),H.projectionMatrixInverse.copy(ie.projectionMatrixInverse);else{const bt=Et+Ht,F=Ve+Ht,cn=It-_t,je=kt+(Ee-_t),b=st*Ve/F*bt,x=Ze*Ve/F*bt;H.projectionMatrix.makePerspective(cn,je,b,x,bt,F),H.projectionMatrixInverse.copy(H.projectionMatrix).invert()}}function ne(H,ie){ie===null?H.matrixWorld.copy(H.matrix):H.matrixWorld.multiplyMatrices(ie.matrixWorld,H.matrix),H.matrixWorldInverse.copy(H.matrixWorld).invert()}this.updateCamera=function(H){if(r===null)return;let ie=H.near,re=H.far;m.texture!==null&&(m.depthNear>0&&(ie=m.depthNear),m.depthFar>0&&(re=m.depthFar)),L.near=T.near=R.near=ie,L.far=T.far=R.far=re,(D!==L.near||z!==L.far)&&(r.updateRenderState({depthNear:L.near,depthFar:L.far}),D=L.near,z=L.far),L.layers.mask=H.layers.mask|6,R.layers.mask=L.layers.mask&-5,T.layers.mask=L.layers.mask&-3;const Ee=H.parent,Ne=L.cameras;ne(L,Ee);for(let Le=0;Le<Ne.length;Le++)ne(Ne[Le],Ee);Ne.length===2?J(L,R,T):L.projectionMatrix.copy(R.projectionMatrix),K(H,L,Ee)};function K(H,ie,re){re===null?H.matrix.copy(ie.matrixWorld):(H.matrix.copy(re.matrixWorld),H.matrix.invert(),H.matrix.multiply(ie.matrixWorld)),H.matrix.decompose(H.position,H.quaternion,H.scale),H.updateMatrixWorld(!0),H.projectionMatrix.copy(ie.projectionMatrix),H.projectionMatrixInverse.copy(ie.projectionMatrixInverse),H.isPerspectiveCamera&&(H.fov=Qd*2*Math.atan(1/H.projectionMatrix.elements[5]),H.zoom=1)}this.getCamera=function(){return L},this.getFoveation=function(){if(!(d===null&&p===null))return l},this.setFoveation=function(H){l=H,d!==null&&(d.fixedFoveation=H),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=H)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(L)},this.getCameraTexture=function(H){return f[H]};let le=null;function Ae(H,ie){if(h=ie.getViewerPose(c||o),v=ie,h!==null){const re=h.views;p!==null&&(e.setRenderTargetFramebuffer(y,p.framebuffer),e.setRenderTarget(y));let Ee=!1;re.length!==L.cameras.length&&(L.cameras.length=0,Ee=!0);for(let Ve=0;Ve<re.length;Ve++){const st=re[Ve];let Ze=null;if(p!==null)Ze=p.getViewport(st);else{const Ct=u.getViewSubImage(d,st);Ze=Ct.viewport,Ve===0&&(e.setRenderTargetTextures(y,Ct.colorTexture,Ct.depthStencilTexture),e.setRenderTarget(y))}let Xe=P[Ve];Xe===void 0&&(Xe=new Yn,Xe.layers.enable(Ve),Xe.viewport=new Mt,P[Ve]=Xe),Xe.matrix.fromArray(st.transform.matrix),Xe.matrix.decompose(Xe.position,Xe.quaternion,Xe.scale),Xe.projectionMatrix.fromArray(st.projectionMatrix),Xe.projectionMatrixInverse.copy(Xe.projectionMatrix).invert(),Xe.viewport.set(Ze.x,Ze.y,Ze.width,Ze.height),Ve===0&&(L.matrix.copy(Xe.matrix),L.matrix.decompose(L.position,L.quaternion,L.scale)),Ee===!0&&L.cameras.push(Xe)}const Ne=r.enabledFeatures;if(Ne&&Ne.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&M){u=i.getBinding();const Ve=u.getDepthInformation(re[0]);Ve&&Ve.isValid&&Ve.texture&&m.init(Ve,r.renderState)}if(Ne&&Ne.includes("camera-access")&&M){e.state.unbindTexture(),u=i.getBinding();for(let Ve=0;Ve<re.length;Ve++){const st=re[Ve].camera;if(st){let Ze=f[st];Ze||(Ze=new Av,f[st]=Ze);const Xe=u.getCameraImage(st);Ze.sourceTexture=Xe}}}}for(let re=0;re<A.length;re++){const Ee=w[re],Ne=A[re];Ee!==null&&Ne!==void 0&&Ne.update(Ee,ie,c||o)}le&&le(H,ie),ie.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:ie}),v=null}const ve=new Cv;ve.setAnimationLoop(Ae),this.setAnimationLoop=function(H){le=H},this.dispose=function(){}}}const zw=new Dt,Uv=new Ue;Uv.set(-1,0,0,0,1,0,0,0,1);function Vw(t,e){function n(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function i(m,f){f.color.getRGB(m.fogColor.value,Rv(t)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function r(m,f,g,S,y){f.isNodeMaterial?f.uniformsNeedUpdate=!1:f.isMeshBasicMaterial?s(m,f):f.isMeshLambertMaterial?(s(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshToonMaterial?(s(m,f),u(m,f)):f.isMeshPhongMaterial?(s(m,f),h(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshStandardMaterial?(s(m,f),d(m,f),f.isMeshPhysicalMaterial&&p(m,f,y)):f.isMeshMatcapMaterial?(s(m,f),v(m,f)):f.isMeshDepthMaterial?s(m,f):f.isMeshDistanceMaterial?(s(m,f),M(m,f)):f.isMeshNormalMaterial?s(m,f):f.isLineBasicMaterial?(o(m,f),f.isLineDashedMaterial&&a(m,f)):f.isPointsMaterial?l(m,f,g,S):f.isSpriteMaterial?c(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function s(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,n(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,n(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,n(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===_n&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,n(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===_n&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,n(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,n(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,n(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);const g=e.get(f),S=g.envMap,y=g.envMapRotation;S&&(m.envMap.value=S,m.envMapRotation.value.setFromMatrix4(zw.makeRotationFromEuler(y)).transpose(),S.isCubeTexture&&S.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(Uv),m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,n(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,n(f.aoMap,m.aoMapTransform))}function o(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,n(f.map,m.mapTransform))}function a(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function l(m,f,g,S){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*g,m.scale.value=S*.5,f.map&&(m.map.value=f.map,n(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,n(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function c(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,n(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,n(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function h(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function u(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function d(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,n(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,n(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function p(m,f,g){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,n(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,n(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,n(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,n(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,n(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===_n&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,n(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,n(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=g.texture,m.transmissionSamplerSize.value.set(g.width,g.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,n(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,n(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,n(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,n(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,n(f.specularIntensityMap,m.specularIntensityMapTransform))}function v(m,f){f.matcap&&(m.matcap.value=f.matcap)}function M(m,f){const g=e.get(f).light;m.referencePosition.value.setFromMatrixPosition(g.matrixWorld),m.nearDistance.value=g.shadow.camera.near,m.farDistance.value=g.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function Hw(t,e,n,i){let r={},s={},o=[];const a=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(y,A){const w=A.program;i.uniformBlockBinding(y,w)}function c(y,A){let w=r[y.id];w===void 0&&(m(y),w=h(y),r[y.id]=w,y.addEventListener("dispose",g));const C=A.program;i.updateUBOMapping(y,C);const _=e.render.frame;s[y.id]!==_&&(d(y),s[y.id]=_)}function h(y){const A=u();y.__bindingPointIndex=A;const w=t.createBuffer(),C=y.__size,_=y.usage;return t.bindBuffer(t.UNIFORM_BUFFER,w),t.bufferData(t.UNIFORM_BUFFER,C,_),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,A,w),w}function u(){for(let y=0;y<a;y++)if(o.indexOf(y)===-1)return o.push(y),y;return $e("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(y){const A=r[y.id],w=y.uniforms,C=y.__cache;t.bindBuffer(t.UNIFORM_BUFFER,A);for(let _=0,R=w.length;_<R;_++){const T=w[_];if(Array.isArray(T))for(let P=0,L=T.length;P<L;P++)p(T[P],_,P,C);else p(T,_,0,C)}t.bindBuffer(t.UNIFORM_BUFFER,null)}function p(y,A,w,C){if(M(y,A,w,C)===!0){const _=y.__offset,R=y.value;if(Array.isArray(R)){let T=0;for(let P=0;P<R.length;P++){const L=R[P],D=f(L);v(L,y.__data,T),typeof L!="number"&&typeof L!="boolean"&&!L.isMatrix3&&!ArrayBuffer.isView(L)&&(T+=D.storage/Float32Array.BYTES_PER_ELEMENT)}}else v(R,y.__data,0);t.bufferSubData(t.UNIFORM_BUFFER,_,y.__data)}}function v(y,A,w){typeof y=="number"||typeof y=="boolean"?A[0]=y:y.isMatrix3?(A[0]=y.elements[0],A[1]=y.elements[1],A[2]=y.elements[2],A[3]=0,A[4]=y.elements[3],A[5]=y.elements[4],A[6]=y.elements[5],A[7]=0,A[8]=y.elements[6],A[9]=y.elements[7],A[10]=y.elements[8],A[11]=0):ArrayBuffer.isView(y)?A.set(new y.constructor(y.buffer,y.byteOffset,A.length)):y.toArray(A,w)}function M(y,A,w,C){const _=y.value,R=A+"_"+w;if(C[R]===void 0)return typeof _=="number"||typeof _=="boolean"?C[R]=_:ArrayBuffer.isView(_)?C[R]=_.slice():C[R]=_.clone(),!0;{const T=C[R];if(typeof _=="number"||typeof _=="boolean"){if(T!==_)return C[R]=_,!0}else{if(ArrayBuffer.isView(_))return!0;if(T.equals(_)===!1)return T.copy(_),!0}}return!1}function m(y){const A=y.uniforms;let w=0;const C=16;for(let R=0,T=A.length;R<T;R++){const P=Array.isArray(A[R])?A[R]:[A[R]];for(let L=0,D=P.length;L<D;L++){const z=P[L],I=Array.isArray(z.value)?z.value:[z.value];for(let V=0,k=I.length;V<k;V++){const U=I[V],$=f(U),J=w%C,ne=J%$.boundary,K=J+ne;w+=ne,K!==0&&C-K<$.storage&&(w+=C-K),z.__data=new Float32Array($.storage/Float32Array.BYTES_PER_ELEMENT),z.__offset=w,w+=$.storage}}}const _=w%C;return _>0&&(w+=C-_),y.__size=w,y.__cache={},this}function f(y){const A={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(A.boundary=4,A.storage=4):y.isVector2?(A.boundary=8,A.storage=8):y.isVector3||y.isColor?(A.boundary=16,A.storage=12):y.isVector4?(A.boundary=16,A.storage=16):y.isMatrix3?(A.boundary=48,A.storage=48):y.isMatrix4?(A.boundary=64,A.storage=64):y.isTexture?Ie("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(y)?(A.boundary=16,A.storage=y.byteLength):Ie("WebGLRenderer: Unsupported uniform value type.",y),A}function g(y){const A=y.target;A.removeEventListener("dispose",g);const w=o.indexOf(A.__bindingPointIndex);o.splice(w,1),t.deleteBuffer(r[A.id]),delete r[A.id],delete s[A.id]}function S(){for(const y in r)t.deleteBuffer(r[y]);o=[],r={},s={}}return{bind:l,update:c,dispose:S}}const Gw=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let ri=null;function Ww(){return ri===null&&(ri=new FS(Gw,16,16,Hr,Ui),ri.name="DFG_LUT",ri.minFilter=en,ri.magFilter=en,ri.wrapS=wi,ri.wrapT=wi,ri.generateMipmaps=!1,ri.needsUpdate=!0),ri}class Xw{constructor(e={}){const{canvas:n=hS(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:d=!1,outputBufferType:p=Nn}=e;this.isWebGLRenderer=!0;let v;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");v=i.getContextAttributes().alpha}else v=o;const M=p,m=new Set([ih,nh,th]),f=new Set([Nn,mi,$o,qo,jf,eh]),g=new Uint32Array(4),S=new Int32Array(4),y=new Y;let A=null,w=null;const C=[],_=[];let R=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=fi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const T=this;let P=!1,L=null,D=null,z=null,I=null;this._outputColorSpace=Wt;let V=0,k=0,U=null,$=-1,J=null;const ne=new Mt,K=new Mt;let le=null;const Ae=new Je(0);let ve=0,H=n.width,ie=n.height,re=1,Ee=null,Ne=null;const Le=new Mt(0,0,H,ie),Et=new Mt(0,0,H,ie);let Ve=!1;const st=new Tv;let Ze=!1,Xe=!1;const Ct=new Dt,It=new Y,kt=new Mt,Ht={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let _t=!1;function bt(){return U===null?re:1}let F=i;function cn(E,O){return n.getContext(E,O)}try{const E={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Qf}`),n.addEventListener("webglcontextlost",xt,!1),n.addEventListener("webglcontextrestored",lt,!1),n.addEventListener("webglcontextcreationerror",jn,!1),F===null){const O="webgl2";if(F=cn(O,E),F===null)throw cn(O)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(E){throw $e("WebGLRenderer: "+E.message),E}let je,b,x,B,X,Z,oe,ce,Q,ee,ue,Re,he,de,Pe,De,Fe,N,ae,j,fe,_e,te;function we(){je=new W1(F),je.init(),fe=new Uw(F,je),b=new F1(F,je,e,fe),x=new Iw(F,je),b.reversedDepthBuffer&&d&&x.buffers.depth.setReversed(!0),D=F.createFramebuffer(),z=F.createFramebuffer(),I=F.createFramebuffer(),B=new $1(F),X=new xw,Z=new Nw(F,je,x,X,b,fe,B),oe=new G1(T),ce=new QS(F),_e=new N1(F,ce),Q=new X1(F,ce,B,_e),ee=new K1(F,Q,ce,_e,B),N=new q1(F,b,Z),Pe=new O1(X),ue=new _w(T,oe,je,b,_e,Pe),Re=new Vw(T,X),he=new Sw,de=new Rw(je),Fe=new I1(T,oe,x,ee,v,l),De=new Dw(T,ee,b),te=new Hw(F,B,b,x),ae=new U1(F,je,B),j=new Y1(F,je,B),B.programs=ue.programs,T.capabilities=b,T.extensions=je,T.properties=X,T.renderLists=he,T.shadowMap=De,T.state=x,T.info=B}we(),M!==Nn&&(R=new Q1(M,n.width,n.height,a,r,s));const Me=new Bw(T,F);this.xr=Me,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){const E=je.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){const E=je.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return re},this.setPixelRatio=function(E){E!==void 0&&(re=E,this.setSize(H,ie,!1))},this.getSize=function(E){return E.set(H,ie)},this.setSize=function(E,O,q=!0){if(Me.isPresenting){Ie("WebGLRenderer: Can't change size while VR device is presenting.");return}H=E,ie=O,n.width=Math.floor(E*re),n.height=Math.floor(O*re),q===!0&&(n.style.width=E+"px",n.style.height=O+"px"),R!==null&&R.setSize(n.width,n.height),this.setViewport(0,0,E,O)},this.getDrawingBufferSize=function(E){return E.set(H*re,ie*re).floor()},this.setDrawingBufferSize=function(E,O,q){H=E,ie=O,re=q,n.width=Math.floor(E*q),n.height=Math.floor(O*q),this.setViewport(0,0,E,O)},this.setEffects=function(E){if(M===Nn){$e("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(E){for(let O=0;O<E.length;O++)if(E[O].isOutputPass===!0){Ie("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}R.setEffects(E||[])},this.getCurrentViewport=function(E){return E.copy(ne)},this.getViewport=function(E){return E.copy(Le)},this.setViewport=function(E,O,q,G){E.isVector4?Le.set(E.x,E.y,E.z,E.w):Le.set(E,O,q,G),x.viewport(ne.copy(Le).multiplyScalar(re).round())},this.getScissor=function(E){return E.copy(Et)},this.setScissor=function(E,O,q,G){E.isVector4?Et.set(E.x,E.y,E.z,E.w):Et.set(E,O,q,G),x.scissor(K.copy(Et).multiplyScalar(re).round())},this.getScissorTest=function(){return Ve},this.setScissorTest=function(E){x.setScissorTest(Ve=E)},this.setOpaqueSort=function(E){Ee=E},this.setTransparentSort=function(E){Ne=E},this.getClearColor=function(E){return E.copy(Fe.getClearColor())},this.setClearColor=function(){Fe.setClearColor(...arguments)},this.getClearAlpha=function(){return Fe.getClearAlpha()},this.setClearAlpha=function(){Fe.setClearAlpha(...arguments)},this.clear=function(E=!0,O=!0,q=!0){let G=0;if(E){let W=!1;if(U!==null){const ge=U.texture.format;W=m.has(ge)}if(W){const ge=U.texture.type,ye=f.has(ge),me=Fe.getClearColor(),Te=Fe.getClearAlpha(),Ce=me.r,Oe=me.g,Be=me.b;ye?(g[0]=Ce,g[1]=Oe,g[2]=Be,g[3]=Te,F.clearBufferuiv(F.COLOR,0,g)):(S[0]=Ce,S[1]=Oe,S[2]=Be,S[3]=Te,F.clearBufferiv(F.COLOR,0,S))}else G|=F.COLOR_BUFFER_BIT}O&&(G|=F.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),q&&(G|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),G!==0&&F.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(E){E.setRenderer(this),L=E},this.dispose=function(){n.removeEventListener("webglcontextlost",xt,!1),n.removeEventListener("webglcontextrestored",lt,!1),n.removeEventListener("webglcontextcreationerror",jn,!1),Fe.dispose(),he.dispose(),de.dispose(),X.dispose(),oe.dispose(),ee.dispose(),_e.dispose(),te.dispose(),ue.dispose(),Me.dispose(),Me.removeEventListener("sessionstart",gh),Me.removeEventListener("sessionend",vh),vr.stop()};function xt(E){E.preventDefault(),$p("WebGLRenderer: Context Lost."),P=!0}function lt(){$p("WebGLRenderer: Context Restored."),P=!1;const E=B.autoReset,O=De.enabled,q=De.autoUpdate,G=De.needsUpdate,W=De.type;we(),B.autoReset=E,De.enabled=O,De.autoUpdate=q,De.needsUpdate=G,De.type=W}function jn(E){$e("WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function ei(E){const O=E.target;O.removeEventListener("dispose",ei),Ov(O)}function Ov(E){kv(E),X.remove(E)}function kv(E){const O=X.get(E).programs;O!==void 0&&(O.forEach(function(q){ue.releaseProgram(q)}),E.isShaderMaterial&&ue.releaseShaderCache(E))}this.renderBufferDirect=function(E,O,q,G,W,ge){O===null&&(O=Ht);const ye=W.isMesh&&W.matrixWorld.determinantAffine()<0,me=Vv(E,O,q,G,W);x.setMaterial(G,ye);let Te=q.index,Ce=1;if(G.wireframe===!0){if(Te=Q.getWireframeAttribute(q),Te===void 0)return;Ce=2}const Oe=q.drawRange,Be=q.attributes.position;let be=Oe.start*Ce,rt=(Oe.start+Oe.count)*Ce;ge!==null&&(be=Math.max(be,ge.start*Ce),rt=Math.min(rt,(ge.start+ge.count)*Ce)),Te!==null?(be=Math.max(be,0),rt=Math.min(rt,Te.count)):Be!=null&&(be=Math.max(be,0),rt=Math.min(rt,Be.count));const Tt=rt-be;if(Tt<0||Tt===1/0)return;_e.setup(W,G,me,q,Te);let yt,ot=ae;if(Te!==null&&(yt=ce.get(Te),ot=j,ot.setIndex(yt)),W.isMesh)G.wireframe===!0?(x.setLineWidth(G.wireframeLinewidth*bt()),ot.setMode(F.LINES)):ot.setMode(F.TRIANGLES);else if(W.isLine){let qt=G.linewidth;qt===void 0&&(qt=1),x.setLineWidth(qt*bt()),W.isLineSegments?ot.setMode(F.LINES):W.isLineLoop?ot.setMode(F.LINE_LOOP):ot.setMode(F.LINE_STRIP)}else W.isPoints?ot.setMode(F.POINTS):W.isSprite&&ot.setMode(F.TRIANGLES);if(W.isBatchedMesh)if(je.get("WEBGL_multi_draw"))ot.renderMultiDraw(W._multiDrawStarts,W._multiDrawCounts,W._multiDrawCount);else{const qt=W._multiDrawStarts,xe=W._multiDrawCounts,xn=W._multiDrawCount,Ye=Te?ce.get(Te).bytesPerElement:1,Pn=X.get(G).currentProgram.getUniforms();for(let ti=0;ti<xn;ti++)Pn.setValue(F,"_gl_DrawID",ti),ot.render(qt[ti]/Ye,xe[ti])}else if(W.isInstancedMesh)ot.renderInstances(be,Tt,W.count);else if(q.isInstancedBufferGeometry){const qt=q._maxInstanceCount!==void 0?q._maxInstanceCount:1/0,xe=Math.min(q.instanceCount,qt);ot.renderInstances(be,Tt,xe)}else ot.render(be,Tt)};function mh(E,O,q){E.transparent===!0&&E.side===En&&E.forceSinglePass===!1?(E.side=_n,E.needsUpdate=!0,ra(E,O,q),E.side=hr,E.needsUpdate=!0,ra(E,O,q),E.side=En):ra(E,O,q)}this.compile=function(E,O,q=null){q===null&&(q=E),w=de.get(q),w.init(O),_.push(w),q.traverseVisible(function(W){W.isLight&&W.layers.test(O.layers)&&(w.pushLight(W),W.castShadow&&w.pushShadow(W))}),E!==q&&E.traverseVisible(function(W){W.isLight&&W.layers.test(O.layers)&&(w.pushLight(W),W.castShadow&&w.pushShadow(W))}),w.setupLights();const G=new Set;return E.traverse(function(W){if(!(W.isMesh||W.isPoints||W.isLine||W.isSprite))return;const ge=W.material;if(ge)if(Array.isArray(ge))for(let ye=0;ye<ge.length;ye++){const me=ge[ye];mh(me,q,W),G.add(me)}else mh(ge,q,W),G.add(ge)}),w=_.pop(),G},this.compileAsync=function(E,O,q=null){const G=this.compile(E,O,q);return new Promise(W=>{function ge(){if(G.forEach(function(ye){X.get(ye).currentProgram.isReady()&&G.delete(ye)}),G.size===0){W(E);return}setTimeout(ge,10)}je.get("KHR_parallel_shader_compile")!==null?ge():setTimeout(ge,10)})};let cc=null;function Bv(E){cc&&cc(E)}function gh(){vr.stop()}function vh(){vr.start()}const vr=new Cv;vr.setAnimationLoop(Bv),typeof self<"u"&&vr.setContext(self),this.setAnimationLoop=function(E){cc=E,Me.setAnimationLoop(E),E===null?vr.stop():vr.start()},Me.addEventListener("sessionstart",gh),Me.addEventListener("sessionend",vh),this.render=function(E,O){if(O!==void 0&&O.isCamera!==!0){$e("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;L!==null&&L.renderStart(E,O);const q=Me.enabled===!0&&Me.isPresenting===!0,G=R!==null&&(U===null||q)&&R.begin(T,U);if(E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),O.parent===null&&O.matrixWorldAutoUpdate===!0&&O.updateMatrixWorld(),Me.enabled===!0&&Me.isPresenting===!0&&(R===null||R.isCompositing()===!1)&&(Me.cameraAutoUpdate===!0&&Me.updateCamera(O),O=Me.getCamera()),E.isScene===!0&&E.onBeforeRender(T,E,O,U),w=de.get(E,_.length),w.init(O),w.state.textureUnits=Z.getTextureUnits(),_.push(w),Ct.multiplyMatrices(O.projectionMatrix,O.matrixWorldInverse),st.setFromProjectionMatrix(Ct,ci,O.reversedDepth),Xe=this.localClippingEnabled,Ze=Pe.init(this.clippingPlanes,Xe),A=he.get(E,C.length),A.init(),C.push(A),Me.enabled===!0&&Me.isPresenting===!0){const ye=T.xr.getDepthSensingMesh();ye!==null&&uc(ye,O,-1/0,T.sortObjects)}uc(E,O,0,T.sortObjects),A.finish(),T.sortObjects===!0&&A.sort(Ee,Ne,O.reversedDepth),_t=Me.enabled===!1||Me.isPresenting===!1||Me.hasDepthSensing()===!1,_t&&Fe.addToRenderList(A,E),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Ze===!0&&Pe.beginShadows();const W=w.state.shadowsArray;if(De.render(W,E,O),Ze===!0&&Pe.endShadows(),(G&&R.hasRenderPass())===!1){const ye=A.opaque,me=A.transmissive;if(w.setupLights(),O.isArrayCamera){const Te=O.cameras;if(me.length>0)for(let Ce=0,Oe=Te.length;Ce<Oe;Ce++){const Be=Te[Ce];xh(ye,me,E,Be)}_t&&Fe.render(E);for(let Ce=0,Oe=Te.length;Ce<Oe;Ce++){const Be=Te[Ce];_h(A,E,Be,Be.viewport)}}else me.length>0&&xh(ye,me,E,O),_t&&Fe.render(E),_h(A,E,O)}U!==null&&k===0&&(Z.updateMultisampleRenderTarget(U),Z.updateRenderTargetMipmap(U)),G&&R.end(T),E.isScene===!0&&E.onAfterRender(T,E,O),_e.resetDefaultState(),$=-1,J=null,_.pop(),_.length>0?(w=_[_.length-1],Z.setTextureUnits(w.state.textureUnits),Ze===!0&&Pe.setGlobalState(T.clippingPlanes,w.state.camera)):w=null,C.pop(),C.length>0?A=C[C.length-1]:A=null,L!==null&&L.renderEnd()};function uc(E,O,q,G){if(E.visible===!1)return;if(E.layers.test(O.layers)){if(E.isGroup)q=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(O);else if(E.isLightProbeGrid)w.pushLightProbeGrid(E);else if(E.isLight)w.pushLight(E),E.castShadow&&w.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||st.intersectsSprite(E)){G&&kt.setFromMatrixPosition(E.matrixWorld).applyMatrix4(Ct);const ye=ee.update(E),me=E.material;me.visible&&A.push(E,ye,me,q,kt.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||st.intersectsObject(E))){const ye=ee.update(E),me=E.material;if(G&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),kt.copy(E.boundingSphere.center)):(ye.boundingSphere===null&&ye.computeBoundingSphere(),kt.copy(ye.boundingSphere.center)),kt.applyMatrix4(E.matrixWorld).applyMatrix4(Ct)),Array.isArray(me)){const Te=ye.groups;for(let Ce=0,Oe=Te.length;Ce<Oe;Ce++){const Be=Te[Ce],be=me[Be.materialIndex];be&&be.visible&&A.push(E,ye,be,q,kt.z,Be)}}else me.visible&&A.push(E,ye,me,q,kt.z,null)}}const ge=E.children;for(let ye=0,me=ge.length;ye<me;ye++)uc(ge[ye],O,q,G)}function _h(E,O,q,G){const{opaque:W,transmissive:ge,transparent:ye}=E;w.setupLightsView(q),Ze===!0&&Pe.setGlobalState(T.clippingPlanes,q),G&&x.viewport(ne.copy(G)),W.length>0&&ia(W,O,q),ge.length>0&&ia(ge,O,q),ye.length>0&&ia(ye,O,q),x.buffers.depth.setTest(!0),x.buffers.depth.setMask(!0),x.buffers.color.setMask(!0),x.setPolygonOffset(!1)}function xh(E,O,q,G){if((q.isScene===!0?q.overrideMaterial:null)!==null)return;if(w.state.transmissionRenderTarget[G.id]===void 0){const be=je.has("EXT_color_buffer_half_float")||je.has("EXT_color_buffer_float");w.state.transmissionRenderTarget[G.id]=new hi(1,1,{generateMipmaps:!0,type:be?Ui:Nn,minFilter:Lr,samples:Math.max(4,b.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ge.workingColorSpace})}const ge=w.state.transmissionRenderTarget[G.id],ye=G.viewport||ne;ge.setSize(ye.z*T.transmissionResolutionScale,ye.w*T.transmissionResolutionScale);const me=T.getRenderTarget(),Te=T.getActiveCubeFace(),Ce=T.getActiveMipmapLevel();T.setRenderTarget(ge),T.getClearColor(Ae),ve=T.getClearAlpha(),ve<1&&T.setClearColor(16777215,.5),T.clear(),_t&&Fe.render(q);const Oe=T.toneMapping;T.toneMapping=fi;const Be=G.viewport;if(G.viewport!==void 0&&(G.viewport=void 0),w.setupLightsView(G),Ze===!0&&Pe.setGlobalState(T.clippingPlanes,G),ia(E,q,G),Z.updateMultisampleRenderTarget(ge),Z.updateRenderTargetMipmap(ge),je.has("WEBGL_multisampled_render_to_texture")===!1){let be=!1;for(let rt=0,Tt=O.length;rt<Tt;rt++){const yt=O[rt],{object:ot,geometry:qt,material:xe,group:xn}=yt;if(xe.side===En&&ot.layers.test(G.layers)){const Ye=xe.side;xe.side=_n,xe.needsUpdate=!0,yh(ot,q,G,qt,xe,xn),xe.side=Ye,xe.needsUpdate=!0,be=!0}}be===!0&&(Z.updateMultisampleRenderTarget(ge),Z.updateRenderTargetMipmap(ge))}T.setRenderTarget(me,Te,Ce),T.setClearColor(Ae,ve),Be!==void 0&&(G.viewport=Be),T.toneMapping=Oe}function ia(E,O,q){const G=O.isScene===!0?O.overrideMaterial:null;for(let W=0,ge=E.length;W<ge;W++){const ye=E[W],{object:me,geometry:Te,group:Ce}=ye;let Oe=ye.material;Oe.allowOverride===!0&&G!==null&&(Oe=G),me.layers.test(q.layers)&&yh(me,O,q,Te,Oe,Ce)}}function yh(E,O,q,G,W,ge){E.onBeforeRender(T,O,q,G,W,ge),E.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),W.onBeforeRender(T,O,q,G,E,ge),W.transparent===!0&&W.side===En&&W.forceSinglePass===!1?(W.side=_n,W.needsUpdate=!0,T.renderBufferDirect(q,O,G,W,E,ge),W.side=hr,W.needsUpdate=!0,T.renderBufferDirect(q,O,G,W,E,ge),W.side=En):T.renderBufferDirect(q,O,G,W,E,ge),E.onAfterRender(T,O,q,G,W,ge)}function ra(E,O,q){O.isScene!==!0&&(O=Ht);const G=X.get(E),W=w.state.lights,ge=w.state.shadowsArray,ye=W.state.version,me=ue.getParameters(E,W.state,ge,O,q,w.state.lightProbeGridArray),Te=ue.getProgramCacheKey(me);let Ce=G.programs;G.environment=E.isMeshStandardMaterial||E.isMeshLambertMaterial||E.isMeshPhongMaterial?O.environment:null,G.fog=O.fog;const Oe=E.isMeshStandardMaterial||E.isMeshLambertMaterial&&!E.envMap||E.isMeshPhongMaterial&&!E.envMap;G.envMap=oe.get(E.envMap||G.environment,Oe),G.envMapRotation=G.environment!==null&&E.envMap===null?O.environmentRotation:E.envMapRotation,Ce===void 0&&(E.addEventListener("dispose",ei),Ce=new Map,G.programs=Ce);let Be=Ce.get(Te);if(Be!==void 0){if(G.currentProgram===Be&&G.lightsStateVersion===ye)return Mh(E,me),Be}else me.uniforms=ue.getUniforms(E),L!==null&&E.isNodeMaterial&&L.build(E,q,me),E.onBeforeCompile(me,T),Be=ue.acquireProgram(me,Te),Ce.set(Te,Be),G.uniforms=me.uniforms;const be=G.uniforms;return(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(be.clippingPlanes=Pe.uniform),Mh(E,me),G.needsLights=Gv(E),G.lightsStateVersion=ye,G.needsLights&&(be.ambientLightColor.value=W.state.ambient,be.lightProbe.value=W.state.probe,be.directionalLights.value=W.state.directional,be.directionalLightShadows.value=W.state.directionalShadow,be.spotLights.value=W.state.spot,be.spotLightShadows.value=W.state.spotShadow,be.rectAreaLights.value=W.state.rectArea,be.ltc_1.value=W.state.rectAreaLTC1,be.ltc_2.value=W.state.rectAreaLTC2,be.pointLights.value=W.state.point,be.pointLightShadows.value=W.state.pointShadow,be.hemisphereLights.value=W.state.hemi,be.directionalShadowMatrix.value=W.state.directionalShadowMatrix,be.spotLightMatrix.value=W.state.spotLightMatrix,be.spotLightMap.value=W.state.spotLightMap,be.pointShadowMatrix.value=W.state.pointShadowMatrix),G.lightProbeGrid=w.state.lightProbeGridArray.length>0,G.currentProgram=Be,G.uniformsList=null,Be}function Sh(E){if(E.uniformsList===null){const O=E.currentProgram.getUniforms();E.uniformsList=cl.seqWithValue(O.seq,E.uniforms)}return E.uniformsList}function Mh(E,O){const q=X.get(E);q.outputColorSpace=O.outputColorSpace,q.batching=O.batching,q.batchingColor=O.batchingColor,q.instancing=O.instancing,q.instancingColor=O.instancingColor,q.instancingMorph=O.instancingMorph,q.skinning=O.skinning,q.morphTargets=O.morphTargets,q.morphNormals=O.morphNormals,q.morphColors=O.morphColors,q.morphTargetsCount=O.morphTargetsCount,q.numClippingPlanes=O.numClippingPlanes,q.numIntersection=O.numClipIntersection,q.vertexAlphas=O.vertexAlphas,q.vertexTangents=O.vertexTangents,q.toneMapping=O.toneMapping}function zv(E,O){if(E.length===0)return null;if(E.length===1)return E[0].texture!==null?E[0]:null;y.setFromMatrixPosition(O.matrixWorld);for(let q=0,G=E.length;q<G;q++){const W=E[q];if(W.texture!==null&&W.boundingBox.containsPoint(y))return W}return null}function Vv(E,O,q,G,W){O.isScene!==!0&&(O=Ht),Z.resetTextureUnits();const ge=O.fog,ye=G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial?O.environment:null,me=U===null?T.outputColorSpace:U.isXRRenderTarget===!0?U.texture.colorSpace:Ge.workingColorSpace,Te=G.isMeshStandardMaterial||G.isMeshLambertMaterial&&!G.envMap||G.isMeshPhongMaterial&&!G.envMap,Ce=oe.get(G.envMap||ye,Te),Oe=G.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,Be=!!q.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),be=!!q.morphAttributes.position,rt=!!q.morphAttributes.normal,Tt=!!q.morphAttributes.color;let yt=fi;G.toneMapped&&(U===null||U.isXRRenderTarget===!0)&&(yt=T.toneMapping);const ot=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,qt=ot!==void 0?ot.length:0,xe=X.get(G),xn=w.state.lights;if(Ze===!0&&(Xe===!0||E!==J)){const ct=E===J&&G.id===$;Pe.setState(G,E,ct)}let Ye=!1;G.version===xe.__version?(xe.needsLights&&xe.lightsStateVersion!==xn.state.version||xe.outputColorSpace!==me||W.isBatchedMesh&&xe.batching===!1||!W.isBatchedMesh&&xe.batching===!0||W.isBatchedMesh&&xe.batchingColor===!0&&W.colorTexture===null||W.isBatchedMesh&&xe.batchingColor===!1&&W.colorTexture!==null||W.isInstancedMesh&&xe.instancing===!1||!W.isInstancedMesh&&xe.instancing===!0||W.isSkinnedMesh&&xe.skinning===!1||!W.isSkinnedMesh&&xe.skinning===!0||W.isInstancedMesh&&xe.instancingColor===!0&&W.instanceColor===null||W.isInstancedMesh&&xe.instancingColor===!1&&W.instanceColor!==null||W.isInstancedMesh&&xe.instancingMorph===!0&&W.morphTexture===null||W.isInstancedMesh&&xe.instancingMorph===!1&&W.morphTexture!==null||xe.envMap!==Ce||G.fog===!0&&xe.fog!==ge||xe.numClippingPlanes!==void 0&&(xe.numClippingPlanes!==Pe.numPlanes||xe.numIntersection!==Pe.numIntersection)||xe.vertexAlphas!==Oe||xe.vertexTangents!==Be||xe.morphTargets!==be||xe.morphNormals!==rt||xe.morphColors!==Tt||xe.toneMapping!==yt||xe.morphTargetsCount!==qt||!!xe.lightProbeGrid!=w.state.lightProbeGridArray.length>0)&&(Ye=!0):(Ye=!0,xe.__version=G.version);let Pn=xe.currentProgram;Ye===!0&&(Pn=ra(G,O,W),L&&G.isNodeMaterial&&L.onUpdateProgram(G,Pn,xe));let ti=!1,Bi=!1,$r=!1;const at=Pn.getUniforms(),wt=xe.uniforms;if(x.useProgram(Pn.program)&&(ti=!0,Bi=!0,$r=!0),G.id!==$&&($=G.id,Bi=!0),xe.needsLights){const ct=zv(w.state.lightProbeGridArray,W);xe.lightProbeGrid!==ct&&(xe.lightProbeGrid=ct,Bi=!0)}if(ti||J!==E){x.buffers.depth.getReversed()&&E.reversedDepth!==!0&&(E._reversedDepth=!0,E.updateProjectionMatrix()),at.setValue(F,"projectionMatrix",E.projectionMatrix),at.setValue(F,"viewMatrix",E.matrixWorldInverse);const Vi=at.map.cameraPosition;Vi!==void 0&&Vi.setValue(F,It.setFromMatrixPosition(E.matrixWorld)),b.logarithmicDepthBuffer&&at.setValue(F,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&at.setValue(F,"isOrthographic",E.isOrthographicCamera===!0),J!==E&&(J=E,Bi=!0,$r=!0)}if(xe.needsLights&&(xn.state.directionalShadowMap.length>0&&at.setValue(F,"directionalShadowMap",xn.state.directionalShadowMap,Z),xn.state.spotShadowMap.length>0&&at.setValue(F,"spotShadowMap",xn.state.spotShadowMap,Z),xn.state.pointShadowMap.length>0&&at.setValue(F,"pointShadowMap",xn.state.pointShadowMap,Z)),W.isSkinnedMesh){at.setOptional(F,W,"bindMatrix"),at.setOptional(F,W,"bindMatrixInverse");const ct=W.skeleton;ct&&(ct.boneTexture===null&&ct.computeBoneTexture(),at.setValue(F,"boneTexture",ct.boneTexture,Z))}W.isBatchedMesh&&(at.setOptional(F,W,"batchingTexture"),at.setValue(F,"batchingTexture",W._matricesTexture,Z),at.setOptional(F,W,"batchingIdTexture"),at.setValue(F,"batchingIdTexture",W._indirectTexture,Z),at.setOptional(F,W,"batchingColorTexture"),W._colorsTexture!==null&&at.setValue(F,"batchingColorTexture",W._colorsTexture,Z));const zi=q.morphAttributes;if((zi.position!==void 0||zi.normal!==void 0||zi.color!==void 0)&&N.update(W,q,Pn),(Bi||xe.receiveShadow!==W.receiveShadow)&&(xe.receiveShadow=W.receiveShadow,at.setValue(F,"receiveShadow",W.receiveShadow)),(G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial)&&G.envMap===null&&O.environment!==null&&(wt.envMapIntensity.value=O.environmentIntensity),wt.dfgLUT!==void 0&&(wt.dfgLUT.value=Ww()),Bi){if(at.setValue(F,"toneMappingExposure",T.toneMappingExposure),xe.needsLights&&Hv(wt,$r),ge&&G.fog===!0&&Re.refreshFogUniforms(wt,ge),Re.refreshMaterialUniforms(wt,G,re,ie,w.state.transmissionRenderTarget[E.id]),xe.needsLights&&xe.lightProbeGrid){const ct=xe.lightProbeGrid;wt.probesSH.value=ct.texture,wt.probesMin.value.copy(ct.boundingBox.min),wt.probesMax.value.copy(ct.boundingBox.max),wt.probesResolution.value.copy(ct.resolution)}cl.upload(F,Sh(xe),wt,Z)}if(G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(cl.upload(F,Sh(xe),wt,Z),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&at.setValue(F,"center",W.center),at.setValue(F,"modelViewMatrix",W.modelViewMatrix),at.setValue(F,"normalMatrix",W.normalMatrix),at.setValue(F,"modelMatrix",W.matrixWorld),G.uniformsGroups!==void 0){const ct=G.uniformsGroups;for(let Vi=0,qr=ct.length;Vi<qr;Vi++){const Eh=ct[Vi];te.update(Eh,Pn),te.bind(Eh,Pn)}}return Pn}function Hv(E,O){E.ambientLightColor.needsUpdate=O,E.lightProbe.needsUpdate=O,E.directionalLights.needsUpdate=O,E.directionalLightShadows.needsUpdate=O,E.pointLights.needsUpdate=O,E.pointLightShadows.needsUpdate=O,E.spotLights.needsUpdate=O,E.spotLightShadows.needsUpdate=O,E.rectAreaLights.needsUpdate=O,E.hemisphereLights.needsUpdate=O}function Gv(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return V},this.getActiveMipmapLevel=function(){return k},this.getRenderTarget=function(){return U},this.setRenderTargetTextures=function(E,O,q){const G=X.get(E);G.__autoAllocateDepthBuffer=E.resolveDepthBuffer===!1,G.__autoAllocateDepthBuffer===!1&&(G.__useRenderToTexture=!1),X.get(E.texture).__webglTexture=O,X.get(E.depthTexture).__webglTexture=G.__autoAllocateDepthBuffer?void 0:q,G.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(E,O){const q=X.get(E);q.__webglFramebuffer=O,q.__useDefaultFramebuffer=O===void 0},this.setRenderTarget=function(E,O=0,q=0){U=E,V=O,k=q;let G=null,W=!1,ge=!1;if(E){const me=X.get(E);if(me.__useDefaultFramebuffer!==void 0){x.bindFramebuffer(F.FRAMEBUFFER,me.__webglFramebuffer),ne.copy(E.viewport),K.copy(E.scissor),le=E.scissorTest,x.viewport(ne),x.scissor(K),x.setScissorTest(le),$=-1;return}else if(me.__webglFramebuffer===void 0)Z.setupRenderTarget(E);else if(me.__hasExternalTextures)Z.rebindTextures(E,X.get(E.texture).__webglTexture,X.get(E.depthTexture).__webglTexture);else if(E.depthBuffer){const Oe=E.depthTexture;if(me.__boundDepthTexture!==Oe){if(Oe!==null&&X.has(Oe)&&(E.width!==Oe.image.width||E.height!==Oe.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");Z.setupDepthRenderbuffer(E)}}const Te=E.texture;(Te.isData3DTexture||Te.isDataArrayTexture||Te.isCompressedArrayTexture)&&(ge=!0);const Ce=X.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(Ce[O])?G=Ce[O][q]:G=Ce[O],W=!0):E.samples>0&&Z.useMultisampledRTT(E)===!1?G=X.get(E).__webglMultisampledFramebuffer:Array.isArray(Ce)?G=Ce[q]:G=Ce,ne.copy(E.viewport),K.copy(E.scissor),le=E.scissorTest}else ne.copy(Le).multiplyScalar(re).floor(),K.copy(Et).multiplyScalar(re).floor(),le=Ve;if(q!==0&&(G=D),x.bindFramebuffer(F.FRAMEBUFFER,G)&&x.drawBuffers(E,G),x.viewport(ne),x.scissor(K),x.setScissorTest(le),W){const me=X.get(E.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+O,me.__webglTexture,q)}else if(ge){const me=O;for(let Te=0;Te<E.textures.length;Te++){const Ce=X.get(E.textures[Te]);F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0+Te,Ce.__webglTexture,q,me)}}else if(E!==null&&q!==0){const me=X.get(E.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,me.__webglTexture,q)}$=-1},this.readRenderTargetPixels=function(E,O,q,G,W,ge,ye,me=0){if(!(E&&E.isWebGLRenderTarget)){$e("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Te=X.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&ye!==void 0&&(Te=Te[ye]),Te){x.bindFramebuffer(F.FRAMEBUFFER,Te);try{const Ce=E.textures[me],Oe=Ce.format,Be=Ce.type;if(E.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+me),!b.textureFormatReadable(Oe)){$e("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!b.textureTypeReadable(Be)){$e("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}O>=0&&O<=E.width-G&&q>=0&&q<=E.height-W&&F.readPixels(O,q,G,W,fe.convert(Oe),fe.convert(Be),ge)}finally{const Ce=U!==null?X.get(U).__webglFramebuffer:null;x.bindFramebuffer(F.FRAMEBUFFER,Ce)}}},this.readRenderTargetPixelsAsync=async function(E,O,q,G,W,ge,ye,me=0){if(!(E&&E.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Te=X.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&ye!==void 0&&(Te=Te[ye]),Te)if(O>=0&&O<=E.width-G&&q>=0&&q<=E.height-W){x.bindFramebuffer(F.FRAMEBUFFER,Te);const Ce=E.textures[me],Oe=Ce.format,Be=Ce.type;if(E.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+me),!b.textureFormatReadable(Oe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!b.textureTypeReadable(Be))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const be=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,be),F.bufferData(F.PIXEL_PACK_BUFFER,ge.byteLength,F.STREAM_READ),F.readPixels(O,q,G,W,fe.convert(Oe),fe.convert(Be),0);const rt=U!==null?X.get(U).__webglFramebuffer:null;x.bindFramebuffer(F.FRAMEBUFFER,rt);const Tt=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await pS(F,Tt,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,be),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,ge),F.deleteBuffer(be),F.deleteSync(Tt),ge}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(E,O=null,q=0){const G=Math.pow(2,-q),W=Math.floor(E.image.width*G),ge=Math.floor(E.image.height*G),ye=O!==null?O.x:0,me=O!==null?O.y:0;Z.setTexture2D(E,0),F.copyTexSubImage2D(F.TEXTURE_2D,q,0,0,ye,me,W,ge),x.unbindTexture()},this.copyTextureToTexture=function(E,O,q=null,G=null,W=0,ge=0){let ye,me,Te,Ce,Oe,Be,be,rt,Tt;const yt=E.isCompressedTexture?E.mipmaps[ge]:E.image;if(q!==null)ye=q.max.x-q.min.x,me=q.max.y-q.min.y,Te=q.isBox3?q.max.z-q.min.z:1,Ce=q.min.x,Oe=q.min.y,Be=q.isBox3?q.min.z:0;else{const wt=Math.pow(2,-W);ye=Math.floor(yt.width*wt),me=Math.floor(yt.height*wt),E.isDataArrayTexture?Te=yt.depth:E.isData3DTexture?Te=Math.floor(yt.depth*wt):Te=1,Ce=0,Oe=0,Be=0}G!==null?(be=G.x,rt=G.y,Tt=G.z):(be=0,rt=0,Tt=0);const ot=fe.convert(O.format),qt=fe.convert(O.type);let xe;O.isData3DTexture?(Z.setTexture3D(O,0),xe=F.TEXTURE_3D):O.isDataArrayTexture||O.isCompressedArrayTexture?(Z.setTexture2DArray(O,0),xe=F.TEXTURE_2D_ARRAY):(Z.setTexture2D(O,0),xe=F.TEXTURE_2D),x.activeTexture(F.TEXTURE0),x.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,O.flipY),x.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),x.pixelStorei(F.UNPACK_ALIGNMENT,O.unpackAlignment);const xn=x.getParameter(F.UNPACK_ROW_LENGTH),Ye=x.getParameter(F.UNPACK_IMAGE_HEIGHT),Pn=x.getParameter(F.UNPACK_SKIP_PIXELS),ti=x.getParameter(F.UNPACK_SKIP_ROWS),Bi=x.getParameter(F.UNPACK_SKIP_IMAGES);x.pixelStorei(F.UNPACK_ROW_LENGTH,yt.width),x.pixelStorei(F.UNPACK_IMAGE_HEIGHT,yt.height),x.pixelStorei(F.UNPACK_SKIP_PIXELS,Ce),x.pixelStorei(F.UNPACK_SKIP_ROWS,Oe),x.pixelStorei(F.UNPACK_SKIP_IMAGES,Be);const $r=E.isDataArrayTexture||E.isData3DTexture,at=O.isDataArrayTexture||O.isData3DTexture;if(E.isDepthTexture){const wt=X.get(E),zi=X.get(O),ct=X.get(wt.__renderTarget),Vi=X.get(zi.__renderTarget);x.bindFramebuffer(F.READ_FRAMEBUFFER,ct.__webglFramebuffer),x.bindFramebuffer(F.DRAW_FRAMEBUFFER,Vi.__webglFramebuffer);for(let qr=0;qr<Te;qr++)$r&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,X.get(E).__webglTexture,W,Be+qr),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,X.get(O).__webglTexture,ge,Tt+qr)),F.blitFramebuffer(Ce,Oe,ye,me,be,rt,ye,me,F.DEPTH_BUFFER_BIT,F.NEAREST);x.bindFramebuffer(F.READ_FRAMEBUFFER,null),x.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(W!==0||E.isRenderTargetTexture||X.has(E)){const wt=X.get(E),zi=X.get(O);x.bindFramebuffer(F.READ_FRAMEBUFFER,z),x.bindFramebuffer(F.DRAW_FRAMEBUFFER,I);for(let ct=0;ct<Te;ct++)$r?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,wt.__webglTexture,W,Be+ct):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,wt.__webglTexture,W),at?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,zi.__webglTexture,ge,Tt+ct):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,zi.__webglTexture,ge),W!==0?F.blitFramebuffer(Ce,Oe,ye,me,be,rt,ye,me,F.COLOR_BUFFER_BIT,F.NEAREST):at?F.copyTexSubImage3D(xe,ge,be,rt,Tt+ct,Ce,Oe,ye,me):F.copyTexSubImage2D(xe,ge,be,rt,Ce,Oe,ye,me);x.bindFramebuffer(F.READ_FRAMEBUFFER,null),x.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else at?E.isDataTexture||E.isData3DTexture?F.texSubImage3D(xe,ge,be,rt,Tt,ye,me,Te,ot,qt,yt.data):O.isCompressedArrayTexture?F.compressedTexSubImage3D(xe,ge,be,rt,Tt,ye,me,Te,ot,yt.data):F.texSubImage3D(xe,ge,be,rt,Tt,ye,me,Te,ot,qt,yt):E.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,ge,be,rt,ye,me,ot,qt,yt.data):E.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,ge,be,rt,yt.width,yt.height,ot,yt.data):F.texSubImage2D(F.TEXTURE_2D,ge,be,rt,ye,me,ot,qt,yt);x.pixelStorei(F.UNPACK_ROW_LENGTH,xn),x.pixelStorei(F.UNPACK_IMAGE_HEIGHT,Ye),x.pixelStorei(F.UNPACK_SKIP_PIXELS,Pn),x.pixelStorei(F.UNPACK_SKIP_ROWS,ti),x.pixelStorei(F.UNPACK_SKIP_IMAGES,Bi),ge===0&&O.generateMipmaps&&F.generateMipmap(xe),x.unbindTexture()},this.initRenderTarget=function(E){X.get(E).__webglFramebuffer===void 0&&Z.setupRenderTarget(E)},this.initTexture=function(E){E.isCubeTexture?Z.setTextureCube(E,0):E.isData3DTexture?Z.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?Z.setTexture2DArray(E,0):Z.setTexture2D(E,0),x.unbindTexture()},this.resetState=function(){V=0,k=0,U=null,x.reset(),_e.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ci}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=Ge._getDrawingBufferColorSpace(e),n.unpackColorSpace=Ge._getUnpackColorSpace()}}function Yw(t){const n=document.createElement("canvas");n.width=t.w*2,n.height=t.h*2;const i=n.getContext("2d");i.scale(2,2),i.clearRect(0,0,t.w,t.h),i.fillStyle=t.bg||"rgba(15, 23, 42, 0.65)",i.fillRect(0,0,t.w,t.h),i.strokeStyle="rgba(255, 255, 255, 0.22)",i.lineWidth=1,i.strokeRect(.5,.5,t.w-1,t.h-1);const r=i.createLinearGradient(0,1,t.w,1);r.addColorStop(0,"rgba(255, 255, 255, 0.35)"),r.addColorStop(.5,"rgba(255, 255, 255, 0.12)"),r.addColorStop(1,"rgba(255, 255, 255, 0.35)"),i.strokeStyle=r,i.beginPath(),i.moveTo(1,1.5),i.lineTo(t.w-1,1.5),i.stroke();const s=6,o=t.w-s*2;let a=t.fontSize??22;const l=(C,_,R)=>{i.font=`${R?"600":"400"} ${_}px Inter, system-ui, sans-serif`;const T=C.split(" "),P=[];let L="";for(const D of T){const z=L?L+" "+D:D;i.measureText(z).width>o&&L?(P.push(L),L=D):L=z}return L&&P.push(L),P};let c=l(t.text,a,!0);for(;a>7&&c.some(C=>i.measureText(C).width>o);)a-=.5,c=l(t.text,a,!0);const h=Math.max(7,a*.75),u=t.subtext?l(t.subtext,h,!1):[],d=a*1.15,p=h*1.15,v=t.subtext?2:0;let M=c.length*d+v+u.length*p;for(;a>7&&M>t.h-4;){a-=.5;const C=l(t.text,a,!0),_=Math.max(7,a*.75),R=t.subtext?l(t.subtext,_,!1):[];M=C.length*(a*1.15)+v+R.length*(_*1.15)}const m=l(t.text,a,!0),f=Math.max(7,a*.75),g=t.subtext?l(t.subtext,f,!1):[];let S=Math.max(2,(t.h-M)/2);i.textBaseline="top";const y=t.align??(t.subtext?"left":"center");i.textAlign=y==="center"?"center":"left";const A=y==="center"?t.w/2:s;i.fillStyle=t.fg,i.font=`600 ${a}px Inter, system-ui, sans-serif`;for(const C of m)i.fillText(C,A,S),S+=a*1.15;if(g.length>0){S+=v,i.fillStyle=t.accent??"#f59e0b",i.font=`400 ${f}px Inter, system-ui, sans-serif`;for(const C of g)i.fillText(C,A,S),S+=f*1.15}t.icon&&(i.font=`${a*1.2}px Inter, system-ui, sans-serif`,i.textAlign="right",i.textBaseline="middle",i.fillStyle=t.accent??t.fg,i.fillText(t.icon,t.w-s,t.h/2));const w=new oc(n);return w.colorSpace=Wt,w}async function $w(t){const n=document.createElement("canvas");n.width=t.w*2,n.height=t.h*2;const i=n.getContext("2d");i.scale(2,2);const r=i.createLinearGradient(0,0,t.w,t.h);if(r.addColorStop(0,"#1a2a4a"),r.addColorStop(1,"#0a1120"),i.fillStyle=r,i.fillRect(0,0,t.w,t.h),t.imageUrl)try{const h=await Fv(t.imageUrl),u=h.width/h.height,d=t.w/t.h;let p=t.w,v=t.h,M=0,m=0;u>d?(v=t.h,p=v*u,M=(t.w-p)/2):(p=t.w,v=p/u,m=(t.h-v)/2),i.drawImage(h,M,m,p,v)}catch{Fm(i,t)}else Fm(i,t);const s=i.createLinearGradient(0,0,0,t.h*.25);if(s.addColorStop(0,"rgba(5,10,20,0.75)"),s.addColorStop(1,"rgba(5,10,20,0)"),i.fillStyle=s,i.fillRect(0,0,t.w,t.h*.25),t.rating>0){const h=`★ ${t.rating.toFixed(1)}`;i.font="700 10px Inter, system-ui, sans-serif";const u=i.measureText(h).width+10,d=18,p=t.w-u-5;i.fillStyle="rgba(245, 158, 11, 0.95)",i.fillRect(p,5,u,d),i.strokeStyle="rgba(255, 255, 255, 0.4)",i.strokeRect(p+.5,5.5,u-1,d-1),i.fillStyle="#0f172a",i.textAlign="center",i.textBaseline="middle",i.fillText(h,p+u/2,5+d/2)}const o=i.createLinearGradient(0,t.h*.4,0,t.h);o.addColorStop(0,"rgba(5,10,20,0)"),o.addColorStop(1,"rgba(5,10,20,0.95)"),i.fillStyle=o,i.fillRect(0,t.h*.4,t.w,t.h*.6);let a=13;const l=t.w-16;for(i.font=`600 ${a}px Inter, system-ui, sans-serif`;a>9.5&&Zw(i,t.title,l)>2;)a-=.5,i.font=`600 ${a}px Inter, system-ui, sans-serif`;i.fillStyle="#f8fafc",i.font=`600 ${a}px Inter, system-ui, sans-serif`,Qw(i,t.title,8,t.h-10,l,a,3);const c=new oc(n);return c.colorSpace=Wt,c}function Fm(t,e){t.fillStyle="#f1f5f9",t.font="600 11px Inter, system-ui, sans-serif",t.textAlign="center",t.textBaseline="middle",ef(t,e.title,e.w/2,e.h/2-10,e.w-12,13,3)}async function qw(t){const n=document.createElement("canvas");n.width=t.w*2,n.height=t.h*2;const i=n.getContext("2d");i.scale(2,2);const r=i.createLinearGradient(0,0,t.w,t.h);if(r.addColorStop(0,"#0d1b2a"),r.addColorStop(1,"#050810"),i.fillStyle=r,i.fillRect(0,0,t.w,t.h),t.imageUrl)try{const l=await Fv(t.imageUrl),c=l.width/l.height,h=t.w/t.h;let u=t.w,d=t.h,p=0,v=0;c>h?(d=t.h,u=d*c,p=(t.w-u)/2):(u=t.w,d=u/c,v=(t.h-d)/2),i.drawImage(l,p,v,u,d)}catch{}const s=i.createLinearGradient(0,0,t.w,0);s.addColorStop(0,"rgba(5,8,16,0.88)"),s.addColorStop(.5,"rgba(5,8,16,0.5)"),s.addColorStop(1,"rgba(5,8,16,0.2)"),i.fillStyle=s,i.fillRect(0,0,t.w,t.h),i.fillStyle="#f8fafc",i.font="700 18px Inter, system-ui, sans-serif",i.textAlign="left",i.textBaseline="top",ef(i,t.title,20,16,t.w*.55,22,2);let o=62;t.metadata&&(i.fillStyle="#94a3b8",i.font="500 10px Inter, system-ui, sans-serif",i.fillText(t.metadata,20,o),o+=16),i.fillStyle="#cbd5e1",i.font="400 11px Inter, system-ui, sans-serif",ef(i,t.overview,20,o,t.w*.5,15,6);const a=new oc(n);return a.colorSpace=Wt,a}function Kw(t){const n=document.createElement("canvas");n.width=t.w*2,n.height=t.h*2;const i=n.getContext("2d");i.scale(2,2),i.clearRect(0,0,t.w,t.h),i.fillStyle="#f8fafc",i.font="700 24px Inter, system-ui, sans-serif",i.textAlign="left",i.textBaseline="middle",i.fillText(t.title,4,t.h/2);const r=new oc(n);return r.colorSpace=Wt,r}function Fv(t){return new Promise((e,n)=>{const i=new Image;i.crossOrigin="anonymous",i.onload=()=>e(i),i.onerror=n,i.src=t})}function Zw(t,e,n){const i=e.split(" ");let r="",s=0;for(const o of i){const a=r?r+" "+o:o;t.measureText(a).width>n&&r?(s++,r=o):r=a}return r&&s++,s}function Qw(t,e,n,i,r,s,o=3){const a=e.split(" ");let l="",c=[];for(const v of a){const M=l?l+" "+v:v;t.measureText(M).width>r&&l?(c.push(l),l=v):l=M}l&&c.push(l);const h=c.slice(0,o),u=s*1.2,d=h.length*u,p=Math.max(8,i-d);t.textBaseline="top",t.textAlign="left",t.font=`600 ${s}px Inter, system-ui, sans-serif`;for(let v=0;v<h.length;v++)t.fillText(h[v],n,p+v*u)}function ef(t,e,n,i,r,s,o){const a=e.split(" ");let l="",c=[];for(const u of a){const d=l?l+" "+u:u;t.measureText(d).width>r&&l?(c.push(l),l=u):l=d}l&&c.push(l);const h=c.slice(0,o);for(let u=0;u<h.length;u++)t.fillText(h[u],n,i+u*s)}const Jw=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
...
`;class eA{constructor(){this.startTime=performance.now(),this.scene=new Sv,this.camera=new lh,this.material=new Jn({vertexShader:Jw,fragmentShader:jw,uniforms:{iTime:{value:0},iResolution:{value:new Ke(window.innerWidth,window.innerHeight)}},depthTest:!1,depthWrite:!1});const e=new Ai(2,2),n=new pn(e,this.material);this.scene.add(n)}update(e,n){this.material.uniforms.iTime.value=(performance.now()-this.startTime)/1e3,this.material.uniforms.iResolution.value.set(e,n)}}const vu=0;class Om{constructor(e,n,i){this.raf=0,this.views=new Map,this.disposed=!1,this.screenW=0,this.screenH=0,this.lastTime=performance.now(),this.textureLoads=new Map,this.textureCache=new Map,this.container=e,this.layout=n,this.engine=i;const r=new Xw({antialias:!0,alpha:!0,powerPreference:"high-performance"});r.setPixelRatio(Math.min(window.devicePixelRatio,2)),r.setSize(window.innerWidth,window.innerHeight),r.shadowMap.enabled=!1,r.colorSpace=Wt,r.autoClear=!1,this.renderer=r,e.appendChild(r.domElement),this.resize(),this.bg=new eA;for(const s of this.layout.allPanels)this.buildPanelView(s);this.loop=this.loop.bind(this),this.raf=requestAnimationFrame(this.loop)}resize(){this.screenW=this.container.clientWidth||window.innerWidth,this.screenH=this.container.clientHeight||window.innerHeight,this.renderer.setSize(this.screenW,this.screenH)}buildPanelView(e){const n=new Sv,i=e.viewport,r=new ch(0,i.w,0,-i.h,-100,100);r.position.z=50,n.add(r);const s=new vo;n.add(s);const o=new Map,a=new Map,l=new Map,c=new Map,h=(u,d)=>{const{x:p,y:v,w:M,h:m}=u.bounds,f=p+M/2,g=-(v+m/2),S=u.content.kind,y=S==="poster"||S==="backdrop",A=new Ai(M,m),w=new Ms({color:u.color,transparent:!0,opacity:d?0:.92,side:En,depthWrite:!1});w.userData.loaded=!y;const C=new pn(A,w);if(C.position.set(f,g,vu),C.renderOrder=1,C.visible=!y,!d&&(S==="poster"||S==="backdrop"||S==="text"||S==="section")){const _=new Ai(M,m),R=new Ms({color:16096779,side:En,depthWrite:!1}),T=new pn(_,R);T.position.set(0,0,-.05),T.scale.set(0,0,1),T.renderOrder=0,T.visible=!y,C.add(T),l.set(u.id,T)}s.add(C),o.set(u.id,C),a.set(u.id,w),this.loadTileTexture(u,w,M,m)};for(const u of e.tiles)h(u,!!u.childPanel);this.views.set(e.id,{panel:e,scene:n,camera:r,contentGroup:s,tileMeshes:o,tileMaterials:a,tileBackMeshes:l,tileContentKeys:c})}updateLayout(e){this.layout=e,this.engine.updateLayout(e);const n=new Set(e.allPanels.map(i=>i.id));for(const[i,r]of this.views.entries())n.has(i)||(r.scene.traverse(s=>{s.geometry&&s.geometry.dispose(),s.material&&(Array.isArray(s.material)?s.material:[s.material]).forEach(a=>{a.map&&a.map.dispose(),a.dispose()})}),this.views.delete(i));for(const i of e.allPanels){const r=this.views.get(i.id);if(!r){this.buildPanelView(i);continue}const s=r.panel;i.scrollX=s.scrollX,i.scrollY=s.scrollY,i.targetScrollX=s.targetScrollX,i.targetScrollY=s.targetScrollY,r.panel=i;const o=new Set(i.tiles.map(a=>a.id));for(const[a,l]of r.tileMeshes.entries())if(!o.has(a)){r.contentGroup.remove(l),r.tileMeshes.delete(a);const c=r.tileMaterials.get(a);c&&(c.map&&c.map.dispose(),c.dispose()),r.tileMaterials.delete(a),r.tileBackMeshes.delete(a),r.tileContentKeys.delete(a),l.geometry.dispose()}for(const a of i.tiles)if(r.tileMeshes.has(a.id)){const l=r.tileMeshes.get(a.id),{x:c,y:h,w:u,h:d}=a.bounds,p=c+u/2,v=-(h+d/2);if(l.position.set(p,v,vu),a.content.kind==="text"||a.content.kind==="section"){const M=a.content.kind==="text"?`text-${a.content.text}`:`section-${a.content.title}`;if(r.tileContentKeys.get(a.id)!==M){r.tileContentKeys.set(a.id,M);const f=r.tileMaterials.get(a.id);f&&(f.map&&(f.map.dispose(),f.map=null),this.loadTileTexture(a,f,u,d))}}}else{const l=!!a.childPanel,{x:c,y:h,w:u,h:d}=a.bounds,p=c+u/2,v=-(h+d/2),M=a.content.kind,m=M==="poster"||M==="backdrop",f=new Ai(u,d),g=new Ms({color:a.color,transparent:!0,opacity:l?.25:.94,side:En,depthWrite:!1});g.userData.loaded=!m;const S=new pn(f,g);if(S.position.set(p,v,vu),S.renderOrder=1,S.visible=!m,!l&&(M==="poster"||M==="backdrop"||M==="text"||M==="section")){const y=new Ai(u,d),A=new Ms({color:16096779,side:En,depthWrite:!1}),w=new pn(y,A);w.position.set(0,0,-.05),w.scale.set(0,0,1),w.renderOrder=0,w.visible=!m,S.add(w),r.tileBackMeshes.set(a.id,w)}r.contentGroup.add(S),r.tileMeshes.set(a.id,S),r.tileMaterials.set(a.id,g),this.loadTileTexture(a,g,u,d)}}}loadTileTexture(e,n,i,r){const s=e.content;let o=e.id;if(s.kind==="poster"||s.kind==="backdrop"?o=s.imageUrl||s.title||e.id:s.kind==="text"&&(o=`text-${s.text}`),this.textureCache.has(o)){n.map=this.textureCache.get(o),n.color.setHex(16777215),n.userData.loaded=!0,(s.kind==="poster"||s.kind==="backdrop")&&(n.opacity=1,n.transparent=!1),n.needsUpdate=!0;return}let a=this.textureLoads.get(o);switch(a?(s.kind==="poster"||s.kind==="backdrop")&&(n.opacity=0,n.transparent=!0,n.userData.loaded=!1):(s.kind==="poster"?(n.opacity=0,n.transparent=!0,n.userData.loaded=!1,s.imageUrl&&(a=$w({imageUrl:s.imageUrl,title:s.title,year:s.year,rating:s.rating,w:Math.max(80,Math.floor(i)),h:Math.max(120,Math.floor(r))}))):s.kind==="backdrop"&&(n.opacity=0,n.transparent=!0,n.userData.loaded=!1,s.imageUrl&&(a=qw({imageUrl:s.imageUrl,title:s.title,metadata:s.metadata,overview:s.overview,w:Math.max(200,Math.floor(i)),h:Math.max(120,Math.floor(r))}))),a&&this.textureLoads.set(o,a)),a&&a.then(l=>{this.disposed||!l||(this.textureCache.set(o,l),n.map=l,n.color.setHex(16777215),(s.kind==="poster"||s.kind==="backdrop")&&(n.opacity=1,n.transparent=!1,n.userData.loaded=!0),n.needsUpdate=!0)}).catch(()=>{}),s.kind){case"text":case"section":case"placeholder":case"detail":n.userData.loaded=!0;break}switch(s.kind){case"text":{n.color.setHex(16777215),n.transparent=!0,n.opacity=.82;const l={"#000000":"#050a14","#1e40af":"#0a1432","#16a34a":"#0a3520","#d97706":"#3a200a"},c="#"+e.color.toString(16).padStart(6,"0"),h=l[c]??"#0f172a",u=Yw({text:s.text,subtext:s.subtext,bg:h,fg:"#f1f5f9",accent:"#f59e0b",w:Math.max(80,Math.floor(i)),h:Math.max(40,Math.floor(r)),fontSize:i>200?22:20,align:s.subtext?"left":"center"});n.map=u,n.needsUpdate=!0;break}case"section":{n.color.setHex(16777215),n.transparent=!0,n.opacity=.75;const l=Kw({title:s.title,w:Math.max(100,Math.floor(i)),h:Math.max(30,Math.floor(r))});n.map=l,n.needsUpdate=!0;break}case"placeholder":n.color.setHex(0),n.opacity=0;break;case"detail":n.color.setHex(0),n.opacity=0;break}}updateFocus(){this.maybeLoadPreviewData()}maybeLoadPreviewData(){}loop(e){if(this.disposed)return;const n=Math.min(.05,(e-this.lastTime)/1e3);this.lastTime=e,this.engine.step(n);for(const s of this.views.values()){const o=s.panel;s.contentGroup.position.set(-o.scrollX,o.scrollY,0);for(const a of o.tiles){const l=s.tileMeshes.get(a.id),c=s.tileMaterials.get(a.id);if(l&&c){const h=this.engine.focused.id===a.id,u=a.content.kind,d=u==="poster",p=u==="poster"||u==="backdrop",v=h&&d?1.12:1;l.scale.x+=(v-l.scale.x)*14*n,l.scale.y+=(v-l.scale.y)*14*n;const M=h?d?10:3:0;l.position.z+=(M-l.position.z)*14*n,l.renderOrder=h?999:1,h&&s.contentGroup.children[s.contentGroup.children.length-1]!==l&&(s.contentGroup.remove(l),s.contentGroup.add(l));let m=0,f=0;if(d&&this.engine.focused.panel===o&&!h){const R=this.engine.focused.bounds;if(Math.abs(a.bounds.y-R.y)<10){const T=a.bounds.x-R.x,P=Math.PI/8,L=.055;T<0&&Math.abs(T)<a.bounds.w*1.5?(m=P,f=-a.bounds.w*L):T>0&&Math.abs(T)<a.bounds.w*1.5&&(m=-P,f=a.bounds.w*L)}}l.rotation.y+=(m-l.rotation.y)*14*n;const S=a.bounds.x+a.bounds.w/2+f;l.position.x+=(S-l.position.x)*14*n;const y=c.userData.loaded!==!1,A=s.tileBackMeshes.get(a.id);if(A)if(A.visible=y,y){const R=p?8:4,T=h?1+2*R/a.bounds.w:0,P=h?1+2*R/a.bounds.h:0;A.scale.x+=(T-A.scale.x)*14*n,A.scale.y+=(P-A.scale.y)*14*n,A.renderOrder=h?998:0}else A.scale.set(0,0,1);if(u==="poster"||u==="backdrop"){const T=h?.88:1,P=h?.55:1,L=c.color.r,D=c.color.g,z=c.color.b;c.color.setRGB(L+(1-L)*10*n,D+(T-D)*10*n,z+(P-z)*10*n)}else if(u==="text"||u==="section"){const R=h?1:.82;c.opacity+=(R-c.opacity)*14*n;const T=h?.85:1,P=h?.35:1,L=1,D=c.color.r,z=c.color.g,I=c.color.b;c.color.setRGB(D+(T-D)*10*n,z+(P-z)*10*n,I+(L-I)*10*n)}const w=a.bounds.y-o.scrollY,C=500,_=y&&!(w>o.viewport.h+C||w+a.bounds.h<-C);l.visible=_}}}const i=this.renderer;i.setScissorTest(!1),i.setViewport(0,0,this.screenW,this.screenH),i.setClearColor(461588,1),i.clear(!0,!0,!0),i.setScissorTest(!0);const r=[...this.views.values()].sort((s,o)=>s.panel.depth-o.panel.depth);for(const s of r){const o=s.panel,a=Yo(o),l=Dy(o);if(l.w<=0||l.h<=0)continue;const c=80,h=Math.max(0,l.x-c),u=l.y-c,d=Math.min(this.screenW,l.x+l.w+c)-h,p=l.h+c*2,v=a.x-c,M=this.screenH-(a.y+a.h)-c,m=a.w+c*2,f=a.h+c*2;i.setViewport(v,M,m,f),i.setScissor(h,this.screenH-(u+p),d,p),s.camera.left=-c,s.camera.right=o.viewport.w+c,s.camera.top=c,s.camera.bottom=-(o.viewport.h+c),s.camera.updateProjectionMatrix(),i.clearDepth(),i.render(s.scene,s.camera)}this.raf=requestAnimationFrame(this.loop)}dispose(){this.disposed=!0,cancelAnimationFrame(this.raf),this.renderer.dispose();for(const e of this.views.values())e.scene.traverse(n=>{n.geometry&&n.geometry.dispose();const i=n.material;Array.isArray(i)?i.forEach(r=>r.dispose()):i&&i.dispose()});this.renderer.domElement.parentElement===this.container&&this.container.removeChild(this.renderer.domElement)}}const tA=600,nA={ArrowUp:"up",ArrowDown:"down",ArrowLeft:"left",ArrowRight:"right"};function km(t){let e=t.key;return(t.keyCode===38||t.keyCode===19||e==="Up")&&(e="ArrowUp"),(t.keyCode===40||t.keyCode===20||e==="Down")&&(e="ArrowDown"),(t.keyCode===37||t.keyCode===21||e==="Left")&&(e="ArrowLeft"),(t.keyCode===39||t.keyCode===22||e==="Right")&&(e="ArrowRight"),(t.keyCode===13||t.keyCode===23||t.keyCode===66&&t.key.length!==1)&&(e="Enter"),e}class iA{constructor(e){this.holdTimer=null,this.holdFired=!1,this.callbacks=e,this.boundKeyDown=this.onKeyDown.bind(this),this.boundKeyUp=this.onKeyUp.bind(this)}attach(){window.addEventListener("keydown",this.boundKeyDown,!0),window.addEventListener("keyup",this.boundKeyUp,!0)}detach(){window.removeEventListener("keydown",this.boundKeyDown,!0),window.removeEventListener("keyup",this.boundKeyUp,!0),this.cancelHold()}cancelHold(){this.holdTimer!==null&&(clearTimeout(this.holdTimer),this.holdTimer=null)}onKeyDown(e){var r,s,o,a,l,c;if((s=(r=this.callbacks).isSuspended)!=null&&s.call(r))return;const n=km(e),i=nA[n];if(i){e.preventDefault(),e.stopPropagation(),this.callbacks.onNavigate(i);return}if(n==="Enter"){if(e.preventDefault(),e.stopPropagation(),e.repeat)return;this.holdFired=!1,this.holdTimer=window.setTimeout(()=>{this.holdFired=!0,this.holdTimer=null},tA);return}if(n==="Backspace"){e.preventDefault(),e.stopPropagation(),(a=(o=this.callbacks).onBackspace)==null||a.call(o);return}if(n.length===1&&!e.ctrlKey&&!e.altKey&&!e.metaKey){e.preventDefault(),e.stopPropagation(),(c=(l=this.callbacks).onType)==null||c.call(l,n);return}}onKeyUp(e){var i,r;if((r=(i=this.callbacks).isSuspended)!=null&&r.call(i)){e.preventDefault();return}if(km(e)==="Enter"){if(e.preventDefault(),e.stopPropagation(),this.holdFired){this.holdFired=!1,this.callbacks.onBack();return}this.cancelHold(),this.callbacks.onSelect()}}}function Bm(t,e,n){if(n.focusLabel){const s=e.allLeaves.find(o=>o.label===n.focusLabel);if(s){t.setFocus(s);return}}let r=e.allLeaves.find(s=>{var a;let o=s.panel;for(;o;){if(o.id==="header"||o.id==="sidebar")return!1;o=((a=o.parentTile)==null?void 0:a.panel)??null}return!0});if(n.type==="search"){const s=e.allLeaves.find(o=>o.label==="PageHeader"||o.content.kind==="text"&&typeof o.content.text=="string"&&o.content.text.includes("Search"));s&&(r=s)}r&&t.setFocus(r)}function rA(){const t=He.useRef(null),[e,n]=He.useState(!0),[i,r]=He.useState(null),[s,o]=He.useState(null),[a,l]=He.useState([{type:"home"}]),[c,h]=He.useState("all"),u=a[a.length-1],d=He.useRef([]),p=He.useRef(u),v=He.useRef(!1),M=He.useRef(!1),m=He.useRef(!1),f=He.useRef(null);He.useEffect(()=>{d.current=u.dynamicData||[]},[u.dynamicData]),He.useEffect(()=>{p.current=u},[u]),He.useEffect(()=>{let T=!1;return(async()=>{try{const P=new Date().getFullYear(),L=Array.from({length:P-1900+1},(ve,H)=>P-H),[D,z,I,V,k,U,$,J,ne,K,le]=await Promise.all([tt.trendingMovies(),tt.popularMovies(),tt.topRatedMovies(),tt.upcomingMovies(),tt.nowPlayingMovies(),tt.trendingTV(),tt.popularTV(),tt.topRatedTV(),tt.latestTV(),tt.movieGenres(),tt.tvGenres()]);if(T)return;const Ae={trending:dn(D.results),popular:dn(z.results),topRated:dn(I.results),upcoming:dn(V.results),nowPlaying:dn(k.results),trendingTV:dn(U.results),popularTV:dn($.results),topRatedTV:dn(J.results),latestTV:dn(ne.results),movieGenres:K.genres,tvGenres:le.genres,years:L};o(Ae),n(!1)}catch(P){if(T)return;r(P instanceof Error?P.message:"Failed to load movie data"),n(!1)}})(),()=>{T=!0}},[]),He.useEffect(()=>{let T=!1;return(async()=>{var P,L;if(!(u.type!=="genre"&&u.type!=="year"&&u.type!=="person"||u.dynamicData)){v.current=!0;try{if(u.type==="person"){const[ve,H]=await Promise.all([tt.personMovieCredits(u.personId),tt.personTVCredits(u.personId)]),ie=dn([...ve.cast||[],...H.cast||[]].sort((re,Ee)=>(Ee.vote_average||0)-(re.vote_average||0)));if(T)return;l(re=>{const Ee=[...re],Ne={...Ee[Ee.length-1]};return Ne.dynamicData=ie,Ee[Ee.length-1]=Ne,Ee}),v.current=!1;return}const D=((P=t.current)==null?void 0:P.clientWidth)||window.innerWidth,z=((L=t.current)==null?void 0:L.clientHeight)||window.innerHeight,V=Math.floor((D-32)/174),k=Math.ceil(z/234),U=V*k,$=Math.max(1,Math.ceil(U/20)),J=ve=>u.type==="genre"?u.mediaType==="tv"?tt.discoverTV({with_genres:u.genreId,page:ve}):tt.discoverMovies({with_genres:u.genreId,page:ve}):u.mediaType==="tv"?tt.discoverTV({first_air_date_year:u.year,page:ve}):tt.discoverMovies({year:u.year,page:ve}),ne=[];for(let ve=1;ve<=$;ve++)ne.push(J(ve));const K=await Promise.all(ne);if(T)return;const le=K.flatMap(ve=>dn(ve.results)),Ae=K[K.length-1];l(ve=>{const H=[...ve],ie={...H[H.length-1]};return ie.dynamicData=le,ie.dynamicPage=$,ie.dynamicHasMore=Ae.results.length>=20,H[H.length-1]=ie,H})}catch{}v.current=!1}})(),()=>{T=!0}},[u]),He.useEffect(()=>{if(u.type!=="search"||!u.query)return;const T=u.query,P=window.setTimeout(async()=>{try{const L=await tt.search(T),D=dn(L.results||[]);l(z=>{const I=[...z],V=I[I.length-1];return V.type==="search"&&V.query===T&&(I[I.length-1]={...V,dynamicData:D,dynamicPage:1,dynamicHasMore:(L.results||[]).length>=20}),I})}catch{}},2e3);return()=>window.clearTimeout(P)},[u.type==="search"?u.query:null]);const g=async()=>{const T=p.current;if(v.current||T.dynamicHasMore===!1||T.type!=="genre"&&T.type!=="year"&&T.type!=="search")return;v.current=!0;const P=(T.dynamicPage||1)+1;try{let L;if(T.type==="genre")L=T.mediaType==="tv"?await tt.discoverTV({with_genres:T.genreId,page:P}):await tt.discoverMovies({with_genres:T.genreId,page:P});else if(T.type==="year")L=T.mediaType==="tv"?await tt.discoverTV({first_air_date_year:T.year,page:P}):await tt.discoverMovies({year:T.year,page:P});else if(T.type==="search"&&T.query)L=await tt.search(T.query,P);else return;const D=dn(L.results);l(z=>{const I=[...z],V={...I[I.length-1]};return D.length>0&&(V.dynamicData=[...V.dynamicData||[],...D],V.dynamicPage=P),(D.length===0||L.results.length<20)&&(V.dynamicHasMore=!1),I[I.length-1]=V,I})}catch{}v.current=!1},S=He.useRef(null),y=He.useRef(null),A=He.useRef(null),w=He.useRef("all"),C=He.useRef(null),[_,R]=He.useState(null);return He.useEffect(()=>{if(u.type!=="details"||u.similar)return;const T=Pr(u.movie);tt.getSimilarMovies(u.movie.id,T).then(P=>{l(L=>{const D=[...L],z=D[D.length-1];return z.type==="details"&&z.movie.id===u.movie.id?(D[D.length-1]={...z,similar:dn(P.results)},D):L})}).catch(console.error),T==="tv"?tt.tvDetails(u.movie.id).then(P=>{const L=u.season||1;(P.seasons&&P.seasons.length>0?tt.tvSeason(u.movie.id,L):Promise.resolve({episodes:[]})).then(z=>{l(I=>{var U,$;const V=[...I],k=V[V.length-1];return k.type==="details"&&k.movie.id===u.movie.id?(V[V.length-1]={...k,movie:{...k.movie,...P,cast:((U=P.credits)==null?void 0:U.cast)||[],crew:(($=P.credits)==null?void 0:$.crew)||[]},seasonsData:P.seasons||[],episodesData:z.episodes||[],season:L,episode:u.episode||1},V):I})}).catch(console.error)}).catch(console.error):tt.movieDetails(u.movie.id).then(P=>{l(L=>{var I,V;const D=[...L],z=D[D.length-1];return z.type==="details"&&z.movie.id===u.movie.id?(D[D.length-1]={...z,movie:{...z.movie,...P,cast:((I=P.credits)==null?void 0:I.cast)||[],crew:((V=P.credits)==null?void 0:V.crew)||[]}},D):L})}).catch(console.error)},[u]),He.useEffect(()=>{u.type!=="details"&&R(null)},[u.type]),He.useEffect(()=>{if(u.type!=="details"||_)return;let T;const P=()=>{S.current&&S.current.allLeaves.filter(D=>D.content.kind==="text"&&D.content.action==="play_server").forEach(D=>{const z=D.content.payload,I=document.getElementById(`server-iframe-${z}`);if(I){const V=D.panel,k=Yo(V),U=k.x+D.bounds.x-V.scrollX,$=k.y+D.bounds.y-V.scrollY;$>-D.bounds.h&&$<window.innerHeight?(I.style.transform=`translate(${U}px, ${$}px)`,I.style.width=`${D.bounds.w}px`,I.style.height=`${D.bounds.h}px`,I.style.display="block"):I.style.display="none"}}),T=requestAnimationFrame(P)};return T=requestAnimationFrame(P),()=>cancelAnimationFrame(T)},[u.type,_]),He.useEffect(()=>{const T=f.current;T&&(u.type==="search"?(T.value=u.query||"",(!T||document.activeElement!==T)&&T.focus(),M.current=!0,m.current=!1):(T.blur(),M.current=!1,m.current=!1))},[u.type]),He.useEffect(()=>()=>{var T,P;(T=y.current)==null||T.dispose(),(P=C.current)==null||P.detach()},[]),He.useEffect(()=>{if(!s)return;const T=t.current;if(!T)return;const P=T.clientWidth||window.innerWidth,L=T.clientHeight||window.innerHeight,D=Ip(P,L,s,u,u.dynamicData||null,c),z=A.current,I=w.current!==c;let V=!1;if(z&&y.current&&S.current&&!I&&z.type===u.type&&(u.type==="genre"&&z.type==="genre"&&z.genreId===u.genreId||u.type==="year"&&z.type==="year"&&z.year===u.year||u.type==="details"&&z.type==="details"&&z.movie.id===u.movie.id&&z.season===u.season&&z.episode===u.episode||u.type==="search"&&z.type==="search"||u.type==="home"&&z.type==="home")&&(V=!0),V)S.current.updateLayout(D),y.current.updateLayout(D),window.engine=S.current,window.sceneManager=y.current;else{if(y.current&&y.current.dispose(),S.current=new Op(D),u.scrollStates)for(const K of S.current.allPanels){const le=u.scrollStates[K.id];le&&(K.scrollX=le.scrollX,K.scrollY=le.scrollY,K.targetScrollX=le.targetScrollX,K.targetScrollY=le.targetScrollY)}Bm(S.current,D,u),y.current=new Om(T,D,S.current),window.engine=S.current,window.sceneManager=y.current}A.current=u,w.current=c,S.current.onFocusChange=(K,le)=>{var ve;u.focusLabel=K.label;const Ae=K.content;Ae.kind==="poster"&&d.current.length>0&&d.current.findIndex(ie=>ie.id===Ae.movieId)>=d.current.length-15&&g(),(ve=y.current)==null||ve.updateFocus()};const k=K=>{var le,Ae;console.log("NAVIGATING TO:",K.type,K.type==="details"?((le=K.movie)==null?void 0:le.title)||((Ae=K.movie)==null?void 0:Ae.name):""),l(ve=>{const H=[...ve],ie={...H[H.length-1]},re={};for(const Ee of S.current.allPanels)re[Ee.id]={scrollX:Ee.scrollX,scrollY:Ee.scrollY,targetScrollX:Ee.targetScrollX,targetScrollY:Ee.targetScrollY};return ie.scrollStates=re,ie.focusLabel=S.current.focused.label,H[H.length-1]=ie,H.push(K),H})},U=()=>{if(_){R(null);return}l(K=>{if(K.length<=1)return K;const le=[...K];return le.pop(),le})};window.navigateBack=U;const $=()=>{const K=S.current.focused.content;if(console.log("SELECT on:",K.kind,"label:",S.current.focused.label),K.kind==="text"&&K.action==="play_server"&&u.type==="details"){const le=K.payload,Ae=Pr(u.movie)==="tv"?"tv":"movie",H=il(u.movie.id,Ae,u.season,u.episode)[le];H!=null&&H.url&&R({url:H.url});return}if(K.kind==="text"&&K.action){if(K.action==="home")h("all"),k({type:"home"});else if(K.action==="setFilter")h(K.payload),u.type!=="home"&&k({type:"home"});else if(K.action==="person"){const le=K.payload;k({type:"person",personId:le.id,personName:le.name})}else if(K.action==="genre"){const le=K.payload;k({type:"genre",genreId:le.id,genreName:le.name,mediaType:le.mediaType})}else if(K.action==="year"){const le=K.payload;k({type:"year",year:le.year,mediaType:le.mediaType})}else if(K.action==="search"){const le=u.type==="search"&&u.query||"";f.current&&(f.current.value=le,f.current.focus()),p.current.type!=="search"&&k({type:"search",query:le})}else if(K.action!=="play_server"){if(K.action==="change_season"&&u.type==="details"){const le=K.payload;tt.tvSeason(u.movie.id,le).then(Ae=>{l(ve=>{const H=[...ve],ie=H[H.length-1];return ie.type==="details"&&ie.movie.id===u.movie.id?(H[H.length-1]={...ie,season:le,episodesData:Ae.episodes,episode:1},H):ve})}).catch(Ae=>console.error("CHANGE_SEASON TMDB ERROR:",Ae))}else if(K.action==="change_episode"&&u.type==="details"){const le=K.payload;l(Ae=>{const ve=[...Ae],H=ve[ve.length-1];return H.type==="details"&&H.movie.id===u.movie.id?(ve[ve.length-1]={...H,episode:le},ve):Ae})}}}else(K.kind==="poster"||K.kind==="backdrop")&&k({type:"details",movie:K.movie})};C.current&&C.current.detach(),C.current=new iA({onNavigate:K=>S.current.handleInput(K),onSelect:$,onBack:U,onType:K=>{if(!(f.current&&document.activeElement===f.current)&&p.current.type==="search"){const Ae=(p.current.query||"")+K;l(ve=>{const H=[...ve];return H[H.length-1]={type:"search",query:Ae,dynamicData:void 0},H})}},onBackspace:()=>{if(!(f.current&&document.activeElement===f.current)&&p.current.type==="search"){const K=p.current.query||"";if(K.length>0){const le=K.slice(0,-1);l(Ae=>{const ve=[...Ae];return ve[ve.length-1]={type:"search",query:le,dynamicData:void 0},ve})}}},isSuspended:()=>!!(f.current&&(M.current||m.current||document.activeElement===f.current))}),C.current.attach();let J;const ne=()=>{window.clearTimeout(J),J=window.setTimeout(()=>{const K=T.clientWidth||window.innerWidth,le=T.clientHeight||window.innerHeight;y.current&&y.current.dispose();const Ae=Ip(K,le,s,u,u.dynamicData||null,c);S.current=new Op(Ae),Bm(S.current,Ae,u),y.current=new Om(T,Ae,S.current),u.type==="search"&&f.current&&f.current.focus()},200)};return window.addEventListener("resize",ne),()=>{window.removeEventListener("resize",ne),window.clearTimeout(J)}},[s,u,c]),e?Qe.jsx("div",{className:"w-screen h-screen flex items-center justify-center bg-[#05070d] text-slate-100",children:Qe.jsxs("div",{className:"text-center",children:[Qe.jsx("div",{className:"inline-block w-12 h-12 border-4 border-amber-400 border-t-transparent rounded-full animate-spin mb-4"}),Qe.jsx("div",{className:"text-lg font-semibold text-amber-300",children:"CineDeck"}),Qe.jsx("div",{className:"text-sm text-slate-400 mt-1",children:"Loading movies & TV shows..."})]})}):i?Qe.jsx("div",{className:"w-screen h-screen flex items-center justify-center bg-[#05070d] text-slate-100",children:Qe.jsxs("div",{className:"text-center max-w-md",children:[Qe.jsx("div",{className:"text-rose-400 text-lg font-semibold mb-2",children:"Couldn't load movie data"}),Qe.jsx("div",{className:"text-sm text-slate-400",children:i})]})}):Qe.jsxs("div",{className:"relative w-screen h-screen overflow-hidden bg-[#05070d] text-slate-100 select-none outline-none",tabIndex:0,autoFocus:!0,ref:T=>{T&&T.focus()},children:[Qe.jsx("div",{ref:t,className:"absolute inset-0"}),Qe.jsx("textarea",{ref:f,rows:1,"aria-label":"Search",autoComplete:"off",autoCorrect:"off",autoCapitalize:"off",spellCheck:!1,enterKeyHint:"none",style:{position:"absolute",top:0,left:0,width:"100%",height:"80px",opacity:.001,color:"transparent",background:"transparent",border:"none",outline:"none",fontSize:"24px",resize:"none",overflow:"hidden",zIndex:50,pointerEvents:"auto",display:u.type==="search"?"block":"none"},onInput:T=>{if(p.current.type!=="search")return;const P=T.target.value.replace(/[\r\n]+/g,"");l(L=>{const D=[...L];return D[D.length-1]={type:"search",query:P,dynamicData:void 0},D})},onBlur:()=>{m.current=!0,setTimeout(()=>{M.current=!1,m.current=!1},50)},onKeyDown:T=>{["ArrowDown","ArrowUp","ArrowLeft","ArrowRight","Escape"].includes(T.key)&&T.currentTarget.blur()},onKeyUp:T=>{["ArrowDown","ArrowUp","ArrowLeft","ArrowRight","Escape"].includes(T.key)?T.currentTarget.blur():(T.key==="Enter"||T.keyCode===13||T.keyCode===23||T.keyCode===66||T.keyCode===160||T.key==="OK"||T.key==="Select"||T.key==="Accept")&&(T.preventDefault(),T.stopPropagation())}}),u.type==="details"&&!_&&(()=>{const T=il(u.movie.id,Pr(u.movie),u.season,u.episode);return Qe.jsx("div",{className:"absolute inset-0 pointer-events-none z-40 overflow-hidden",children:T.map((P,L)=>Qe.jsx("div",{id:`server-iframe-${L}`,className:"absolute shadow-2xl bg-black overflow-hidden",style:{display:"none"},children:Qe.jsx("iframe",{src:`${P.url}?autoplay=1`,className:"w-full h-full border-none pointer-events-none",allow:"autoplay; encrypted-media; fullscreen",title:`Server ${L+1}`,referrerPolicy:"no-referrer"})},P.url))})})(),_&&Qe.jsxs("div",{className:"absolute inset-0 z-50 bg-black",children:[Qe.jsx("div",{className:"absolute top-4 left-6 text-slate-400 text-sm font-mono pointer-events-none z-10",children:"Hold OK to go back"}),Qe.jsx("iframe",{src:`${_.url}?autoplay=1`,className:"w-full h-full border-none",allowFullScreen:!0,allow:"autoplay; encrypted-media; fullscreen",title:"Player",referrerPolicy:"no-referrer"},_.url)]}),u.type==="player"&&!_&&(()=>{const T=il(u.movie.id,Pr(u.movie),u.season,u.episode)[u.serverIndex];return Qe.jsxs("div",{className:"absolute inset-0 z-50 bg-black",children:[Qe.jsx("div",{className:"absolute top-4 left-6 text-slate-400 text-sm font-mono pointer-events-none",children:"Hold OK to go back"}),Qe.jsx("iframe",{src:`${T.url}?autoplay=1&autoplay=true`,className:"w-full h-full border-none",allowFullScreen:!0,allow:"autoplay; encrypted-media; fullscreen",title:"Player",referrerPolicy:"no-referrer"},T.url)]})})()]})}function dn(t){return t?t.filter(e=>e&&(e.title||e.name)&&e.poster_path&&e.backdrop_path):[]}function sA(){const t=()=>{document.documentElement.requestFullscreen().catch(e=>{console.error("Failed to enter fullscreen:",e)})};return He.useEffect(()=>{const e=n=>{n.key==="Enter"&&t()};return document.addEventListener("keydown",e),()=>document.removeEventListener("keydown",e)},[]),Qe.jsxs("div",{className:"fixed inset-0 bg-[#070b14]/80 backdrop-blur-2xl flex flex-col items-center justify-center text-white cursor-pointer border border-white/10",onClick:t,children:[Qe.jsx("h1",{className:"text-6xl font-extrabold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-rose-500 to-amber-500 tracking-widest drop-shadow-lg",children:"NETFLIX"}),Qe.jsx("div",{className:"text-xs font-mono tracking-widest text-amber-400/90 uppercase mb-6 px-3 py-1 bg-amber-400/10 border border-amber-400/30 rounded-full",children:"Version 0.5.7"}),Qe.jsx("p",{className:"text-xl text-slate-300/80 mb-10 font-mono backdrop-blur-md px-6 py-2 border border-white/10 bg-white/5",children:"This app is designed for TV and requires Fullscreen mode."}),Qe.jsx("button",{className:"px-10 py-5 bg-gradient-to-r from-red-600/90 to-rose-600/90 hover:from-red-500 hover:to-rose-500 text-white font-bold text-2xl transition-all shadow-[0_8px_32px_rgba(220,38,38,0.4)] border border-white/30 backdrop-blur-md",children:"Press OK to Start"})]})}function oA(){const[t,e]=He.useState(!!document.fullscreenElement||!!window.__SKIP_FULLSCREEN__);return He.useEffect(()=>{const n=()=>e(!!document.fullscreenElement);return document.addEventListener("fullscreenchange",n),window.__enterApp__=()=>e(!0),()=>document.removeEventListener("fullscreenchange",n)},[]),t?Qe.jsx(rA,{}):Qe.jsx(sA,{})}J0(document.getElementById("root")).render(Qe.jsx(He.StrictMode,{children:Qe.jsx(oA,{})}));
