(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=n(r);fetch(r.href,s)}})();var tg={exports:{}},nc={},ng={exports:{}},Ge={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(N,W){var K=N.length;N.push(W);e:for(;0<K;){var j=K-1>>>1,re=N[j];if(0<r(re,W))N[j]=W,N[K]=re,K=j;else break e}}function n(N){return N.length===0?null:N[0]}function i(N){if(N.length===0)return null;var W=N[0],K=N.pop();if(K!==W){N[0]=K;e:for(var j=0,re=N.length,se=re>>>1;j<se;){var le=2*(j+1)-1,oe=N[le],B=le+1,Z=N[B];if(0>r(oe,K))B<re&&0>r(Z,oe)?(N[j]=Z,N[B]=K,j=B):(N[j]=oe,N[le]=K,j=le);else if(B<re&&0>r(Z,K))N[j]=Z,N[B]=K,j=B;else break e}}return W}function r(N,W){var K=N.sortIndex-W.sortIndex;return K!==0?K:N.id-W.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],d=1,h=null,u=3,p=!1,g=!1,v=!1,m=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function M(N){for(var W=n(c);W!==null;){if(W.callback===null)i(c);else if(W.startTime<=N)i(c),W.sortIndex=W.expirationTime,e(l,W);else break;W=n(c)}}function x(N){if(v=!1,M(N),!g)if(n(l)!==null)g=!0,X(E);else{var W=n(c);W!==null&&O(x,W.startTime-N)}}function E(N,W){g=!1,v&&(v=!1,f(y),y=-1),p=!0;var K=u;try{for(M(W),h=n(l);h!==null&&(!(h.expirationTime>W)||N&&!P());){var j=h.callback;if(typeof j=="function"){h.callback=null,u=h.priorityLevel;var re=j(h.expirationTime<=W);W=t.unstable_now(),typeof re=="function"?h.callback=re:h===n(l)&&i(l),M(W)}else i(l);h=n(l)}if(h!==null)var se=!0;else{var le=n(c);le!==null&&O(x,le.startTime-W),se=!1}return se}finally{h=null,u=K,p=!1}}var A=!1,C=null,y=-1,w=5,R=-1;function P(){return!(t.unstable_now()-R<w)}function L(){if(C!==null){var N=t.unstable_now();R=N;var W=!0;try{W=C(!0,N)}finally{W?k():(A=!1,C=null)}}else A=!1}var k;if(typeof _=="function")k=function(){_(L)};else if(typeof MessageChannel<"u"){var $=new MessageChannel,D=$.port2;$.port1.onmessage=L,k=function(){D.postMessage(null)}}else k=function(){m(L,0)};function X(N){C=N,A||(A=!0,k())}function O(N,W){y=m(function(){N(t.unstable_now())},W)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(N){N.callback=null},t.unstable_continueExecution=function(){g||p||(g=!0,X(E))},t.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):w=0<N?Math.floor(1e3/N):5},t.unstable_getCurrentPriorityLevel=function(){return u},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(N){switch(u){case 1:case 2:case 3:var W=3;break;default:W=u}var K=u;u=W;try{return N()}finally{u=K}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(N,W){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var K=u;u=N;try{return W()}finally{u=K}},t.unstable_scheduleCallback=function(N,W,K){var j=t.unstable_now();switch(typeof K=="object"&&K!==null?(K=K.delay,K=typeof K=="number"&&0<K?j+K:j):K=j,N){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=K+re,N={id:d++,callback:W,priorityLevel:N,startTime:K,expirationTime:re,sortIndex:-1},K>j?(N.sortIndex=K,e(c,N),n(l)===null&&N===n(c)&&(v?(f(y),y=-1):v=!0,O(x,K-j))):(N.sortIndex=re,e(l,N),g||p||(g=!0,X(E))),N},t.unstable_shouldYield=P,t.unstable_wrapCallback=function(N){var W=u;return function(){var K=u;u=W;try{return N.apply(this,arguments)}finally{u=K}}}})(pg);hg.exports=pg;var R_=hg.exports;/**
 * @license React
...
}`,Ow=[new V(1,0,0),new V(-1,0,0),new V(0,1,0),new V(0,-1,0),new V(0,0,1),new V(0,0,-1)],Bw=[new V(0,-1,0),new V(0,-1,0),new V(0,0,1),new V(0,0,-1),new V(0,-1,0),new V(0,-1,0)],jm=new Ct,uo=new V,Iu=new V;function kw(t,e,n){let i=new kv;const r=new et,s=new et,o=new Et,a=new jy,l=new eM,c={},d=n.maxTextureSize,h={[mr]:gn,[gn]:mr,[Un]:Un},u=new xi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new et},radius:{value:4}},vertexShader:Uw,fragmentShader:Fw}),p=u.clone();p.defines.HORIZONTAL_PASS=1;const g=new Rn;g.setAttribute("position",new vi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new zn(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ml;let f=this.type;this.render=function(A,C,y){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;this.type===HS&&(Fe("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ml);const w=t.getRenderTarget(),R=t.getActiveCubeFace(),P=t.getActiveMipmapLevel(),L=t.state;L.setBlending(Di),L.buffers.depth.getReversed()===!0?L.buffers.color.setClear(0,0,0,0):L.buffers.color.setClear(1,1,1,1),L.buffers.depth.setTest(!0),L.setScissorTest(!1);const k=f!==this.type;k&&C.traverse(function($){$.material&&(Array.isArray($.material)?$.material.forEach(D=>D.needsUpdate=!0):$.material.needsUpdate=!0)});for(let $=0,D=A.length;$<D;$++){const X=A[$],O=X.shadow;if(O===void 0){Fe("WebGLShadowMap:",X,"has no shadow.");continue}if(O.autoUpdate===!1&&O.needsUpdate===!1)continue;r.copy(O.mapSize);const N=O.getFrameExtents();r.multiply(N),s.copy(O.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/N.x),r.x=s.x*N.x,O.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/N.y),r.y=s.y*N.y,O.mapSize.y=s.y));const W=t.state.buffers.depth.getReversed();if(O.camera._reversedDepth=W,O.map===null||k===!0){if(O.map!==null&&(O.map.depthTexture!==null&&(O.map.depthTexture.dispose(),O.map.depthTexture=null),O.map.dispose()),this.type===vo){if(X.isPointLight){Fe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}O.map=new gi(r.x,r.y,{format:Gr,type:Bi,minFilter:en,magFilter:en,generateMipmaps:!1}),O.map.texture.name=X.name+".shadowMap",O.map.depthTexture=new Hs(r.x,r.y,fi),O.map.depthTexture.name=X.name+".shadowMapDepth",O.map.depthTexture.format=ki,O.map.depthTexture.compareFunction=null,O.map.depthTexture.minFilter=Wt,O.map.depthTexture.magFilter=Wt}else X.isPointLight?(O.map=new $v(r.x),O.map.depthTexture=new Yy(r.x,_i)):(O.map=new gi(r.x,r.y),O.map.depthTexture=new Hs(r.x,r.y,_i)),O.map.depthTexture.name=X.name+".shadowMap",O.map.depthTexture.format=ki,this.type===ml?(O.map.depthTexture.compareFunction=W?Eh:Mh,O.map.depthTexture.minFilter=en,O.map.depthTexture.magFilter=en):(O.map.depthTexture.compareFunction=null,O.map.depthTexture.minFilter=Wt,O.map.depthTexture.magFilter=Wt);O.camera.updateProjectionMatrix()}const K=O.map.isWebGLCubeRenderTarget?6:1;for(let j=0;j<K;j++){if(O.map.isWebGLCubeRenderTarget)t.setRenderTarget(O.map,j),t.clear();else{j===0&&(t.setRenderTarget(O.map),t.clear());const re=O.getViewport(j);o.set(s.x*re.x,s.y*re.y,s.x*re.z,s.y*re.w),L.viewport(o)}if(X.isPointLight){const re=O.camera,se=O.matrix,le=X.distance||re.far;le!==re.far&&(re.far=le,re.updateProjectionMatrix()),uo.setFromMatrixPosition(X.matrixWorld),re.position.copy(uo),Iu.copy(re.position),Iu.add(Ow[j]),re.up.copy(Bw[j]),re.lookAt(Iu),re.updateMatrixWorld(),se.makeTranslation(-uo.x,-uo.y,-uo.z),jm.multiplyMatrices(re.projectionMatrix,re.matrixWorldInverse),O._frustum.setFromProjectionMatrix(jm,re.coordinateSystem,re.reversedDepth)}else O.updateMatrices(X);i=O.getFrustum(),x(C,y,O.camera,X,this.type)}O.isPointLightShadow!==!0&&this.type===vo&&_(O,y),O.needsUpdate=!1}f=this.type,m.needsUpdate=!1,t.setRenderTarget(w,R,P)};function _(A,C){const y=e.update(v);u.defines.VSM_SAMPLES!==A.blurSamples&&(u.defines.VSM_SAMPLES=A.blurSamples,p.defines.VSM_SAMPLES=A.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new gi(r.x,r.y,{format:Gr,type:Bi})),u.uniforms.shadow_pass.value=A.map.depthTexture,u.uniforms.resolution.value=A.mapSize,u.uniforms.radius.value=A.radius,t.setRenderTarget(A.mapPass),t.clear(),t.renderBufferDirect(C,null,y,u,v,null),p.uniforms.shadow_pass.value=A.mapPass.texture,p.uniforms.resolution.value=A.mapSize,p.uniforms.radius.value=A.radius,t.setRenderTarget(A.map),t.clear(),t.renderBufferDirect(C,null,y,p,v,null)}function M(A,C,y,w){let R=null;const P=y.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(P!==void 0)R=P;else if(R=y.isPointLight===!0?l:a,t.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const L=R.uuid,k=C.uuid;let $=c[L];$===void 0&&($={},c[L]=$);let D=$[k];D===void 0&&(D=R.clone(),$[k]=D,C.addEventListener("dispose",E)),R=D}if(R.visible=C.visible,R.wireframe=C.wireframe,w===vo?R.side=C.shadowSide!==null?C.shadowSide:C.side:R.side=C.shadowSide!==null?C.shadowSide:h[C.side],R.alphaMap=C.alphaMap,R.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,R.map=C.map,R.clipShadows=C.clipShadows,R.clippingPlanes=C.clippingPlanes,R.clipIntersection=C.clipIntersection,R.displacementMap=C.displacementMap,R.displacementScale=C.displacementScale,R.displacementBias=C.displacementBias,R.wireframeLinewidth=C.wireframeLinewidth,R.linewidth=C.linewidth,y.isPointLight===!0&&R.isMeshDistanceMaterial===!0){const L=t.properties.get(R);L.light=y}return R}function x(A,C,y,w,R){if(A.visible===!1)return;if(A.layers.test(C.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&R===vo)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(y.matrixWorldInverse,A.matrixWorld);const k=e.update(A),$=A.material;if(Array.isArray($)){const D=k.groups;for(let X=0,O=D.length;X<O;X++){const N=D[X],W=$[N.materialIndex];if(W&&W.visible){const K=M(A,W,w,R);A.onBeforeShadow(t,A,C,y,k,K,N),t.renderBufferDirect(y,null,k,K,A,N),A.onAfterShadow(t,A,C,y,k,K,N)}}}else if($.visible){const D=M(A,$,w,R);A.onBeforeShadow(t,A,C,y,k,D,null),t.renderBufferDirect(y,null,k,D,A,null),A.onAfterShadow(t,A,C,y,k,D,null)}}const L=A.children;for(let k=0,$=L.length;k<$;k++)x(L[k],C,y,w,R)}function E(A){A.target.removeEventListener("dispose",E);for(const y in c){const w=c[y],R=A.target.uuid;R in w&&(w[R].dispose(),delete w[R])}}}function zw(t,e){function n(){let I=!1;const ue=new Et;let ee=null;const pe=new Et(0,0,0,0);return{setMask:function(xe){ee!==xe&&!I&&(t.colorMask(xe,xe,xe,xe),ee=xe)},setLocked:function(xe){I=xe},setClear:function(xe,ie,Ae,Te,St){St===!0&&(xe*=Te,ie*=Te,Ae*=Te),ue.set(xe,ie,Ae,Te),pe.equals(ue)===!1&&(t.clearColor(xe,ie,Ae,Te),pe.copy(ue))},reset:function(){I=!1,ee=null,pe.set(-1,0,0,0)}}}function i(){let I=!1,ue=!1,ee=null,pe=null,xe=null;return{setReversed:function(ie){if(ue!==ie){const Ae=e.get("EXT_clip_control");ie?Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.ZERO_TO_ONE_EXT):Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.NEGATIVE_ONE_TO_ONE_EXT),ue=ie;const Te=xe;xe=null,this.setClear(Te)}},getReversed:function(){return ue},setTest:function(ie){ie?te(t.DEPTH_TEST):Ee(t.DEPTH_TEST)},setMask:function(ie){ee!==ie&&!I&&(t.depthMask(ie),ee=ie)},setFunc:function(ie){if(ue&&(ie=yy[ie]),pe!==ie){switch(ie){case Nf:t.depthFunc(t.NEVER);break;case If:t.depthFunc(t.ALWAYS);break;case Uf:t.depthFunc(t.LESS);break;case zs:t.depthFunc(t.LEQUAL);break;case Ff:t.depthFunc(t.EQUAL);break;case Of:t.depthFunc(t.GEQUAL);break;case Bf:t.depthFunc(t.GREATER);break;case kf:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}pe=ie}},setLocked:function(ie){I=ie},setClear:function(ie){xe!==ie&&(xe=ie,ue&&(ie=1-ie),t.clearDepth(ie))},reset:function(){I=!1,ee=null,pe=null,xe=null,ue=!1}}}function r(){let I=!1,ue=null,ee=null,pe=null,xe=null,ie=null,Ae=null,Te=null,St=null;return{setTest:function(ct){I||(ct?te(t.STENCIL_TEST):Ee(t.STENCIL_TEST))},setMask:function(ct){ue!==ct&&!I&&(t.stencilMask(ct),ue=ct)},setFunc:function(ct,ni,ii){(ee!==ct||pe!==ni||xe!==ii)&&(t.stencilFunc(ct,ni,ii),ee=ct,pe=ni,xe=ii)},setOp:function(ct,ni,ii){(ie!==ct||Ae!==ni||Te!==ii)&&(t.stencilOp(ct,ni,ii),ie=ct,Ae=ni,Te=ii)},setLocked:function(ct){I=ct},setClear:function(ct){St!==ct&&(t.clearStencil(ct),St=ct)},reset:function(){I=!1,ue=null,ee=null,pe=null,xe=null,ie=null,Ae=null,Te=null,St=null}}}const s=new n,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let d={},h={},u={},p=new WeakMap,g=[],v=null,m=!1,f=null,_=null,M=null,x=null,E=null,A=null,C=null,y=new je(0,0,0),w=0,R=!1,P=null,L=null,k=null,$=null,D=null;const X=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,N=0;const W=t.getParameter(t.VERSION);W.indexOf("WebGL")!==-1?(N=parseFloat(/^WebGL (\d)/.exec(W)[1]),O=N>=1):W.indexOf("OpenGL ES")!==-1&&(N=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),O=N>=2);let K=null,j={};const re=t.getParameter(t.SCISSOR_BOX),se=t.getParameter(t.VIEWPORT),le=new Et().fromArray(re),oe=new Et().fromArray(se);function B(I,ue,ee,pe){const xe=new Uint8Array(4),ie=t.createTexture();t.bindTexture(I,ie),t.texParameteri(I,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(I,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Ae=0;Ae<ee;Ae++)I===t.TEXTURE_3D||I===t.TEXTURE_2D_ARRAY?t.texImage3D(ue,0,t.RGBA,1,1,pe,0,t.RGBA,t.UNSIGNED_BYTE,xe):t.texImage2D(ue+Ae,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,xe);return ie}const Z={};Z[t.TEXTURE_2D]=B(t.TEXTURE_2D,t.TEXTURE_2D,1),Z[t.TEXTURE_CUBE_MAP]=B(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[t.TEXTURE_2D_ARRAY]=B(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),Z[t.TEXTURE_3D]=B(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),te(t.DEPTH_TEST),o.setFunc(zs),bt(!1),Nt(Qp),te(t.CULL_FACE),Qe(Di);function te(I){d[I]!==!0&&(t.enable(I),d[I]=!0)}function Ee(I){d[I]!==!1&&(t.disable(I),d[I]=!1)}function De(I,ue){return u[I]!==ue?(t.bindFramebuffer(I,ue),u[I]=ue,I===t.DRAW_FRAMEBUFFER&&(u[t.FRAMEBUFFER]=ue),I===t.FRAMEBUFFER&&(u[t.DRAW_FRAMEBUFFER]=ue),!0):!1}function Ce(I,ue){let ee=g,pe=!1;if(I){ee=p.get(ue),ee===void 0&&(ee=[],p.set(ue,ee));const xe=I.textures;if(ee.length!==xe.length||ee[0]!==t.COLOR_ATTACHMENT0){for(let ie=0,Ae=xe.length;ie<Ae;ie++)ee[ie]=t.COLOR_ATTACHMENT0+ie;ee.length=xe.length,pe=!0}}else ee[0]!==t.BACK&&(ee[0]=t.BACK,pe=!0);pe&&t.drawBuffers(ee)}function Tt(I){return v!==I?(t.useProgram(I),v=I,!0):!1}const We={[Rr]:t.FUNC_ADD,[WS]:t.FUNC_SUBTRACT,[XS]:t.FUNC_REVERSE_SUBTRACT};We[$S]=t.MIN,We[YS]=t.MAX;const st={[qS]:t.ZERO,[KS]:t.ONE,[ZS]:t.SRC_COLOR,[Lf]:t.SRC_ALPHA,[ny]:t.SRC_ALPHA_SATURATE,[ey]:t.DST_COLOR,[QS]:t.DST_ALPHA,[JS]:t.ONE_MINUS_SRC_COLOR,[Df]:t.ONE_MINUS_SRC_ALPHA,[ty]:t.ONE_MINUS_DST_COLOR,[jS]:t.ONE_MINUS_DST_ALPHA,[iy]:t.CONSTANT_COLOR,[ry]:t.ONE_MINUS_CONSTANT_COLOR,[sy]:t.CONSTANT_ALPHA,[oy]:t.ONE_MINUS_CONSTANT_ALPHA};function Qe(I,ue,ee,pe,xe,ie,Ae,Te,St,ct){if(I===Di){m===!0&&(Ee(t.BLEND),m=!1);return}if(m===!1&&(te(t.BLEND),m=!0),I!==GS){if(I!==f||ct!==R){if((_!==Rr||E!==Rr)&&(t.blendEquation(t.FUNC_ADD),_=Rr,E=Rr),ct)switch(I){case Ps:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case jp:t.blendFunc(t.ONE,t.ONE);break;case em:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case tm:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:Ze("WebGLState: Invalid blending: ",I);break}else switch(I){case Ps:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case jp:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case em:Ze("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case tm:Ze("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ze("WebGLState: Invalid blending: ",I);break}M=null,x=null,A=null,C=null,y.set(0,0,0),w=0,f=I,R=ct}return}xe=xe||ue,ie=ie||ee,Ae=Ae||pe,(ue!==_||xe!==E)&&(t.blendEquationSeparate(We[ue],We[xe]),_=ue,E=xe),(ee!==M||pe!==x||ie!==A||Ae!==C)&&(t.blendFuncSeparate(st[ee],st[pe],st[ie],st[Ae]),M=ee,x=pe,A=ie,C=Ae),(Te.equals(y)===!1||St!==w)&&(t.blendColor(Te.r,Te.g,Te.b,St),y.copy(Te),w=St),f=I,R=!1}function qe(I,ue){I.side===Un?Ee(t.CULL_FACE):te(t.CULL_FACE);let ee=I.side===gn;ue&&(ee=!ee),bt(ee),I.blending===Ps&&I.transparent===!1?Qe(Di):Qe(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),o.setFunc(I.depthFunc),o.setTest(I.depthTest),o.setMask(I.depthWrite),s.setMask(I.colorWrite);const pe=I.stencilWrite;a.setTest(pe),pe&&(a.setMask(I.stencilWriteMask),a.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),a.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),Ht(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?te(t.SAMPLE_ALPHA_TO_COVERAGE):Ee(t.SAMPLE_ALPHA_TO_COVERAGE)}function bt(I){P!==I&&(I?t.frontFace(t.CW):t.frontFace(t.CCW),P=I)}function Nt(I){I!==zS?(te(t.CULL_FACE),I!==L&&(I===Qp?t.cullFace(t.BACK):I===VS?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Ee(t.CULL_FACE),L=I}function Bt(I){I!==k&&(O&&t.lineWidth(I),k=I)}function Ht(I,ue,ee){I?(te(t.POLYGON_OFFSET_FILL),($!==ue||D!==ee)&&($=ue,D=ee,o.getReversed()&&(ue=-ue),t.polygonOffset(ue,ee))):Ee(t.POLYGON_OFFSET_FILL)}function xt(I){I?te(t.SCISSOR_TEST):Ee(t.SCISSOR_TEST)}function Pt(I){I===void 0&&(I=t.TEXTURE0+X-1),K!==I&&(t.activeTexture(I),K=I)}function U(I,ue,ee){ee===void 0&&(K===null?ee=t.TEXTURE0+X-1:ee=K);let pe=j[ee];pe===void 0&&(pe={type:void 0,texture:void 0},j[ee]=pe),(pe.type!==I||pe.texture!==ue)&&(K!==ee&&(t.activeTexture(ee),K=ee),t.bindTexture(I,ue||Z[I]),pe.type=I,pe.texture=ue)}function cn(){const I=j[K];I!==void 0&&I.type!==void 0&&(t.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function tt(){try{t.compressedTexImage2D(...arguments)}catch(I){Ze("WebGLState:",I)}}function b(){try{t.compressedTexImage3D(...arguments)}catch(I){Ze("WebGLState:",I)}}function S(){try{t.texSubImage2D(...arguments)}catch(I){Ze("WebGLState:",I)}}function z(){try{t.texSubImage3D(...arguments)}catch(I){Ze("WebGLState:",I)}}function Y(){try{t.compressedTexSubImage2D(...arguments)}catch(I){Ze("WebGLState:",I)}}function J(){try{t.compressedTexSubImage3D(...arguments)}catch(I){Ze("WebGLState:",I)}}function ce(){try{t.texStorage2D(...arguments)}catch(I){Ze("WebGLState:",I)}}function fe(){try{t.texStorage3D(...arguments)}catch(I){Ze("WebGLState:",I)}}function Q(){try{t.texImage2D(...arguments)}catch(I){Ze("WebGLState:",I)}}function ne(){try{t.texImage3D(...arguments)}catch(I){Ze("WebGLState:",I)}}function de(I){return h[I]!==void 0?h[I]:t.getParameter(I)}function be(I,ue){h[I]!==ue&&(t.pixelStorei(I,ue),h[I]=ue)}function me(I){le.equals(I)===!1&&(t.scissor(I.x,I.y,I.z,I.w),le.copy(I))}function he(I){oe.equals(I)===!1&&(t.viewport(I.x,I.y,I.z,I.w),oe.copy(I))}function Ne(I,ue){let ee=c.get(ue);ee===void 0&&(ee=new WeakMap,c.set(ue,ee));let pe=ee.get(I);pe===void 0&&(pe=t.getUniformBlockIndex(ue,I.name),ee.set(I,pe))}function Ue(I,ue){const pe=c.get(ue).get(I);l.get(ue)!==pe&&(t.uniformBlockBinding(ue,pe,I.__bindingPointIndex),l.set(ue,pe))}function ke(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),o.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),d={},h={},K=null,j={},u={},p=new WeakMap,g=[],v=null,m=!1,f=null,_=null,M=null,x=null,E=null,A=null,C=null,y=new je(0,0,0),w=0,R=!1,P=null,L=null,k=null,$=null,D=null,le.set(0,0,t.canvas.width,t.canvas.height),oe.set(0,0,t.canvas.width,t.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:te,disable:Ee,bindFramebuffer:De,drawBuffers:Ce,useProgram:Tt,setBlending:Qe,setMaterial:qe,setFlipSided:bt,setCullFace:Nt,setLineWidth:Bt,setPolygonOffset:Ht,setScissorTest:xt,activeTexture:Pt,bindTexture:U,unbindTexture:cn,compressedTexImage2D:tt,compressedTexImage3D:b,texImage2D:Q,texImage3D:ne,pixelStorei:be,getParameter:de,updateUBOMapping:Ne,uniformBlockBinding:Ue,texStorage2D:ce,texStorage3D:fe,texSubImage2D:S,texSubImage3D:z,compressedTexSubImage2D:Y,compressedTexSubImage3D:J,scissor:me,viewport:he,reset:ke}}function Vw(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new et,d=new WeakMap,h=new Set;let u;const p=new WeakMap;let g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(b,S){return g?new OffscreenCanvas(b,S):Jl("canvas")}function m(b,S,z){let Y=1;const J=tt(b);if((J.width>z||J.height>z)&&(Y=z/Math.max(J.width,J.height)),Y<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const ce=Math.floor(Y*J.width),fe=Math.floor(Y*J.height);u===void 0&&(u=v(ce,fe));const Q=S?v(ce,fe):u;return Q.width=ce,Q.height=fe,Q.getContext("2d").drawImage(b,0,0,ce,fe),Fe("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+ce+"x"+fe+")."),Q}else return"data"in b&&Fe("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),b;return b}function f(b){return b.generateMipmaps}function _(b){t.generateMipmap(b)}function M(b){return b.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?t.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function x(b,S,z,Y,J,ce=!1){if(b!==null){if(t[b]!==void 0)return t[b];Fe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let fe;Y&&(fe=e.get("EXT_texture_norm16"),fe||Fe("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Q=S;if(S===t.RED&&(z===t.FLOAT&&(Q=t.R32F),z===t.HALF_FLOAT&&(Q=t.R16F),z===t.UNSIGNED_BYTE&&(Q=t.R8),z===t.UNSIGNED_SHORT&&fe&&(Q=fe.R16_EXT),z===t.SHORT&&fe&&(Q=fe.R16_SNORM_EXT)),S===t.RED_INTEGER&&(z===t.UNSIGNED_BYTE&&(Q=t.R8UI),z===t.UNSIGNED_SHORT&&(Q=t.R16UI),z===t.UNSIGNED_INT&&(Q=t.R32UI),z===t.BYTE&&(Q=t.R8I),z===t.SHORT&&(Q=t.R16I),z===t.INT&&(Q=t.R32I)),S===t.RG&&(z===t.FLOAT&&(Q=t.RG32F),z===t.HALF_FLOAT&&(Q=t.RG16F),z===t.UNSIGNED_BYTE&&(Q=t.RG8),z===t.UNSIGNED_SHORT&&fe&&(Q=fe.RG16_EXT),z===t.SHORT&&fe&&(Q=fe.RG16_SNORM_EXT)),S===t.RG_INTEGER&&(z===t.UNSIGNED_BYTE&&(Q=t.RG8UI),z===t.UNSIGNED_SHORT&&(Q=t.RG16UI),z===t.UNSIGNED_INT&&(Q=t.RG32UI),z===t.BYTE&&(Q=t.RG8I),z===t.SHORT&&(Q=t.RG16I),z===t.INT&&(Q=t.RG32I)),S===t.RGB_INTEGER&&(z===t.UNSIGNED_BYTE&&(Q=t.RGB8UI),z===t.UNSIGNED_SHORT&&(Q=t.RGB16UI),z===t.UNSIGNED_INT&&(Q=t.RGB32UI),z===t.BYTE&&(Q=t.RGB8I),z===t.SHORT&&(Q=t.RGB16I),z===t.INT&&(Q=t.RGB32I)),S===t.RGBA_INTEGER&&(z===t.UNSIGNED_BYTE&&(Q=t.RGBA8UI),z===t.UNSIGNED_SHORT&&(Q=t.RGBA16UI),z===t.UNSIGNED_INT&&(Q=t.RGBA32UI),z===t.BYTE&&(Q=t.RGBA8I),z===t.SHORT&&(Q=t.RGBA16I),z===t.INT&&(Q=t.RGBA32I)),S===t.RGB&&(z===t.UNSIGNED_SHORT&&fe&&(Q=fe.RGB16_EXT),z===t.SHORT&&fe&&(Q=fe.RGB16_SNORM_EXT),z===t.UNSIGNED_INT_5_9_9_9_REV&&(Q=t.RGB9_E5),z===t.UNSIGNED_INT_10F_11F_11F_REV&&(Q=t.R11F_G11F_B10F)),S===t.RGBA){const ne=ce?Kl:$e.getTransfer(J);z===t.FLOAT&&(Q=t.RGBA32F),z===t.HALF_FLOAT&&(Q=t.RGBA16F),z===t.UNSIGNED_BYTE&&(Q=ne===nt?t.SRGB8_ALPHA8:t.RGBA8),z===t.UNSIGNED_SHORT&&fe&&(Q=fe.RGBA16_EXT),z===t.SHORT&&fe&&(Q=fe.RGBA16_SNORM_EXT),z===t.UNSIGNED_SHORT_4_4_4_4&&(Q=t.RGBA4),z===t.UNSIGNED_SHORT_5_5_5_1&&(Q=t.RGB5_A1)}return(Q===t.R16F||Q===t.R32F||Q===t.RG16F||Q===t.RG32F||Q===t.RGBA16F||Q===t.RGBA32F)&&e.get("EXT_color_buffer_float"),Q}function E(b,S){let z;return b?S===null||S===_i||S===Zo?z=t.DEPTH24_STENCIL8:S===fi?z=t.DEPTH32F_STENCIL8:S===Ko&&(z=t.DEPTH24_STENCIL8,Fe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===_i||S===Zo?z=t.DEPTH_COMPONENT24:S===fi?z=t.DEPTH_COMPONENT32F:S===Ko&&(z=t.DEPTH_COMPONENT16),z}function A(b,S){return f(b)===!0||b.isFramebufferTexture&&b.minFilter!==Wt&&b.minFilter!==en?Math.log2(Math.max(S.width,S.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?S.mipmaps.length:1}function C(b){const S=b.target;S.removeEventListener("dispose",C),w(S),S.isVideoTexture&&d.delete(S),S.isHTMLTexture&&h.delete(S)}function y(b){const S=b.target;S.removeEventListener("dispose",y),P(S)}function w(b){const S=i.get(b);if(S.__webglInit===void 0)return;const z=b.source,Y=p.get(z);if(Y){const J=Y[S.__cacheKey];J.usedTimes--,J.usedTimes===0&&R(b),Object.keys(Y).length===0&&p.delete(z)}i.remove(b)}function R(b){const S=i.get(b);t.deleteTexture(S.__webglTexture);const z=b.source,Y=p.get(z);delete Y[S.__cacheKey],o.memory.textures--}function P(b){const S=i.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),i.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(S.__webglFramebuffer[Y]))for(let J=0;J<S.__webglFramebuffer[Y].length;J++)t.deleteFramebuffer(S.__webglFramebuffer[Y][J]);else t.deleteFramebuffer(S.__webglFramebuffer[Y]);S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer[Y])}else{if(Array.isArray(S.__webglFramebuffer))for(let Y=0;Y<S.__webglFramebuffer.length;Y++)t.deleteFramebuffer(S.__webglFramebuffer[Y]);else t.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&t.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let Y=0;Y<S.__webglColorRenderbuffer.length;Y++)S.__webglColorRenderbuffer[Y]&&t.deleteRenderbuffer(S.__webglColorRenderbuffer[Y]);S.__webglDepthRenderbuffer&&t.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const z=b.textures;for(let Y=0,J=z.length;Y<J;Y++){const ce=i.get(z[Y]);ce.__webglTexture&&(t.deleteTexture(ce.__webglTexture),o.memory.textures--),i.remove(z[Y])}i.remove(b)}let L=0;function k(){L=0}function $(){return L}function D(b){L=b}function X(){const b=L;return b>=r.maxTextures&&Fe("WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+r.maxTextures),L+=1,b}function O(b){const S=[];return S.push(b.wrapS),S.push(b.wrapT),S.push(b.wrapR||0),S.push(b.magFilter),S.push(b.minFilter),S.push(b.anisotropy),S.push(b.internalFormat),S.push(b.format),S.push(b.type),S.push(b.generateMipmaps),S.push(b.premultiplyAlpha),S.push(b.flipY),S.push(b.unpackAlignment),S.push(b.colorSpace),S.join()}function N(b,S){const z=i.get(b);if(b.isVideoTexture&&U(b),b.isRenderTargetTexture===!1&&b.isExternalTexture!==!0&&b.version>0&&z.__version!==b.version){const Y=b.image;if(Y===null)Fe("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)Fe("WebGLRenderer: Texture marked for update but image is incomplete");else{Ee(z,b,S);return}}else b.isExternalTexture&&(z.__webglTexture=b.sourceTexture?b.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,z.__webglTexture,t.TEXTURE0+S)}function W(b,S){const z=i.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&z.__version!==b.version){Ee(z,b,S);return}else b.isExternalTexture&&(z.__webglTexture=b.sourceTexture?b.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,z.__webglTexture,t.TEXTURE0+S)}function K(b,S){const z=i.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&z.__version!==b.version){Ee(z,b,S);return}n.bindTexture(t.TEXTURE_3D,z.__webglTexture,t.TEXTURE0+S)}function j(b,S){const z=i.get(b);if(b.isCubeDepthTexture!==!0&&b.version>0&&z.__version!==b.version){De(z,b,S);return}n.bindTexture(t.TEXTURE_CUBE_MAP,z.__webglTexture,t.TEXTURE0+S)}const re={[zf]:t.REPEAT,[Pi]:t.CLAMP_TO_EDGE,[Vf]:t.MIRRORED_REPEAT},se={[Wt]:t.NEAREST,[cy]:t.NEAREST_MIPMAP_NEAREST,[Ra]:t.NEAREST_MIPMAP_LINEAR,[en]:t.LINEAR,[nu]:t.LINEAR_MIPMAP_NEAREST,[Dr]:t.LINEAR_MIPMAP_LINEAR},le={[dy]:t.NEVER,[vy]:t.ALWAYS,[hy]:t.LESS,[Mh]:t.LEQUAL,[py]:t.EQUAL,[Eh]:t.GEQUAL,[my]:t.GREATER,[gy]:t.NOTEQUAL};function oe(b,S){if(S.type===fi&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===en||S.magFilter===nu||S.magFilter===Ra||S.magFilter===Dr||S.minFilter===en||S.minFilter===nu||S.minFilter===Ra||S.minFilter===Dr)&&Fe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(b,t.TEXTURE_WRAP_S,re[S.wrapS]),t.texParameteri(b,t.TEXTURE_WRAP_T,re[S.wrapT]),(b===t.TEXTURE_3D||b===t.TEXTURE_2D_ARRAY)&&t.texParameteri(b,t.TEXTURE_WRAP_R,re[S.wrapR]),t.texParameteri(b,t.TEXTURE_MAG_FILTER,se[S.magFilter]),t.texParameteri(b,t.TEXTURE_MIN_FILTER,se[S.minFilter]),S.compareFunction&&(t.texParameteri(b,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(b,t.TEXTURE_COMPARE_FUNC,le[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Wt||S.minFilter!==Ra&&S.minFilter!==Dr||S.type===fi&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");t.texParameterf(b,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function B(b,S){let z=!1;b.__webglInit===void 0&&(b.__webglInit=!0,S.addEventListener("dispose",C));const Y=S.source;let J=p.get(Y);J===void 0&&(J={},p.set(Y,J));const ce=O(S);if(ce!==b.__cacheKey){J[ce]===void 0&&(J[ce]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,z=!0),J[ce].usedTimes++;const fe=J[b.__cacheKey];fe!==void 0&&(J[b.__cacheKey].usedTimes--,fe.usedTimes===0&&R(S)),b.__cacheKey=ce,b.__webglTexture=J[ce].texture}return z}function Z(b,S,z){return Math.floor(Math.floor(b/z)/S)}function te(b,S,z,Y){const ce=b.updateRanges;if(ce.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,S.width,S.height,z,Y,S.data);else{ce.sort((be,me)=>be.start-me.start);let fe=0;for(let be=1;be<ce.length;be++){const me=ce[fe],he=ce[be],Ne=me.start+me.count,Ue=Z(he.start,S.width,4),ke=Z(me.start,S.width,4);he.start<=Ne+1&&Ue===ke&&Z(he.start+he.count-1,S.width,4)===Ue?me.count=Math.max(me.count,he.start+he.count-me.start):(++fe,ce[fe]=he)}ce.length=fe+1;const Q=n.getParameter(t.UNPACK_ROW_LENGTH),ne=n.getParameter(t.UNPACK_SKIP_PIXELS),de=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,S.width);for(let be=0,me=ce.length;be<me;be++){const he=ce[be],Ne=Math.floor(he.start/4),Ue=Math.ceil(he.count/4),ke=Ne%S.width,I=Math.floor(Ne/S.width),ue=Ue,ee=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,ke),n.pixelStorei(t.UNPACK_SKIP_ROWS,I),n.texSubImage2D(t.TEXTURE_2D,0,ke,I,ue,ee,z,Y,S.data)}b.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,Q),n.pixelStorei(t.UNPACK_SKIP_PIXELS,ne),n.pixelStorei(t.UNPACK_SKIP_ROWS,de)}}function Ee(b,S,z){let Y=t.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(Y=t.TEXTURE_2D_ARRAY),S.isData3DTexture&&(Y=t.TEXTURE_3D);const J=B(b,S),ce=S.source;n.bindTexture(Y,b.__webglTexture,t.TEXTURE0+z);const fe=i.get(ce);if(ce.version!==fe.__version||J===!0){if(n.activeTexture(t.TEXTURE0+z),(typeof ImageBitmap<"u"&&S.image instanceof ImageBitmap)===!1){const ee=$e.getPrimaries($e.workingColorSpace),pe=S.colorSpace===tr?null:$e.getPrimaries(S.colorSpace),xe=S.colorSpace===tr||ee===pe?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe)}n.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment);let ne=m(S.image,!1,r.maxTextureSize);ne=cn(S,ne);const de=s.convert(S.format,S.colorSpace),be=s.convert(S.type);let me=x(S.internalFormat,de,be,S.normalized,S.colorSpace,S.isVideoTexture);oe(Y,S);let he;const Ne=S.mipmaps,Ue=S.isVideoTexture!==!0,ke=fe.__version===void 0||J===!0,I=ce.dataReady,ue=A(S,ne);if(S.isDepthTexture)me=E(S.format===Nr,S.type),ke&&(Ue?n.texStorage2D(t.TEXTURE_2D,1,me,ne.width,ne.height):n.texImage2D(t.TEXTURE_2D,0,me,ne.width,ne.height,0,de,be,null));else if(S.isDataTexture)if(Ne.length>0){Ue&&ke&&n.texStorage2D(t.TEXTURE_2D,ue,me,Ne[0].width,Ne[0].height);for(let ee=0,pe=Ne.length;ee<pe;ee++)he=Ne[ee],Ue?I&&n.texSubImage2D(t.TEXTURE_2D,ee,0,0,he.width,he.height,de,be,he.data):n.texImage2D(t.TEXTURE_2D,ee,me,he.width,he.height,0,de,be,he.data);S.generateMipmaps=!1}else Ue?(ke&&n.texStorage2D(t.TEXTURE_2D,ue,me,ne.width,ne.height),I&&te(S,ne,de,be)):n.texImage2D(t.TEXTURE_2D,0,me,ne.width,ne.height,0,de,be,ne.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){Ue&&ke&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ue,me,Ne[0].width,Ne[0].height,ne.depth);for(let ee=0,pe=Ne.length;ee<pe;ee++)if(he=Ne[ee],S.format!==Qn)if(de!==null)if(Ue){if(I)if(S.layerUpdates.size>0){const xe=Pm(he.width,he.height,S.format,S.type);for(const ie of S.layerUpdates){const Ae=he.data.subarray(ie*xe/he.data.BYTES_PER_ELEMENT,(ie+1)*xe/he.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ee,0,0,ie,he.width,he.height,1,de,Ae)}S.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ee,0,0,0,he.width,he.height,ne.depth,de,he.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,ee,me,he.width,he.height,ne.depth,0,he.data,0,0);else Fe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ue?I&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,ee,0,0,0,he.width,he.height,ne.depth,de,be,he.data):n.texImage3D(t.TEXTURE_2D_ARRAY,ee,me,he.width,he.height,ne.depth,0,de,be,he.data)}else{Ue&&ke&&n.texStorage2D(t.TEXTURE_2D,ue,me,Ne[0].width,Ne[0].height);for(let ee=0,pe=Ne.length;ee<pe;ee++)he=Ne[ee],S.format!==Qn?de!==null?Ue?I&&n.compressedTexSubImage2D(t.TEXTURE_2D,ee,0,0,he.width,he.height,de,he.data):n.compressedTexImage2D(t.TEXTURE_2D,ee,me,he.width,he.height,0,he.data):Fe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ue?I&&n.texSubImage2D(t.TEXTURE_2D,ee,0,0,he.width,he.height,de,be,he.data):n.texImage2D(t.TEXTURE_2D,ee,me,he.width,he.height,0,de,be,he.data)}else if(S.isDataArrayTexture)if(Ue){if(ke&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ue,me,ne.width,ne.height,ne.depth),I)if(S.layerUpdates.size>0){const ee=Pm(ne.width,ne.height,S.format,S.type);for(const pe of S.layerUpdates){const xe=ne.data.subarray(pe*ee/ne.data.BYTES_PER_ELEMENT,(pe+1)*ee/ne.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,pe,ne.width,ne.height,1,de,be,xe)}S.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,ne.width,ne.height,ne.depth,de,be,ne.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,me,ne.width,ne.height,ne.depth,0,de,be,ne.data);else if(S.isData3DTexture)Ue?(ke&&n.texStorage3D(t.TEXTURE_3D,ue,me,ne.width,ne.height,ne.depth),I&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,ne.width,ne.height,ne.depth,de,be,ne.data)):n.texImage3D(t.TEXTURE_3D,0,me,ne.width,ne.height,ne.depth,0,de,be,ne.data);else if(S.isFramebufferTexture){if(ke)if(Ue)n.texStorage2D(t.TEXTURE_2D,ue,me,ne.width,ne.height);else{let ee=ne.width,pe=ne.height;for(let xe=0;xe<ue;xe++)n.texImage2D(t.TEXTURE_2D,xe,me,ee,pe,0,de,be,null),ee>>=1,pe>>=1}}else if(S.isHTMLTexture){if("texElementImage2D"in t){const ee=t.canvas;if(ee.hasAttribute("layoutsubtree")||ee.setAttribute("layoutsubtree","true"),ne.parentNode!==ee){ee.appendChild(ne),h.add(S),ee.onpaint=pe=>{const xe=pe.changedElements;for(const ie of h)xe.includes(ie.image)&&(ie.needsUpdate=!0)},ee.requestPaint();return}if(t.texElementImage2D.length===3)t.texElementImage2D(t.TEXTURE_2D,t.RGBA8,ne);else{const xe=t.RGBA,ie=t.RGBA,Ae=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,0,xe,ie,Ae,ne)}t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(Ne.length>0){if(Ue&&ke){const ee=tt(Ne[0]);n.texStorage2D(t.TEXTURE_2D,ue,me,ee.width,ee.height)}for(let ee=0,pe=Ne.length;ee<pe;ee++)he=Ne[ee],Ue?I&&n.texSubImage2D(t.TEXTURE_2D,ee,0,0,de,be,he):n.texImage2D(t.TEXTURE_2D,ee,me,de,be,he);S.generateMipmaps=!1}else if(Ue){if(ke){const ee=tt(ne);n.texStorage2D(t.TEXTURE_2D,ue,me,ee.width,ee.height)}I&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,de,be,ne)}else n.texImage2D(t.TEXTURE_2D,0,me,de,be,ne);f(S)&&_(Y),fe.__version=ce.version,S.onUpdate&&S.onUpdate(S)}b.__version=S.version}function De(b,S,z){if(S.image.length!==6)return;const Y=B(b,S),J=S.source;n.bindTexture(t.TEXTURE_CUBE_MAP,b.__webglTexture,t.TEXTURE0+z);const ce=i.get(J);if(J.version!==ce.__version||Y===!0){n.activeTexture(t.TEXTURE0+z);const fe=$e.getPrimaries($e.workingColorSpace),Q=S.colorSpace===tr?null:$e.getPrimaries(S.colorSpace),ne=S.colorSpace===tr||fe===Q?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,ne);const de=S.isCompressedTexture||S.image[0].isCompressedTexture,be=S.image[0]&&S.image[0].isDataTexture,me=[];for(let ie=0;ie<6;ie++)!de&&!be?me[ie]=m(S.image[ie],!0,r.maxCubemapSize):me[ie]=be?S.image[ie].image:S.image[ie],me[ie]=cn(S,me[ie]);const he=me[0],Ne=s.convert(S.format,S.colorSpace),Ue=s.convert(S.type),ke=x(S.internalFormat,Ne,Ue,S.normalized,S.colorSpace),I=S.isVideoTexture!==!0,ue=ce.__version===void 0||Y===!0,ee=J.dataReady;let pe=A(S,he);oe(t.TEXTURE_CUBE_MAP,S);let xe;if(de){I&&ue&&n.texStorage2D(t.TEXTURE_CUBE_MAP,pe,ke,he.width,he.height);for(let ie=0;ie<6;ie++){xe=me[ie].mipmaps;for(let Ae=0;Ae<xe.length;Ae++){const Te=xe[Ae];S.format!==Qn?Ne!==null?I?ee&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae,0,0,Te.width,Te.height,Ne,Te.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae,ke,Te.width,Te.height,0,Te.data):Fe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?ee&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae,0,0,Te.width,Te.height,Ne,Ue,Te.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae,ke,Te.width,Te.height,0,Ne,Ue,Te.data)}}}else{if(xe=S.mipmaps,I&&ue){xe.length>0&&pe++;const ie=tt(me[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,pe,ke,ie.width,ie.height)}for(let ie=0;ie<6;ie++)if(be){I?ee&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,0,0,me[ie].width,me[ie].height,Ne,Ue,me[ie].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,ke,me[ie].width,me[ie].height,0,Ne,Ue,me[ie].data);for(let Ae=0;Ae<xe.length;Ae++){const St=xe[Ae].image[ie].image;I?ee&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae+1,0,0,St.width,St.height,Ne,Ue,St.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae+1,ke,St.width,St.height,0,Ne,Ue,St.data)}}else{I?ee&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,0,0,Ne,Ue,me[ie]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,ke,Ne,Ue,me[ie]);for(let Ae=0;Ae<xe.length;Ae++){const Te=xe[Ae];I?ee&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae+1,0,0,Ne,Ue,Te.image[ie]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae+1,ke,Ne,Ue,Te.image[ie])}}}f(S)&&_(t.TEXTURE_CUBE_MAP),ce.__version=J.version,S.onUpdate&&S.onUpdate(S)}b.__version=S.version}function Ce(b,S,z,Y,J,ce){const fe=s.convert(z.format,z.colorSpace),Q=s.convert(z.type),ne=x(z.internalFormat,fe,Q,z.normalized,z.colorSpace),de=i.get(S),be=i.get(z);if(be.__renderTarget=S,!de.__hasExternalTextures){const me=Math.max(1,S.width>>ce),he=Math.max(1,S.height>>ce);J===t.TEXTURE_3D||J===t.TEXTURE_2D_ARRAY?n.texImage3D(J,ce,ne,me,he,S.depth,0,fe,Q,null):n.texImage2D(J,ce,ne,me,he,0,fe,Q,null)}n.bindFramebuffer(t.FRAMEBUFFER,b),Pt(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Y,J,be.__webglTexture,0,xt(S)):(J===t.TEXTURE_2D||J>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,Y,J,be.__webglTexture,ce),n.bindFramebuffer(t.FRAMEBUFFER,null)}function Tt(b,S,z){if(t.bindRenderbuffer(t.RENDERBUFFER,b),S.depthBuffer){const Y=S.depthTexture,J=Y&&Y.isDepthTexture?Y.type:null,ce=E(S.stencilBuffer,J),fe=S.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;Pt(S)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,xt(S),ce,S.width,S.height):z?t.renderbufferStorageMultisample(t.RENDERBUFFER,xt(S),ce,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,ce,S.width,S.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,fe,t.RENDERBUFFER,b)}else{const Y=S.textures;for(let J=0;J<Y.length;J++){const ce=Y[J],fe=s.convert(ce.format,ce.colorSpace),Q=s.convert(ce.type),ne=x(ce.internalFormat,fe,Q,ce.normalized,ce.colorSpace);Pt(S)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,xt(S),ne,S.width,S.height):z?t.renderbufferStorageMultisample(t.RENDERBUFFER,xt(S),ne,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,ne,S.width,S.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function We(b,S,z){const Y=S.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,b),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const J=i.get(S.depthTexture);if(J.__renderTarget=S,(!J.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),Y){if(J.__webglInit===void 0&&(J.__webglInit=!0,S.depthTexture.addEventListener("dispose",C)),J.__webglTexture===void 0){J.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,J.__webglTexture),oe(t.TEXTURE_CUBE_MAP,S.depthTexture);const de=s.convert(S.depthTexture.format),be=s.convert(S.depthTexture.type);let me;S.depthTexture.format===ki?me=t.DEPTH_COMPONENT24:S.depthTexture.format===Nr&&(me=t.DEPTH24_STENCIL8);for(let he=0;he<6;he++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+he,0,me,S.width,S.height,0,de,be,null)}}else N(S.depthTexture,0);const ce=J.__webglTexture,fe=xt(S),Q=Y?t.TEXTURE_CUBE_MAP_POSITIVE_X+z:t.TEXTURE_2D,ne=S.depthTexture.format===Nr?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(S.depthTexture.format===ki)Pt(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,ne,Q,ce,0,fe):t.framebufferTexture2D(t.FRAMEBUFFER,ne,Q,ce,0);else if(S.depthTexture.format===Nr)Pt(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,ne,Q,ce,0,fe):t.framebufferTexture2D(t.FRAMEBUFFER,ne,Q,ce,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function st(b){const S=i.get(b),z=b.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==b.depthTexture){const Y=b.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),Y){const J=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,Y.removeEventListener("dispose",J)};Y.addEventListener("dispose",J),S.__depthDisposeCallback=J}S.__boundDepthTexture=Y}if(b.depthTexture&&!S.__autoAllocateDepthBuffer)if(z)for(let Y=0;Y<6;Y++)We(S.__webglFramebuffer[Y],b,Y);else{const Y=b.texture.mipmaps;Y&&Y.length>0?We(S.__webglFramebuffer[0],b,0):We(S.__webglFramebuffer,b,0)}else if(z){S.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[Y]),S.__webglDepthbuffer[Y]===void 0)S.__webglDepthbuffer[Y]=t.createRenderbuffer(),Tt(S.__webglDepthbuffer[Y],b,!1);else{const J=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ce=S.__webglDepthbuffer[Y];t.bindRenderbuffer(t.RENDERBUFFER,ce),t.framebufferRenderbuffer(t.FRAMEBUFFER,J,t.RENDERBUFFER,ce)}}else{const Y=b.texture.mipmaps;if(Y&&Y.length>0?n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=t.createRenderbuffer(),Tt(S.__webglDepthbuffer,b,!1);else{const J=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ce=S.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,ce),t.framebufferRenderbuffer(t.FRAMEBUFFER,J,t.RENDERBUFFER,ce)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function Qe(b,S,z){const Y=i.get(b);S!==void 0&&Ce(Y.__webglFramebuffer,b,b.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),z!==void 0&&st(b)}function qe(b){const S=b.texture,z=i.get(b),Y=i.get(S);b.addEventListener("dispose",y);const J=b.textures,ce=b.isWebGLCubeRenderTarget===!0,fe=J.length>1;if(fe||(Y.__webglTexture===void 0&&(Y.__webglTexture=t.createTexture()),Y.__version=S.version,o.memory.textures++),ce){z.__webglFramebuffer=[];for(let Q=0;Q<6;Q++)if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer[Q]=[];for(let ne=0;ne<S.mipmaps.length;ne++)z.__webglFramebuffer[Q][ne]=t.createFramebuffer()}else z.__webglFramebuffer[Q]=t.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer=[];for(let Q=0;Q<S.mipmaps.length;Q++)z.__webglFramebuffer[Q]=t.createFramebuffer()}else z.__webglFramebuffer=t.createFramebuffer();if(fe)for(let Q=0,ne=J.length;Q<ne;Q++){const de=i.get(J[Q]);de.__webglTexture===void 0&&(de.__webglTexture=t.createTexture(),o.memory.textures++)}if(b.samples>0&&Pt(b)===!1){z.__webglMultisampledFramebuffer=t.createFramebuffer(),z.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let Q=0;Q<J.length;Q++){const ne=J[Q];z.__webglColorRenderbuffer[Q]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,z.__webglColorRenderbuffer[Q]);const de=s.convert(ne.format,ne.colorSpace),be=s.convert(ne.type),me=x(ne.internalFormat,de,be,ne.normalized,ne.colorSpace,b.isXRRenderTarget===!0),he=xt(b);t.renderbufferStorageMultisample(t.RENDERBUFFER,he,me,b.width,b.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Q,t.RENDERBUFFER,z.__webglColorRenderbuffer[Q])}t.bindRenderbuffer(t.RENDERBUFFER,null),b.depthBuffer&&(z.__webglDepthRenderbuffer=t.createRenderbuffer(),Tt(z.__webglDepthRenderbuffer,b,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ce){n.bindTexture(t.TEXTURE_CUBE_MAP,Y.__webglTexture),oe(t.TEXTURE_CUBE_MAP,S);for(let Q=0;Q<6;Q++)if(S.mipmaps&&S.mipmaps.length>0)for(let ne=0;ne<S.mipmaps.length;ne++)Ce(z.__webglFramebuffer[Q][ne],b,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ne);else Ce(z.__webglFramebuffer[Q],b,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0);f(S)&&_(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(fe){for(let Q=0,ne=J.length;Q<ne;Q++){const de=J[Q],be=i.get(de);let me=t.TEXTURE_2D;(b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(me=b.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(me,be.__webglTexture),oe(me,de),Ce(z.__webglFramebuffer,b,de,t.COLOR_ATTACHMENT0+Q,me,0),f(de)&&_(me)}n.unbindTexture()}else{let Q=t.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(Q=b.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(Q,Y.__webglTexture),oe(Q,S),S.mipmaps&&S.mipmaps.length>0)for(let ne=0;ne<S.mipmaps.length;ne++)Ce(z.__webglFramebuffer[ne],b,S,t.COLOR_ATTACHMENT0,Q,ne);else Ce(z.__webglFramebuffer,b,S,t.COLOR_ATTACHMENT0,Q,0);f(S)&&_(Q),n.unbindTexture()}b.depthBuffer&&st(b)}function bt(b){const S=b.textures;for(let z=0,Y=S.length;z<Y;z++){const J=S[z];if(f(J)){const ce=M(b),fe=i.get(J).__webglTexture;n.bindTexture(ce,fe),_(ce),n.unbindTexture()}}}const Nt=[],Bt=[];function Ht(b){if(b.samples>0){if(Pt(b)===!1){const S=b.textures,z=b.width,Y=b.height;let J=t.COLOR_BUFFER_BIT;const ce=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,fe=i.get(b),Q=S.length>1;if(Q)for(let de=0;de<S.length;de++)n.bindFramebuffer(t.FRAMEBUFFER,fe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+de,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,fe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+de,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,fe.__webglMultisampledFramebuffer);const ne=b.texture.mipmaps;ne&&ne.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,fe.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,fe.__webglFramebuffer);for(let de=0;de<S.length;de++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(J|=t.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(J|=t.STENCIL_BUFFER_BIT)),Q){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,fe.__webglColorRenderbuffer[de]);const be=i.get(S[de]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,be,0)}t.blitFramebuffer(0,0,z,Y,0,0,z,Y,J,t.NEAREST),l===!0&&(Nt.length=0,Bt.length=0,Nt.push(t.COLOR_ATTACHMENT0+de),b.depthBuffer&&b.resolveDepthBuffer===!1&&(Nt.push(ce),Bt.push(ce),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,Bt)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,Nt))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),Q)for(let de=0;de<S.length;de++){n.bindFramebuffer(t.FRAMEBUFFER,fe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+de,t.RENDERBUFFER,fe.__webglColorRenderbuffer[de]);const be=i.get(S[de]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,fe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+de,t.TEXTURE_2D,be,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,fe.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){const S=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[S])}}}function xt(b){return Math.min(r.maxSamples,b.samples)}function Pt(b){const S=i.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function U(b){const S=o.render.frame;d.get(b)!==S&&(d.set(b,S),b.update())}function cn(b,S){const z=b.colorSpace,Y=b.format,J=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||z!==ql&&z!==tr&&($e.getTransfer(z)===nt?(Y!==Qn||J!==Fn)&&Fe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ze("WebGLTextures: Unsupported texture color space:",z)),S}function tt(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=X,this.resetTextureUnits=k,this.getTextureUnits=$,this.setTextureUnits=D,this.setTexture2D=N,this.setTexture2DArray=W,this.setTexture3D=K,this.setTextureCube=j,this.rebindTextures=Qe,this.setupRenderTarget=qe,this.updateRenderTargetMipmap=bt,this.updateMultisampleRenderTarget=Ht,this.setupDepthRenderbuffer=st,this.setupFrameBufferTexture=Ce,this.useMultisampledRTT=Pt,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function Hw(t,e){function n(i,r=tr){let s;const o=$e.getTransfer(r);if(i===Fn)return t.UNSIGNED_BYTE;if(i===vh)return t.UNSIGNED_SHORT_4_4_4_4;if(i===_h)return t.UNSIGNED_SHORT_5_5_5_1;if(i===Rv)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===Cv)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===wv)return t.BYTE;if(i===Av)return t.SHORT;if(i===Ko)return t.UNSIGNED_SHORT;if(i===gh)return t.INT;if(i===_i)return t.UNSIGNED_INT;if(i===fi)return t.FLOAT;if(i===Bi)return t.HALF_FLOAT;if(i===bv)return t.ALPHA;if(i===Pv)return t.RGB;if(i===Qn)return t.RGBA;if(i===ki)return t.DEPTH_COMPONENT;if(i===Nr)return t.DEPTH_STENCIL;if(i===Lv)return t.RED;if(i===xh)return t.RED_INTEGER;if(i===Gr)return t.RG;if(i===Sh)return t.RG_INTEGER;if(i===yh)return t.RGBA_INTEGER;if(i===gl||i===vl||i===_l||i===xl)if(o===nt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===gl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===vl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===_l)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===xl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===gl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===vl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===_l)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===xl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Hf||i===Gf||i===Wf||i===Xf)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Hf)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Gf)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Wf)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Xf)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===$f||i===Yf||i===qf||i===Kf||i===Zf||i===$l||i===Jf)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===$f||i===Yf)return o===nt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===qf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Kf)return s.COMPRESSED_R11_EAC;if(i===Zf)return s.COMPRESSED_SIGNED_R11_EAC;if(i===$l)return s.COMPRESSED_RG11_EAC;if(i===Jf)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Qf||i===jf||i===ed||i===td||i===nd||i===id||i===rd||i===sd||i===od||i===ad||i===ld||i===cd||i===ud||i===fd)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Qf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===jf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===ed)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===td)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===nd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===id)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===rd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===sd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===od)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===ad)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===ld)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===cd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===ud)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===fd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===dd||i===hd||i===pd)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===dd)return o===nt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===hd)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===pd)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===md||i===gd||i===Yl||i===vd)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===md)return s.COMPRESSED_RED_RGTC1_EXT;if(i===gd)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Yl)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===vd)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Zo?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const Gw=`
void main() {
...
}`;class Xw{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n){if(this.texture===null){const i=new Vv(e.texture);(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new xi({vertexShader:Gw,fragmentShader:Ww,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new zn(new Fr(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class $w extends Yr{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,d=null,h=null,u=null,p=null,g=null;const v=typeof XRWebGLBinding<"u",m=new Xw,f={},_=n.getContextAttributes();let M=null,x=null;const E=[],A=[],C=new et;let y=null;const w=new Jn;w.viewport=new Et;const R=new Jn;R.viewport=new Et;const P=[w,R],L=new nM;let k=null,$=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(B){let Z=E[B];return Z===void 0&&(Z=new cu,E[B]=Z),Z.getTargetRaySpace()},this.getControllerGrip=function(B){let Z=E[B];return Z===void 0&&(Z=new cu,E[B]=Z),Z.getGripSpace()},this.getHand=function(B){let Z=E[B];return Z===void 0&&(Z=new cu,E[B]=Z),Z.getHandSpace()};function D(B){const Z=A.indexOf(B.inputSource);if(Z===-1)return;const te=E[Z];te!==void 0&&(te.update(B.inputSource,B.frame,c||o),te.dispatchEvent({type:B.type,data:B.inputSource}))}function X(){r.removeEventListener("select",D),r.removeEventListener("selectstart",D),r.removeEventListener("selectend",D),r.removeEventListener("squeeze",D),r.removeEventListener("squeezestart",D),r.removeEventListener("squeezeend",D),r.removeEventListener("end",X),r.removeEventListener("inputsourceschange",O);for(let B=0;B<E.length;B++){const Z=A[B];Z!==null&&(A[B]=null,E[B].disconnect(Z))}k=null,$=null,m.reset();for(const B in f)delete f[B];e.setRenderTarget(M),p=null,u=null,h=null,r=null,x=null,oe.stop(),i.isPresenting=!1,e.setPixelRatio(y),e.setSize(C.width,C.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(B){s=B,i.isPresenting===!0&&Fe("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(B){a=B,i.isPresenting===!0&&Fe("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(B){c=B},this.getBaseLayer=function(){return u!==null?u:p},this.getBinding=function(){return h===null&&v&&(h=new XRWebGLBinding(r,n)),h},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(B){if(r=B,r!==null){if(M=e.getRenderTarget(),r.addEventListener("select",D),r.addEventListener("selectstart",D),r.addEventListener("selectend",D),r.addEventListener("squeeze",D),r.addEventListener("squeezestart",D),r.addEventListener("squeezeend",D),r.addEventListener("end",X),r.addEventListener("inputsourceschange",O),_.xrCompatible!==!0&&await n.makeXRCompatible(),y=e.getPixelRatio(),e.getSize(C),v&&"createProjectionLayer"in XRWebGLBinding.prototype){let te=null,Ee=null,De=null;_.depth&&(De=_.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,te=_.stencil?Nr:ki,Ee=_.stencil?Zo:_i);const Ce={colorFormat:n.RGBA8,depthFormat:De,scaleFactor:s};h=this.getBinding(),u=h.createProjectionLayer(Ce),r.updateRenderState({layers:[u]}),e.setPixelRatio(1),e.setSize(u.textureWidth,u.textureHeight,!1),x=new gi(u.textureWidth,u.textureHeight,{format:Qn,type:Fn,depthTexture:new Hs(u.textureWidth,u.textureHeight,Ee,void 0,void 0,void 0,void 0,void 0,void 0,te),stencilBuffer:_.stencil,colorSpace:e.outputColorSpace,samples:_.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{const te={antialias:_.antialias,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,n,te),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),x=new gi(p.framebufferWidth,p.framebufferHeight,{format:Qn,type:Fn,colorSpace:e.outputColorSpace,stencilBuffer:_.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}x.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),oe.setContext(r),oe.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function O(B){for(let Z=0;Z<B.removed.length;Z++){const te=B.removed[Z],Ee=A.indexOf(te);Ee>=0&&(A[Ee]=null,E[Ee].disconnect(te))}for(let Z=0;Z<B.added.length;Z++){const te=B.added[Z];let Ee=A.indexOf(te);if(Ee===-1){for(let Ce=0;Ce<E.length;Ce++)if(Ce>=A.length){A.push(te),Ee=Ce;break}else if(A[Ce]===null){A[Ce]=te,Ee=Ce;break}if(Ee===-1)break}const De=E[Ee];De&&De.connect(te)}}const N=new V,W=new V;function K(B,Z,te){N.setFromMatrixPosition(Z.matrixWorld),W.setFromMatrixPosition(te.matrixWorld);const Ee=N.distanceTo(W),De=Z.projectionMatrix.elements,Ce=te.projectionMatrix.elements,Tt=De[14]/(De[10]-1),We=De[14]/(De[10]+1),st=(De[9]+1)/De[5],Qe=(De[9]-1)/De[5],qe=(De[8]-1)/De[0],bt=(Ce[8]+1)/Ce[0],Nt=Tt*qe,Bt=Tt*bt,Ht=Ee/(-qe+bt),xt=Ht*-qe;if(Z.matrixWorld.decompose(B.position,B.quaternion,B.scale),B.translateX(xt),B.translateZ(Ht),B.matrixWorld.compose(B.position,B.quaternion,B.scale),B.matrixWorldInverse.copy(B.matrixWorld).invert(),De[10]===-1)B.projectionMatrix.copy(Z.projectionMatrix),B.projectionMatrixInverse.copy(Z.projectionMatrixInverse);else{const Pt=Tt+Ht,U=We+Ht,cn=Nt-xt,tt=Bt+(Ee-xt),b=st*We/U*Pt,S=Qe*We/U*Pt;B.projectionMatrix.makePerspective(cn,tt,b,S,Pt,U),B.projectionMatrixInverse.copy(B.projectionMatrix).invert()}}function j(B,Z){Z===null?B.matrixWorld.copy(B.matrix):B.matrixWorld.multiplyMatrices(Z.matrixWorld,B.matrix),B.matrixWorldInverse.copy(B.matrixWorld).invert()}this.updateCamera=function(B){if(r===null)return;let Z=B.near,te=B.far;m.texture!==null&&(m.depthNear>0&&(Z=m.depthNear),m.depthFar>0&&(te=m.depthFar)),L.near=R.near=w.near=Z,L.far=R.far=w.far=te,(k!==L.near||$!==L.far)&&(r.updateRenderState({depthNear:L.near,depthFar:L.far}),k=L.near,$=L.far),L.layers.mask=B.layers.mask|6,w.layers.mask=L.layers.mask&-5,R.layers.mask=L.layers.mask&-3;const Ee=B.parent,De=L.cameras;j(L,Ee);for(let Ce=0;Ce<De.length;Ce++)j(De[Ce],Ee);De.length===2?K(L,w,R):L.projectionMatrix.copy(w.projectionMatrix),re(B,L,Ee)};function re(B,Z,te){te===null?B.matrix.copy(Z.matrixWorld):(B.matrix.copy(te.matrixWorld),B.matrix.invert(),B.matrix.multiply(Z.matrixWorld)),B.matrix.decompose(B.position,B.quaternion,B.scale),B.updateMatrixWorld(!0),B.projectionMatrix.copy(Z.projectionMatrix),B.projectionMatrixInverse.copy(Z.projectionMatrixInverse),B.isPerspectiveCamera&&(B.fov=_d*2*Math.atan(1/B.projectionMatrix.elements[5]),B.zoom=1)}this.getCamera=function(){return L},this.getFoveation=function(){if(!(u===null&&p===null))return l},this.setFoveation=function(B){l=B,u!==null&&(u.fixedFoveation=B),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=B)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(L)},this.getCameraTexture=function(B){return f[B]};let se=null;function le(B,Z){if(d=Z.getViewerPose(c||o),g=Z,d!==null){const te=d.views;p!==null&&(e.setRenderTargetFramebuffer(x,p.framebuffer),e.setRenderTarget(x));let Ee=!1;te.length!==L.cameras.length&&(L.cameras.length=0,Ee=!0);for(let We=0;We<te.length;We++){const st=te[We];let Qe=null;if(p!==null)Qe=p.getViewport(st);else{const bt=h.getViewSubImage(u,st);Qe=bt.viewport,We===0&&(e.setRenderTargetTextures(x,bt.colorTexture,bt.depthStencilTexture),e.setRenderTarget(x))}let qe=P[We];qe===void 0&&(qe=new Jn,qe.layers.enable(We),qe.viewport=new Et,P[We]=qe),qe.matrix.fromArray(st.transform.matrix),qe.matrix.decompose(qe.position,qe.quaternion,qe.scale),qe.projectionMatrix.fromArray(st.projectionMatrix),qe.projectionMatrixInverse.copy(qe.projectionMatrix).invert(),qe.viewport.set(Qe.x,Qe.y,Qe.width,Qe.height),We===0&&(L.matrix.copy(qe.matrix),L.matrix.decompose(L.position,L.quaternion,L.scale)),Ee===!0&&L.cameras.push(qe)}const De=r.enabledFeatures;if(De&&De.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&v){h=i.getBinding();const We=h.getDepthInformation(te[0]);We&&We.isValid&&We.texture&&m.init(We,r.renderState)}if(De&&De.includes("camera-access")&&v){e.state.unbindTexture(),h=i.getBinding();for(let We=0;We<te.length;We++){const st=te[We].camera;if(st){let Qe=f[st];Qe||(Qe=new Vv,f[st]=Qe);const qe=h.getCameraImage(st);Qe.sourceTexture=qe}}}}for(let te=0;te<E.length;te++){const Ee=A[te],De=E[te];Ee!==null&&De!==void 0&&De.update(Ee,Z,c||o)}se&&se(B,Z),Z.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:Z}),g=null}const oe=new Wv;oe.setAnimationLoop(le),this.setAnimationLoop=function(B){se=B},this.dispose=function(){}}}const Yw=new Ct,Jv=new Be;Jv.set(-1,0,0,0,1,0,0,0,1);function qw(t,e){function n(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function i(m,f){f.color.getRGB(m.fogColor.value,Hv(t)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function r(m,f,_,M,x){f.isNodeMaterial?f.uniformsNeedUpdate=!1:f.isMeshBasicMaterial?s(m,f):f.isMeshLambertMaterial?(s(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshToonMaterial?(s(m,f),h(m,f)):f.isMeshPhongMaterial?(s(m,f),d(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshStandardMaterial?(s(m,f),u(m,f),f.isMeshPhysicalMaterial&&p(m,f,x)):f.isMeshMatcapMaterial?(s(m,f),g(m,f)):f.isMeshDepthMaterial?s(m,f):f.isMeshDistanceMaterial?(s(m,f),v(m,f)):f.isMeshNormalMaterial?s(m,f):f.isLineBasicMaterial?(o(m,f),f.isLineDashedMaterial&&a(m,f)):f.isPointsMaterial?l(m,f,_,M):f.isSpriteMaterial?c(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function s(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,n(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,n(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,n(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===gn&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,n(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===gn&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,n(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,n(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,n(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);const _=e.get(f),M=_.envMap,x=_.envMapRotation;M&&(m.envMap.value=M,m.envMapRotation.value.setFromMatrix4(Yw.makeRotationFromEuler(x)).transpose(),M.isCubeTexture&&M.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(Jv),m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,n(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,n(f.aoMap,m.aoMapTransform))}function o(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,n(f.map,m.mapTransform))}function a(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function l(m,f,_,M){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*_,m.scale.value=M*.5,f.map&&(m.map.value=f.map,n(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,n(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function c(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,n(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,n(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function d(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function h(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function u(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,n(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,n(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function p(m,f,_){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,n(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,n(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,n(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,n(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,n(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===gn&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,n(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,n(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=_.texture,m.transmissionSamplerSize.value.set(_.width,_.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,n(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,n(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,n(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,n(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,n(f.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,f){f.matcap&&(m.matcap.value=f.matcap)}function v(m,f){const _=e.get(f).light;m.referencePosition.value.setFromMatrixPosition(_.matrixWorld),m.nearDistance.value=_.shadow.camera.near,m.farDistance.value=_.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function Kw(t,e,n,i){let r={},s={},o=[];const a=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(x,E){const A=E.program;i.uniformBlockBinding(x,A)}function c(x,E){let A=r[x.id];A===void 0&&(m(x),A=d(x),r[x.id]=A,x.addEventListener("dispose",_));const C=E.program;i.updateUBOMapping(x,C);const y=e.render.frame;s[x.id]!==y&&(u(x),s[x.id]=y)}function d(x){const E=h();x.__bindingPointIndex=E;const A=t.createBuffer(),C=x.__size,y=x.usage;return t.bindBuffer(t.UNIFORM_BUFFER,A),t.bufferData(t.UNIFORM_BUFFER,C,y),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,E,A),A}function h(){for(let x=0;x<a;x++)if(o.indexOf(x)===-1)return o.push(x),x;return Ze("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(x){const E=r[x.id],A=x.uniforms,C=x.__cache;t.bindBuffer(t.UNIFORM_BUFFER,E);for(let y=0,w=A.length;y<w;y++){const R=A[y];if(Array.isArray(R))for(let P=0,L=R.length;P<L;P++)p(R[P],y,P,C);else p(R,y,0,C)}t.bindBuffer(t.UNIFORM_BUFFER,null)}function p(x,E,A,C){if(v(x,E,A,C)===!0){const y=x.__offset,w=x.value;if(Array.isArray(w)){let R=0;for(let P=0;P<w.length;P++){const L=w[P],k=f(L);g(L,x.__data,R),typeof L!="number"&&typeof L!="boolean"&&!L.isMatrix3&&!ArrayBuffer.isView(L)&&(R+=k.storage/Float32Array.BYTES_PER_ELEMENT)}}else g(w,x.__data,0);t.bufferSubData(t.UNIFORM_BUFFER,y,x.__data)}}function g(x,E,A){typeof x=="number"||typeof x=="boolean"?E[0]=x:x.isMatrix3?(E[0]=x.elements[0],E[1]=x.elements[1],E[2]=x.elements[2],E[3]=0,E[4]=x.elements[3],E[5]=x.elements[4],E[6]=x.elements[5],E[7]=0,E[8]=x.elements[6],E[9]=x.elements[7],E[10]=x.elements[8],E[11]=0):ArrayBuffer.isView(x)?E.set(new x.constructor(x.buffer,x.byteOffset,E.length)):x.toArray(E,A)}function v(x,E,A,C){const y=x.value,w=E+"_"+A;if(C[w]===void 0)return typeof y=="number"||typeof y=="boolean"?C[w]=y:ArrayBuffer.isView(y)?C[w]=y.slice():C[w]=y.clone(),!0;{const R=C[w];if(typeof y=="number"||typeof y=="boolean"){if(R!==y)return C[w]=y,!0}else{if(ArrayBuffer.isView(y))return!0;if(R.equals(y)===!1)return R.copy(y),!0}}return!1}function m(x){const E=x.uniforms;let A=0;const C=16;for(let w=0,R=E.length;w<R;w++){const P=Array.isArray(E[w])?E[w]:[E[w]];for(let L=0,k=P.length;L<k;L++){const $=P[L],D=Array.isArray($.value)?$.value:[$.value];for(let X=0,O=D.length;X<O;X++){const N=D[X],W=f(N),K=A%C,j=K%W.boundary,re=K+j;A+=j,re!==0&&C-re<W.storage&&(A+=C-re),$.__data=new Float32Array(W.storage/Float32Array.BYTES_PER_ELEMENT),$.__offset=A,A+=W.storage}}}const y=A%C;return y>0&&(A+=C-y),x.__size=A,x.__cache={},this}function f(x){const E={boundary:0,storage:0};return typeof x=="number"||typeof x=="boolean"?(E.boundary=4,E.storage=4):x.isVector2?(E.boundary=8,E.storage=8):x.isVector3||x.isColor?(E.boundary=16,E.storage=12):x.isVector4?(E.boundary=16,E.storage=16):x.isMatrix3?(E.boundary=48,E.storage=48):x.isMatrix4?(E.boundary=64,E.storage=64):x.isTexture?Fe("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(x)?(E.boundary=16,E.storage=x.byteLength):Fe("WebGLRenderer: Unsupported uniform value type.",x),E}function _(x){const E=x.target;E.removeEventListener("dispose",_);const A=o.indexOf(E.__bindingPointIndex);o.splice(A,1),t.deleteBuffer(r[E.id]),delete r[E.id],delete s[E.id]}function M(){for(const x in r)t.deleteBuffer(r[x]);o=[],r={},s={}}return{bind:l,update:c,dispose:M}}const Zw=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let ai=null;function Jw(){return ai===null&&(ai=new Hy(Zw,16,16,Gr,Bi),ai.name="DFG_LUT",ai.minFilter=en,ai.magFilter=en,ai.wrapS=Pi,ai.wrapT=Pi,ai.generateMipmaps=!1,ai.needsUpdate=!0),ai}class Qw{constructor(e={}){const{canvas:n=xy(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:u=!1,outputBufferType:p=Fn}=e;this.isWebGLRenderer=!0;let g;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=i.getContextAttributes().alpha}else g=o;const v=p,m=new Set([yh,Sh,xh]),f=new Set([Fn,_i,Ko,Zo,vh,_h]),_=new Uint32Array(4),M=new Int32Array(4),x=new V;let E=null,A=null;const C=[],y=[];let w=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=mi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const R=this;let P=!1,L=null,k=null,$=null,D=null;this._outputColorSpace=Qt;let X=0,O=0,N=null,W=-1,K=null;const j=new Et,re=new Et;let se=null;const le=new je(0);let oe=0,B=n.width,Z=n.height,te=1,Ee=null,De=null;const Ce=new Et(0,0,B,Z),Tt=new Et(0,0,B,Z);let We=!1;const st=new kv;let Qe=!1,qe=!1;const bt=new Ct,Nt=new V,Bt=new Et,Ht={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let xt=!1;function Pt(){return N===null?te:1}let U=i;function cn(T,F){return n.getContext(T,F)}try{const T={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:h};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${mh}`),n.addEventListener("webglcontextlost",St,!1),n.addEventListener("webglcontextrestored",ct,!1),n.addEventListener("webglcontextcreationerror",ni,!1),U===null){const F="webgl2";if(U=cn(F,T),U===null)throw cn(F)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(T){throw Ze("WebGLRenderer: "+T.message),T}let tt,b,S,z,Y,J,ce,fe,Q,ne,de,be,me,he,Ne,Ue,ke,I,ue,ee,pe,xe,ie;function Ae(){tt=new J1(U),tt.init(),pe=new Hw(U,tt),b=new G1(U,tt,e,pe),S=new zw(U,tt),b.reversedDepthBuffer&&u&&S.buffers.depth.setReversed(!0),k=U.createFramebuffer(),$=U.createFramebuffer(),D=U.createFramebuffer(),z=new eT(U),Y=new Aw,J=new Vw(U,tt,S,Y,b,pe,z),ce=new Z1(R),fe=new rM(U),xe=new V1(U,fe),Q=new Q1(U,fe,z,xe),ne=new nT(U,Q,fe,xe,z),I=new tT(U,b,J),Ne=new W1(Y),de=new ww(R,ce,tt,b,xe,Ne),be=new qw(R,Y),me=new Cw,he=new Iw(tt),ke=new z1(R,ce,S,ne,g,l),Ue=new kw(R,ne,b),ie=new Kw(U,z,b,S),ue=new H1(U,tt,z),ee=new j1(U,tt,z),z.programs=de.programs,R.capabilities=b,R.extensions=tt,R.properties=Y,R.renderLists=me,R.shadowMap=Ue,R.state=S,R.info=z}Ae(),v!==Fn&&(w=new rT(v,n.width,n.height,a,r,s));const Te=new $w(R,U);this.xr=Te,this.getContext=function(){return U},this.getContextAttributes=function(){return U.getContextAttributes()},this.forceContextLoss=function(){const T=tt.get("WEBGL_lose_context");T&&T.loseContext()},this.forceContextRestore=function(){const T=tt.get("WEBGL_lose_context");T&&T.restoreContext()},this.getPixelRatio=function(){return te},this.setPixelRatio=function(T){T!==void 0&&(te=T,this.setSize(B,Z,!1))},this.getSize=function(T){return T.set(B,Z)},this.setSize=function(T,F,q=!0){if(Te.isPresenting){Fe("WebGLRenderer: Can't change size while VR device is presenting.");return}B=T,Z=F,n.width=Math.floor(T*te),n.height=Math.floor(F*te),q===!0&&(n.style.width=T+"px",n.style.height=F+"px"),w!==null&&w.setSize(n.width,n.height),this.setViewport(0,0,T,F)},this.getDrawingBufferSize=function(T){return T.set(B*te,Z*te).floor()},this.setDrawingBufferSize=function(T,F,q){B=T,Z=F,te=q,n.width=Math.floor(T*q),n.height=Math.floor(F*q),this.setViewport(0,0,T,F)},this.setEffects=function(T){if(v===Fn){Ze("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(T){for(let F=0;F<T.length;F++)if(T[F].isOutputPass===!0){Fe("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}w.setEffects(T||[])},this.getCurrentViewport=function(T){return T.copy(j)},this.getViewport=function(T){return T.copy(Ce)},this.setViewport=function(T,F,q,H){T.isVector4?Ce.set(T.x,T.y,T.z,T.w):Ce.set(T,F,q,H),S.viewport(j.copy(Ce).multiplyScalar(te).round())},this.getScissor=function(T){return T.copy(Tt)},this.setScissor=function(T,F,q,H){T.isVector4?Tt.set(T.x,T.y,T.z,T.w):Tt.set(T,F,q,H),S.scissor(re.copy(Tt).multiplyScalar(te).round())},this.getScissorTest=function(){return We},this.setScissorTest=function(T){S.setScissorTest(We=T)},this.setOpaqueSort=function(T){Ee=T},this.setTransparentSort=function(T){De=T},this.getClearColor=function(T){return T.copy(ke.getClearColor())},this.setClearColor=function(){ke.setClearColor(...arguments)},this.getClearAlpha=function(){return ke.getClearAlpha()},this.setClearAlpha=function(){ke.setClearAlpha(...arguments)},this.clear=function(T=!0,F=!0,q=!0){let H=0;if(T){let G=!1;if(N!==null){const _e=N.texture.format;G=m.has(_e)}if(G){const _e=N.texture.type,ye=f.has(_e),ve=ke.getClearColor(),we=ke.getClearAlpha(),Pe=ve.r,ze=ve.g,He=ve.b;ye?(_[0]=Pe,_[1]=ze,_[2]=He,_[3]=we,U.clearBufferuiv(U.COLOR,0,_)):(M[0]=Pe,M[1]=ze,M[2]=He,M[3]=we,U.clearBufferiv(U.COLOR,0,M))}else H|=U.COLOR_BUFFER_BIT}F&&(H|=U.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),q&&(H|=U.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),H!==0&&U.clear(H)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(T){T.setRenderer(this),L=T},this.dispose=function(){n.removeEventListener("webglcontextlost",St,!1),n.removeEventListener("webglcontextrestored",ct,!1),n.removeEventListener("webglcontextcreationerror",ni,!1),ke.dispose(),me.dispose(),he.dispose(),Y.dispose(),ce.dispose(),ne.dispose(),xe.dispose(),ie.dispose(),de.dispose(),Te.dispose(),Te.removeEventListener("sessionstart",Dh),Te.removeEventListener("sessionend",Nh),xr.stop()};function St(T){T.preventDefault(),am("WebGLRenderer: Context Lost."),P=!0}function ct(){am("WebGLRenderer: Context Restored."),P=!1;const T=z.autoReset,F=Ue.enabled,q=Ue.autoUpdate,H=Ue.needsUpdate,G=Ue.type;Ae(),z.autoReset=T,Ue.enabled=F,Ue.autoUpdate=q,Ue.needsUpdate=H,Ue.type=G}function ni(T){Ze("WebGLRenderer: A WebGL context could not be created. Reason: ",T.statusMessage)}function ii(T){const F=T.target;F.removeEventListener("dispose",ii),jv(F)}function jv(T){e_(T),Y.remove(T)}function e_(T){const F=Y.get(T).programs;F!==void 0&&(F.forEach(function(q){de.releaseProgram(q)}),T.isShaderMaterial&&de.releaseShaderCache(T))}this.renderBufferDirect=function(T,F,q,H,G,_e){F===null&&(F=Ht);const ye=G.isMesh&&G.matrixWorld.determinantAffine()<0,ve=i_(T,F,q,H,G);S.setMaterial(H,ye);let we=q.index,Pe=1;if(H.wireframe===!0){if(we=Q.getWireframeAttribute(q),we===void 0)return;Pe=2}const ze=q.drawRange,He=q.attributes.position;let Le=ze.start*Pe,rt=(ze.start+ze.count)*Pe;_e!==null&&(Le=Math.max(Le,_e.start*Pe),rt=Math.min(rt,(_e.start+_e.count)*Pe)),we!==null?(Le=Math.max(Le,0),rt=Math.min(rt,we.count)):He!=null&&(Le=Math.max(Le,0),rt=Math.min(rt,He.count));const wt=rt-Le;if(wt<0||wt===1/0)return;xe.setup(G,H,ve,q,we);let yt,ot=ue;if(we!==null&&(yt=fe.get(we),ot=ee,ot.setIndex(yt)),G.isMesh)H.wireframe===!0?(S.setLineWidth(H.wireframeLinewidth*Pt()),ot.setMode(U.LINES)):ot.setMode(U.TRIANGLES);else if(G.isLine){let Yt=H.linewidth;Yt===void 0&&(Yt=1),S.setLineWidth(Yt*Pt()),G.isLineSegments?ot.setMode(U.LINES):G.isLineLoop?ot.setMode(U.LINE_LOOP):ot.setMode(U.LINE_STRIP)}else G.isPoints?ot.setMode(U.POINTS):G.isSprite&&ot.setMode(U.TRIANGLES);if(G.isBatchedMesh)if(tt.get("WEBGL_multi_draw"))ot.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{const Yt=G._multiDrawStarts,Se=G._multiDrawCounts,_n=G._multiDrawCount,Ke=we?fe.get(we).bytesPerElement:1,Pn=Y.get(H).currentProgram.getUniforms();for(let ri=0;ri<_n;ri++)Pn.setValue(U,"_gl_DrawID",ri),ot.render(Yt[ri]/Ke,Se[ri])}else if(G.isInstancedMesh)ot.renderInstances(Le,wt,G.count);else if(q.isInstancedBufferGeometry){const Yt=q._maxInstanceCount!==void 0?q._maxInstanceCount:1/0,Se=Math.min(q.instanceCount,Yt);ot.renderInstances(Le,wt,Se)}else ot.render(Le,wt)};function Lh(T,F,q){T.transparent===!0&&T.side===Un&&T.forceSinglePass===!1?(T.side=gn,T.needsUpdate=!0,aa(T,F,q),T.side=mr,T.needsUpdate=!0,aa(T,F,q),T.side=Un):aa(T,F,q)}this.compile=function(T,F,q=null){q===null&&(q=T),A=he.get(q),A.init(F),y.push(A),q.traverseVisible(function(G){G.isLight&&G.layers.test(F.layers)&&(A.pushLight(G),G.castShadow&&A.pushShadow(G))}),T!==q&&T.traverseVisible(function(G){G.isLight&&G.layers.test(F.layers)&&(A.pushLight(G),G.castShadow&&A.pushShadow(G))}),A.setupLights();const H=new Set;return T.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;const _e=G.material;if(_e)if(Array.isArray(_e))for(let ye=0;ye<_e.length;ye++){const ve=_e[ye];Lh(ve,q,G),H.add(ve)}else Lh(_e,q,G),H.add(_e)}),A=y.pop(),H},this.compileAsync=function(T,F,q=null){const H=this.compile(T,F,q);return new Promise(G=>{function _e(){if(H.forEach(function(ye){Y.get(ye).currentProgram.isReady()&&H.delete(ye)}),H.size===0){G(T);return}setTimeout(_e,10)}tt.get("KHR_parallel_shader_compile")!==null?_e():setTimeout(_e,10)})};let Ec=null;function t_(T){Ec&&Ec(T)}function Dh(){xr.stop()}function Nh(){xr.start()}const xr=new Wv;xr.setAnimationLoop(t_),typeof self<"u"&&xr.setContext(self),this.setAnimationLoop=function(T){Ec=T,Te.setAnimationLoop(T),T===null?xr.stop():xr.start()},Te.addEventListener("sessionstart",Dh),Te.addEventListener("sessionend",Nh),this.render=function(T,F){if(F!==void 0&&F.isCamera!==!0){Ze("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;L!==null&&L.renderStart(T,F);const q=Te.enabled===!0&&Te.isPresenting===!0,H=w!==null&&(N===null||q)&&w.begin(R,N);if(T.matrixWorldAutoUpdate===!0&&T.updateMatrixWorld(),F.parent===null&&F.matrixWorldAutoUpdate===!0&&F.updateMatrixWorld(),Te.enabled===!0&&Te.isPresenting===!0&&(w===null||w.isCompositing()===!1)&&(Te.cameraAutoUpdate===!0&&Te.updateCamera(F),F=Te.getCamera()),T.isScene===!0&&T.onBeforeRender(R,T,F,N),A=he.get(T,y.length),A.init(F),A.state.textureUnits=J.getTextureUnits(),y.push(A),bt.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),st.setFromProjectionMatrix(bt,di,F.reversedDepth),qe=this.localClippingEnabled,Qe=Ne.init(this.clippingPlanes,qe),E=me.get(T,C.length),E.init(),C.push(E),Te.enabled===!0&&Te.isPresenting===!0){const ye=R.xr.getDepthSensingMesh();ye!==null&&Tc(ye,F,-1/0,R.sortObjects)}Tc(T,F,0,R.sortObjects),E.finish(),R.sortObjects===!0&&E.sort(Ee,De,F.reversedDepth),xt=Te.enabled===!1||Te.isPresenting===!1||Te.hasDepthSensing()===!1,xt&&ke.addToRenderList(E,T),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Qe===!0&&Ne.beginShadows();const G=A.state.shadowsArray;if(Ue.render(G,T,F),Qe===!0&&Ne.endShadows(),(H&&w.hasRenderPass())===!1){const ye=E.opaque,ve=E.transmissive;if(A.setupLights(),F.isArrayCamera){const we=F.cameras;if(ve.length>0)for(let Pe=0,ze=we.length;Pe<ze;Pe++){const He=we[Pe];Uh(ye,ve,T,He)}xt&&ke.render(T);for(let Pe=0,ze=we.length;Pe<ze;Pe++){const He=we[Pe];Ih(E,T,He,He.viewport)}}else ve.length>0&&Uh(ye,ve,T,F),xt&&ke.render(T),Ih(E,T,F)}N!==null&&O===0&&(J.updateMultisampleRenderTarget(N),J.updateRenderTargetMipmap(N)),H&&w.end(R),T.isScene===!0&&T.onAfterRender(R,T,F),xe.resetDefaultState(),W=-1,K=null,y.pop(),y.length>0?(A=y[y.length-1],J.setTextureUnits(A.state.textureUnits),Qe===!0&&Ne.setGlobalState(R.clippingPlanes,A.state.camera)):A=null,C.pop(),C.length>0?E=C[C.length-1]:E=null,L!==null&&L.renderEnd()};function Tc(T,F,q,H){if(T.visible===!1)return;if(T.layers.test(F.layers)){if(T.isGroup)q=T.renderOrder;else if(T.isLOD)T.autoUpdate===!0&&T.update(F);else if(T.isLightProbeGrid)A.pushLightProbeGrid(T);else if(T.isLight)A.pushLight(T),T.castShadow&&A.pushShadow(T);else if(T.isSprite){if(!T.frustumCulled||st.intersectsSprite(T)){H&&Bt.setFromMatrixPosition(T.matrixWorld).applyMatrix4(bt);const ye=ne.update(T),ve=T.material;ve.visible&&E.push(T,ye,ve,q,Bt.z,null)}}else if((T.isMesh||T.isLine||T.isPoints)&&(!T.frustumCulled||st.intersectsObject(T))){const ye=ne.update(T),ve=T.material;if(H&&(T.boundingSphere!==void 0?(T.boundingSphere===null&&T.computeBoundingSphere(),Bt.copy(T.boundingSphere.center)):(ye.boundingSphere===null&&ye.computeBoundingSphere(),Bt.copy(ye.boundingSphere.center)),Bt.applyMatrix4(T.matrixWorld).applyMatrix4(bt)),Array.isArray(ve)){const we=ye.groups;for(let Pe=0,ze=we.length;Pe<ze;Pe++){const He=we[Pe],Le=ve[He.materialIndex];Le&&Le.visible&&E.push(T,ye,Le,q,Bt.z,He)}}else ve.visible&&E.push(T,ye,ve,q,Bt.z,null)}}const _e=T.children;for(let ye=0,ve=_e.length;ye<ve;ye++)Tc(_e[ye],F,q,H)}function Ih(T,F,q,H){const{opaque:G,transmissive:_e,transparent:ye}=T;A.setupLightsView(q),Qe===!0&&Ne.setGlobalState(R.clippingPlanes,q),H&&S.viewport(j.copy(H)),G.length>0&&oa(G,F,q),_e.length>0&&oa(_e,F,q),ye.length>0&&oa(ye,F,q),S.buffers.depth.setTest(!0),S.buffers.depth.setMask(!0),S.buffers.color.setMask(!0),S.setPolygonOffset(!1)}function Uh(T,F,q,H){if((q.isScene===!0?q.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[H.id]===void 0){const Le=tt.has("EXT_color_buffer_half_float")||tt.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[H.id]=new gi(1,1,{generateMipmaps:!0,type:Le?Bi:Fn,minFilter:Dr,samples:Math.max(4,b.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:$e.workingColorSpace})}const _e=A.state.transmissionRenderTarget[H.id],ye=H.viewport||j;_e.setSize(ye.z*R.transmissionResolutionScale,ye.w*R.transmissionResolutionScale);const ve=R.getRenderTarget(),we=R.getActiveCubeFace(),Pe=R.getActiveMipmapLevel();R.setRenderTarget(_e),R.getClearColor(le),oe=R.getClearAlpha(),oe<1&&R.setClearColor(16777215,.5),R.clear(),xt&&ke.render(q);const ze=R.toneMapping;R.toneMapping=mi;const He=H.viewport;if(H.viewport!==void 0&&(H.viewport=void 0),A.setupLightsView(H),Qe===!0&&Ne.setGlobalState(R.clippingPlanes,H),oa(T,q,H),J.updateMultisampleRenderTarget(_e),J.updateRenderTargetMipmap(_e),tt.has("WEBGL_multisampled_render_to_texture")===!1){let Le=!1;for(let rt=0,wt=F.length;rt<wt;rt++){const yt=F[rt],{object:ot,geometry:Yt,material:Se,group:_n}=yt;if(Se.side===Un&&ot.layers.test(H.layers)){const Ke=Se.side;Se.side=gn,Se.needsUpdate=!0,Fh(ot,q,H,Yt,Se,_n),Se.side=Ke,Se.needsUpdate=!0,Le=!0}}Le===!0&&(J.updateMultisampleRenderTarget(_e),J.updateRenderTargetMipmap(_e))}R.setRenderTarget(ve,we,Pe),R.setClearColor(le,oe),He!==void 0&&(H.viewport=He),R.toneMapping=ze}function oa(T,F,q){const H=F.isScene===!0?F.overrideMaterial:null;for(let G=0,_e=T.length;G<_e;G++){const ye=T[G],{object:ve,geometry:we,group:Pe}=ye;let ze=ye.material;ze.allowOverride===!0&&H!==null&&(ze=H),ve.layers.test(q.layers)&&Fh(ve,F,q,we,ze,Pe)}}function Fh(T,F,q,H,G,_e){T.onBeforeRender(R,F,q,H,G,_e),T.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,T.matrixWorld),T.normalMatrix.getNormalMatrix(T.modelViewMatrix),G.onBeforeRender(R,F,q,H,T,_e),G.transparent===!0&&G.side===Un&&G.forceSinglePass===!1?(G.side=gn,G.needsUpdate=!0,R.renderBufferDirect(q,F,H,G,T,_e),G.side=mr,G.needsUpdate=!0,R.renderBufferDirect(q,F,H,G,T,_e),G.side=Un):R.renderBufferDirect(q,F,H,G,T,_e),T.onAfterRender(R,F,q,H,G,_e)}function aa(T,F,q){F.isScene!==!0&&(F=Ht);const H=Y.get(T),G=A.state.lights,_e=A.state.shadowsArray,ye=G.state.version,ve=de.getParameters(T,G.state,_e,F,q,A.state.lightProbeGridArray),we=de.getProgramCacheKey(ve);let Pe=H.programs;H.environment=T.isMeshStandardMaterial||T.isMeshLambertMaterial||T.isMeshPhongMaterial?F.environment:null,H.fog=F.fog;const ze=T.isMeshStandardMaterial||T.isMeshLambertMaterial&&!T.envMap||T.isMeshPhongMaterial&&!T.envMap;H.envMap=ce.get(T.envMap||H.environment,ze),H.envMapRotation=H.environment!==null&&T.envMap===null?F.environmentRotation:T.envMapRotation,Pe===void 0&&(T.addEventListener("dispose",ii),Pe=new Map,H.programs=Pe);let He=Pe.get(we);if(He!==void 0){if(H.currentProgram===He&&H.lightsStateVersion===ye)return Bh(T,ve),He}else ve.uniforms=de.getUniforms(T),L!==null&&T.isNodeMaterial&&L.build(T,q,ve),T.onBeforeCompile(ve,R),He=de.acquireProgram(ve,we),Pe.set(we,He),H.uniforms=ve.uniforms;const Le=H.uniforms;return(!T.isShaderMaterial&&!T.isRawShaderMaterial||T.clipping===!0)&&(Le.clippingPlanes=Ne.uniform),Bh(T,ve),H.needsLights=s_(T),H.lightsStateVersion=ye,H.needsLights&&(Le.ambientLightColor.value=G.state.ambient,Le.lightProbe.value=G.state.probe,Le.directionalLights.value=G.state.directional,Le.directionalLightShadows.value=G.state.directionalShadow,Le.spotLights.value=G.state.spot,Le.spotLightShadows.value=G.state.spotShadow,Le.rectAreaLights.value=G.state.rectArea,Le.ltc_1.value=G.state.rectAreaLTC1,Le.ltc_2.value=G.state.rectAreaLTC2,Le.pointLights.value=G.state.point,Le.pointLightShadows.value=G.state.pointShadow,Le.hemisphereLights.value=G.state.hemi,Le.directionalShadowMatrix.value=G.state.directionalShadowMatrix,Le.spotLightMatrix.value=G.state.spotLightMatrix,Le.spotLightMap.value=G.state.spotLightMap,Le.pointShadowMatrix.value=G.state.pointShadowMatrix),H.lightProbeGrid=A.state.lightProbeGridArray.length>0,H.currentProgram=He,H.uniformsList=null,He}function Oh(T){if(T.uniformsList===null){const F=T.currentProgram.getUniforms();T.uniformsList=yl.seqWithValue(F.seq,T.uniforms)}return T.uniformsList}function Bh(T,F){const q=Y.get(T);q.outputColorSpace=F.outputColorSpace,q.batching=F.batching,q.batchingColor=F.batchingColor,q.instancing=F.instancing,q.instancingColor=F.instancingColor,q.instancingMorph=F.instancingMorph,q.skinning=F.skinning,q.morphTargets=F.morphTargets,q.morphNormals=F.morphNormals,q.morphColors=F.morphColors,q.morphTargetsCount=F.morphTargetsCount,q.numClippingPlanes=F.numClippingPlanes,q.numIntersection=F.numClipIntersection,q.vertexAlphas=F.vertexAlphas,q.vertexTangents=F.vertexTangents,q.toneMapping=F.toneMapping}function n_(T,F){if(T.length===0)return null;if(T.length===1)return T[0].texture!==null?T[0]:null;x.setFromMatrixPosition(F.matrixWorld);for(let q=0,H=T.length;q<H;q++){const G=T[q];if(G.texture!==null&&G.boundingBox.containsPoint(x))return G}return null}function i_(T,F,q,H,G){F.isScene!==!0&&(F=Ht),J.resetTextureUnits();const _e=F.fog,ye=H.isMeshStandardMaterial||H.isMeshLambertMaterial||H.isMeshPhongMaterial?F.environment:null,ve=N===null?R.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:$e.workingColorSpace,we=H.isMeshStandardMaterial||H.isMeshLambertMaterial&&!H.envMap||H.isMeshPhongMaterial&&!H.envMap,Pe=ce.get(H.envMap||ye,we),ze=H.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,He=!!q.attributes.tangent&&(!!H.normalMap||H.anisotropy>0),Le=!!q.morphAttributes.position,rt=!!q.morphAttributes.normal,wt=!!q.morphAttributes.color;let yt=mi;H.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(yt=R.toneMapping);const ot=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,Yt=ot!==void 0?ot.length:0,Se=Y.get(H),_n=A.state.lights;if(Qe===!0&&(qe===!0||T!==K)){const ut=T===K&&H.id===W;Ne.setState(H,T,ut)}let Ke=!1;H.version===Se.__version?(Se.needsLights&&Se.lightsStateVersion!==_n.state.version||Se.outputColorSpace!==ve||G.isBatchedMesh&&Se.batching===!1||!G.isBatchedMesh&&Se.batching===!0||G.isBatchedMesh&&Se.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&Se.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&Se.instancing===!1||!G.isInstancedMesh&&Se.instancing===!0||G.isSkinnedMesh&&Se.skinning===!1||!G.isSkinnedMesh&&Se.skinning===!0||G.isInstancedMesh&&Se.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&Se.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&Se.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&Se.instancingMorph===!1&&G.morphTexture!==null||Se.envMap!==Pe||H.fog===!0&&Se.fog!==_e||Se.numClippingPlanes!==void 0&&(Se.numClippingPlanes!==Ne.numPlanes||Se.numIntersection!==Ne.numIntersection)||Se.vertexAlphas!==ze||Se.vertexTangents!==He||Se.morphTargets!==Le||Se.morphNormals!==rt||Se.morphColors!==wt||Se.toneMapping!==yt||Se.morphTargetsCount!==Yt||!!Se.lightProbeGrid!=A.state.lightProbeGridArray.length>0)&&(Ke=!0):(Ke=!0,Se.__version=H.version);let Pn=Se.currentProgram;Ke===!0&&(Pn=aa(H,F,G),L&&H.isNodeMaterial&&L.onUpdateProgram(H,Pn,Se));let ri=!1,Vi=!1,qr=!1;const at=Pn.getUniforms(),At=Se.uniforms;if(S.useProgram(Pn.program)&&(ri=!0,Vi=!0,qr=!0),H.id!==W&&(W=H.id,Vi=!0),Se.needsLights){const ut=n_(A.state.lightProbeGridArray,G);Se.lightProbeGrid!==ut&&(Se.lightProbeGrid=ut,Vi=!0)}if(ri||K!==T){S.buffers.depth.getReversed()&&T.reversedDepth!==!0&&(T._reversedDepth=!0,T.updateProjectionMatrix()),at.setValue(U,"projectionMatrix",T.projectionMatrix),at.setValue(U,"viewMatrix",T.matrixWorldInverse);const Gi=at.map.cameraPosition;Gi!==void 0&&Gi.setValue(U,Nt.setFromMatrixPosition(T.matrixWorld)),b.logarithmicDepthBuffer&&at.setValue(U,"logDepthBufFC",2/(Math.log(T.far+1)/Math.LN2)),(H.isMeshPhongMaterial||H.isMeshToonMaterial||H.isMeshLambertMaterial||H.isMeshBasicMaterial||H.isMeshStandardMaterial||H.isShaderMaterial)&&at.setValue(U,"isOrthographic",T.isOrthographicCamera===!0),K!==T&&(K=T,Vi=!0,qr=!0)}if(Se.needsLights&&(_n.state.directionalShadowMap.length>0&&at.setValue(U,"directionalShadowMap",_n.state.directionalShadowMap,J),_n.state.spotShadowMap.length>0&&at.setValue(U,"spotShadowMap",_n.state.spotShadowMap,J),_n.state.pointShadowMap.length>0&&at.setValue(U,"pointShadowMap",_n.state.pointShadowMap,J)),G.isSkinnedMesh){at.setOptional(U,G,"bindMatrix"),at.setOptional(U,G,"bindMatrixInverse");const ut=G.skeleton;ut&&(ut.boneTexture===null&&ut.computeBoneTexture(),at.setValue(U,"boneTexture",ut.boneTexture,J))}G.isBatchedMesh&&(at.setOptional(U,G,"batchingTexture"),at.setValue(U,"batchingTexture",G._matricesTexture,J),at.setOptional(U,G,"batchingIdTexture"),at.setValue(U,"batchingIdTexture",G._indirectTexture,J),at.setOptional(U,G,"batchingColorTexture"),G._colorsTexture!==null&&at.setValue(U,"batchingColorTexture",G._colorsTexture,J));const Hi=q.morphAttributes;if((Hi.position!==void 0||Hi.normal!==void 0||Hi.color!==void 0)&&I.update(G,q,Pn),(Vi||Se.receiveShadow!==G.receiveShadow)&&(Se.receiveShadow=G.receiveShadow,at.setValue(U,"receiveShadow",G.receiveShadow)),(H.isMeshStandardMaterial||H.isMeshLambertMaterial||H.isMeshPhongMaterial)&&H.envMap===null&&F.environment!==null&&(At.envMapIntensity.value=F.environmentIntensity),At.dfgLUT!==void 0&&(At.dfgLUT.value=Jw()),Vi){if(at.setValue(U,"toneMappingExposure",R.toneMappingExposure),Se.needsLights&&r_(At,qr),_e&&H.fog===!0&&be.refreshFogUniforms(At,_e),be.refreshMaterialUniforms(At,H,te,Z,A.state.transmissionRenderTarget[T.id]),Se.needsLights&&Se.lightProbeGrid){const ut=Se.lightProbeGrid;At.probesSH.value=ut.texture,At.probesMin.value.copy(ut.boundingBox.min),At.probesMax.value.copy(ut.boundingBox.max),At.probesResolution.value.copy(ut.resolution)}yl.upload(U,Oh(Se),At,J)}if(H.isShaderMaterial&&H.uniformsNeedUpdate===!0&&(yl.upload(U,Oh(Se),At,J),H.uniformsNeedUpdate=!1),H.isSpriteMaterial&&at.setValue(U,"center",G.center),at.setValue(U,"modelViewMatrix",G.modelViewMatrix),at.setValue(U,"normalMatrix",G.normalMatrix),at.setValue(U,"modelMatrix",G.matrixWorld),H.uniformsGroups!==void 0){const ut=H.uniformsGroups;for(let Gi=0,Kr=ut.length;Gi<Kr;Gi++){const kh=ut[Gi];ie.update(kh,Pn),ie.bind(kh,Pn)}}return Pn}function r_(T,F){T.ambientLightColor.needsUpdate=F,T.lightProbe.needsUpdate=F,T.directionalLights.needsUpdate=F,T.directionalLightShadows.needsUpdate=F,T.pointLights.needsUpdate=F,T.pointLightShadows.needsUpdate=F,T.spotLights.needsUpdate=F,T.spotLightShadows.needsUpdate=F,T.rectAreaLights.needsUpdate=F,T.hemisphereLights.needsUpdate=F}function s_(T){return T.isMeshLambertMaterial||T.isMeshToonMaterial||T.isMeshPhongMaterial||T.isMeshStandardMaterial||T.isShadowMaterial||T.isShaderMaterial&&T.lights===!0}this.getActiveCubeFace=function(){return X},this.getActiveMipmapLevel=function(){return O},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(T,F,q){const H=Y.get(T);H.__autoAllocateDepthBuffer=T.resolveDepthBuffer===!1,H.__autoAllocateDepthBuffer===!1&&(H.__useRenderToTexture=!1),Y.get(T.texture).__webglTexture=F,Y.get(T.depthTexture).__webglTexture=H.__autoAllocateDepthBuffer?void 0:q,H.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(T,F){const q=Y.get(T);q.__webglFramebuffer=F,q.__useDefaultFramebuffer=F===void 0},this.setRenderTarget=function(T,F=0,q=0){N=T,X=F,O=q;let H=null,G=!1,_e=!1;if(T){const ve=Y.get(T);if(ve.__useDefaultFramebuffer!==void 0){S.bindFramebuffer(U.FRAMEBUFFER,ve.__webglFramebuffer),j.copy(T.viewport),re.copy(T.scissor),se=T.scissorTest,S.viewport(j),S.scissor(re),S.setScissorTest(se),W=-1;return}else if(ve.__webglFramebuffer===void 0)J.setupRenderTarget(T);else if(ve.__hasExternalTextures)J.rebindTextures(T,Y.get(T.texture).__webglTexture,Y.get(T.depthTexture).__webglTexture);else if(T.depthBuffer){const ze=T.depthTexture;if(ve.__boundDepthTexture!==ze){if(ze!==null&&Y.has(ze)&&(T.width!==ze.image.width||T.height!==ze.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");J.setupDepthRenderbuffer(T)}}const we=T.texture;(we.isData3DTexture||we.isDataArrayTexture||we.isCompressedArrayTexture)&&(_e=!0);const Pe=Y.get(T).__webglFramebuffer;T.isWebGLCubeRenderTarget?(Array.isArray(Pe[F])?H=Pe[F][q]:H=Pe[F],G=!0):T.samples>0&&J.useMultisampledRTT(T)===!1?H=Y.get(T).__webglMultisampledFramebuffer:Array.isArray(Pe)?H=Pe[q]:H=Pe,j.copy(T.viewport),re.copy(T.scissor),se=T.scissorTest}else j.copy(Ce).multiplyScalar(te).floor(),re.copy(Tt).multiplyScalar(te).floor(),se=We;if(q!==0&&(H=k),S.bindFramebuffer(U.FRAMEBUFFER,H)&&S.drawBuffers(T,H),S.viewport(j),S.scissor(re),S.setScissorTest(se),G){const ve=Y.get(T.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_CUBE_MAP_POSITIVE_X+F,ve.__webglTexture,q)}else if(_e){const ve=F;for(let we=0;we<T.textures.length;we++){const Pe=Y.get(T.textures[we]);U.framebufferTextureLayer(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0+we,Pe.__webglTexture,q,ve)}}else if(T!==null&&q!==0){const ve=Y.get(T.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,ve.__webglTexture,q)}W=-1},this.readRenderTargetPixels=function(T,F,q,H,G,_e,ye,ve=0){if(!(T&&T.isWebGLRenderTarget)){Ze("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let we=Y.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&ye!==void 0&&(we=we[ye]),we){S.bindFramebuffer(U.FRAMEBUFFER,we);try{const Pe=T.textures[ve],ze=Pe.format,He=Pe.type;if(T.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+ve),!b.textureFormatReadable(ze)){Ze("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!b.textureTypeReadable(He)){Ze("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}F>=0&&F<=T.width-H&&q>=0&&q<=T.height-G&&U.readPixels(F,q,H,G,pe.convert(ze),pe.convert(He),_e)}finally{const Pe=N!==null?Y.get(N).__webglFramebuffer:null;S.bindFramebuffer(U.FRAMEBUFFER,Pe)}}},this.readRenderTargetPixelsAsync=async function(T,F,q,H,G,_e,ye,ve=0){if(!(T&&T.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let we=Y.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&ye!==void 0&&(we=we[ye]),we)if(F>=0&&F<=T.width-H&&q>=0&&q<=T.height-G){S.bindFramebuffer(U.FRAMEBUFFER,we);const Pe=T.textures[ve],ze=Pe.format,He=Pe.type;if(T.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+ve),!b.textureFormatReadable(ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!b.textureTypeReadable(He))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Le=U.createBuffer();U.bindBuffer(U.PIXEL_PACK_BUFFER,Le),U.bufferData(U.PIXEL_PACK_BUFFER,_e.byteLength,U.STREAM_READ),U.readPixels(F,q,H,G,pe.convert(ze),pe.convert(He),0);const rt=N!==null?Y.get(N).__webglFramebuffer:null;S.bindFramebuffer(U.FRAMEBUFFER,rt);const wt=U.fenceSync(U.SYNC_GPU_COMMANDS_COMPLETE,0);return U.flush(),await Sy(U,wt,4),U.bindBuffer(U.PIXEL_PACK_BUFFER,Le),U.getBufferSubData(U.PIXEL_PACK_BUFFER,0,_e),U.deleteBuffer(Le),U.deleteSync(wt),_e}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(T,F=null,q=0){const H=Math.pow(2,-q),G=Math.floor(T.image.width*H),_e=Math.floor(T.image.height*H),ye=F!==null?F.x:0,ve=F!==null?F.y:0;J.setTexture2D(T,0),U.copyTexSubImage2D(U.TEXTURE_2D,q,0,0,ye,ve,G,_e),S.unbindTexture()},this.copyTextureToTexture=function(T,F,q=null,H=null,G=0,_e=0){let ye,ve,we,Pe,ze,He,Le,rt,wt;const yt=T.isCompressedTexture?T.mipmaps[_e]:T.image;if(q!==null)ye=q.max.x-q.min.x,ve=q.max.y-q.min.y,we=q.isBox3?q.max.z-q.min.z:1,Pe=q.min.x,ze=q.min.y,He=q.isBox3?q.min.z:0;else{const At=Math.pow(2,-G);ye=Math.floor(yt.width*At),ve=Math.floor(yt.height*At),T.isDataArrayTexture?we=yt.depth:T.isData3DTexture?we=Math.floor(yt.depth*At):we=1,Pe=0,ze=0,He=0}H!==null?(Le=H.x,rt=H.y,wt=H.z):(Le=0,rt=0,wt=0);const ot=pe.convert(F.format),Yt=pe.convert(F.type);let Se;F.isData3DTexture?(J.setTexture3D(F,0),Se=U.TEXTURE_3D):F.isDataArrayTexture||F.isCompressedArrayTexture?(J.setTexture2DArray(F,0),Se=U.TEXTURE_2D_ARRAY):(J.setTexture2D(F,0),Se=U.TEXTURE_2D),S.activeTexture(U.TEXTURE0),S.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,F.flipY),S.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),S.pixelStorei(U.UNPACK_ALIGNMENT,F.unpackAlignment);const _n=S.getParameter(U.UNPACK_ROW_LENGTH),Ke=S.getParameter(U.UNPACK_IMAGE_HEIGHT),Pn=S.getParameter(U.UNPACK_SKIP_PIXELS),ri=S.getParameter(U.UNPACK_SKIP_ROWS),Vi=S.getParameter(U.UNPACK_SKIP_IMAGES);S.pixelStorei(U.UNPACK_ROW_LENGTH,yt.width),S.pixelStorei(U.UNPACK_IMAGE_HEIGHT,yt.height),S.pixelStorei(U.UNPACK_SKIP_PIXELS,Pe),S.pixelStorei(U.UNPACK_SKIP_ROWS,ze),S.pixelStorei(U.UNPACK_SKIP_IMAGES,He);const qr=T.isDataArrayTexture||T.isData3DTexture,at=F.isDataArrayTexture||F.isData3DTexture;if(T.isDepthTexture){const At=Y.get(T),Hi=Y.get(F),ut=Y.get(At.__renderTarget),Gi=Y.get(Hi.__renderTarget);S.bindFramebuffer(U.READ_FRAMEBUFFER,ut.__webglFramebuffer),S.bindFramebuffer(U.DRAW_FRAMEBUFFER,Gi.__webglFramebuffer);for(let Kr=0;Kr<we;Kr++)qr&&(U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,Y.get(T).__webglTexture,G,He+Kr),U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,Y.get(F).__webglTexture,_e,wt+Kr)),U.blitFramebuffer(Pe,ze,ye,ve,Le,rt,ye,ve,U.DEPTH_BUFFER_BIT,U.NEAREST);S.bindFramebuffer(U.READ_FRAMEBUFFER,null),S.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else if(G!==0||T.isRenderTargetTexture||Y.has(T)){const At=Y.get(T),Hi=Y.get(F);S.bindFramebuffer(U.READ_FRAMEBUFFER,$),S.bindFramebuffer(U.DRAW_FRAMEBUFFER,D);for(let ut=0;ut<we;ut++)qr?U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,At.__webglTexture,G,He+ut):U.framebufferTexture2D(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,At.__webglTexture,G),at?U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,Hi.__webglTexture,_e,wt+ut):U.framebufferTexture2D(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,Hi.__webglTexture,_e),G!==0?U.blitFramebuffer(Pe,ze,ye,ve,Le,rt,ye,ve,U.COLOR_BUFFER_BIT,U.NEAREST):at?U.copyTexSubImage3D(Se,_e,Le,rt,wt+ut,Pe,ze,ye,ve):U.copyTexSubImage2D(Se,_e,Le,rt,Pe,ze,ye,ve);S.bindFramebuffer(U.READ_FRAMEBUFFER,null),S.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else at?T.isDataTexture||T.isData3DTexture?U.texSubImage3D(Se,_e,Le,rt,wt,ye,ve,we,ot,Yt,yt.data):F.isCompressedArrayTexture?U.compressedTexSubImage3D(Se,_e,Le,rt,wt,ye,ve,we,ot,yt.data):U.texSubImage3D(Se,_e,Le,rt,wt,ye,ve,we,ot,Yt,yt):T.isDataTexture?U.texSubImage2D(U.TEXTURE_2D,_e,Le,rt,ye,ve,ot,Yt,yt.data):T.isCompressedTexture?U.compressedTexSubImage2D(U.TEXTURE_2D,_e,Le,rt,yt.width,yt.height,ot,yt.data):U.texSubImage2D(U.TEXTURE_2D,_e,Le,rt,ye,ve,ot,Yt,yt);S.pixelStorei(U.UNPACK_ROW_LENGTH,_n),S.pixelStorei(U.UNPACK_IMAGE_HEIGHT,Ke),S.pixelStorei(U.UNPACK_SKIP_PIXELS,Pn),S.pixelStorei(U.UNPACK_SKIP_ROWS,ri),S.pixelStorei(U.UNPACK_SKIP_IMAGES,Vi),_e===0&&F.generateMipmaps&&U.generateMipmap(Se),S.unbindTexture()},this.initRenderTarget=function(T){Y.get(T).__webglFramebuffer===void 0&&J.setupRenderTarget(T)},this.initTexture=function(T){T.isCubeTexture?J.setTextureCube(T,0):T.isData3DTexture?J.setTexture3D(T,0):T.isDataArrayTexture||T.isCompressedArrayTexture?J.setTexture2DArray(T,0):J.setTexture2D(T,0),S.unbindTexture()},this.resetState=function(){X=0,O=0,N=null,S.reset(),xe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return di}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=$e._getDrawingBufferColorSpace(e),n.unpackColorSpace=$e._getUnpackColorSpace()}}function jw(t){const n=document.createElement("canvas");n.width=t.w*2,n.height=t.h*2;const i=n.getContext("2d");i.scale(2,2),iA(i,0,0,t.w,t.h,10),i.fillStyle=t.bg,i.fill(),t.accent&&(i.strokeStyle=t.accent,i.lineWidth=2,i.stroke());const s=16,o=t.fontSize??18;i.fillStyle=t.fg,i.font=`600 ${o}px Inter, system-ui, sans-serif`,t.align==="center"||!t.subtext?(i.textAlign="center",i.textBaseline="middle",t.subtext?(i.font=`600 ${o}px Inter, system-ui, sans-serif`,i.fillText(t.text,t.w/2,t.h/2-o*.6),i.font=`400 ${o*.65}px Inter, system-ui, sans-serif`,i.fillStyle=t.accent??t.fg,i.fillText(t.subtext,t.w/2,t.h/2+o*.6)):i.fillText(t.text,t.w/2,t.h/2)):(i.textAlign="left",i.textBaseline="top",i.fillText(t.text,s,t.h/2-o*.5),t.subtext&&(i.font=`400 ${o*.7}px Inter, system-ui, sans-serif`,i.fillStyle=t.accent??t.fg,i.fillText(t.subtext,s,t.h/2+o*.6))),t.icon&&(i.font=`${o*1.2}px Inter, system-ui, sans-serif`,i.textAlign="right",i.textBaseline="middle",i.fillStyle=t.accent??t.fg,i.fillText(t.icon,t.w-s,t.h/2));const a=new Sc(n);return a.colorSpace=Qt,a}async function eA(t){const n=document.createElement("canvas");n.width=t.w*2,n.height=t.h*2;const i=n.getContext("2d");i.scale(2,2);const r=i.createLinearGradient(0,0,t.w,t.h);if(r.addColorStop(0,"#1a2a4a"),r.addColorStop(1,"#0a1120"),i.fillStyle=r,i.fillRect(0,0,t.w,t.h),t.imageUrl)try{const l=await Qv(t.imageUrl),c=l.width/l.height,d=t.w/t.h;let h=t.w,u=t.h,p=0,g=0;c>d?(u=t.h,h=u*c,p=(t.w-h)/2):(h=t.w,u=h/c,g=(t.h-u)/2),i.drawImage(l,p,g,h,u)}catch{eg(i,t)}else eg(i,t);const s=i.createLinearGradient(0,t.h*.5,0,t.h);s.addColorStop(0,"rgba(5,10,20,0)"),s.addColorStop(1,"rgba(5,10,20,0.92)"),i.fillStyle=s,i.fillRect(0,t.h*.5,t.w,t.h*.5);const o=16;i.fillStyle="rgba(245,158,11,0.95)",i.beginPath(),i.arc(t.w-o-10,o+10,o,0,Math.PI*2),i.fill(),i.fillStyle="#0a1120",i.font="700 13px Inter, system-ui, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillText(t.rating.toFixed(1),t.w-o-10,o+10),i.fillStyle="#f1f5f9",i.font="600 15px Inter, system-ui, sans-serif",i.textAlign="left",i.textBaseline="bottom",ec(i,t.title,12,t.h-24,t.w-24,17,2),i.font="400 12px Inter, system-ui, sans-serif",i.fillStyle="#94a3b8",i.fillText(t.year,12,t.h-8);const a=new Sc(n);return a.colorSpace=Qt,a}function eg(t,e){t.fillStyle="#f1f5f9",t.font="600 16px Inter, system-ui, sans-serif",t.textAlign="center",t.textBaseline="middle",ec(t,e.title,e.w/2,e.h/2-10,e.w-20,18,3)}async function tA(t){const n=document.createElement("canvas");n.width=t.w*2,n.height=t.h*2;const i=n.getContext("2d");i.scale(2,2);const r=i.createLinearGradient(0,0,t.w,t.h);if(r.addColorStop(0,"#0d1b2a"),r.addColorStop(1,"#050810"),i.fillStyle=r,i.fillRect(0,0,t.w,t.h),t.imageUrl)try{const l=await Qv(t.imageUrl),c=l.width/l.height,d=t.w/t.h;let h=t.w,u=t.h,p=0,g=0;c>d?(u=t.h,h=u*c,p=(t.w-h)/2):(h=t.w,u=h/c,g=(t.h-u)/2),i.drawImage(l,p,g,h,u)}catch{}const s=i.createLinearGradient(0,0,t.w,0);s.addColorStop(0,"rgba(5,8,16,0.88)"),s.addColorStop(.5,"rgba(5,8,16,0.5)"),s.addColorStop(1,"rgba(5,8,16,0.2)"),i.fillStyle=s,i.fillRect(0,0,t.w,t.h),i.fillStyle="#f8fafc",i.font="700 28px Inter, system-ui, sans-serif",i.textAlign="left",i.textBaseline="top",ec(i,t.title,28,28,t.w*.55,32,2);let o=90;t.metadata&&(i.fillStyle="#94a3b8",i.font="500 14px Inter, system-ui, sans-serif",i.fillText(t.metadata,28,o),o+=24),i.fillStyle="#cbd5e1",i.font="400 15px Inter, system-ui, sans-serif",ec(i,t.overview,28,o,t.w*.5,22,6);const a=new Sc(n);return a.colorSpace=Qt,a}function nA(t){const n=document.createElement("canvas");n.width=t.w*2,n.height=t.h*2;const i=n.getContext("2d");i.scale(2,2),i.fillStyle="#0a0f1a",i.fillRect(0,0,t.w,t.h),i.fillStyle="#f59e0b",i.fillRect(0,0,4,t.h),i.fillStyle="#f8fafc",i.font="700 22px Inter, system-ui, sans-serif",i.textAlign="left",i.textBaseline="middle",i.fillText(t.title,20,t.h/2);const r=new Sc(n);return r.colorSpace=Qt,r}function Qv(t){return new Promise((e,n)=>{const i=new Image;i.crossOrigin="anonymous",i.onload=()=>e(i),i.onerror=n,i.src=t})}function iA(t,e,n,i,r,s){t.beginPath(),t.moveTo(e+s,n),t.arcTo(e+i,n,e+i,n+r,s),t.arcTo(e+i,n+r,e,n+r,s),t.arcTo(e,n+r,e,n,s),t.arcTo(e,n,e+i,n,s),t.closePath()}function ec(t,e,n,i,r,s,o){const a=e.split(" ");let l="",c=[];for(const d of a){const h=l?l+" "+d:d;t.measureText(h).width>r&&l?(c.push(l),l=d):l=h}if(l&&c.push(l),c=c.slice(0,o),c.length===o){const d=c[o-1];c[o-1]=d.slice(0,Math.max(0,d.length-3))+"..."}for(let d=0;d<c.length;d++)t.fillText(c[d],n,i+d*s)}const tl=0,fs=1.5;class Uu{constructor(e,n,i){this.raf=0,this.lastTime=0,this.screenW=0,this.screenH=0,this.views=new Map,this.textureLoads=new Map,this.textureCache=new Map,this.disposed=!1,this.onFocusChange=()=>{this.updateHighlight()},this.container=e,this.layout=n,this.engine=i,this.screenW=e.clientWidth||window.innerWidth,this.screenH=e.clientHeight||window.innerHeight,this.renderer=new Qw({antialias:!0,alpha:!1}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setSize(this.screenW,this.screenH),this.renderer.setClearColor(329485,1),this.renderer.autoClear=!1,this.renderer.setScissorTest(!0),e.appendChild(this.renderer.domElement),this.buildScenes(),this.lastTime=performance.now(),this.loop=this.loop.bind(this),this.raf=requestAnimationFrame(this.loop)}buildScenes(){for(const e of this.layout.allPanels)this.buildPanelView(e);this.updateHighlight()}buildPanelView(e){const n=new Fy,i=e.viewport,r=new wh(0,i.w,0,-i.h,-100,100);r.position.z=50,n.add(r);const s=new _o;n.add(s);const o=new Map,a=new Map,l=new Map,c=(_,M)=>{const{x,y:E,w:A,h:C}=_.bounds,y=x+A/2,w=-(E+C/2),R=new Fr(A,C),P=new Po({color:_.color,transparent:M,opacity:M?.35:1,side:Un,depthWrite:!M}),L=new zn(R,P);L.position.set(y,w,tl),s.add(L),o.set(_.id,L),l.set(_.id,P);const k=new Cu(R),$=new xo({color:M?3359061:725536,transparent:!0,opacity:M?.4:.8}),D=new Ya(k,$);D.position.copy(L.position),s.add(D),a.set(_.id,D),this.loadTileTexture(_,P,A,C)};for(const _ of e.tiles)c(_,!!_.childPanel);const d=new Fr(1,1),h=new Po({color:16096779,transparent:!0,opacity:.18,side:Un,depthWrite:!1}),u=new zn(d,h);u.position.z=fs,u.visible=!1,s.add(u);const p=new Cu(d),g=new xo({color:16096779,transparent:!0,opacity:1,depthWrite:!1}),v=new Ya(p,g);v.position.z=fs+.01,v.visible=!1,s.add(v);const m=new xo({color:16777215,transparent:!0,opacity:1,depthWrite:!1}),f=new Ya(new Rn,m);f.position.z=fs+.02,f.visible=!1,s.add(f),this.views.set(e.id,{panel:e,scene:n,camera:r,contentGroup:s,highlight:u,highlightBorder:v,brackets:f,hlFillMat:h,hlBorderMat:g,bracketMat:m,tileMeshes:o,tileBorders:a,tileMaterials:l})}updateLayout(e){this.layout=e,this.engine.updateLayout(e);const n=new Set(e.allPanels.map(i=>i.id));for(const[i,r]of this.views.entries())n.has(i)||(r.scene.traverse(s=>{s.geometry&&s.geometry.dispose(),s.material&&(Array.isArray(s.material)?s.material:[s.material]).forEach(a=>{a.map&&a.map.dispose(),a.dispose()})}),this.views.delete(i));for(const i of e.allPanels){const r=this.views.get(i.id);if(!r){this.buildPanelView(i);continue}const s=r.panel;i.scrollX=s.scrollX,i.scrollY=s.scrollY,i.targetScrollX=s.targetScrollX,i.targetScrollY=s.targetScrollY,r.panel=i;const o=new Set(i.tiles.map(a=>a.id));for(const[a,l]of r.tileMeshes.entries())if(!o.has(a)){r.contentGroup.remove(l);const c=r.tileBorders.get(a);c&&(r.contentGroup.remove(c),c.geometry.dispose(),c.material.dispose(),r.tileBorders.delete(a)),r.tileMeshes.delete(a);const d=r.tileMaterials.get(a);d&&(d.map&&d.map.dispose(),d.dispose()),r.tileMaterials.delete(a),l.geometry.dispose()}for(const a of i.tiles)if(r.tileMeshes.has(a.id)){const l=r.tileMeshes.get(a.id),{x:c,y:d,w:h,h:u}=a.bounds,p=c+h/2,g=-(d+u/2),v=r.tileBorders.get(a.id);l.position.set(p,g,tl),v&&v.position.set(p,g,tl)}else{const l=!!a.childPanel,{x:c,y:d,w:h,h:u}=a.bounds,p=c+h/2,g=-(d+u/2),v=new Fr(h,u),m=new Po({color:a.color,transparent:l,opacity:l?.35:1,side:Un,depthWrite:!l}),f=new zn(v,m);f.position.set(p,g,tl),r.contentGroup.add(f),r.tileMeshes.set(a.id,f),r.tileMaterials.set(a.id,m);const _=new Cu(v),M=new xo({color:l?3359061:725536,transparent:!0,opacity:l?.4:.8}),x=new Ya(_,M);x.position.copy(f.position),r.contentGroup.add(x),r.tileBorders.set(a.id,x),this.loadTileTexture(a,m,h,u)}}this.updateHighlight()}loadTileTexture(e,n,i,r){const s=e.content;let o=e.id;if(s.kind==="poster"||s.kind==="backdrop"?o=s.imageUrl||s.title||e.id:s.kind==="text"&&(o=`text-${s.text}`),this.textureCache.has(o)){n.map=this.textureCache.get(o),n.color.setHex(16777215),n.needsUpdate=!0;return}let a=this.textureLoads.get(o);switch(a?(s.kind==="poster"&&n.color.setHex(659744),s.kind==="backdrop"&&n.color.setHex(858922)):(s.kind==="poster"?(n.color.setHex(659744),s.imageUrl&&(a=eA({imageUrl:s.imageUrl,title:s.title,year:s.year,rating:s.rating,w:Math.max(80,Math.floor(i)),h:Math.max(120,Math.floor(r))}))):s.kind==="backdrop"&&(n.color.setHex(858922),s.imageUrl&&(a=tA({imageUrl:s.imageUrl,title:s.title,metadata:s.metadata,overview:s.overview,w:Math.max(200,Math.floor(i)),h:Math.max(120,Math.floor(r))}))),a&&this.textureLoads.set(o,a)),a&&a.then(l=>{this.disposed||!l||(this.textureCache.set(o,l),n.map=l,n.color.setHex(16777215),n.needsUpdate=!0)}).catch(()=>{}),s.kind){case"text":{n.color.setHex(16777215),n.transparent=!0,n.opacity=1;const l={"#0d9488":"#0d2d2a","#059669":"#0a3a2a","#2563eb":"#16265a","#0ea5e9":"#0c2f4a","#ea580c":"#3a1a0a","#dc2626":"#3a1010","#e11d48":"#3a0f1a","#0891b2":"#0a3040","#16a34a":"#0a3520","#d97706":"#3a200a"},c="#"+e.color.toString(16).padStart(6,"0"),d=l[c]??"#1e293b",h=jw({text:s.text,subtext:s.subtext,bg:d,fg:"#f1f5f9",accent:"#f59e0b",w:Math.max(80,Math.floor(i)),h:Math.max(40,Math.floor(r)),fontSize:i>200?16:15,align:s.subtext?"left":"center"});n.map=h,n.needsUpdate=!0;break}case"section":{n.color.setHex(16777215);const l=nA({title:s.title,w:Math.max(100,Math.floor(i)),h:Math.max(30,Math.floor(r))});n.map=l,n.needsUpdate=!0;break}case"placeholder":n.color.setHex(1976635);break;case"detail":n.color.setHex(1976635);break}}updateFocus(){this.updateHighlight(),this.maybeLoadPreviewData()}maybeLoadPreviewData(){}buildBracketGeometry(e,n){const i=Math.min(18,Math.min(e,n)*.22),r=e/2,s=n/2,o=[],a=(c,d,h,u)=>{o.push(c,d,0,c+h*i,d,0),o.push(c,d,0,c,d+u*i,0)};a(-r,-s,1,1),a(r,-s,-1,1),a(-r,s,1,-1),a(r,s,-1,-1);const l=new Rn;return l.setAttribute("position",new wn(o,3)),l}updateHighlight(){const e=this.engine.focused;for(const n of this.views.values()){const i=n.panel===e.panel;if(n.highlight.visible=i,n.highlightBorder.visible=i,n.brackets.visible=i,i){const{x:r,y:s,w:o,h:a}=e.bounds,l=r+o/2,c=-(s+a/2),d=6;n.highlight.position.set(l,c,fs),n.highlight.scale.set(o+d,a+d,1),n.highlightBorder.position.set(l,c,fs+.01),n.highlightBorder.scale.set(o+d,a+d,1),n.brackets.position.set(l,c,fs+.02),n.brackets.geometry.dispose(),n.brackets.geometry=this.buildBracketGeometry(o+d,a+d)}}}loop(e){if(this.disposed)return;const n=Math.min(.05,(e-this.lastTime)/1e3);this.lastTime=e,this.engine.step(n);for(const l of this.views.values()){const c=l.panel;l.contentGroup.position.set(-c.scrollX,c.scrollY,0);for(const d of c.tiles){const h=l.tileMeshes.get(d.id),u=l.tileBorders.get(d.id);if(h){const g=this.engine.focused.id===d.id?1.05:1;h.scale.x+=(g-h.scale.x)*12*n,h.scale.y+=(g-h.scale.y)*12*n,u&&u.scale.copy(h.scale);const v=d.bounds.y-c.scrollY,m=500,f=!(v>c.viewport.h+m||v+d.bounds.h<-m);h.visible=f,u&&(u.visible=f)}}}const i=e/1e3,r=.5+.5*Math.sin(i*5),s=this.views.get(this.engine.focused.panel.id);s&&(s.hlFillMat.opacity=.14+.12*r,s.hlBorderMat.opacity=.7+.3*r,s.bracketMat.opacity=.8+.2*r);const o=this.renderer;o.setScissorTest(!0),o.clear(!0,!0,!0);const a=[...this.views.values()].sort((l,c)=>l.panel.depth-c.panel.depth);for(const l of a){const c=l.panel,d=qo(c),h=BS(c);if(h.w<=0||h.h<=0)continue;const u=d.x,p=this.screenH-(d.y+d.h);o.setViewport(u,p,d.w,d.h),o.setScissor(h.x,this.screenH-(h.y+h.h),h.w,h.h),o.clearDepth(),o.render(l.scene,l.camera)}this.raf=requestAnimationFrame(this.loop)}dispose(){this.disposed=!0,cancelAnimationFrame(this.raf),this.renderer.dispose();for(const e of this.views.values())e.scene.traverse(n=>{n.geometry&&n.geometry.dispose();const i=n.material;Array.isArray(i)?i.forEach(r=>r.dispose()):i&&i.dispose()});this.renderer.domElement.parentElement===this.container&&this.container.removeChild(this.renderer.domElement)}}const rA={ArrowUp:"up",ArrowDown:"down",ArrowLeft:"left",ArrowRight:"right"};function sA(){const t=lt.useRef(null),[e,n]=lt.useState(null),[i,r]=lt.useState([]),[s,o]=lt.useState(!0),[a,l]=lt.useState(null),[c,d]=lt.useState(null),[h,u]=lt.useState([{type:"home"}]),[p,g]=lt.useState("all"),v=h[h.length-1],m=lt.useRef([]),f=lt.useRef(v),_=lt.useRef(!1);lt.useEffect(()=>{m.current=v.dynamicData||[]},[v.dynamicData]),lt.useEffect(()=>{f.current=v},[v]),lt.useEffect(()=>{let w=!1;return(async()=>{try{const R=new Date().getFullYear(),P=Array.from({length:10},(le,oe)=>R-oe),[L,k,$,D,X,O,N,W,K,j,re]=await Promise.all([ft.trendingMovies(),ft.popularMovies(),ft.topRatedMovies(),ft.upcomingMovies(),ft.nowPlayingMovies(),ft.trendingTV(),ft.popularTV(),ft.topRatedTV(),ft.latestTV(),ft.movieGenres(),ft.tvGenres()]);if(w)return;const se={trending:yn(L.results),popular:yn(k.results),topRated:yn($.results),upcoming:yn(D.results),nowPlaying:yn(X.results),trendingTV:yn(O.results),popularTV:yn(N.results),topRatedTV:yn(W.results),latestTV:yn(K.results),movieGenres:j.genres,tvGenres:re.genres,years:P};d(se),o(!1)}catch(R){if(w)return;l(R instanceof Error?R.message:"Failed to load movie data"),o(!1)}})(),()=>{w=!0}},[]),lt.useEffect(()=>{let w=!1;return(async()=>{var R,P;if(!(v.type!=="genre"&&v.type!=="year"&&v.type!=="person"||v.dynamicData)){_.current=!0;try{if(v.type==="person"){const[le,oe]=await Promise.all([ft.personMovieCredits(v.personId),ft.personTVCredits(v.personId)]),B=yn([...le.cast||[],...oe.cast||[]].sort((Z,te)=>(te.vote_average||0)-(Z.vote_average||0)));if(w)return;u(Z=>{const te=[...Z],Ee={...te[te.length-1]};return Ee.dynamicData=B,te[te.length-1]=Ee,te}),_.current=!1;return}const L=((R=t.current)==null?void 0:R.clientWidth)||window.innerWidth,k=((P=t.current)==null?void 0:P.clientHeight)||window.innerHeight,D=Math.floor((L-32)/174),X=Math.ceil(k/234),O=D*X,N=Math.max(1,Math.ceil(O/20)),W=le=>v.type==="genre"?v.mediaType==="tv"?ft.discoverTV({with_genres:v.genreId,page:le}):ft.discoverMovies({with_genres:v.genreId,page:le}):v.mediaType==="tv"?ft.discoverTV({first_air_date_year:v.year,page:le}):ft.discoverMovies({year:v.year,page:le}),K=[];for(let le=1;le<=N;le++)K.push(W(le));const j=await Promise.all(K);if(w)return;const re=j.flatMap(le=>yn(le.results)),se=j[j.length-1];u(le=>{const oe=[...le],B={...oe[oe.length-1]};return B.dynamicData=re,B.dynamicPage=N,B.dynamicHasMore=se.results.length>=20,oe[oe.length-1]=B,oe})}catch{}_.current=!1}})(),()=>{w=!0}},[v]);const M=async()=>{const w=f.current;if(_.current||w.dynamicHasMore===!1||w.type!=="genre"&&w.type!=="year")return;_.current=!0;const R=(w.dynamicPage||1)+1;try{let P;if(w.type==="genre")P=w.mediaType==="tv"?await ft.discoverTV({with_genres:w.genreId,page:R}):await ft.discoverMovies({with_genres:w.genreId,page:R});else if(w.type==="year")P=w.mediaType==="tv"?await ft.discoverTV({first_air_date_year:w.year,page:R}):await ft.discoverMovies({year:w.year,page:R});else return;const L=yn(P.results);u(k=>{const $=[...k],D={...$[$.length-1]};return L.length>0&&(D.dynamicData=[...D.dynamicData||[],...L],D.dynamicPage=R),(L.length===0||P.results.length<20)&&(D.dynamicHasMore=!1),$[$.length-1]=D,$})}catch{}_.current=!1},x=lt.useRef(null),E=lt.useRef(null),A=lt.useRef(null),C=lt.useRef("all"),y=lt.useRef([]);return lt.useEffect(()=>{if(v.type==="details"&&!v.similar){const w=pl(v.movie);ft.getSimilarMovies(v.movie.id,w).then(R=>{u(P=>{const L=[...P],k=L[L.length-1];return k.type==="details"&&k.movie.id===v.movie.id?(L[L.length-1]={...k,similar:yn(R.results)},L):P})}).catch(console.error),w==="tv"?ft.tvDetails(v.movie.id).then(R=>{const P=v.season||1;(R.seasons&&R.seasons.length>0?ft.tvSeason(v.movie.id,P):Promise.resolve({episodes:[]})).then(k=>{u($=>{var O,N;const D=[...$],X=D[D.length-1];return X.type==="details"&&X.movie.id===v.movie.id?(D[D.length-1]={...X,movie:{...X.movie,...R,cast:((O=R.credits)==null?void 0:O.cast)||[],crew:((N=R.credits)==null?void 0:N.crew)||[]},seasonsData:R.seasons||[],episodesData:k.episodes||[],season:P,episode:v.episode||1},D):$})}).catch(console.error)}).catch(console.error):ft.movieDetails(v.movie.id).then(R=>{u(P=>{var $,D;const L=[...P],k=L[L.length-1];return k.type==="details"&&k.movie.id===v.movie.id?(L[L.length-1]={...k,movie:{...k.movie,...R,cast:(($=R.credits)==null?void 0:$.cast)||[],crew:((D=R.credits)==null?void 0:D.crew)||[]}},L):P})}).catch(console.error)}},[v]),lt.useEffect(()=>{let w=0;const R=()=>{if(w=requestAnimationFrame(R),v.type!=="details"||!x.current)return;x.current.allLeaves.filter(L=>L.content.action==="play_server").forEach((L,k)=>{const $=y.current[k];if(!$)return;const D=qo(L.panel),X=D.x+L.bounds.x-L.panel.scrollX,O=D.y+L.bounds.y-L.panel.scrollY;$.style.transform=`translate(${X}px, ${O}px)`,$.style.width=`${L.bounds.w}px`,$.style.height=`${L.bounds.h}px`;const N=O+L.bounds.h>0&&O<window.innerHeight;$.style.display=N?"block":"none"})};return w=requestAnimationFrame(R),()=>cancelAnimationFrame(w)},[v.type]),lt.useEffect(()=>()=>{var w;(w=E.current)==null||w.dispose()},[]),lt.useEffect(()=>{if(!c)return;const w=t.current;if(!w)return;const R=w.clientWidth||window.innerWidth,P=w.clientHeight||window.innerHeight,L=Jc(R,P,c,v,v.dynamicData||null,p),k=A.current,$=C.current!==p;let D=!1;if(k&&E.current&&x.current&&!$&&k.type===v.type&&(v.type==="genre"&&k.type==="genre"&&k.genreId===v.genreId||v.type==="year"&&k.type==="year"&&k.year===v.year||v.type==="details"&&k.type==="details"&&k.movie.id===v.movie.id&&k.season===v.season&&k.episode===v.episode)&&(D=!0),D)x.current.updateLayout(L),E.current.updateLayout(L),window.engine=x.current,window.sceneManager=E.current;else{if(E.current&&E.current.dispose(),x.current=new jc(L),v.scrollStates)for(const se of x.current.allPanels){const le=v.scrollStates[se.id];le&&(se.scrollX=le.scrollX,se.scrollY=le.scrollY,se.targetScrollX=le.targetScrollX,se.targetScrollY=le.targetScrollY)}if(v.focusLabel){const se=L.allLeaves.find(le=>le.label===v.focusLabel);se&&x.current.setFocus(se)}else{const se=L.allLeaves.find(le=>{var B;let oe=le.panel;for(;oe;){if(oe.id==="header"||oe.id==="sidebar")return!1;oe=((B=oe.parentTile)==null?void 0:B.panel)??null}return!0});se&&x.current.setFocus(se)}E.current=new Uu(w,L,x.current),window.engine=x.current,window.sceneManager=E.current}A.current=v,C.current=p,x.current.onFocusChange=(se,le)=>{var B;v.focusLabel=se.label;const oe=se.content;oe.kind==="poster"&&m.current.length>0&&m.current.findIndex(te=>te.id===oe.movieId)>=m.current.length-15&&M(),(B=E.current)==null||B.updateFocus(),X(le),r(Z=>[`${new Date().toLocaleTimeString()} → ${se.label} (${se.panel.id})`,...Z].slice(0,6))};const X=se=>{const le=x.current.focused;n({focusedLabel:le.label,panelId:le.panel.id,depth:le.panel.depth,dir:se,count:x.current.layout.allLeaves.length})};X(x.current.lastDir);let O;const N=()=>{window.clearTimeout(O),O=window.setTimeout(()=>{const se=w.clientWidth||window.innerWidth,le=w.clientHeight||window.innerHeight;E.current&&E.current.dispose();const oe=Jc(se,le,c,v,v.dynamicData||null,p);x.current=new jc(oe),E.current=new Uu(w,oe,x.current)},200)},W=()=>{const se=w.clientWidth||window.innerWidth,le=w.clientHeight||window.innerHeight;E.current&&E.current.dispose();const oe=Jc(se,le,c,v,v.dynamicData||null,p);x.current=new jc(oe),E.current=new Uu(w,oe,x.current),window.engine=x.current},K=se=>{var le,oe;console.log("NAVIGATING TO:",se.type,se.type==="details"?((le=se.movie)==null?void 0:le.title)||((oe=se.movie)==null?void 0:oe.name):""),u(B=>{const Z=[...B],te={...Z[Z.length-1]},Ee={};for(const De of x.current.allPanels)Ee[De.id]={scrollX:De.scrollX,scrollY:De.scrollY,targetScrollX:De.targetScrollX,targetScrollY:De.targetScrollY};return te.scrollStates=Ee,te.focusLabel=x.current.focused.label,Z[Z.length-1]=te,Z.push(se),Z})},j=()=>{u(se=>{if(se.length<=1)return se;const le=[...se];return le.pop(),le})},re=se=>{if(se.key==="r"||se.key==="R"){se.preventDefault(),W();return}if(se.key==="Enter"){se.preventDefault();const oe=x.current.focused.content;if(console.log("ENTER on:",oe.kind,"label:",x.current.focused.label),oe.kind==="text"&&oe.action){if(oe.action==="home")g("all"),K({type:"home"});else if(oe.action==="setFilter")g(oe.payload),v.type!=="home"&&K({type:"home"});else if(oe.action==="person"){const B=oe.payload;K({type:"person",personId:B.id,personName:B.name})}else if(oe.action==="genre"){const B=oe.payload;K({type:"genre",genreId:B.id,genreName:B.name,mediaType:B.mediaType})}else if(oe.action==="year"){const B=oe.payload;K({type:"year",year:B.year,mediaType:B.mediaType})}else if(oe.action==="play_server")K({type:"player",movie:v.type==="details"?v.movie:oe.payload,serverIndex:oe.payload,season:v.type==="details"?v.season:void 0,episode:v.type==="details"?v.episode:void 0});else if(oe.action==="change_season"&&v.type==="details"){const B=oe.payload;console.log("CHANGE_SEASON DISPATCHED:",B,"for movie",v.movie.id),ft.tvSeason(v.movie.id,B).then(Z=>{var te;console.log("TMDB RESOLVED:",(te=Z.episodes)==null?void 0:te.length,"episodes"),u(Ee=>{const De=[...Ee],Ce=De[De.length-1];return Ce.type==="details"&&Ce.movie.id===v.movie.id?(console.log("UPDATING VIEW STACK with season",B),De[De.length-1]={...Ce,season:B,episodesData:Z.episodes,episode:1},De):(console.log("NOT UPDATING VIEW STACK: top.type=",Ce.type,"top.id=",Ce.type==="details"?Ce.movie.id:null),Ee)})}).catch(Z=>console.error("CHANGE_SEASON TMDB ERROR:",Z))}else if(oe.action==="change_episode"&&v.type==="details"){const B=oe.payload;u(Z=>{const te=[...Z],Ee=te[te.length-1];return Ee.type==="details"&&Ee.movie.id===v.movie.id?(te[te.length-1]={...Ee,episode:B},te):Z})}}else(oe.kind==="poster"||oe.kind==="backdrop")&&K({type:"details",movie:oe.movie});return}if(se.key==="Escape"||se.key==="Backspace"){se.preventDefault(),j();return}const le=rA[se.key];le&&(se.preventDefault(),x.current.handleInput(le))};return window.addEventListener("keydown",re),window.addEventListener("resize",N),()=>{window.removeEventListener("keydown",re),window.removeEventListener("resize",N),window.clearTimeout(O)}},[c,v,p]),s?Ie.jsx("div",{className:"w-screen h-screen flex items-center justify-center bg-[#05070d] text-slate-100",children:Ie.jsxs("div",{className:"text-center",children:[Ie.jsx("div",{className:"inline-block w-12 h-12 border-4 border-amber-400 border-t-transparent rounded-full animate-spin mb-4"}),Ie.jsx("div",{className:"text-lg font-semibold text-amber-300",children:"CineDeck"}),Ie.jsx("div",{className:"text-sm text-slate-400 mt-1",children:"Loading movies & TV shows..."})]})}):a?Ie.jsx("div",{className:"w-screen h-screen flex items-center justify-center bg-[#05070d] text-slate-100",children:Ie.jsxs("div",{className:"text-center max-w-md",children:[Ie.jsx("div",{className:"text-rose-400 text-lg font-semibold mb-2",children:"Couldn't load movie data"}),Ie.jsx("div",{className:"text-sm text-slate-400",children:a})]})}):Ie.jsxs("div",{className:"relative w-screen h-screen overflow-hidden bg-[#05070d] text-slate-100 select-none",children:[Ie.jsx("div",{ref:t,className:"absolute inset-0"}),v.type==="details"&&Ie.jsx("div",{className:"absolute inset-0 z-0 pointer-events-none overflow-hidden",children:Pf(v.movie.id,pl(v.movie),v.season,v.episode).map((w,R)=>Ie.jsx("div",{ref:P=>y.current[R]=P,className:"absolute top-0 left-0 bg-black",style:{display:"none"},children:Ie.jsx("iframe",{src:`${w.url}?mute=1&muted=1&autoplay=1&autoplay=true&muted=true`,className:"w-full h-full border-none pointer-events-auto",allowFullScreen:!0,allow:"autoplay; fullscreen",title:`Server ${R+1}`})},`server-bg-${R}-${v.season}-${v.episode}`))}),v.type==="player"&&Ie.jsx("div",{className:"absolute inset-0 z-50 bg-black",children:Ie.jsx("iframe",{src:`${Pf(v.movie.id,pl(v.movie),v.season,v.episode)[v.serverIndex].url}?autoplay=1&autoplay=true`,className:"w-full h-full border-none",allowFullScreen:!0,allow:"autoplay; fullscreen",title:"Fullscreen Player"})}),Ie.jsx("div",{className:"pointer-events-none absolute top-3 left-3 z-10 font-mono text-xs leading-relaxed",children:Ie.jsxs("div",{className:"rounded-lg bg-black/60 backdrop-blur-sm border border-white/10 px-3 py-2 shadow-lg",children:[Ie.jsx("div",{className:"text-[10px] uppercase tracking-widest text-amber-300/80 mb-1",children:"CineDeck · TMDB Browser"}),e&&Ie.jsxs(Ie.Fragment,{children:[Ie.jsxs("div",{className:"flex gap-2",children:[Ie.jsx("span",{className:"text-slate-400",children:"title"}),Ie.jsx("span",{className:"text-amber-300 font-semibold",children:e.focusedLabel})]}),Ie.jsxs("div",{className:"flex gap-2",children:[Ie.jsx("span",{className:"text-slate-400",children:"panel"}),Ie.jsx("span",{className:"text-sky-300",children:e.panelId}),Ie.jsxs("span",{className:"text-slate-500",children:["depth ",e.depth]})]}),Ie.jsxs("div",{className:"flex gap-2",children:[Ie.jsx("span",{className:"text-slate-400",children:"last"}),Ie.jsx("span",{className:"text-emerald-300",children:e.dir??"—"}),Ie.jsxs("span",{className:"text-slate-500",children:[e.count," tiles"]})]})]})]})}),Ie.jsx("div",{className:"pointer-events-none absolute top-3 right-3 z-10 font-mono text-xs",children:Ie.jsxs("div",{className:"rounded-lg bg-black/60 backdrop-blur-sm border border-white/10 px-3 py-2 shadow-lg",children:[Ie.jsx("div",{className:"text-[10px] uppercase tracking-widest text-slate-400 mb-1",children:"Controls"}),Ie.jsx("div",{className:"text-slate-200",children:"↑ ↓ ← → navigate"}),Ie.jsx("div",{className:"text-amber-300",children:"R refresh layout"}),Ie.jsx("div",{className:"text-slate-500 text-[10px] mt-1",children:"panels auto-scroll · focus stays in view"})]})}),Ie.jsx("div",{className:"pointer-events-none absolute bottom-3 right-3 z-10 font-mono text-[11px]",children:Ie.jsxs("div",{className:"rounded-lg bg-black/60 backdrop-blur-sm border border-white/10 px-3 py-2 shadow-lg w-64",children:[Ie.jsx("div",{className:"text-[10px] uppercase tracking-widest text-slate-400 mb-1",children:"Nav log"}),Ie.jsxs("div",{className:"space-y-0.5",children:[i.length===0&&Ie.jsx("div",{className:"text-slate-500",children:"—"}),i.map((w,R)=>Ie.jsx("div",{className:R===0?"text-emerald-300":"text-slate-400",children:w},R))]})]})}),e&&Ie.jsx("div",{className:"pointer-events-none absolute bottom-3 left-3 z-10 font-mono text-xs",children:Ie.jsxs("div",{className:"rounded-lg bg-amber-400/10 border border-amber-300/30 px-3 py-2 shadow-lg",children:[Ie.jsx("span",{className:"text-amber-300 font-semibold",children:e.focusedLabel}),Ie.jsx("span",{className:"text-slate-400",children:" in "}),Ie.jsx("span",{className:"text-sky-300",children:e.panelId})]})})]})}function yn(t){return t?t.filter(e=>e&&(e.title||e.name)&&e.poster_path&&e.backdrop_path):[]}hv(document.getElementById("root")).render(Ie.jsx(lt.StrictMode,{children:Ie.jsx(sA,{})}));
